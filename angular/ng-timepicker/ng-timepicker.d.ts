...
export declare class NgTimepicker extends LitElement {
    ...
    _cleanupFloatingList: (() => void) | null;
    _cleanupFloatingManual: (() => void) | null;
    _referenceEl: HTMLElement | null;
    _floatingListEl: HTMLElement | null;
    _floatingManualEl: HTMLElement | null;
    constructor();
    ...
    _updatePopperList(): Promise<void>;
    _createPopperManual(): void;
    _updatePopperManual(): Promise<void>;
