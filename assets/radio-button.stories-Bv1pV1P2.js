import{x as e}from"./iframe-CK9yflr1.js";import{w as a}from"./storybook-decorators-DSS85Rnr.js";const o=`
 .wrapper {
        display: flex;
...
`,y={title:"Components/Radio Button",argTypes:{label:{name:"Label"},hideLabel:{name:"Amagar Label",control:{type:"boolean"}},disabled:{name:"Deshabilitar",control:{type:"boolean"}},checked:{name:"Marcat",control:{type:"boolean"}}},parameters:{layout:"centered"}},r={render:d=>e`
            <dss-radio-button
    ...
    `,decorators:[a(o,"radio-checked-style")]},l={tags:["!dev"],render:()=>e`
      <div class="wrapper">
                ...
                <dss-radio-button-group name="group-disabled single" label="Deshabilitat individual" orientation="vertical" value="dewey">
                    <dss-radio-button label="Huey" value="huey"></dss-radio-button>
                    <dss-radio-button label="Dewey" value="dewey"></dss-radio-button>
                    <dss-radio-button label="Louie" value="louie" disabled></dss-radio-button>
                </dss-radio-button-group>
                <dss-radio-button-group name="group-vertical"  label="Deshabilitat per grup" disabled value="dewey">
                    <dss-radio-button label="Huey" value="huey"></dss-radio-button>
                    <dss-radio-button label="Dewey" value="dewey"></dss-radio-button>
                    <dss-radio-button label="Louie" value="louie"></dss-radio-button>
                </dss-radio-button-group>
    ...
    `,decorators:[a(o,"radio-group-style")]},v={tags:["!dev"],render:()=>e`
            <div class="wrapper">
                <dss-button label="Focus" @click=${()=>{const m=document.querySelector("#manual-focus-demo");m&&m.focus()}}></dss-button>
        ...
        `,decorators:[a(o,"radio-focus-style")]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: (args: any) => {
    return html\`
            <dss-radio-button
                name="radio-playground"
...
}`,...v.parameters?.docs?.source}}};const g=["Playground","Default","Checked","Disabled","Horizontal","NoLabel","Label","GroupHideLabel","GroupDefaultValue","GroupDisabled","Focus"],L=Object.freeze(Object.defineProperty({__proto__:null,Checked:s,Default:t,Disabled:l,Focus:v,GroupDefaultValue:p,GroupDisabled:c,GroupHideLabel:b,Horizontal:u,Label:n,NoLabel:i,Playground:r,__namedExportsOrder:g,default:y},Symbol.toStringTag,{value:"Module"}));export{s as C,t as D,v as F,b as G,u as H,n as L,i as N,r as P,L as S,l as a};
