...
`,he={title:"Components/Form/Input",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},label:{name:"Label"},hideLabel:{name:"Amagar label",control:{type:"boolean"}},showIcon:{name:"Mostrar icona",control:{type:"boolean"}},icon:{name:"Icona",control:{type:"text"},if:{arg:"showIcon"}},required:{name:"Camp requerit",control:{type:"boolean"}},readonly:{name:"Només lectura",control:{type:"boolean"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}},showPlaceholder:{name:"Mostrar placeholder",control:{type:"boolean"}},placeholder:{name:"Placeholder",if:{arg:"showPlaceholder"}},showDescription:{name:"Mostrar descripció",control:{type:"boolean"}},description:{name:"Descripció",if:{arg:"showDescription"}},showMaxLength:{name:"Mostrar màxim de caràcters",control:{type:"boolean"}},maxLength:{name:"Màxim de caràcters",control:{type:"number"},if:{arg:"showMaxLength"}},min:{name:"Valor mínim",control:{type:"number"}},max:{name:"Valor màxim",control:{type:"number"}},step:{name:"Passos",control:{type:"number"}},showUnit:{name:"Mostrar unitat",control:{type:"boolean"}},unit:{name:"Unitats",control:{type:"text"},if:{arg:"showUnit"}},showInputPrefix:{name:"Mostrar prefix",control:{type:"boolean"}},inputPrefix:{name:"Prefix",control:{type:"text"},if:{arg:"showInputPrefix"}},hasActions:{name:"Amb accions",control:{type:"boolean"}}},parameters:{layout:"centered"}},t={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=892-20744&m=dev"}},name:"Playground - Text",args:{size:"lg",label:"Label",hideLabel:!1,showIcon:!0,icon:"person",required:!1,readonly:!1,disabled:!1,showPlaceholder:!1,placeholder:"Escriu aquí",showDescription:!1,description:"Help Text",showMaxLength:!1,maxLength:10,showUnit:!1,unit:"cm",showInputPrefix:!1,inputPrefix:"1/",hasActions:!1},render:e=>{const i=e.showMaxLength?e.maxLength:null,fe=e.showDescription?e.description:null;return s`
    ...
    `,decorators:[n(a,"input-disabled-style")]},d={tags:["!dev"],render:()=>s`
        <div class="inputs-sizes">
            <dss-form-input
                name="iReadOnly1"
                icon="add_box"
    ...
    `,decorators:[n(a,"input-sizes-style")]},m={tags:["!dev"],render:()=>s`
            <dss-form-input
                name="inputHelp"
                icon="live_help"
                label="Label"
    ...
    `},decorators:[n(a,"input-actions-style")]},v={tags:["!dev"],render:()=>s`
            <div class="inputs-sizes">
        ...
        `,decorators:[n(a,"input-focus-style")]};var w,L,$;t.parameters={...t.parameters,docs:{...(w=t.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...($=(L=t.parameters)==null?void 0:L.docs)==null?void 0:$.source}}};var z,S,P;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...(P=(S=r.parameters)==null?void 0:S.docs)==null?void 0:P.source}}};var _,I,A;o.parameters={...o.parameters,docs:{...(_=o.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-form-input
...
}`,...(A=(I=o.parameters)==null?void 0:I.docs)==null?void 0:A.source}}};var D,q,T;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <div class="inputs-sizes">
...
}`,...(T=(q=l.parameters)==null?void 0:q.docs)==null?void 0:T.source}}};var R,M,k;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <div class="inputs-sizes">
...
}`,...(k=(M=d.parameters)==null?void 0:M.docs)==null?void 0:k.source}}};var F,H,C;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <div class="inputs-sizes">
...
}`,...(C=(H=u.parameters)==null?void 0:H.docs)==null?void 0:C.source}}};var O,E,N;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(N=(E=p.parameters)==null?void 0:E.docs)==null?void 0:N.source}}};var U,J,K;m.parameters={...m.parameters,docs:{...(U=m.parameters)==null?void 0:U.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-form-input
...
}`,...(K=(J=m.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var X,j,G;c.parameters={...c.parameters,docs:{...(X=c.parameters)==null?void 0:X.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-form-input
...
}`,...(G=(j=c.parameters)==null?void 0:j.docs)==null?void 0:G.source}}};var V,B,Q;b.parameters={...b.parameters,docs:{...(V=b.parameters)==null?void 0:V.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-form-input
...
}`,...(Q=(B=b.parameters)==null?void 0:B.docs)==null?void 0:Q.source}}};var W,Y,Z;f.parameters={...f.parameters,docs:{...(W=f.parameters)==null?void 0:W.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(Z=(Y=f.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,se,ne;h.parameters={...h.parameters,docs:{...(ee=h.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(ne=(se=h.parameters)==null?void 0:se.docs)==null?void 0:ne.source}}};var ae,ie,te;x.parameters={...x.parameters,docs:{...(ae=x.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(te=(ie=x.parameters)==null?void 0:ie.docs)==null?void 0:te.source}}};var re,oe,le;y.parameters={...y.parameters,docs:{...(re=y.parameters)==null?void 0:re.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(le=(oe=y.parameters)==null?void 0:oe.docs)==null?void 0:le.source}}};var de,ue,pe;g.parameters={...g.parameters,docs:{...(de=g.parameters)==null?void 0:de.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    const actions = html\`
            <dss-icon-button icon="edit" ariaLabel="Edit"></dss-icon-button>
...
}`,...(pe=(ue=g.parameters)==null?void 0:ue.docs)==null?void 0:pe.source}}};var me,ce,be;v.parameters={...v.parameters,docs:{...(me=v.parameters)==null?void 0:me.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    const forceFocus = () => {
...
}`,...(be=(ce=v.parameters)==null?void 0:ce.docs)==null?void 0:be.source}}};const xe=["PlaygroundText","PlaygroundNumber","Required","Disabled","ReadOnly","Invalid","Size","Help","Counter","Float","NoLabel","Masks","Units","Prefix","Actions","Focus"],ve=Object.freeze(Object.defineProperty({__proto__:null,Actions:g,Counter:c,Disabled:l,Float:b,Focus:v,Help:m,Invalid:u,Masks:h,NoLabel:f,PlaygroundNumber:r,PlaygroundText:t,Prefix:y,ReadOnly:d,Required:o,Size:p,Units:x,__namedExportsOrder:xe,default:he},Symbol.toStringTag,{value:"Module"}));export{g as A,c as C,l as D,b as F,m as H,u as I,h as M,f as N,t as P,o as R,ve as S,x as U,d as a,p as b,y as c,v as d};
