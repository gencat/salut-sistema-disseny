import{x as a}from"./iframe-Dc24GPd4.js";const m={title:"Collections/List Menu",argTypes:{title:{name:"Títol",control:{type:"text"}},description:{name:"Descripció",control:{type:"text"}},icon:{name:"Icona títol",control:{type:"text"}},label1:{name:"Text ítem 1",control:{type:"text"}},icon1:{name:"Icona ítem 1",control:{type:"text"}},hasNotification1:{name:"Notificació ítem 1",control:{type:"boolean"}},hasAction1:{name:"Acció ítem 1",control:{type:"boolean"}},disabled1:{name:"Ítem 1 deshabilitat",control:{type:"boolean"}},label2:{name:"Text ítem 2",control:{type:"text"}},icon2:{name:"Icona ítem 2",control:{type:"text"}},hasNotification2:{name:"Notificació ítem 2",control:{type:"boolean"}},hasAction2:{name:"Acció ítem 2",control:{type:"boolean"}},disabled2:{name:"Ítem 2 deshabilitat",control:{type:"boolean"}},label3:{name:"Text ítem 3",control:{type:"text"}},icon3:{name:"Icona ítem 3",control:{type:"text"}},hasNotification3:{name:"Notificació ítem 3",control:{type:"boolean"}},hasAction3:{name:"Acció ítem 3",control:{type:"boolean"}},disabled3:{name:"Ítem 3 deshabilitat",control:{type:"boolean"}}},parameters:{layout:"centered"}},t={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=2664-1702&m=dev"}},args:{title:"Title",description:"Lorem ipsum dolor sit amet.",icon:"add_box",label1:"Item1",icon1:"add_box",hasNotification1:!0,hasAction1:!0,disabled1:!1,label2:"Item2",icon2:"add_box",hasNotification2:!1,hasAction2:!1,disabled2:!0,label3:"Item3",icon3:"add_box",hasNotification3:!0,hasAction3:!0,disabled3:!1},render:e=>{let r=e.selected?"dss-list-menu-item.selected ":"";return r+=e.disabled?"dss-list-menu-item.disabled":"",a`
        <dss-list-menu
          titleText="${e.title}"
