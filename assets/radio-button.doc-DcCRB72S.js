import{j as e,M as o,T as l,C as a,S as i}from"./blocks-B0kcQ3Dr.js";import{useMDXComponents as d}from"./index-IeeZE5S6.js";import{S as r,P as c,D as u,C as h,a as p,H as x,G as b,L as m,N as j,F as f}from"./radio-button.stories-Bv1pV1P2.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CK9yflr1.js";import"./storybook-decorators-DSS85Rnr.js";function t(s){const n={a:"a",blockquote:"blockquote",code:"code",h3:"h3",h5:"h5",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{of:r}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(l,{}),e.jsx("component-title",{children:"dss-radio-button"}),e.jsx("component-title",{children:"dss-radio-button-group"})]}),`
...
`,e.jsxs(n.p,{children:["El ",e.jsx(n.code,{children:"disabled"})," es gestiona de dues maneres diferents segons el nivell de control que es vulgui aplicar:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Si s’aplica l’atribut ",e.jsx(n.code,{children:"disabled"})," al component ",e.jsx(n.code,{children:"dss-radio-button-group"}),", aquest valor es propaga a tots els ",e.jsx(n.code,{children:"dss-radio-button"})," interns i els deshabilita de manera global."]}),`
`,e.jsxs(n.li,{children:["Si es necessita controlar l’estat de cada opció de forma individual, llavors el ",e.jsx(n.code,{children:"disabled"})," s’ha de definir a cada ",e.jsx(n.code,{children:"dss-radio-button"})," i no s’ha d’usar mai al ",e.jsx(n.code,{children:"dss-radio-button-group"}),"."]}),`
`]}),`
`,e.jsxs(n.p,{children:["Això és important perquè el grup no ha de sobrescriure els estats individuals. El ",e.jsx(n.code,{children:"disabled"})," del grup serveix per desactivar el conjunt sencer; el ",e.jsx(n.code,{children:"disabled"})," de cada radio serveix per deshabilitar només aquella opció concreta."]}),`
`,e.jsx(a,{of:p}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`const forceFocus = () => {
  ...
  if (element) {
    (element as HTMLElement).focus(); // RadioButton | HTMLElement | any
  }
}
`})})]})}function L(s={}){const{wrapper:n}={...d(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{L as default};
