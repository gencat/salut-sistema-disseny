import{x as t}from"./iframe-CK9yflr1.js";import{w as i}from"./storybook-decorators-DSS85Rnr.js";const r=`
 .container--flex {
        display: flex;
...
`,d={title:"Components/Angular/Timepicker",component:"dss-timepicker",argTypes:{label:{name:"Label"},inputSize:{name:"Input Size",control:{type:"radio"},options:["sm","md","lg"]},enableDropdown:{name:"Enable dropdown",control:{type:"boolean"}},dropdown:{name:"Dropdown type",control:{type:"radio"},options:["list","manual"],if:{arg:"enableDropdown",truthy:!0}},minutesRange:{name:"Minutes Range",control:{type:"number"},if:{arg:"enableDropdown"}},minHour:{name:"Min Hour",control:{type:"number"},if:{arg:"enableDropdown"}},maxHour:{name:"Max Hour",control:{type:"number"},if:{arg:"enableDropdown"}},helpText:{name:"Message for initial help"},errorTimeFormatText:{name:"Message for wrong time format"},errorTimeOptionText:{name:"Message for non-available time in dropdown",if:{arg:"enableDropdown"}}},parameters:{layout:"centered"}},n={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=737-187&m=dev"}},args:{label:"Label",enableDropdown:!1,inputSize:"lg",dropdown:"list",minutesRange:1,minHour:0,maxHour:23,helpText:"Help text.",errorTimeFormatText:"Format not valid.",errorTimeOptionText:"Option not available."},render:e=>t`
    ...
    <dss-ng-timepicker dropdown="list" minutesRange="10">
      <label slot="label" for="myTimepicker007">Label</label>

      <input slot="input" id="myTimepicker007" type="text"  maxlength="5" />
    </dss-ng-timepicker>

    <dss-ng-timepicker dropdown="list" minutesRange="10" errorTimeOptionText="Option not available" helpText="Help text." minHour="8" maxHour="18" minutesRange="15">
    ...
    `,decorators:[i(r,"timepicker-style-manual")]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...m.parameters?.docs?.source}}};const c=["Playground","ByDefault","Disabled","ReadOnly","DropdownList","CustomDropdownList","DropdownManual"],g=Object.freeze(Object.defineProperty({__proto__:null,ByDefault:l,CustomDropdownList:p,Disabled:a,DropdownList:s,DropdownManual:m,Playground:n,ReadOnly:o,__namedExportsOrder:c,default:d},Symbol.toStringTag,{value:"Module"}));export{l as B,p as C,a as D,n as P,o as R,g as S,s as a,m as b};
