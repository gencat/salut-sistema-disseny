import{x as n,E as B}from"./lit-html-CeYizTxc.js";const _={title:"Components/Module Header",argTypes:{title:{name:"Títol",control:{type:"text"}},withDescription:{name:"Amb descripció",control:{type:"boolean"}},legend:{name:"Descripció",control:{type:"text"},if:{arg:"withDescription"}},withButton:{name:"Amb botó",control:{type:"boolean"}},buttonNumber:{name:"Quantitat de botons",control:{type:"select"},options:[1,2],if:{arg:"withButton"}}},parameters:{layout:"centered"}},e={render:t=>{const x=t.withButton?Array.from({length:t.buttonNumber},(D,g)=>n`
          <dss-button
            label=${`Botó ${g+1}`}
            icon="add_box"
            variant="subtle"
