...
`,v={title:"Components/Textarea",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},label:{name:"Label"},showIcon:{name:"Mostrar icona",control:{type:"boolean"}},icon:{name:"Icona",control:{type:"text"},if:{arg:"showIcon"}},showError:{name:"Mostrar error",control:{type:"boolean"}},required:{name:"Camp requerit",control:{type:"boolean"}},showDescription:{name:"Mostrar descripció",control:{type:"boolean"}},description:{name:"Descripció",if:{arg:"showDescription"}},showMaxLength:{name:"Mostrar màxim de caràcters",control:{type:"boolean"}},maxLength:{name:"Màxim de caràcters",control:{type:"number"},if:{arg:"showMaxLength"}},rows:{name:"Files visibles",control:{type:"number"}},autoHeight:{name:"Alçada automàtica",control:{type:"boolean"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}},readonly:{name:"Només lectura",control:{type:"boolean"}}},parameters:{layout:"centered"}},t={render:e=>a`
            <dss-textarea
                ...
                maxlength=${e.showMaxLength?e.maxLength:g}
                icon=${e.showIcon?e.icon:g}
                helpText=${e.showDescription?e.description:g}
             ></dss-textarea> 
    ...
    `,decorators:[r(s,"textarea-disabled-style")]},i={tags:["!dev"],render:()=>a`
     <div class="wrapper">
        <dss-textarea label="Label SM" size="sm" icon="add_box" readonly value="Lorem ipsum"></dss-textarea>
        <dss-textarea label="Label MD" size="md" icon="add_box" readonly value="Lorem ipsum"></dss-textarea>
        <dss-textarea label="Label LG" size="lg" icon="add_box" readonly value="Lorem ipsum"></dss-textarea>
      </div>
    ...
    `,decorators:[r(s,"textarea-description-style")]},p={tags:["!dev"],render:()=>a`
       <div class="wrapper">
    ...
    `,decorators:[r(s,"textarea-counter-style")]},u={tags:["!dev"],render:()=>a`
            <div class="wrapper">
                <dss-button label="Focus" @click=${()=>{const h=document.querySelector("#manual-focus-demo");h&&h.focus()}}></dss-button>
        <dss-textarea
                    id="manual-focus-demo"
                    label="1 fila"
                ></dss-textarea>
            </div>
        `,decorators:[r(s,"textarea-focus-style")]};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: (args: any) => {
    return html\`
            <dss-textarea
                size=\${args.size}
...
}`,...u.parameters?.docs?.source}}};const y=["Playground","Size","Icon","Disabled","ReadOnly","Required","Invalid","Description","Placeholder","Counter","HeightConfig","Focus"],S=Object.freeze(Object.defineProperty({__proto__:null,Counter:b,Description:x,Disabled:l,Focus:u,HeightConfig:m,Icon:o,Invalid:c,Placeholder:p,Playground:t,ReadOnly:i,Required:n,Size:d,__namedExportsOrder:y,default:v},Symbol.toStringTag,{value:"Module"}));export{b as C,l as D,u as F,m as H,o as I,t as P,i as R,S,d as a,n as b,c,x as d,p as e};
