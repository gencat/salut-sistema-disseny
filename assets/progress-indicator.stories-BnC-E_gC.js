import"./lit-element-DyeN6MU1.js";import{x as e}from"./lit-html-CeYizTxc.js";const W={title:"Components/Progress Indicator",argTypes:{title:{name:"Títol"},description:{name:"Descripció"},percentage:{name:"Percentatge",control:{type:"range",min:0,max:100,step:1},defaultValue:0},state:{name:"Estat",control:{type:"select"},options:["default","info","success","warning","error"],defaultValue:"default"},hasFailed:{name:"Mostrar error",control:{type:"boolean"},defaultValue:!1}},parameters:{layout:"centered"}},s={args:{title:"Title",description:"Description, short and clear.",percentage:0,state:"default",hasFailed:!1},render:r=>e`
