import{x as t}from"./iframe-BgTKh_jv.js";import{w as e}from"./storybook-decorators-DSS85Rnr.js";const L=[{column:"name",label:"Nom",sortType:"string"},{column:"age",label:"Edat",sortType:"number",align:"right"},{column:"badge",label:"Estat",align:"center"},{column:"result",label:"Resultat",align:"center"},{column:"review",label:"Revisat",align:"center"},{column:"actions",label:""}],R=[{column:"name",label:"Nom",sortType:"string",style:"width:200px;"},{column:"age",label:"Edat",sortType:"number",align:"right",style:"width:300px;"},{column:"badge",label:"Estat",align:"center",style:"width:300px;"},{column:"result",label:"Resultat",align:"center",style:"width:300px;"},{column:"review",label:"Revisat",align:"center",style:"width:300px;"},{column:"actions",label:"",style:"width:100px;"}],F=[{column:"name",label:"Nom",sortType:"string"},{column:"age",label:"Edat",sortType:"number",align:"right"},{column:"badge",label:"Estat",align:"center"},{column:"result",label:"Resultat",align:"center",highlight:!0},{column:"review",label:"Revisat",align:"center"},{column:"actions",label:""}],T=[{name:"John",age:22,badge:"text",result:120},{name:"William",age:43,badge:"text",result:44},{name:"Anna",age:12,badge:"text",result:22},{name:"Maria",age:87,badge:"text",result:83},{name:"Joe",age:66,badge:"text",result:180},{name:"Odette",age:55,badge:"text",result:120},{name:"Kimberley",age:16,badge:"text",result:44},{name:"Uta",age:56,badge:"text",result:22},{name:"Leila",age:71,badge:"text",result:83},{name:"Fitzgeral",age:32,badge:"text",result:180},{name:"Lea",age:22,badge:"text",result:120},{name:"Donita",age:43,badge:"text",result:44},{name:"Sonya",age:12,badge:"text",result:22},{name:"Thomas",age:87,badge:"text",result:83},{name:"Shayla",age:66,badge:"text",result:180},{name:"Marlene",age:55,badge:"text",result:120},{name:"Frederic",age:16,badge:"text",result:44},{name:"Jamie",age:56,badge:"text",result:22},{name:"Carmen",age:71,badge:"text",result:83},{name:"Joseph",age:32,badge:"text",result:180}],c=JSON.stringify(L),V=JSON.stringify(R),C=JSON.stringify(F),n=JSON.stringify(T),b=T.slice(0,4),o=`
  .table-wrapper {
    width: 900px;
    height: 600px;
  }
...
`,M={title:"Collections/Custom Table",argTypes:{},parameters:{layout:"centered"}},v={tags:["!dev"],args:{columnsHeader:c,mockedData:T,data:n},render:s=>t`
        ...
        >
          <div class="dss-table-container" slot="table">
            <table class="dss-custom-table">
              <tbody>
                ${a(!0,s.mockedData[0],"",!1,"left")}
                ${a(!0,s.mockedData[1],"",!0)}
                ${a(!0,s.mockedData[2],"",!0,"right")}
                ${a(!0,s.mockedData[3],"",!1,"left",!1,!0)}
              </tbody>
            </table>
          </div>
    ...
    `},u={tags:["!dev"],args:{columnsHeader:c,mockedData:T,data:n},render:s=>t`
      <div class="table-wrapper">
        <dss-custom-table 
          hideHeader 
          hidePaginator
        ...
        >
          ${s.mockedData[0]}
            <div class="dss-table-container" slot="table">
              <table class="dss-custom-table">
                <tbody>
                  ${a(!1,s.mockedData[0],"selected",!1,"left",!0)}
                  ...
                  ${a(!1,s.mockedData[1],"deleted",!0)}
                  ${a(!1,s.mockedData[2],"disabled",!0,"right")}
                  ${a(!1,s.mockedData[3],"clickable",!1,"left",!1,!0)}
                  ${a(!1,s.mockedData[4],"disable-hover",!1)}
                </tbody>
              </table>
            </div>
            <div class="table-footer-actions" slot="footer-actions">
    ...
    `,decorators:[e(o,"custom-table-row-style")]},a=(s,d,i,r=!1,l="left",J=!1,A=!1)=>t`
    <tr class="dss-tbody-row ${i!==""?`dss-tbody-row--${i}`:""} ${s?"dss-tbody-row--multiselect":""}">
      ${s?t`
        <td class="dss-td dss-td--font-bold">
          <div class="dss-td-content">
            <dss-checkbox class="dss-checkbox dss-checkbox--multiselect" label="Seleccionar la fila" hideLabel>
            </dss-checkbox>
          </div>
        </td>`:""}
      <td class="dss-td dss-td--font-bold">
        <div class="dss-td-content">
          ...
          `:""}
          ${r&&l==="left"?t`<dss-icon class="dss-td-content__icon" size="md" icon="person"></dss-icon>`:""}
          <span class="dss-td-content__value">${d.name} ${i??""}</span>
          ${r&&l==="right"?t`<dss-icon class="dss-td-content__icon" size="md" icon="person"></dss-icon>`:""}
        </div>
      </td>
      <td class="dss-td dss-td--align-right">
        <div class="dss-td-content">
          ${r&&l==="left"?t`<dss-icon class="dss-td-content__icon" size="md" icon="123"></dss-icon>`:""}
          <span class="dss-td-content__value">${d.age}</span>
          ${r&&l==="right"?t`<dss-icon class="dss-td-content__icon" size="md" icon="123"></dss-icon>`:""}
        </div>
      </td>
      ...
      <td class="dss-td dss-td--align-center">
        <div class="dss-td-content dss-td-content--sm">
          ...
          ${J?t`<dss-icon-button label="Label" hideTooltip icon="expand_less" size="md" variant="primary"></dss-icon-button>`:t`<dss-icon-button label="Label" hideTooltip icon="expand_more" size="md" variant="primary"></dss-icon-button>`}
        </div>
      </td>
    </tr>
  `,m={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:b},render:s=>t`
      <div class="table-wrapper">
        <dss-custom-table 
          multiselect 
          tableTitle="My custom table" 
          ...
          filters='["Lorem","Ipsum"]'>
            <div class="dss-table-container" slot="table">
              <table class="dss-custom-table">
                <tbody>
                  ${Array.from(s.displayData).map(d=>a(!0,d,"",!1))}
                </tbody>
              </table>
            </div>
            <div class="table-footer-actions" slot="footer-actions">
    ...
    `,decorators:[e(o,"custom-table-alt-header-style")]},g={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:b},render:s=>t`
      <div class="table-wrapper">
        <dss-custom-table 
          multiselect 
          tableTitle="My custom table" 
    ...
    `,decorators:[e(o,"custom-table-alt-header-style")]},p={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:b},render:s=>t`
      <div class="table-wrapper">
        <dss-custom-table 
          multiselect 
          tableTitle="My custom table" 
    ...
    `,decorators:[e(o,"custom-table-alt-header-style")]},h={tags:["!dev"],args:{columnsHeader:V,data:n,displayData:b},render:s=>t`
      <div class="table-wrapper">
      <dss-custom-table 
        tableTitle="My custom table" 
        filters='["Filter1","Filter2"]' 
      ...
      >
        <div class="dss-table-container" slot="table">
          <table class="dss-custom-table dss-custom-table--max-content-width">
            <tbody>
              ${Array.from(s.displayData).map(d=>a(!1,d,"",!1))}
            </tbody>
          </table>
        </div>
      </dss-custom-table>
  </div>
    `,decorators:[e(o,"custom-table-horizontal-scroll-style")]},y={tags:["!dev"],args:{columnsHeader:V,data:n,displayData:b},render:s=>t`
      <div class="table-wrapper">
      <dss-custom-table 
        multiselect
    ...
    `,decorators:[e(o,"custom-table-sticky-lit-style")]},_={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:b},render:s=>t`
    ...
    `,decorators:[e(o,"custom-table-height-sm-style")]},x={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:b},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[e(o,"custom-table-height-auto-style")]},z={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:b},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
          ...
          data="${s.data}">
            <div class="dss-table-container" slot="table">
              <table class="dss-custom-table dss-custom-table--grid">
                <tbody>
                  ${Array.from(s.displayData).map(d=>a(!1,d,"",!0))}
                </tbody>
              </table>
            </div>
          </dss-custom-table>
      </div>
    `,decorators:[e(o,"custom-table-grid-style")]},f={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:b},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[e(o,"custom-table-grid-no-divider-style")]},w={tags:["!dev"],args:{columnsHeader:c,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[e(o,"custom-table-custom-divider-style")]},k={tags:["!dev"],args:{columnsHeader:c,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[e(o,"custom-table-nested-rows-style")]},H={tags:["!dev"],args:{columnsHeader:C,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[e(o,"custom-table-highlight-style")]},S={tags:["!dev"],args:{columnsHeader:C,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[e(o,"custom-table-cell-hover-style")]},D={tags:["!dev"],args:{columnsHeader:c,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[e(o,"custom-table-cell-single-line-style")]},$={tags:["!dev"],args:{columnsHeader:c,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[e(o,"custom-table-corner-action-style")]},B={tags:["!dev"],args:{data:n},render:s=>{const d=[{column:"name",label:"Nom",sortType:"string"},{column:"age",label:"Edat"},{column:"badge",label:"Estat",align:"center"},{column:"result",label:"Resultat",align:"center"},{column:"review",label:"Revisat",align:"center"},{column:"button",label:""},{column:"actions",label:""}];return d[1].renderTemplate=()=>{const i=document.createElement("div");i.style.maxWidth="100%";const r=document.createElement("dss-datepicker");r.setAttribute("inputSize","sm"),r.style.width="100%";const l=document.createElement("input");return l.setAttribute("slot","input"),l.setAttribute("id","myDatepicker"),l.setAttribute("type","text"),l.setAttribute("class","dss-input"),l.setAttribute("aria-label","Age picker"),r.appendChild(l),i.appendChild(r),i},t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `},decorators:[e(o,"custom-table-custom-th-style")]},O=()=>{const s=[{label:"Element 1",value:"1"},{label:"Element 2",value:"2"},{label:"Element 3",value:"3"},{label:"Element 4",value:"4"}];return t`
    <dss-select label="Filter 1" size="md" elements='${JSON.stringify(s)}' style="width:200px"></dss-select>
    <dss-select label="Filter 2" size="md" elements='${JSON.stringify(s)}' style="width:200px"></dss-select>
    <dss-select label="Filter 3" size="md" elements='${JSON.stringify(s)}' style="width:200px"></dss-select>
            ...
            <div class="dss-table-container" slot="table">
              <table class="dss-custom-table">
                <tbody>
                  ...
                  \${renderTableRow(false, args.mockedData[4], 'disable-hover', false)}
                </tbody>
              </table>
            </div>
            <div class="table-footer-actions" slot="footer-actions">
...
}`,...B.parameters?.docs?.source}}};const P=["Playground","RowStyles","FiltersChips","FiltersSlot","FiltersCombined","HorizontalScroll","StickyColumnsLIT","TableStylesHeightSM","TableStylesHeightAuto","TableStylesGrid","TableStylesGridNoDivider","TableStylesCustomDivider","TableStylesNestedRows","TableStylesHighlight","TableStylesCellHover","TableStylesCellSingleLine","TableStylesCornerAction","TableStylesCustomTh"],N=Object.freeze(Object.defineProperty({__proto__:null,FiltersChips:m,FiltersCombined:p,FiltersSlot:g,HorizontalScroll:h,Playground:v,RowStyles:u,StickyColumnsLIT:y,TableStylesCellHover:S,TableStylesCellSingleLine:D,TableStylesCornerAction:$,TableStylesCustomDivider:w,TableStylesCustomTh:B,TableStylesGrid:z,TableStylesGridNoDivider:f,TableStylesHeightAuto:x,TableStylesHeightSM:_,TableStylesHighlight:H,TableStylesNestedRows:k,__namedExportsOrder:P,default:M},Symbol.toStringTag,{value:"Module"}));export{m as F,h as H,v as P,u as R,N as S,_ as T,g as a,p as b,y as c,x as d,z as e,f,w as g,k as h,H as i,S as j,D as k,$ as l,B as m};
