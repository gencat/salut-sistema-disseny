import{j as e,M as r,T as a,C as n,a as l,S as c}from"./index-BTzLlL9D.js";import{useMDXComponents as d}from"./index-Cz3Lqr56.js";import{S as h,P as x,a as o,F as j,E as p,D as m,M as b}from"./content-switcher.stories-GYUE_lmu.js";import"./iframe-BFL1ZyYe.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-C_pJYAGD.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-element-Dloa6E9d.js";import"./lit-html-D6a8R3xZ.js";function t(i){const s={a:"a",blockquote:"blockquote",code:"code",h3:"h3",h4:"h4",h5:"h5",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...d(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
      .wrapper {
        display: flex;
...
`,e.jsxs(s.table,{children:[e.jsx(s.thead,{children:e.jsxs(s.tr,{children:[e.jsx(s.th,{children:"Versió"}),e.jsx(s.th,{children:"Canvis"})]})}),e.jsxs(s.tbody,{children:[e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"2.7.1"})}),e.jsx(s.td,{children:"S'ha augmentat la mida de la tipografia per als tamanys md i lg."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"2.2.2"})}),e.jsx(s.td,{children:"S'ha corregit un error pel qual el component no es visualitzava correctament en canviar la pestanya seleccionada en React, a causa d'un nou renderitzat no desitjat."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"2.2.1"})}),e.jsx(s.td,{children:"S'ha actualitzat l'estil del component: color de tipografia i ombra de l'element seleccionat, i distància entre cada element."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"2.0.0"})}),e.jsx(s.td,{children:"Refactor v2."})]})]})]})]})}function q(i={}){const{wrapper:s}={...d(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(t,{...i})}):t(i)}export{q as default};
