import{x as e}from"./iframe-D7EeAtJA.js";const n={title:"Components/List",argTypes:{label:{name:"Text"},items:{name:"Quantitat de elements",control:{type:"select"},options:[1,2,3,4,5]},type:{name:"Tipus",control:{type:"select"},options:["unstyled","ordered","unordered"]}},parameters:{layout:"centered"}},s={render:d=>{const a=d.type!=="unstyled"?` dss-list--${d.type}`:"";return e`
      <ol class="dss-list${a}">
