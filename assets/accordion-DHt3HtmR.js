      ...
      <div class="dss-accordion-header">
        <div class="dss-accordion-header__info">
          <div class="dss-accordion-title">
            ${s._icon?a`
                  <${y} icon=${s._icon} state=${s._iconStatus} size="md"></${y}>
                `:null}
            ${s._hasCheckbox?a`
        ...
        <div class="dss-accordion-header__action">
          <${r}
            label="${s._isOpen?`Obrir ${s._title} acordió`:`Tancar ${s._title} acordió`}"
            ariaExpanded="${s._isOpen}"
            size="md"
