        ...
        <div style="width: 98vw">
          ...
          `:e.variant==="Amb pacient: Assistencial"?t`
            <dss-header 
              ...
              <dss-badge-button slot="allergies" label="Slot Allergies" size="md" state="neutral" outlined hideicon></dss-badge-button>
              <dss-badge-button slot="criticality" label="Slot Criticality" size="md" state="danger" hideicon></dss-badge-button>
              ${e.showLinks?k:null}
              ${e.showProfessional?s:null}
            </dss-header>
          `:e.variant==="Amb pacient: Administratiu"?t`
            <dss-header 
              logoSrc=${r}>
              ${e.showPatient?i:null}
              <dss-badge-button slot="allergies" label="Slot Criticality" size="md" state="danger" hideicon></dss-badge-button>
              ${e.showLinks?q:null}
              ${e.showProfessional?s:null}
            </dss-header>
