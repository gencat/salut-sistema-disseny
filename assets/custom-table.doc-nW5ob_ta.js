import{ae as e,af as d,ag as i,ah as l,ak as a}from"./index-CPQky8E4.js";import{u as t}from"./index-CFBmBEPl.js";import{C as c,P as o,R as h,A as x,H as j,S as u}from"./custom-table.stories-DxjjeUtp.js";import"./iframe-B3b_zykC.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-html-B2eaWknC.js";function r(n){const s={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .table-wrapper {
      width: 900px;
      height: 600px;
    }
...
`,e.jsx("div",{className:"dss-sb-properties",children:e.jsxs(s.table,{children:[e.jsx(s.thead,{children:e.jsxs(s.tr,{children:[e.jsx(s.th,{children:"Name"}),e.jsx(s.th,{children:"Type"}),e.jsx(s.th,{children:"Default"}),e.jsx(s.th,{children:"Description"})]})}),e.jsxs(s.tbody,{children:[e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"hideHeader"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"boolean"})}),e.jsx(s.td,{children:"false"}),e.jsx(s.td,{children:"Si es defineix s'ocultarà la capçalera de la taula."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"tableTitle"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string"})}),e.jsx(s.td,{children:"'Title'"}),e.jsx(s.td,{children:"Títol mostrat a la capçalera de la taula."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"filters"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string[]"})}),e.jsx(s.td,{children:"[]"}),e.jsx(s.td,{children:"Filtres aplicats prèviament a la taula. En cas d' interacció amb els mateixos, el component notificarà mitjançant esdeveniment que hi va haver un canvi i que s' ha de tornar a aplicar un nou filtratge fora de la taula."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"innerFilters"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"boolean"})}),e.jsx(s.td,{children:"false"}),e.jsx(s.td,{children:"Canvia la capçalera per defecte a una versió on es poden incloure els filtres a traves d' un slot. L' aplicació d' aquests filtres s' ha d' executar fora del component."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"expandTable"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"boolean"})}),e.jsx(s.td,{children:"false"}),e.jsx(s.td,{children:"Permet mostrar tots els elements de la taula quan es renderitza el component. Per defecte la taula mostra la meitat d' elements afegint scroll vertical."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"expandLabel"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string"})}),e.jsx(s.td,{children:"'Ampliar'"}),e.jsx(s.td,{children:"Text mostrat al botó d'interacció per ampliar el nombre d' elements visibles a la taula."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"collapseLabel"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string"})}),e.jsx(s.td,{children:"'Reduir'"}),e.jsx(s.td,{children:"Text mostrat al botó d'interacció per reduir el nombre d' elements visibles a la taula."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"filtersLabel"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string"})}),e.jsx(s.td,{children:"'Selecció'"}),e.jsx(s.td,{children:"Text mostrat al botó d'interacció per obrir un component extern on s' alleugereixen els filtres."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"cleanFiltersLabel"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string"})}),e.jsx(s.td,{children:"'Netejar filtres'"}),e.jsx(s.td,{children:"Text mostrat al botó d' interacció per eliminar tots els filtres seleccionats."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"noFiltersLabel"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string"})}),e.jsx(s.td,{children:"'No hi ha filtres seleccionats'"}),e.jsx(s.td,{children:"Text mostrat quan no hi ha cap filtre seleccionat."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"hideHeaderTitleAndExpand"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"boolean"})}),e.jsx(s.td,{children:"false"}),e.jsx(s.td,{children:"Amaga tota la fila de la capçalera on es mostra el títol i el botó d'expandir la taula en cas que només calgui utilitzar els filtres."})]})]})]})}),`
`,e.jsx("br",{}),`
