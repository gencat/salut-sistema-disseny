import{i as p,r as e}from"./lit-element-Dloa6E9d.js";import"./lit-html-D6a8R3xZ.js";import{n as o}from"./property-BpSxuat7.js";import{i as b}from"./icon.style-Bcf7OUvG.js";import{r as f}from"./reset.style-B0CQ8619.js";import{b as m}from"./property-types-CkH-zh1n.js";import{e as v}from"./class-map-t53NE6z1.js";import{s as k,i as y,u as c}from"./static-BTPASdtP.js";import{g}from"./custom-element-scope-Dp4Dg8bo.js";const h=":host{display:inline-block;vertical-align:middle}.dss-button-link{display:inline-flex;align-items:center;gap:var(--dss-spacing-xxs);font-size:14px;line-height:24px;font-weight:var(--font-semibold);color:var(--color-primary-500);text-decoration:none;border-radius:var(--dss-radius-xs);transition:.2s all ease-in;vertical-align:middle}.dss-button-link:visited{color:var(--color-purple-700)}.dss-button-link:hover{color:var(--color-primary-600)}.dss-button-link:active{color:var(--color-primary-400)}.dss-button-link:focus-visible{outline:var(--dss-border-width-md) solid var(--color-blue-200)}.dss-button-link.dss-button-link--disabled{cursor:not-allowed;color:var(--color-neutral-500)!important}.dss-button-link .dss-button-link-text{text-decoration:underline}.dss-button-link--icon-right{flex-direction:row-reverse}",u=y`dss-icon${k(g())}`,x=t=>c`
  <a
    href="${t.linkHref}"
