import{j as e,M as o,T as l,C as s}from"./blocks-D_zk3kjZ.js";import{useMDXComponents as t}from"./index-D0A3GcHo.js";import{S as c,P as r,a as d,E as x,D as m,I as p,N as h,b as u,c as j}from"./action-menu.stories-Cq1cpkzu.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DNLJd-HG.js";import"./storybook-decorators-DSS85Rnr.js";function a(i){const n={a:"a",blockquote:"blockquote",h2:"h2",h3:"h3",h5:"h5",li:"li",p:"p",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{of:c}),`
...
`]}),`
`,e.jsx(s,{of:r}),`
`,e.jsx("dss-alert",{size:"lg",status:"warning",message:"Atès que el contingut d'aquest component s'injecta mitjançant slots, no s'ha pogut aplicar la nova funcionalitat de portals de la v3. Per aquest motiu, s'ha creat una nova collection 'context-menu' com a versió reduïda que funciona amb portals i permet una millor interacció, especialment dins de components complexos com el custom-table amb columnes fixes."}),`
`,e.jsx("br",{}),`
...
`,e.jsx(n.p,{children:"Mínima amplada 160px i màxima amplada 280px, tenint en compte que a partir de 160px s'adaptarà l'amplada del modal fins a 280px."})]})}function P(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}export{P as default};
