import{j as e,M as r,T as t,C as a,S as d}from"./blocks-0TN8mBac.js";import{useMDXComponents as l}from"./index-D_THLDEK.js";import{S as c,P as o,R as u,D as m,a as p,I as x,b as h,H as j,C as b,F as f,N as g,U as q,c as v,M as A}from"./ng-input.stories-CNvzfIii.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-Dc24GPd4.js";function i(s){const n={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
  .inputs-sizes {
    display: flex;
    gap: 16px;
    align-items: end;
...
`}),`
`,e.jsx(r,{of:c}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(t,{}),e.jsx("component-title",{children:"dss-ng-input"})]}),`
`,e.jsx("br",{}),`
...
`,e.jsxs(n.p,{children:["Veure nou component: ",e.jsx(n.a,{href:"/docs/components-input--docs",children:e.jsx(n.strong,{children:"Input"})})]}),`
...
`,e.jsxs(n.p,{children:["L'input number ha de gestionar-se de manera nativa, per la qual cosa per a habilitar l'ús de decimals ha d'afegir-se la propietat ",e.jsx(n.code,{children:"step"})," dins del ",e.jsx(n.code,{children:"<input>"})," en lloc d'en el selector ",e.jsx(n.code,{children:"<dss-ng-input>"}),`.
...
<dss-ng-input icon="" inputsize="lg" maskRegex="/(\\d{4})(?=\\d)/g" maskReplace="$1 " >
...
<input ... maxLength={19} />
</dss-ng-input>

Custom Pattern example React:
<dss-ng-input maskRegex="/^(.{2})(.*)$/" maskReplace="$1-$2">
...
<input ... maxLength={6} />
</dss-ng-input>
...
manera següent:`}),`
`,e.jsx(d,{code:`
<dss-ng-input icon="person" [value]="myForm.get('name')?.value">
