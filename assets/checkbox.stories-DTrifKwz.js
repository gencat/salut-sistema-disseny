import{x as e}from"./iframe-CK9yflr1.js";import{w as a}from"./storybook-decorators-DSS85Rnr.js";const c=`
  .wrapper {
    display: flex;
...
`,x={title:"Components/Checkbox",argTypes:{hideLabel:{name:"Amagar label",control:{type:"boolean"}},label:{name:"Label",control:{type:"text"}},disabled:{name:"Deshabil·litar",control:{type:"boolean"}},checked:{name:"Marcat",control:{type:"boolean"}},indeterminate:{name:"Indeterminat",control:{type:"boolean"},if:{arg:"checked",truthy:!1}},validateType:{name:"Tipús validacio (verd)",control:{type:"boolean"}}},parameters:{layout:"centered"}},l={render:s=>e`
    ...
    `,decorators:[a(c,"checkbox-label-style")]},r={tags:["!dev"],render:()=>e`
        ...
        `,decorators:[a(c,"checkbox-group-style")]},n={tags:["!dev"],render:()=>e`
            <div class="wrapper">
                <dss-checkbox-group name="group-disabled" label="Deshabilitat individual" orientation="vertical"  value='["dewey"]'>
                    <dss-checkbox label="Huey" value="huey"></dss-checkbox>
                    <dss-checkbox label="Dewey" value="dewey"></dss-checkbox>
                    <dss-checkbox label="Louie" value="louie" disabled></dss-checkbox>
                </dss-checkbox-group>
                <dss-checkbox-group name="group-disabled" label="Deshabilitat per grup" orientation="vertical" disabled value='["dewey"]'>
                    <dss-checkbox label="Huey" value="huey"></dss-checkbox>
                    <dss-checkbox label="Dewey" value="dewey"></dss-checkbox>
                    <dss-checkbox label="Louie" value="louie"></dss-checkbox>
                </dss-checkbox-group>
        ...
        `,decorators:[a(c,"checkbox-focus-style")]};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: (args: any) => {
    return html\`
            <dss-checkbox 
...
}`,...k.parameters?.docs?.source}}};const p=["Playground","NoLabel","TypeValidation","Label","GroupVertical","GroupHorizontal","GroupHideLabel","GroupDefaultValue","GroupDisabled","Focus"],y=Object.freeze(Object.defineProperty({__proto__:null,Focus:k,GroupDefaultValue:i,GroupDisabled:n,GroupHideLabel:h,GroupHorizontal:t,GroupVertical:r,Label:b,NoLabel:o,Playground:l,TypeValidation:d,__namedExportsOrder:p,default:x},Symbol.toStringTag,{value:"Module"}));export{k as F,r as G,b as L,o as N,l as P,y as S,d as T,t as a,h as b,i as c,n as d};
