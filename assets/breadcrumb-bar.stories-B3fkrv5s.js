import{x as s}from"./iframe-_r7gOCbv.js";import{w as i}from"./storybook-decorators-DSS85Rnr.js";const d=`
    .wrapper {
        width: 800px;
        display: flex;
...
`,r=[{label:"Home",href:"/"},{label:"Products",href:"/products"},{label:"Product 1",href:"/products/1"}],o={title:"Collections/Breadcrumb Bar",argTypes:{items:{name:"Elements",description:"Els elements del breadcrumb.",control:{type:"object"}},showAction:{name:"Show action",control:{type:"boolean"}},action:{name:"Action",control:{type:"radio"},options:["button","icon-button","link","input-switch"],if:{arg:"showAction"}}},parameters:{layout:"centered"}},t={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=250-5939&m=dev"}},args:{items:r,showAction:!1,action:"button"},render:e=>s`
    ...
    `,decorators:[i(d,"breadcrumb-bar-actions-style")]};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...a.parameters?.docs?.source}}};const b=["Playground","More","Actions"],m=Object.freeze(Object.defineProperty({__proto__:null,Actions:a,More:n,Playground:t,__namedExportsOrder:b,default:o},Symbol.toStringTag,{value:"Module"}));export{a as A,n as M,t as P,m as S};
