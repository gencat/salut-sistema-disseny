import{x as o}from"./lit-html-B2eaWknC.js";const V={title:"Components/Icon Button",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},variant:{name:"Variant",control:{type:"select"},options:["default","white-default","primary","error","warning","success","info","orange","purple"]},icon:{name:"Icona"},label:{name:"Label (accessibilitat)"}},parameters:{layout:"centered"}},s={args:{size:"md",variant:"primary",icon:"add_box",label:"Botó d'acció"},render:r=>o`
      <dss-icon-button size="${r.size}" variant="${r.variant}" icon="${r.icon}" label="${r.label}"></dss-icon-button>
    `},n={tags:["!dev"],render:()=>o`
      <dss-icon-button size="sm" icon="add_box" label="Botó d'acció"></dss-icon-button>
            <dss-icon-button size="md" icon="add_box" label="Botó d'acció"></dss-icon-button>
            <dss-icon-button size="lg" icon="add_box" label="Botó d'acció"></dss-icon-button>
            <dss-icon-button size="sm" icon="add_box" label="Botó d'acció" disabled></dss-icon-button>
            <dss-icon-button size="md" icon="add_box" label="Botó d'acció" disabled></dss-icon-button>
            <dss-icon-button size="lg" icon="add_box" label="Botó d'acció" disabled></dss-icon-button>
    `},i={tags:["!dev"],render:()=>o`
    ...
    `};var l,u,m;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    size: 'md',
    variant: 'primary',
    icon: 'add_box',
...
}`,...(m=(u=s.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var v,_,z;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(z=(_=n.parameters)==null?void 0:_.docs)==null?void 0:z.source}}};var B,x,g;i.parameters={...i.parameters,docs:{...(B=i.parameters)==null?void 0:B.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="primary" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(g=(x=i.parameters)==null?void 0:x.docs)==null?void 0:g.source}}};var p,y,f;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="error" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(f=(y=a.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var S,w,h;t.parameters={...t.parameters,docs:{...(S=t.parameters)==null?void 0:S.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="warning" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(h=(w=t.parameters)==null?void 0:w.docs)==null?void 0:h.source}}};var P,$,O;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="success" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(O=($=d.parameters)==null?void 0:$.docs)==null?void 0:O.source}}};var I,E,W;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="info" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(W=(E=c.parameters)==null?void 0:E.docs)==null?void 0:W.source}}};var j,D,M;e.parameters={...e.parameters,docs:{...(j=e.parameters)==null?void 0:j.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="orange" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(M=(D=e.parameters)==null?void 0:D.docs)==null?void 0:M.source}}};var T,C,L;b.parameters={...b.parameters,docs:{...(T=b.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="purple" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(L=(C=b.parameters)==null?void 0:C.docs)==null?void 0:L.source}}};const k=["Playground","ByDefault","Primary","ErrorState","Warning","Success","Info","Orange","Purple"],A=Object.freeze(Object.defineProperty({__proto__:null,ByDefault:n,ErrorState:a,Info:c,Orange:e,Playground:s,Primary:i,Purple:b,Success:d,Warning:t,__namedExportsOrder:k,default:V},Symbol.toStringTag,{value:"Module"}));export{n as B,a as E,c as I,e as O,s as P,A as S,t as W,i as a,d as b,b as c};
