import{x as t}from"./iframe-DNLJd-HG.js";import{w as a}from"./storybook-decorators-DSS85Rnr.js";const r=`
 .datepicker-canvas {
        min-height: 350px;
        display: flex;
...
`,y={title:"Components/Angular/Datepicker",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},label:{name:"Label"},helpText:{name:"Message for initial help"},invalid:{name:"Mostrar error",control:{type:"boolean"}},showTime:{name:"Mostrar temps",control:{type:"boolean"}},timepickerSelector:{name:"Timepicker Dropdown",control:{type:"radio"},options:["list","manual"],if:{arg:"showTime"}},minutesRange:{name:"Minutes Range",control:{type:"number",min:0,max:59},if:{arg:"showTime"}},minHour:{name:"Min Hour",control:{type:"number",min:0,max:22},if:{arg:"showTime"}},maxHour:{name:"Max Hour",control:{type:"number",min:1,max:23},if:{arg:"showTime"}},leftLabel:{name:"Botó esquerra",if:{arg:"showTime"}},rightLabel:{name:"Botó dreta",if:{arg:"showTime"}},validate:{name:"validació interna",control:{type:"boolean"}},hasStepper:{name:"Amb stepper",control:{type:"boolean"}}},parameters:{layout:"centered"}},s={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=750-7973&m=dev"}},args:{size:"lg",label:"Data",helpText:"Help text.",invalid:!1,showTime:!1,timepickerSelector:"manual",minutesRange:1,minHour:0,maxHour:23,leftLabel:"Cancel·lar",rightLabel:"Acceptar",validate:!0,hasStepper:!1},render:e=>t`
    ...
    `},u={tags:["!dev"],render:()=>{const e=new Date,g=e.getFullYear(),b=e.getMonth(),v=JSON.stringify([{date:`4/${b+1}/${g}`,type:"green"},{date:`15/${b+1}/${g}`,type:"yellow"},{date:`27/${b+1}/${g}`,type:"red"}]);return t`
     <div class="datepicker-canvas">
                <dss-ng-datepicker customCalendar='${v}'>
    ...
    `,decorators:[a(r,"datepicker-validation-style")]},k={tags:["!dev"],render:()=>t`
     <div class="datepicker-canvas">
            <dss-ng-datepicker hasStepper>
                <label slot="label" for="dpStepper">Data</label>
                <input slot="input" id="dpStepper" type="text"  />
            </dss-ng-datepicker>
        </div>
    `,decorators:[a(r,"datepicker-stepper-style")]};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
  ...
  render: () => {
    ...
    return html\`
     <div class="datepicker-canvas">
                <dss-ng-datepicker customCalendar='\${customCalendar}'>
                        <label slot="label" for="customCalendar">Dates personalitzades</label>
                        <input slot="input" id="customCalendar" type="text"  />
                </dss-ng-datepicker>
            </div>
...
}`,...k.parameters?.docs?.source}}};const h=["Playground","Sizes","Disabled","ReadOnly","Required","Invalid","Timepicker","Buttons","CustomCalendar","Validation","Stepper"],f=Object.freeze(Object.defineProperty({__proto__:null,Buttons:c,CustomCalendar:u,Disabled:l,Invalid:p,Playground:s,ReadOnly:d,Required:n,Sizes:i,Stepper:k,Timepicker:o,Validation:m,__namedExportsOrder:h,default:y},Symbol.toStringTag,{value:"Module"}));export{u as C,l as D,p as I,s as P,d as R,f as S,o as T,m as V,i as a,n as b,k as c};
