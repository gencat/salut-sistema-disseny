import"./lit-element-BL4lq474.js";import{x as i}from"./lit-html-D6cejpwM.js";const $={title:"Components/Slider",argTypes:{min:{name:"Min.",control:{type:"number",min:0}},max:{name:"Màx.",control:{type:"number",min:0}},step:{name:"Pasos",control:{type:"number",min:0}},value:{name:"Valor",control:{type:"number",min:0}},orientation:{name:"Orientació",control:{type:"radio"},options:["vertical","horizontal"]},disabled:{name:"Deshabil·litar",control:{type:"boolean"}}},parameters:{layout:"centered"}},r={render:e=>i`
