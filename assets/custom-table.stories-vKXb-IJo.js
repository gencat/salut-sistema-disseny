import{x as t}from"./iframe-q4RU5zot.js";import{w as e}from"./storybook-decorators-DSS85Rnr.js";const L=[{column:"name",label:"Nom",sortType:"string"},{column:"age",label:"Edat",sortType:"number",align:"right"},{column:"badge",label:"Estat",align:"center"},{column:"result",label:"Resultat",align:"center"},{column:"review",label:"Revisat",align:"center"},{column:"actions",label:""}],R=[{column:"name",label:"Nom",sortType:"string",style:"width:200px;"},{column:"age",label:"Edat",sortType:"number",align:"right",style:"width:300px;"},{column:"badge",label:"Estat",align:"center",style:"width:300px;"},{column:"result",label:"Resultat",align:"center",style:"width:300px;"},{column:"review",label:"Revisat",align:"center",style:"width:300px;"},{column:"actions",label:"",style:"width:100px;"}],F=[{column:"name",label:"Nom",sortType:"string"},{column:"age",label:"Edat",sortType:"number",align:"right"},{column:"badge",label:"Estat",align:"center"},{column:"result",label:"Resultat",align:"center",highlight:!0},{column:"review",label:"Revisat",align:"center"},{column:"actions",label:""}],T=[{name:"John",age:22,badge:"text",result:120},{name:"William",age:43,badge:"text",result:44},{name:"Anna",age:12,badge:"text",result:22},{name:"Maria",age:87,badge:"text",result:83},{name:"Joe",age:66,badge:"text",result:180},{name:"Odette",age:55,badge:"text",result:120},{name:"Kimberley",age:16,badge:"text",result:44},{name:"Uta",age:56,badge:"text",result:22},{name:"Leila",age:71,badge:"text",result:83},{name:"Fitzgeral",age:32,badge:"text",result:180},{name:"Lea",age:22,badge:"text",result:120},{name:"Donita",age:43,badge:"text",result:44},{name:"Sonya",age:12,badge:"text",result:22},{name:"Thomas",age:87,badge:"text",result:83},{name:"Shayla",age:66,badge:"text",result:180},{name:"Marlene",age:55,badge:"text",result:120},{name:"Frederic",age:16,badge:"text",result:44},{name:"Jamie",age:56,badge:"text",result:22},{name:"Carmen",age:71,badge:"text",result:83},{name:"Joseph",age:32,badge:"text",result:180}],c=JSON.stringify(L),V=JSON.stringify(R),C=JSON.stringify(F),n=JSON.stringify(T),b=T.slice(0,4),o=`
  .table-wrapper {
    width: 900px;
    height: 600px;
  }
