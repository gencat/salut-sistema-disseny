import{x as t}from"./iframe-_r7gOCbv.js";const r={title:"Collections/Modal",argTypes:{open:{name:"Obert",control:{type:"boolean"}},hideCloseIcon:{name:"Amagar icona de tancar",control:{type:"boolean"}},title:{name:"Títol",control:{type:"text"}},type:{name:"Tipus",control:{type:"select"},options:["default","warning","danger"]},hideFooter:{name:"Amagar footer",control:{type:"boolean"}},hasButtonAlternative:{name:"Botó alternatiu",control:{type:"boolean"},if:{arg:"hideFooter",eq:!1}},hasButtonSecondary:{name:"Botó secundari",control:{type:"boolean"},if:{arg:"hideFooter",eq:!1}},hasScroll:{name:"Simular scroll",control:{type:"boolean"}}},parameters:{layout:"centered"}},e={args:{open:!1,hideCloseIcon:!1,title:"Títol de la modal",type:"default",hideFooter:!1,hasButtonAlternative:!0,hasButtonSecondary:!0,hasScroll:!1},render:o=>{const l="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",n=t`
    ...
    `,a=t`
        ...
        ${o.hasButtonSecondary?t`<dss-button label="Button" size="md" variant="secondary"></dss-button>`:""}
                ...
                ${o.type==="warning"?t`<dss-button label="Button" size="md" variant="warning"></dss-button>`:o.type==="error"||o.type==="danger"?t`<dss-button label="Button" size="md" variant="danger"></dss-button>`:t`<dss-button label="Button" size="md"></dss-button>`}
      `;return t`
        ${o.hideFooter?t`
          ${o.type==="default"?t`
            ...
            `:t`
              <dss-modal modalTitle="${o.title}" ?open=${o.open} status="${o.type}" ?hideCloseIcon=${o.hideCloseIcon} ?hasScroll=${o.hasScroll}>
                <div slot="body" style="text-align: center;">
                   ${o.hasScroll?s:n}
                </div>
              </dss-modal>
  ...
  render: (args: any) => {
    ...
    const modalFooter = html\`
        ...
        \${args.hasButtonSecondary ? html\`<dss-button label="Button" size="md" variant="secondary"></dss-button>\` : ''}
                ...
                \${args.type === 'warning' ? html\`<dss-button label="Button" size="md" variant="warning"></dss-button>\` : args.type === 'error' || args.type === 'danger' ? html\`<dss-button label="Button" size="md" variant="danger"></dss-button>\` : html\`<dss-button label="Button" size="md"></dss-button>\`}
      \`;
    return html\`
        \${args.hideFooter ? html\`
          \${args.type === 'default' ? html\`
            ...
            \` : html\`
              <dss-modal modalTitle="\${args.title}" ?open=\${args.open} status="\${args.type}" ?hideCloseIcon=\${args.hideCloseIcon} ?hasScroll=\${args.hasScroll}>
                <div slot="body" style="text-align: center;">
                   \${args.hasScroll ? modalBodyScroll : modalBody}
                </div>
              </dss-modal>
...
}`,...e.parameters?.docs?.source}}};const d=["Playground"],c=Object.freeze(Object.defineProperty({__proto__:null,Playground:e,__namedExportsOrder:d,default:r},Symbol.toStringTag,{value:"Module"}));export{c as S};
