import{x as p}from"./lit-html-D6a8R3xZ.js";const m={title:"Components/Spinner",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]}},parameters:{layout:"centered"}},s={render:o=>p`<dss-spinner size="${o.size}"></dss-spinner>`,args:{size:"md"},parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=1470-3928&m=dev"}}},e={tags:["!dev"],render:()=>p`
      <div class="wrapper">
