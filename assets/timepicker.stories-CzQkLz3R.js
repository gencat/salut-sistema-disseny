import{x as r}from"./iframe-MtZZlI9v.js";import{w as a}from"./storybook-decorators-DSS85Rnr.js";const t=`
  .container--flex {
        display: flex;
...
`,u={title:"Components/Timepicker",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},label:{name:"Label"},hideLabel:{name:"Amagar label",control:{type:"boolean"}},showIcon:{name:"Mostrar icona",control:{type:"boolean"}},icon:{name:"Icona",control:{type:"text"},if:{arg:"showIcon"}},required:{name:"Camp requerit",control:{type:"boolean"}},readonly:{name:"Només lectura",control:{type:"boolean"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}},dropdown:{name:"Tipus de selector",control:{type:"radio"},options:["list","manual"]},minutesRange:{name:"Interval de minuts",control:{type:"number"}},minHour:{name:"Hora mínima",control:{type:"number"}},maxHour:{name:"Hora màxima",control:{type:"number"}},helpText:{name:"Missatge d’ajuda inicial"},errorTimeFormatText:{name:"Missatge per format d’hora incorrecte"},errorTimeOptionText:{name:"Missatge per opció no disponible al desplegable"}},parameters:{layout:"centered"}},i={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=892-20744&m=dev"}},args:{size:"lg",label:"Label",hideLabel:!1,showIcon:!0,icon:"schedule",required:!1,readonly:!1,disabled:!1,dropdown:"list",minutesRange:15,minHour:0,maxHour:23,helpText:"Help text.",errorTimeFormatText:"Format not valid.",errorTimeOptionText:"Option not available."},render:e=>r`
    ...
    `,decorators:[a(t,"timepicker-dropdown-manual")]},c={tags:["!dev"],render:()=>r`
            <div class="container--flex container--dropdown">
        ...
        `,decorators:[a(t,"timepicker-focus-style")]};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...c.parameters?.docs?.source}}};const x=["Playground","ByDefault","Disabled","ReadOnly","DropdownList","CustomDropdownList","DropdownManual","Focus"],w=Object.freeze(Object.defineProperty({__proto__:null,ByDefault:o,CustomDropdownList:d,Disabled:s,DropdownList:n,DropdownManual:m,Focus:c,Playground:i,ReadOnly:l,__namedExportsOrder:x,default:u},Symbol.toStringTag,{value:"Module"}));export{o as B,d as C,s as D,c as F,i as P,l as R,w as S,n as a,m as b};
