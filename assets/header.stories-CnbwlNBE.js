          ...
          ${n.showAppName?e`
                <dss-header 
                  ...
                  ${n.showLinks?e`
                    ${l}
                  `:null}
                  ${n.showProfessional?e`
                    ${s}
                  `:null}
                </dss-header>
              `:e`
              <dss-header logoSrc=${t}>
                  ${n.showPatient?e`
                    ${d}
                  `:null}
                  ${n.showLinks?e`
...
}`,...(i=(o=a.parameters)==null?void 0:o.docs)==null?void 0:i.source}}};const u=["Playground"],c=Object.freeze(Object.defineProperty({__proto__:null,Playground:a,__namedExportsOrder:u,default:p},Symbol.toStringTag,{value:"Module"}));export{a as P,c as S};
