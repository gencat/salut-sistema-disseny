...
}`,...(z=(g=n.parameters)==null?void 0:g.docs)==null?void 0:z.source}}};var _,x,p;a.parameters={...a.parameters,docs:{...(_=a.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="neutral" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(p=(x=a.parameters)==null?void 0:x.docs)==null?void 0:p.source}}};var B,y,f;t.parameters={...t.parameters,docs:{...(B=t.parameters)==null?void 0:B.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="error" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(f=(y=t.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var S,w,h;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="warning" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(h=(w=i.parameters)==null?void 0:w.docs)==null?void 0:h.source}}};var P,$,I;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="success" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(I=($=d.parameters)==null?void 0:$.docs)==null?void 0:I.source}}};var E,O,F;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="info" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(F=(O=c.parameters)==null?void 0:O.docs)==null?void 0:F.source}}};var T,C,N;e.parameters={...e.parameters,docs:{...(T=e.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="orange" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(N=(C=e.parameters)==null?void 0:C.docs)==null?void 0:N.source}}};var W,j,k;r.parameters={...r.parameters,docs:{...(W=r.parameters)==null?void 0:W.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="purple" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(k=(j=r.parameters)==null?void 0:j.docs)==null?void 0:k.source}}};const A=["Playground","Primary","Neutral","ErrorState","Warning","Success","Info","Orange","Purple"],H=Object.freeze(Object.defineProperty({__proto__:null,ErrorState:t,Info:c,Neutral:a,Orange:e,Playground:s,Primary:n,Purple:r,Success:d,Warning:i,__namedExportsOrder:A,default:q},Symbol.toStringTag,{value:"Module"}));export{t as E,c as I,a as N,e as O,s as P,H as S,i as W,n as a,d as b,r as c};
