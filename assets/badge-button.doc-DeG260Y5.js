import{j as e,M as r,T as l,C as n,a as c}from"./index-C53Pb-wt.js";import{useMDXComponents as d}from"./index-CCGKjApK.js";import{S as a,P as o,a as h,D as x,T as j,I as m,b as p,A as f,c as u,d as b,e as g,M as C,f as I,g as M,h as q,i as w,j as A,C as D,U as y,k as v,l as S,m as N,n as P,o as L,N as z}from"./badge-button.stories-DxOdQ9Y8.js";import"./iframe-C5JhQJD_.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-C_pJYAGD.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-element-Dloa6E9d.js";import"./lit-html-D6a8R3xZ.js";import"./badge-button-BPo3Vl_n.js";import"./property-BpSxuat7.js";import"./reset.style-B0CQ8619.js";import"./property-types-CkH-zh1n.js";import"./class-map-t53NE6z1.js";import"./static-BTPASdtP.js";import"./custom-element-scope-Dp4Dg8bo.js";function t(s){const i={a:"a",blockquote:"blockquote",code:"code",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .wrapper {
      display: flex;
...
`,e.jsxs(i.p,{children:["Podem modificar la icona dacció utilitzant la propietat ",e.jsx(i.code,{children:"action"}),". Pot ser ",e.jsx(i.code,{children:"dropdown"})," (defecte) o ",e.jsx(i.code,{children:"details"}),"."]}),`
`,e.jsx(n,{of:f}),`
...
`,e.jsxs(i.table,{children:[e.jsx(i.thead,{children:e.jsxs(i.tr,{children:[e.jsx(i.th,{children:"Versió"}),e.jsx(i.th,{children:"Canvis"})]})}),e.jsxs(i.tbody,{children:[e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"2.5.1"})}),e.jsxs(i.td,{children:["S’ha modificat l’aparença del component per incloure una icona a la dreta que farà referència a les diferents accions que pot representar aquest botó d’estil badge.",e.jsx("br",{}),"S'ha afegit la propietat width que modifica l'amplada automàtica del component per l'amplada fixa definida en píxels.",e.jsx("br",{}),"S'ha afegit la propietat showIcon que mostra la icona d'estat associada o la definida amb la propietat icon, que per defecte està oculta en la mida sm."]})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"2.4.0"})}),e.jsx(i.td,{children:"Nou web component."})]})]})]})]})}function Y(s={}){const{wrapper:i}={...d(),...s.components};return i?e.jsx(i,{...s,children:e.jsx(t,{...s})}):t(s)}export{Y as default};
