import{x as a}from"./iframe-_r7gOCbv.js";const n={title:"Foundations/Elevation",argTypes:{options:{name:"Opcions",control:{type:"radio"},options:["sm","md","lg"]}},parameters:{layout:"centered"}},e={render:o=>a`<div class="elevations-box dss-elevation--${o.options}"></div>`,args:{options:"md"}},s={tags:["!dev"],render:()=>a`
