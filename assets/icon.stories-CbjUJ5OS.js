import{x as n}from"./iframe-q4RU5zot.js";const r={title:"Foundations/Icons",argTypes:{icon:{name:"Icona"},size:{name:"Mides",control:{type:"radio"},options:["sm","md","lg","xl"]}},parameters:{layout:"centered"}},e={args:{icon:"add_box",size:"lg"},render:o=>n`
