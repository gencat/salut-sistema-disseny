import{x as s}from"./lit-html-B2eaWknC.js";const B={title:"Components/Input Switch",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},showLabel:{name:"Mostrar Label",control:{type:"boolean"}},label:{name:"Label",if:{arg:"showLabel"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}}},parameters:{layout:"centered"}},e={args:{size:"md",showLabel:!1,label:"Switch",disabled:!1},render:t=>{const A=t.showLabel?t.label:null;return s`
