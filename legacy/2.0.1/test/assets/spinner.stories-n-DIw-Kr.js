import{x as t}from"./lit-html-B2eaWknC.js";const m={title:"Components/Spinner",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]}},parameters:{layout:"centered"}},s={render:o=>t`<dss-spinner size="${o.size}"></dss-spinner>`,name:"Exemple",args:{size:"md"}},e={tags:["!dev"],render:()=>t`
      <div class="wrapper">
