import{x as r}from"./lit-html-B2eaWknC.js";const b={title:"Components/Drawer",argTypes:{open:{name:"Obert",control:{type:"boolean"}},title:{name:"Títol",control:{type:"text"}},contentScroll:{name:"Contingut amb scroll",control:{type:"boolean"}},hasButtonAlternative:{name:"Botó alternatiu",control:{type:"boolean"}},hasButtonSecondary:{name:"Botó secundari",control:{type:"boolean"}},description:{name:"Descripció",control:{type:"text"}},size:{name:"Mida",control:{type:"select",options:["sm","md","lg"]}}},parameters:{layout:"centered"}},n={args:{open:!1,title:"Drawer title",size:"md",contentScroll:!1,hasButtonAlternative:!0,hasButtonSecondary:!0,description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur amet labore. Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur amet labore."},render:t=>{const a=r`
      ...
      `;return r`
        <dss-drawer title="${t.title}" ?open=${t.open} size="${t.size}">
  ...
  render: (args: any) => {
    ...
    const drawerFooter = html\`
      ...
      \`;
    return html\`
        <dss-drawer title="\${args.title}" ?open=\${args.open} size="\${args.size}">
          <div slot="drawer-body">
...
}`,...(s=(e=n.parameters)==null?void 0:e.docs)==null?void 0:s.source}}};const p=["Playground"],c=Object.freeze(Object.defineProperty({__proto__:null,Playground:n,__namedExportsOrder:p,default:b},Symbol.toStringTag,{value:"Module"}));export{n as P,c as S};
