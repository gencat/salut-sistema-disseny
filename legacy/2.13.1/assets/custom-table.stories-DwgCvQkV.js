...
`,zs={title:"Components/Custom Table",argTypes:{},parameters:{layout:"centered"}},e={tags:["!dev"],render:()=>s`
    ...
    `},decorators:[t(d,"custom-table-custom-th-style")]};var f,S,J;e.parameters={...e.parameters,docs:{...(f=e.parameters)==null?void 0:f.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="table-wrapper">
...
}`,...(J=(S=e.parameters)==null?void 0:S.docs)==null?void 0:J.source}}};var D,B,T;a.parameters={...a.parameters,docs:{...(D=a.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="table-wrapper">
