import{x as o}from"./lit-html-B2eaWknC.js";const q={title:"Components/Icon Button",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},variant:{name:"Variant",control:{type:"select"},options:["default","white-default","primary","error","warning","success","info","orange","purple"]},icon:{name:"Icona"},label:{name:"Label (accessibilitat)"}},parameters:{layout:"centered"}},s={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=39-6419&m=dev"}},args:{size:"md",variant:"primary",icon:"add_box",label:"Botó d'acció"},render:r=>o`
...
}`,...(m=(u=s.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var v,g,z;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(z=(g=n.parameters)==null?void 0:g.docs)==null?void 0:z.source}}};var _,x,B;i.parameters={...i.parameters,docs:{...(_=i.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="primary" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(B=(x=i.parameters)==null?void 0:x.docs)==null?void 0:B.source}}};var p,y,f;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="error" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(f=(y=t.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var S,w,h;a.parameters={...a.parameters,docs:{...(S=a.parameters)==null?void 0:S.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="warning" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(h=(w=a.parameters)==null?void 0:w.docs)==null?void 0:h.source}}};var P,$,I;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="success" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(I=($=d.parameters)==null?void 0:$.docs)==null?void 0:I.source}}};var E,O,D;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="info" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(D=(O=c.parameters)==null?void 0:O.docs)==null?void 0:D.source}}};var F,T,C;e.parameters={...e.parameters,docs:{...(F=e.parameters)==null?void 0:F.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="orange" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(C=(T=e.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};var W,j,k;b.parameters={...b.parameters,docs:{...(W=b.parameters)==null?void 0:W.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-icon-button size="sm" variant="purple" icon="add_box" label="Botó d'acció"></dss-icon-button>
...
}`,...(k=(j=b.parameters)==null?void 0:j.docs)==null?void 0:k.source}}};const A=["Playground","ByDefault","Primary","ErrorState","Warning","Success","Info","Orange","Purple"],J=Object.freeze(Object.defineProperty({__proto__:null,ByDefault:n,ErrorState:t,Info:c,Orange:e,Playground:s,Primary:i,Purple:b,Success:d,Warning:a,__namedExportsOrder:A,default:q},Symbol.toStringTag,{value:"Module"}));export{n as B,t as E,c as I,e as O,s as P,J as S,a as W,i as a,d as b,b as c};
