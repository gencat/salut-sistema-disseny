            ...
            ${e._hasCheckbox?a`
                ...
                `:a`
                  ...
                  >
                    ...
                    <${u} hideArrow class="title-tooltip" aria-hidden="true">
                      ${e._title?a` ${e._title} `:a` ${e._type} ${e._index} `}
                    </${u}>
