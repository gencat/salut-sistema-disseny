import{j as e,M as r,T as d,C as s,S as n}from"./blocks-ByMpuAd0.js";import{useMDXComponents as t}from"./index-CuUNIXCo.js";import{S as c,P as o,R as u,F as m,a as h,b as x,H as p,c as b,T as j,d as f,e as g,f as v,g as q,h as T,i as y,j as S,k,l as z,m as C}from"./custom-table.stories-BDvQgHHC.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-MtZZlI9v.js";import"./storybook-decorators-DSS85Rnr.js";function i(l){const a={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...t(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:c}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(d,{}),e.jsx("component-title",{children:"dss-custom-table"})]}),`
...
`,e.jsxs(a.li,{children:[e.jsx(a.code,{children:"dss-tbody-row--clickable"}),": cursor: pointer + :active --> background: --color-primary-50"]}),`
`,e.jsxs(a.li,{children:[e.jsx(a.code,{children:"dss-tbody-row--disable-hover"}),": Deshabilita l'efecte hover sobre la fila."]}),`
`]}),`
...
`,e.jsxs(a.ul,{children:[`
`,e.jsx(a.li,{children:e.jsx(a.a,{href:"#taula-amb-filtres-chips",children:"Taula amb filtres (chips)"})}),`
`,e.jsx(a.li,{children:e.jsx(a.a,{href:"#taula-amb-filtres-slots",children:"Taula amb filtres (slots)"})}),`
`,e.jsx(a.li,{children:e.jsx(a.a,{href:"#taula-amb-filtres-combinats",children:"Taula amb filtres (combinats)"})}),`
...
`,e.jsx(a.li,{children:e.jsx(a.a,{href:"#taula-amb-divisor-personalitzat",children:"Taula amb divisor personalitzat"})}),`
...
`]}),`
`,e.jsx(a.h3,{id:"taula-amb-filtres-chips",children:"Taula amb filtres (chips)"}),`
`,e.jsx(s,{of:m}),`
`,e.jsx("br",{}),`
`,e.jsx(a.h3,{id:"taula-amb-filtres-slot",children:"Taula amb filtres (slot)"}),`
...
`,e.jsx(s,{of:h}),`
`,e.jsx("br",{}),`
`,e.jsx(a.h3,{id:"taula-amb-filtres-combinats",children:"Taula amb filtres (combinats)"}),`
`,e.jsx(s,{of:x}),`
`,e.jsx("br",{}),`
...
`,e.jsx("dss-alert",{fullWidth:!0,state:"warning",message:"En la v3 s'ha introduït una nova collection anomenada context-menu que elimina aquest problema. Aquest nou menú contextual és una versió reduïda de l'action-menu. En cas que el disseny quadri amb aquesta nova versió, us recomanem migrar a aquest component, que utilitza l'estratègia de portals per evitar l'error detallat aquí."}),`
...
`}),`
`]}),`
`]})]})}function _(l={}){const{wrapper:a}={...t(),...l.components};return a?e.jsx(a,{...l,children:e.jsx(i,{...l})}):i(l)}export{_ as default};
