import{x as t}from"./lit-html-D6a8R3xZ.js";const g={title:"Foundations/Elevation",argTypes:{options:{name:"Opcions",control:{type:"radio"},options:["sm","md","lg","left","right","top"]}},parameters:{layout:"centered"}},e={render:m=>t`<div class="elevations-box dss-elevation--${m.options}"></div>`,args:{options:"md"}},s={tags:["!dev"],render:()=>t`
