import"./lit-element-BL4lq474.js";import{x as s}from"./lit-html-D6cejpwM.js";import{w as t}from"./storybook-decorators-DSS85Rnr.js";const d=`
  .wrapper {
    display: flex;
...
`,Je={title:"Components/Badge",argTypes:{size:{name:"Mides",control:{type:"radio"},options:["sm","md","lg","xl"]},modifyIcon:{name:"Modificar icona",control:{type:"boolean"}},icon:{name:"Icona",control:{type:"text"},if:{arg:"modifyIcon",truthy:!0}},text:{name:"Text",control:{type:"text"}},type:{name:"Tipus",control:{type:"radio"},options:["Criticitat","Informació"]},stateCritic:{name:"Estat",control:{type:"select"},options:["danger-high","danger","danger-low","moderate-high","moderate","moderate-low","slight-high","slight","slight-low","correct","undetermined"],if:{arg:"type",eq:"Criticitat"}},stateInfo:{name:"Estat",control:{type:"select"},options:["critical","alert","ideal","info","info-alt","neutral"],if:{arg:"type",eq:"Informació"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}},outlined:{name:"Outlined (Només informació)",control:{type:"boolean"}},hideIcon:{name:"Amaga icona",control:{type:"boolean"},if:{arg:"type",eq:"Informació"}},showIcon:{name:"Mostra Icona (Per mida sm)",control:{type:"boolean"},if:{arg:"size",eq:"sm"}},showTooltip:{name:"Amb tooltip",control:{type:"boolean"}},tooltipPosition:{name:"Posición tooltip",control:{type:"radio"},options:["top","right","bottom","left"],if:{arg:"showTooltip",truthy:!0}}},parameters:{layout:"centered"}},a={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=70-3728&m=dev"}},args:{size:"lg",modifyIcon:!1,text:"12345",icon:"person",type:"Criticitat",stateCritic:"danger-high",stateInfo:"critical",disabled:!1,outlined:!1,hideIcon:!1,showTooltip:!1,tooltipPosition:"top"},render:e=>{const P=e.type==="Criticitat"?e.stateCritic:e.stateInfo;return s`
    ...
    <div class="wrapper">
      <dss-badge size="sm" state="critical" text="12345" ></dss-badge>
      <dss-badge size="md" state="critical" text="12345" ></dss-badge>
      <dss-badge size="lg" state="critical" text="12345" ></dss-badge>
      <dss-badge size="lg" state="critical" text="12345" dot></dss-badge>
      <dss-badge size="sm" state="critical" text="12345" outlined></dss-badge>
      <dss-badge size="md" state="critical" text="12345" outlined ></dss-badge>
      <dss-badge size="lg" state="critical" text="12345" outlined ></dss-badge>
      <dss-badge size="lg" state="critical" text="12345" outlined dot ></dss-badge>
    </div>
    ...
    `,decorators:[t(d,"badge-neutral-style")]};var T,D,H;a.parameters={...a.parameters,docs:{...(T=a.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...(H=(D=a.parameters)==null?void 0:D.docs)==null?void 0:H.source}}};var M,A,_;r.parameters={...r.parameters,docs:{...(M=r.parameters)==null?void 0:M.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="wrapper">
...
}`,...(_=(A=r.parameters)==null?void 0:A.docs)==null?void 0:_.source}}};var q,L,E;i.parameters={...i.parameters,docs:{...(q=i.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-badge size="lg" state="ideal" text="12345" disabled></dss-badge>
...
}`,...(ee=(Z=c.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var se,te,de;m.parameters={...m.parameters,docs:{...(se=m.parameters)==null?void 0:se.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="wrapper">
...
}`,...(de=(te=m.parameters)==null?void 0:te.docs)==null?void 0:de.source}}};var ae,re,ie;p.parameters={...p.parameters,docs:{...(ae=p.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="wrapper">
...
}`,...(ie=(re=p.parameters)==null?void 0:re.docs)==null?void 0:ie.source}}};var oe,ge,le;u.parameters={...u.parameters,docs:{...(oe=u.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="wrapper">
...
}`,...(ce=(be=x.parameters)==null?void 0:be.docs)==null?void 0:ce.source}}};var me,pe,ue;z.parameters={...z.parameters,docs:{...(me=z.parameters)==null?void 0:me.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="wrapper">
...
}`,...(ue=(pe=z.parameters)==null?void 0:pe.docs)==null?void 0:ue.source}}};var xe,ze,he;h.parameters={...h.parameters,docs:{...(xe=h.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="wrapper">
...
}`,...(Pe=(Ce=y.parameters)==null?void 0:Ce.docs)==null?void 0:Pe.source}}};var Te,De,He;f.parameters={...f.parameters,docs:{...(Te=f.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="wrapper">
...
}`,...(He=(De=f.parameters)==null?void 0:De.docs)==null?void 0:He.source}}};var Me,Ae,_e;S.parameters={...S.parameters,docs:{...(Me=S.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="wrapper">
...
}`,...(_e=(Ae=S.parameters)==null?void 0:Ae.docs)==null?void 0:_e.source}}};var qe,Le,Ee;I.parameters={...I.parameters,docs:{...(qe=I.parameters)==null?void 0:qe.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="wrapper">
...
}`,...(Ue=(ke=C.parameters)==null?void 0:ke.docs)==null?void 0:Ue.source}}};const Ke=["Playground","Sizes","Disabled","Tooltip","CustomIcon","HideIcon","DangerHigh","Danger","DangerLow","ModerateHigh","Moderate","ModerateLow","SlightHigh","Slight","SlightLow","Correct","Undeterminated","Ideal","Critic","Alert","Info","InfoAlt","Neutral"],Qe=Object.freeze(Object.defineProperty({__proto__:null,Alert:S,Correct:w,Critic:f,CustomIcon:g,Danger:b,DangerHigh:n,DangerLow:c,Disabled:i,HideIcon:l,Ideal:y,Info:I,InfoAlt:$,Moderate:p,ModerateHigh:m,ModerateLow:u,Neutral:C,Playground:a,Sizes:r,Slight:z,SlightHigh:x,SlightLow:h,Tooltip:o,Undeterminated:v,__namedExportsOrder:Ke,default:Je},Symbol.toStringTag,{value:"Module"}));export{S as A,g as C,i as D,l as H,y as I,m as M,C as N,a as P,Qe as S,o as T,v as U,r as a,n as b,b as c,c as d,p as e,u as f,x as g,z as h,h as i,w as j,f as k,I as l,$ as m};
