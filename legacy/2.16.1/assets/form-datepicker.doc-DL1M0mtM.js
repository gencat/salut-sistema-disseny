...
`,e.jsx(i.li,{children:e.jsx(i.a,{href:"#amb-calendari-customitzat",children:"Amb calendari customitzat"})}),`
`,e.jsx(i.li,{children:e.jsx(i.a,{href:"#amb-stepper",children:"Amb stepper"})}),`
`,e.jsx(i.li,{children:e.jsx(i.a,{href:"#focus-manual",children:"Focus manual"})}),`
`]}),`
...
`]}),`
`,e.jsx(a,{of:j}),`
`,e.jsx(i.h3,{id:"amb-calendari-customitzat",children:"Amb calendari customitzat"}),`
`,e.jsx(a,{of:f}),`
`,e.jsx(i.h3,{id:"amb-stepper",children:"Amb stepper"}),`
`,e.jsx(i.p,{children:"En activar el mode stepper, es deshabilita automàticament el botó per netejar la data seleccionada."}),`
`,e.jsx(a,{of:b}),`
`,e.jsx(i.h3,{id:"focus-manual",children:"Focus manual"}),`
`,e.jsxs(i.p,{children:[`S'ha habilitat el mètode focus(options), que permet passar també les opcions del mètode natiu
`,e.jsx(i.a,{href:"https://www.w3api.com/HTMLDOM/HTMLElement/focus/#par%C3%A1metros",rel:"nofollow",children:"HTMLElement.focus()"}),"."]}),`
`,e.jsx(i.p,{children:`Aquest mètode força el focus sobre l'input intern per corregir problemes
amb la propietat autofocus en entorns complexos.`}),`
`,e.jsx(a,{of:g}),`
`,e.jsx(i.pre,{children:e.jsx(i.code,{children:`const forceFocus = () => {
  const element = document.querySelector('#manual-focus-demo');
  if (element) {
    (element as HTMLElement).focus(); // FormDatepicker | HTMLElement | any
  }
}
`})})]})}function H(n={}){const{wrapper:i}={...r(),...n.components};return i?e.jsx(i,{...n,children:e.jsx(s,{...n})}):s(n)}export{H as default};
