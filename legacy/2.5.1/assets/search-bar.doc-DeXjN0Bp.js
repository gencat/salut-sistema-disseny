import{j as e,M as d,T as l,C as s,a as c}from"./index-C53Pb-wt.js";import{useMDXComponents as t}from"./index-CCGKjApK.js";import{S as a,P as h,a as x,M as o,b as j,R as p,c as m,D as u,L as g,d as b,e as f,C as q}from"./search-bar.stories-CyM9_DEm.js";import"./iframe-C5JhQJD_.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-C_pJYAGD.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-html-D6a8R3xZ.js";function i(n){const r={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .css-1sqhzee {
      display:none
    }
...
`,e.jsxs(r.table,{children:[e.jsx(r.thead,{children:e.jsxs(r.tr,{children:[e.jsx(r.th,{children:"Versió"}),e.jsx(r.th,{children:"Canvis"})]})}),e.jsxs(r.tbody,{children:[e.jsxs(r.tr,{children:[e.jsx(r.td,{children:e.jsx(r.strong,{children:"2.5.0"})}),e.jsx(r.td,{children:"S'ha corregit un error en la mida de l'input per a la mesura md."})]}),e.jsxs(r.tr,{children:[e.jsx(r.td,{children:e.jsx(r.strong,{children:"2.2.2"})}),e.jsx(r.td,{children:"S'ha afegit la propietat innerFocus."})]})]})]})]})}function E(n={}){const{wrapper:r}={...t(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(i,{...n})}):i(n)}export{E as default};
