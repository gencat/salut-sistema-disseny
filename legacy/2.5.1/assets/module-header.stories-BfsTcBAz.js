import{x as n,E as B}from"./lit-html-D6a8R3xZ.js";const _={title:"Components/Module Header",argTypes:{title:{name:"Títol",control:{type:"text"}},withDescription:{name:"Amb descripció",control:{type:"boolean"}},legend:{name:"Descripció",control:{type:"text"},if:{arg:"withDescription"}},withButton:{name:"Amb botó",control:{type:"boolean"}},buttonNumber:{name:"Quantitat de botons",control:{type:"select"},options:[1,2],if:{arg:"withButton"}}},parameters:{layout:"centered"}},e={render:t=>{const v=t.withButton?Array.from({length:t.buttonNumber},(D,x)=>n`
          <dss-button
            label=${`Botó ${x+1}`}
            icon="add_box"
            variant="subtle"
