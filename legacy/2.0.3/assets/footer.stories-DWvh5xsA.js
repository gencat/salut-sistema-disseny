import{x as n}from"./lit-html-CeYizTxc.js";const i=""+new URL("gencat-logotip-default-DgxwRSWF.svg",import.meta.url).href,a={title:"Components/Footer",argTypes:{description:{name:"Descripció"}},parameters:{layout:"centered"}},e={args:{description:"Historial Electrònic de Salut (HES)"},render:s=>n`
