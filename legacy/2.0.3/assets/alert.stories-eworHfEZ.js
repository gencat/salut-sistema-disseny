import"./lit-element-DyeN6MU1.js";import{x as s}from"./lit-html-CeYizTxc.js";import"./alert-D0ojxcik.js";const P={title:"Components/Alert",component:"dss-alert",argTypes:{text:{name:"Missatge",control:{type:"text"}},size:{name:"Mides",control:{type:"radio"},options:["lg","md","sm"]},state:{name:"Estat",control:{type:"radio"},options:["error","warning","success","info"]},show:{name:"Mostrar",control:{type:"radio"},options:["Cap","Close Icon","Button"]},buttonLabel:{name:"Text del botó.",control:{type:"text"},if:{arg:"show",eq:"Button"}}},parameters:{layout:"centered"}},a={args:{text:"Your message, short and clear.",size:"lg",state:"error",show:"Cap",buttonLabel:"Button"},render:e=>{let i=!1,c=!1;switch(e.show){case"Close Icon":i=!0,c=!1;break;case"Button":i=!1,c=!0;break;default:i=!1,c=!1;break}return s`
        <dss-alert 
          state="${e.state}" 
          size="${e.size}" 
          message="${e.text}"
