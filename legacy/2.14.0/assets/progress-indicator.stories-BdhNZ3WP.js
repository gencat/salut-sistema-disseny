...
}`,...(g=(l=s.parameters)==null?void 0:l.docs)==null?void 0:g.source}}};var T,u,m;t.parameters={...t.parameters,docs:{...(T=t.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-progress-indicator description="Description, short and clear." percentage="23"></dss-progress-indicator>
...
}`,...(m=(u=t.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var h,D,x;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator titleText="Title" description="Description, short and clear." percentage="23"></dss-progress-indicator>
...
}`,...(x=(D=i.parameters)==null?void 0:D.docs)==null?void 0:x.source}}};var f,S,v;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator titleText="Title" description="Description, short and clear." percentage="23" state="default"></dss-progress-indicator>
...
}`,...(v=(S=a.parameters)==null?void 0:S.docs)==null?void 0:v.source}}};var w,y,P;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator titleText="Title" description="Description, short and clear." percentage="23" state="info"></dss-progress-indicator>
...
}`,...(P=(y=n.parameters)==null?void 0:y.docs)==null?void 0:P.source}}};var $,F,E;o.parameters={...o.parameters,docs:{...($=o.parameters)==null?void 0:$.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator titleText="Title" description="Description, short and clear." percentage="23" state="success"></dss-progress-indicator>
...
}`,...(E=(F=o.parameters)==null?void 0:F.docs)==null?void 0:E.source}}};var I,_,b;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator titleText="Title" description="Description, short and clear." percentage="23" state="warning"></dss-progress-indicator>
