import{x as n}from"./lit-html-D6cejpwM.js";const ae={title:"Components/Input",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},label:{name:"Label"},icon:{name:"Mostrar icona",control:{type:"boolean"}},required:{name:"Camp requerit",control:{type:"boolean"}},readonly:{name:"Només lectura",control:{type:"boolean"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}},showPlaceholder:{name:"Mostrar placeholder",control:{type:"boolean"}},placeholder:{name:"Placeholder",if:{arg:"showPlaceholder"}},showDescription:{name:"Mostrar descripció",control:{type:"boolean"}},description:{name:"Descripció",if:{arg:"showDescription"}},showMaxLength:{name:"Mostrar màxim de caràcters",control:{type:"boolean"}},maxLength:{name:"Màxim de caràcters",control:{type:"number"},if:{arg:"showMaxLength"}},showUnit:{name:"Mostrar unitat",control:{type:"boolean"}},unit:{name:"Unitats",control:{type:"text"},if:{arg:"showUnit"}},showInputPrefix:{name:"Mostrar prefix",control:{type:"boolean"}},inputPrefix:{name:"Prefix",control:{type:"text"},if:{arg:"showInputPrefix"}}},parameters:{layout:"centered"}},i={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=892-20744&m=dev"}},name:"Playground - Text",args:{size:"lg",label:"Label",icon:!1,required:!1,readonly:!1,disabled:!1,showPlaceholder:!1,placeholder:"Type here",showDescription:!1,description:"Help Text",showMaxLength:!1,maxLength:10,showUnit:!1,unit:"cm",showInputPrefix:!1,inputPrefix:"1/"},render:e=>{const t=e.showMaxLength?e.maxLength:null,l=e.showDescription?e.description:null;return n`
  ...
  >
    ...
    `},r={tags:["!dev"],render:()=>n`
        <div class="inputs-sizes">
            <dss-input icon="add_box" invalid helpText="Help text.">
        ...
        <br/>
        <div class="inputs-sizes">
            <dss-input icon="add_box" inputSize="sm" invalid helpText="Help text.">
                <label slot="label" for="inputInvalid5">Size SM</label>
                <input slot="input" id="inputInvalid5"  type="text" />
            </dss-input>
            <dss-input icon="add_box" invalid helpText="Help text.">
...
}`,...(L=(I=a.parameters)==null?void 0:I.docs)==null?void 0:L.source}}};var _,T,S;d.parameters={...d.parameters,docs:{...(_=d.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <div class="inputs-sizes">
...
}`,...(S=(T=d.parameters)==null?void 0:T.docs)==null?void 0:S.source}}};var M,q,R;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <div class="inputs-sizes">
...
}`,...(R=(q=p.parameters)==null?void 0:q.docs)==null?void 0:R.source}}};var D,O,H;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <div class="inputs-sizes">
...
}`,...(H=(O=r.parameters)==null?void 0:O.docs)==null?void 0:H.source}}};var k,N,U;o.parameters={...o.parameters,docs:{...(k=o.parameters)==null?void 0:k.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(U=(N=o.parameters)==null?void 0:N.docs)==null?void 0:U.source}}};var C,F,V;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-input
...
}`,...(j=(X=c.parameters)==null?void 0:X.docs)==null?void 0:j.source}}};var G,B,Q;x.parameters={...x.parameters,docs:{...(G=x.parameters)==null?void 0:G.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(Q=(B=x.parameters)==null?void 0:B.docs)==null?void 0:Q.source}}};var W,Y,Z;m.parameters={...m.parameters,docs:{...(W=m.parameters)==null?void 0:W.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(Z=(Y=m.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,ne,te;h.parameters={...h.parameters,docs:{...(ee=h.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="inputs-sizes">
...
}`,...(se=(ie=y.parameters)==null?void 0:ie.docs)==null?void 0:se.source}}};const de=["PlaygroundText","PlaygroundNumber","Required","Disabled","ReadOnly","Invalid","Size","Help","Counter","Float","NoLabel","Masks","Units","Prefix"],re=Object.freeze(Object.defineProperty({__proto__:null,Counter:b,Disabled:d,Float:c,Help:u,Invalid:r,Masks:m,NoLabel:x,PlaygroundNumber:s,PlaygroundText:i,Prefix:y,ReadOnly:p,Required:a,Size:o,Units:h,__namedExportsOrder:de,default:ae},Symbol.toStringTag,{value:"Module"}));export{b as C,d as D,c as F,u as H,r as I,m as M,x as N,i as P,a as R,re as S,h as U,p as a,o as b,y as c};
