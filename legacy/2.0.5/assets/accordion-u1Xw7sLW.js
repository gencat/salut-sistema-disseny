      ...
      <div class="dss-accordion-header">
        <div class="dss-accordion-header__info">
          <div class="dss-accordion-title">
            ${s._icon?a`
                  <${v} icon=${s._icon} state=${s._iconStatus} size="md"></${v}>
                `:null}
            ${s._hasCheckbox?a`
