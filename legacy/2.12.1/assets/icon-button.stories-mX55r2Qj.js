...
`,D={title:"Components/Icon Button",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},variant:{name:"Variant",control:{type:"select"},options:["primary","error","warning","success","info","neutral","ghost","orange","purple"]},icon:{name:"Icona"},label:{name:"Label (accessibilitat)"}},parameters:{layout:"centered"}},n={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=39-6419&m=dev"}},args:{size:"md",variant:"primary",icon:"add_box",label:"Botó d'acció"},render:u=>o`
    ...
    `,decorators:[t(s,"icon-button-primary-style")]},i={tags:["!dev"],render:()=>o`
    ...
    `,decorators:[t(s,"icon-button-neutral-style")]},d={tags:["!dev"],render:()=>o`
    ...
    `,decorators:[t(s,"icon-button-error-style")]},c={tags:["!dev"],render:()=>o`
    ...
    `,decorators:[t(s,"icon-button-warning-style")]},e={tags:["!dev"],render:()=>o`
    ...
    `,decorators:[t(s,"icon-button-success-style")]},r={tags:["!dev"],render:()=>o`
    ...
    `,decorators:[t(s,"icon-button-info-style")]},b={tags:["!dev"],render:()=>o`
    ...
    `,decorators:[t(s,"icon-button-orange-style")]},l={tags:["!dev"],render:()=>o`
    ...
    `,decorators:[t(s,"icon-button-purple-style")]};var m,p,v;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...(v=(p=n.parameters)==null?void 0:p.docs)==null?void 0:v.source}}};var g,z,x;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-icon-button size="sm" variant="primary" icon="add_box" label="Botó d'acció"></dss-icon-button>
