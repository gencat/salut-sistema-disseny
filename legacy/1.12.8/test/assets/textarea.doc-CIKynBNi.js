import{ae as e,af as l,ag as d,ak as i,ah as r}from"./index-1F3Yg9mW.js";import{u as t}from"./index-BlDNg98T.js";import{S as c,P as o,a as h,D as x,R as p,b as j,I as m,c as u,d as b,C as f}from"./textarea.stories-BVFxAfFi.js";import"./iframe-Cf2BqtzP.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-html-B2eaWknC.js";function n(s){const a={a:"a",blockquote:"blockquote",code:"code",em:"em",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .wrapper {
      display: flex;
...
`,e.jsxs(a.p,{children:["El component ",e.jsx(a.strong,{children:"dss-textarea"}),` ofereix als usuaris una caixa de text per a un
formulari. Dins aquesta etiqueta hi afegirem el label i el textarea.`]}),`
`,e.jsx(a.p,{children:e.jsxs(a.em,{children:[e.jsx(a.strong,{children:"Important:"}),` Hem d'afegir al label i al textarea els seus respectius slots,
...
`,e.jsxs(a.p,{children:[`Per indicar que l'input o textarea es troba només lectura, cal afegir la
propietat `,e.jsx(a.strong,{children:"readOnly"})," a l'element."]}),`
`,e.jsx(r,{of:p}),`
...
`,e.jsxs(a.p,{children:["Per indicar que l'input és invalid, cal afegir la propietat ",e.jsx(a.strong,{children:"showError"}),` al
...
`,e.jsxs(a.table,{children:[e.jsx(a.thead,{children:e.jsxs(a.tr,{children:[e.jsx(a.th,{children:"Versió"}),e.jsx(a.th,{children:"Canvis"})]})}),e.jsx(a.tbody,{children:e.jsxs(a.tr,{children:[e.jsx(a.td,{children:e.jsx(a.strong,{children:"2.0.0"})}),e.jsx(a.td,{children:"Refactor v2."})]})})]})]})}function w(s={}){const{wrapper:a}={...t(),...s.components};return a?e.jsx(a,{...s,children:e.jsx(n,{...s})}):n(s)}export{w as default};
