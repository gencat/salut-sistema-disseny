import{x as a}from"./lit-html-B2eaWknC.js";const g={title:"Foundations/Elevation",argTypes:{options:{name:"Opcions",control:{type:"radio"},options:["sm","md","lg","left","right","top"]}},parameters:{layout:"centered"}},e={render:m=>a`<div class="elevations-box dss-elevation--${m.options}"></div>`,args:{options:"md"}},s={tags:["!dev"],render:()=>a`
