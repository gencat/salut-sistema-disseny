      ...
      <div class="dss-accordion-header">
        ...
        <div class="dss-accordion-header__config">
            ...
            <div class="dss-accordion-header__config-info">
              ...
              ${e.info?a`
                  <${f}  size="md" state="${e.infoBadgeState}" icon="${e.infoBadgeIcon}" ?outlined="${e.infoBadgeOutlined}">
