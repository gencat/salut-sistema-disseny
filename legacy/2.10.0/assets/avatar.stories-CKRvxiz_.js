import"./lit-element-BL4lq474.js";import{x as m}from"./lit-html-D6cejpwM.js";import{w as i}from"./storybook-decorators-DSS85Rnr.js";import{a as n}from"./avatar-doctor-BBv5l1RE.js";const d=`
  #root-inner {
        display: flex;
        align-items: center;
        gap: 16px;  
...
`,x={title:"Components/Avatar",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg","xl"]},name:{name:"Nom",control:{type:"text"}},surname:{name:"Cognom",control:{type:"text"}},imageUrl:{name:"Imatge",control:{type:"text"}}},parameters:{layout:"centered"}},a={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=285-1631&m=dev"}},args:{size:"md",name:"Nom",surname:"Cognom",imageUrl:""},render:t=>m`<dss-avatar
  ...
  <dss-avatar size="xl"></dss-avatar>
      `,decorators:[i(d,"avatar-icons-style")]};var o,g,l;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...(l=(g=a.parameters)==null?void 0:g.docs)==null?void 0:l.source}}};var v,c,u;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-avatar
...
}`,...(u=(c=s.parameters)==null?void 0:c.docs)==null?void 0:u.source}}};var p,y,S;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
         <dss-avatar size="sm" name="Design" surname="System"></dss-avatar>
