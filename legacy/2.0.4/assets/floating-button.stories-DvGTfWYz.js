import{x as n}from"./lit-html-CeYizTxc.js";const _={title:"Components/Floating Button",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},disabled:{name:"Deshabil·litar",control:{type:"boolean"}},ifText:{name:"Amb text",control:{type:"boolean"}},text:{name:"Text",control:{type:"text"},if:{arg:"ifText"}}},parameters:{layout:"centered"}},s={render:t=>{const f=t.disabled?n`<button
    ...
    `};var l,d,i;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: (args: any) => {
...
}`,...(i=(d=s.parameters)==null?void 0:d.docs)==null?void 0:i.source}}};var e,u,b;o.parameters={...o.parameters,docs:{...(e=o.parameters)==null?void 0:e.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="wrapper">
