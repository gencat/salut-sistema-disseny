          ...
          <dss-header-menu-professional 
              ...
              >
                ...
                <dss-input-dropdown
                  ...
                  <input id="preferences2" slot="input" type="text" class="dss-input" />
                </dss-input-dropdown>
                <dss-input-dropdown
                  icon="people_alt"
                  type="default" 
