import{x as d}from"./lit-html-CeYizTxc.js";const m={title:"Discontinued/Input Field ⚠️",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["Mitjá","Petit"]},label:{name:"Label"},clearable:{name:"Accionable",control:{type:"boolean"}},icon:{name:"Mostrar icona",control:{type:"boolean"}},showError:{name:"Mostrar error",control:{type:"boolean"}},required:{name:"Camp requerit",control:{type:"boolean"}},showDescription:{name:"Mostrar descripció",control:{type:"boolean"}},description:{name:"Descripció",if:{arg:"showDescription"}},showMaxLength:{name:"Mostrar màxim de caràcters",control:{type:"boolean"}},maxLength:{name:"Màxim de caràcters",control:{type:"number"},if:{arg:"showMaxLength"}}},parameters:{layout:"centered"}},n={render:e=>{const s=e.showMaxLength?e.maxLength:null,a=e.showDescription?e.description:null;return d`
      <dss-input-field
        type="text"
        label="${e.label}"
        icon="${e.icon?"person":""}"
