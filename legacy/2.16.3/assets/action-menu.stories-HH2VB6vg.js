import"./lit-element-BL4lq474.js";import{x as e}from"./lit-html-D6cejpwM.js";import{w as n}from"./storybook-decorators-DSS85Rnr.js";const s=`
    .demo-nested {
        width: 750px;
    }
    .demo-wrapper {
...
`,T={title:"Components/Action Menu",argTypes:{label:{name:"Text"},elements:{name:"Nombre de ítems",control:{type:"number",max:5,min:1}},type:{name:"Tipus",control:{type:"radio"},options:["primary","error"]},showLeftIcon:{name:"Mostrar icona esquerra",control:{type:"boolean"}},leftIcon:{name:"Icona esquerra",if:{arg:"showLeftIcon"}},showRightIcon:{name:"Mostrar icona dreta",control:{type:"boolean"}},rightIcon:{name:"Icona dreta",if:{arg:"showRightIcon"}},hasNestedMenu:{name:"Habilita menú niat",control:{type:"boolean"}},showNotifications:{name:"Mostrar notificacions",control:{type:"boolean"}},notifications:{name:"Notificacions",control:{type:"number",max:10,min:0},if:{arg:"showNotifications"}},notificationsState:{name:"Estat de la notificació",control:{type:"select"},options:["error","alert","success","info"],if:{arg:"showNotifications"}},disabled:{name:"Deshabilitar",control:{type:"boolean"}}},parameters:{layout:"centered"}},i={render:t=>e`
    ...
    `,decorators:[n(s,"accordion-primary-style")]};var u,b,p;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: (args: Args) => {
    return html\`
...
}`,...(p=(b=i.parameters)==null?void 0:b.docs)==null?void 0:p.source}}};var v,f,A;o.parameters={...o.parameters,docs:{...(v=o.parameters)==null?void 0:v.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="demo-wrapper">
...
}`,...(A=(f=o.parameters)==null?void 0:f.docs)==null?void 0:A.source}}};var y,h,x;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="demo-wrapper">
  ...
  decorators: [withStyle(wrapperStyle, 'accordion-primary-style')]
}`,...(x=(h=a.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var I,g,w;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="demo-wrapper">
  ...
  decorators: [withStyle(wrapperStyle, 'accordion-primary-style')]
}`,...($=(F=m.parameters)==null?void 0:F.docs)==null?void 0:$.source}}};var z,P,E;l.parameters={...l.parameters,docs:{...(z=l.parameters)==null?void 0:z.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <div class="demo-nested">
  ...
  decorators: [withStyle(wrapperStyle, 'accordion-primary-style')]
}`,...(E=(P=l.parameters)==null?void 0:P.docs)==null?void 0:E.source}}};var D,L,R;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="demo-wrapper demo-wrapper--positions">
  ...
  decorators: [withStyle(wrapperStyle, 'accordion-primary-style')]
}`,...(R=(L=r.parameters)==null?void 0:L.docs)==null?void 0:R.source}}};const O=["Playground","Primary","ErrorState","Disabled","IconOptions","Notifications","NestedMenu","Position"],H=Object.freeze(Object.defineProperty({__proto__:null,Disabled:d,ErrorState:a,IconOptions:c,NestedMenu:l,Notifications:m,Playground:i,Position:r,Primary:o,__namedExportsOrder:O,default:T},Symbol.toStringTag,{value:"Module"}));export{d as D,a as E,c as I,m as N,i as P,H as S,o as a,l as b,r as c};
