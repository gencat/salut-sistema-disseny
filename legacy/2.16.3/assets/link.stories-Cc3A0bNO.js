import"./lit-element-BL4lq474.js";import{x as i}from"./lit-html-D6cejpwM.js";import"./link-3eVjgWXy.js";import{w as s}from"./storybook-decorators-DSS85Rnr.js";const n=`
 .none {
        display:none;
    }
    .wrapper {
...
`,M={title:"Components/Link",argTypes:{style:{name:"Estil",control:{type:"radio"},options:["inline","standalone"]},size:{name:"Mida",control:{type:"select"},options:["sm","md","lg"],if:{arg:"style",eq:"standalone"}},variant:{name:"Variant",control:{type:"select"},options:["default","primary","secondary"],if:{arg:"style",eq:"standalone"}},label:{name:"Text"},href:{name:"Href"},showIcon:{name:"Mostrar icona",control:{type:"boolean"}},iconSize:{name:"Mida de la icona",control:{type:"select"},options:["sm","md","lg","xl"],if:{arg:"style",eq:"inline"}},icon:{name:"Icona",if:{arg:"showIcon"}},iconPosition:{name:"Posició de la icona",control:{type:"radio"},options:["left","right"],if:{arg:"showIcon"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}},target:{name:"Target",control:{type:"select"},options:["_self","_blank","_parent","_top"]},fontSize:{name:"Font-size",if:{arg:"style",eq:"inline"}},fontWeight:{name:"Font-weight",control:{type:"select"},options:["regular","semibold","bold"],if:{arg:"style",eq:"inline"}}},parameters:{layout:"centered"}},l={parameters:{design:{type:"figma",url:"https://www.figma.com/design/vc3HcReFayadsJO1cEM8HS/Foundations---Design-System-HES-Salut?node-id=658-784&m=dev"}},args:{style:"inline",size:"md",variant:"default",label:"Anchor link",href:"#",showIcon:!0,icon:"add_box",iconSize:"sm",iconPosition:"left",disabled:!1,target:"_self",fontSize:"14px",fontWeight:"semibold"},render:e=>i`
    ...
    `,decorators:[s(n,"link-disabled-style")]},c={tags:["!dev"],render:()=>i`
        ...
        `,decorators:[s(n,"link-focus-style")]};var k,b,m;l.parameters={...l.parameters,docs:{...(k=l.parameters)==null?void 0:k.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...(m=(b=l.parameters)==null?void 0:b.docs)==null?void 0:m.source}}};var f,u,h;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="wrapper">
...
}`,...(h=(u=a.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};var g,v,x;d.parameters={...d.parameters,docs:{...(g=d.parameters)==null?void 0:g.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="wrapper">
...
}`,...(x=(v=d.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};var y,z,S;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="wrapper">
...
}`,...(S=(z=o.parameters)==null?void 0:z.docs)==null?void 0:S.source}}};var _,w,$;r.parameters={...r.parameters,docs:{...(_=r.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="wrapper">
  ...
  decorators: [withStyle(wrapperStyle, 'link-disabled-style')]
}`,...($=(w=r.parameters)==null?void 0:w.docs)==null?void 0:$.source}}};var W,L,P;t.parameters={...t.parameters,docs:{...(W=t.parameters)==null?void 0:W.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div class="wrapper wrapper--tooltip">
  ...
  decorators: [withStyle(wrapperStyle, 'link-disabled-style')]
}`,...(P=(L=t.parameters)==null?void 0:L.docs)==null?void 0:P.source}}};var F,q,A;c.parameters={...c.parameters,docs:{...(F=c.parameters)==null?void 0:F.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    const forceFocus = () => {
...
}`,...(A=(q=c.parameters)==null?void 0:q.docs)==null?void 0:A.source}}};const I=["Playground","Mode","CustomLink","Sizes","Disabled","MaxWidth","Focus"],B=Object.freeze(Object.defineProperty({__proto__:null,CustomLink:d,Disabled:r,Focus:c,MaxWidth:t,Mode:a,Playground:l,Sizes:o,__namedExportsOrder:I,default:M},Symbol.toStringTag,{value:"Module"}));export{d as C,r as D,c as F,a as M,l as P,B as S,o as a,t as b};
