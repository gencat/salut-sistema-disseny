import"./lit-element-BL4lq474.js";import{x as s}from"./lit-html-D6cejpwM.js";const G={title:"Discontinuat/Switch ⚠️",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},showLabel:{name:"Mostrar Label",control:{type:"boolean"}},label:{name:"Label",if:{arg:"showLabel"}}},parameters:{layout:"centered"}},e={render:h=>s`
            ${h.showLabel?s`
