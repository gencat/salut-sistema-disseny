import{j as e,M as l,T as d,S as n,C as r}from"./index-y6SDvDJw.js";import{useMDXComponents as t}from"./index-B2d17vgF.js";import{S as c,P as o,a as h,D as x,R as j,b as p,I as m,c as u,d as b,C as f}from"./textarea.stories-BIoms4tN.js";import"./iframe-XmxlMGwg.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-C_pJYAGD.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-html-D6a8R3xZ.js";function i(s){const a={a:"a",blockquote:"blockquote",code:"code",em:"em",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .wrapper {
      display: flex;
...
`,e.jsxs(a.table,{children:[e.jsx(a.thead,{children:e.jsxs(a.tr,{children:[e.jsx(a.th,{children:"Versió"}),e.jsx(a.th,{children:"Canvis"})]})}),e.jsxs(a.tbody,{children:[e.jsxs(a.tr,{children:[e.jsx(a.td,{children:e.jsx(a.strong,{children:"2.7.1"})}),e.jsx(a.td,{children:"S'ha afegit un min-height per solucionar un error pel qual, en redimensionar el textarea de manera nativa, es podia reduir l'alçada per sota del límit permès."})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{children:e.jsx(a.strong,{children:"2.5.0"})}),e.jsx(a.td,{children:"S'ha corregit un error en l'estat readOnly pel qual els elements del component es desplaçaven com en el cas per defecte, donant la sensació que el textarea no estava blocat."})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{children:e.jsx(a.strong,{children:"2.0.0"})}),e.jsx(a.td,{children:"Refactor v2."})]})]})]})]})}function S(s={}){const{wrapper:a}={...t(),...s.components};return a?e.jsx(a,{...s,children:e.jsx(i,{...s})}):i(s)}export{S as default};
