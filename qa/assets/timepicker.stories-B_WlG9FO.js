import"./lit-element-DhY7bShc.js";import{x as t}from"./lit-html-B2eaWknC.js";const z={title:"Components/Timepicker",component:"dss-timepicker",argTypes:{label:{name:"Label"},inputSize:{name:"Input Size",control:{type:"radio"},options:["sm","md","lg"]},enableDropdown:{name:"Enable dropdown",control:{type:"boolean"}},dropdown:{name:"Dropdown type",control:{type:"radio"},options:["list","manual"],if:{arg:"enableDropdown",truthy:!0}},minutesRange:{name:"Minutes Range",control:{type:"number"},if:{arg:"enableDropdown"}},minHour:{name:"Min Hour",control:{type:"number"},if:{arg:"enableDropdown"}},maxHour:{name:"Max Hour",control:{type:"number"},if:{arg:"enableDropdown"}},helpText:{name:"Message for initial help"},errorTimeFormatText:{name:"Message for wrong time format"},errorTimeOptionText:{name:"Message for non-available time in dropdown",if:{arg:"enableDropdown"}}},parameters:{layout:"centered"}},i={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=737-187&m=dev"}},args:{label:"Label",enableDropdown:!1,inputSize:"lg",dropdown:"list",minutesRange:1,minHour:0,maxHour:23,helpText:"Help text.",errorTimeFormatText:"Format not valid.",errorTimeOptionText:"Option not available."},render:e=>t`
        ...
        <div class="container--flex">
            ...
            <dss-timepicker inputSize="sm" helpText="Help text.">
...
}`,...(k=(T=r.parameters)==null?void 0:T.docs)==null?void 0:k.source}}};var g,y,v;l.parameters={...l.parameters,docs:{...(g=l.parameters)==null?void 0:g.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
         <div class="container--flex">
...
}`,...(v=(y=l.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};var h,f,w;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="container--flex container--dropdown">
...
}`,...(S=(H=o.parameters)==null?void 0:H.docs)==null?void 0:S.source}}};var D,$,O;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="container--flex container--dropdown">
