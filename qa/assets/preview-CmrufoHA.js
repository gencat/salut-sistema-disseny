...
`;var __defProp$Z=Object.defineProperty,__decorateClass$_=(d,a,l,_)=>{for(var h=void 0,b=d.length-1,g;b>=0;b--)(g=d[b])&&(h=g(a,l,h)||h);return h&&__defProp$Z(a,l,h),h};class Footer extends i{constructor(){super(...arguments),this.logo=void 0,this.description=""}static get styles(){return[r$1(resetStyles),r$1(styles$n),r$1(typographyStyles)]}render(){return template$p(this)}}__decorateClass$_([n({type:String})],Footer.prototype,"logo");__decorateClass$_([n({type:String})],Footer.prototype,"description");const headerLinksStyles=":host{display:block}.dss-header-links{display:flex;align-items:center;gap:var(--dss-spacing-xs)}",dssButton$5=i$1`dss-button${s(getCustomElementSuffix())}`,headerLinksTemplate=d=>u$1`
...
`;var __defProp$J=Object.defineProperty,__decorateClass$K=(d,a,l,_)=>{for(var h=void 0,b=d.length-1,g;b>=0;b--)(g=d[b])&&(h=g(a,l,h)||h);return h&&__defProp$J(a,l,h),h};class Pagination extends i{constructor(){super(...arguments),this.length=0,this.pageSize=0,this.currentIndex=1,this.size="md",this._totalPages=0,this._buttons=[]}static get styles(){return r$1(styles$g)}_next(){this.currentIndex++,this._updateButtons(),this._emitCurrentPage()}_prev(){this.currentIndex--,this._updateButtons(),this._emitCurrentPage()}_emitCurrentPage(){this.dispatchEvent(new CustomEvent("onChangePage",{detail:this.currentIndex,bubbles:!0,composed:!0}))}_updateButtons(){this._buttons=[];const a=1,l=Math.max(this.currentIndex-1,1),_=Math.min(this.currentIndex+1,this._totalPages),h=l>2,b=_<this._totalPages-2,g=this._getButtons(a,a),f=this._getButtons(this._totalPages,this._totalPages),y=x`
