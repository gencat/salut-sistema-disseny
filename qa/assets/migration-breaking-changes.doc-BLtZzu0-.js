import{j as e,M as a}from"./index-BauLvQ7S.js";import{useMDXComponents as s}from"./index-DL_N9JPE.js";import"./DocsRenderer-CFRXHY34-D4hTfiAh.js";import"./iframe-Bg6vOPaM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";function i(o){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Documentación/ Migració V2 Breaking changes"}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#botones",children:"Botones"})}),`
...
`]}),`
`,e.jsx("br",{}),`
`,e.jsx(n.h3,{id:"botones",children:"Botones"}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Problema"})}),`
`,e.jsx(n.p,{children:`Los componentes de tipo botón usaban de manera incorrecta la propiedad type, que en realidad es una propiedad nativa de los elementos button,
y no debería ser utilizada para definir el estilo del botón.`}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Solución"})}),`
`,e.jsx(n.p,{children:`Se ha refactorizado ambos componentes para mejorar su accesibilidad y usabilidad, añadiendo una nueva propiedad variant que define el estilo del botón,
mientras que la antigua propiedad type se ha mantenido para definir el tipo de botón (button, submit, reset o menu).`}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Refactor en iniciativas"})}),`
`,e.jsxs(n.p,{children:["Los componentes afectados por este cambio, y que por tanto necesitan ser refactorizados desde las iniciativas, son: ",e.jsx(n.strong,{children:"button, icon-button y split-button"}),"."]}),`
`,e.jsx(n.p,{children:e.jsx(n.em,{children:"A actualizar:"})}),`
`,e.jsxs(n.p,{children:["Antes: ",e.jsx(n.code,{children:'<dss-button type="primary" />'}),`
`,e.jsx("br",{}),"Ahora: ",e.jsx(n.code,{children:'<dss-button variant="primary" />'})]}),`
`,e.jsxs(n.p,{children:["Antes: ",e.jsx(n.code,{children:'<dss-icon-button type="primary" />'}),`
`,e.jsx("br",{}),"Ahora: ",e.jsx(n.code,{children:'<dss-icon-button variant="primary" />'})]}),`
`,e.jsxs(n.p,{children:["Antes: ",e.jsx(n.code,{children:'<dss-split-button type="primary" />'}),`
`,e.jsx("br",{}),"Ahora: ",e.jsx(n.code,{children:'<dss-split-button variant="primary" />'})]}),`
`,e.jsx(n.p,{children:"La propiedad type se define por defecto como 'button' en ambos componentes, por lo que no es necesario añadirla si no se desea cambiar el tipo de botón."}),`
`,e.jsx("hr",{}),`
