import{x as a}from"./lit-html-D6a8R3xZ.js";const S={title:"Components/Tabs",argTypes:{label:{name:"Tabs label: internal wai aria-label",control:{type:"text"}},addTabEnabled:{name:"Enable add tab",control:{type:"boolean"}},addTabText:{name:"Text per afegir tab",control:{type:"text"},if:{arg:"addTabEnabled",truthy:!0}}}},e={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=361-3737&m=dev"}},render:b=>{const d=[{id:"tab-1",text:"First tab",panel:"tabpanel-1",selected:!0},{id:"tab-2",text:"Second tab",panel:"tabpanel-2"},{id:"tab-3",text:"Last tab",panel:"tabpanel-3"}];return a`
      ${b.addTabEnabled?a`
            <dss-tabs-list
              dssTabsId="tabsDemo1"
              label="${b.label}"
...
}`,...(c=(x=t.parameters)==null?void 0:x.docs)==null?void 0:c.source}}};var T,h,m;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-tabs-list
...
}`,...(m=(h=s.parameters)==null?void 0:h.docs)==null?void 0:m.source}}};var u,v,I;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-tabs-list
...
}`,...(g=(L=l.parameters)==null?void 0:L.docs)==null?void 0:g.source}}};const M=["Playground","Default","AddTab","IconBadge","Scroll"],k=Object.freeze(Object.defineProperty({__proto__:null,AddTab:s,Default:t,IconBadge:n,Playground:e,Scroll:l,__namedExportsOrder:M,default:S},Symbol.toStringTag,{value:"Module"}));export{s as A,t as D,n as I,e as P,k as S,l as a};
