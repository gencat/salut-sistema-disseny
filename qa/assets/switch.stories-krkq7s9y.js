import"./lit-element-Dloa6E9d.js";import{x as s}from"./lit-html-D6a8R3xZ.js";const G={title:"Discontinuat/Switch ⚠️",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},showLabel:{name:"Mostrar Label",control:{type:"boolean"}},label:{name:"Label",if:{arg:"showLabel"}}},parameters:{layout:"centered"}},e={render:h=>s`
            ${h.showLabel?s`
