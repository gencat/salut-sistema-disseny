...
}`,...(I=(h=s.parameters)==null?void 0:h.docs)==null?void 0:I.source}}};var P,k,S;o.parameters={...o.parameters,docs:{...(P=o.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-button size="sm" label="Small button"></dss-button>
...
}`,...(S=(k=o.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};var f,w,$;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-button size="md" label="Sense icona"></dss-button>
...
}`,...($=(w=d.parameters)==null?void 0:w.docs)==null?void 0:$.source}}};var T,A,L;a.parameters={...a.parameters,docs:{...(T=a.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-button size="md" label="Amb icona" icon="add_box"></dss-button>
...
}`,...(j=(O=b.parameters)==null?void 0:O.docs)==null?void 0:j.source}}};var q,H,J;r.parameters={...r.parameters,docs:{...(q=r.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
        <dss-button variant="subtle" size="md" label="Button"></dss-button>
...
}`,...(J=(H=r.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};var K,X,V;l.parameters={...l.parameters,docs:{...(K=l.parameters)==null?void 0:K.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-button variant="danger" size="md" label="Button"></dss-button>
...
}`,...(V=(X=l.parameters)==null?void 0:X.docs)==null?void 0:V.source}}};var G,Q,R;u.parameters={...u.parameters,docs:{...(G=u.parameters)==null?void 0:G.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-button variant="warning" size="md" label="Button" icon="add_box"></dss-button>
...
}`,...(bt=(it=z.parameters)==null?void 0:it.docs)==null?void 0:bt.source}}};var rt,lt,ut;g.parameters={...g.parameters,docs:{...(rt=g.parameters)==null?void 0:rt.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-button variant="alternative-dark" size="md" label="Button"></dss-button>
...
}`,...(ut=(lt=g.parameters)==null?void 0:lt.docs)==null?void 0:ut.source}}};var ct,mt,vt;B.parameters={...B.parameters,docs:{...(ct=B.parameters)==null?void 0:ct.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-button variant="primary" label="Lorem ipsum dolor sit amet consecutur ipsum" size="md"></dss-button>
...
}`,...(Bt=(gt=x.parameters)==null?void 0:gt.docs)==null?void 0:Bt.source}}};const yt=["Playground","Size","TextNoIcon","TextIcon","IconNoText","Primary","Secondary","Subtle","ErrorState","Warning","Success","Info","Link","AltLight","AltDark","MaxWidth","Loading"],St=Object.freeze(Object.defineProperty({__proto__:null,AltDark:g,AltLight:z,ErrorState:l,IconNoText:e,Info:m,Link:v,Loading:x,MaxWidth:B,Playground:s,Primary:i,Secondary:b,Size:o,Subtle:r,Success:c,TextIcon:a,TextNoIcon:d,Warning:u,__namedExportsOrder:yt,default:pt},Symbol.toStringTag,{value:"Module"}));export{z as A,l as E,e as I,v as L,B as M,s as P,St as S,d as T,u as W,o as a,a as b,i as c,b as d,r as e,c as f,m as g,g as h,x as i};
