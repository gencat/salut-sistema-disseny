import"./lit-element-Dloa6E9d.js";import{x as a}from"./lit-html-D6a8R3xZ.js";import"./datepicker-l95xg86-.js";const G={title:"Components/Datepicker",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},label:{name:"Label"},helpText:{name:"Message for initial help"},invalid:{name:"Mostrar error",control:{type:"boolean"}},showTime:{name:"Mostrar temps",control:{type:"boolean"}},timepickerSelector:{name:"Timepicker Dropdown",control:{type:"radio"},options:["list","manual"],if:{arg:"showTime"}},minutesRange:{name:"Minutes Range",control:{type:"number",min:0,max:59},if:{arg:"showTime"}},minHour:{name:"Min Hour",control:{type:"number",min:0,max:22},if:{arg:"showTime"}},maxHour:{name:"Max Hour",control:{type:"number",min:1,max:23},if:{arg:"showTime"}},leftLabel:{name:"Botó esquerra",if:{arg:"showTime"}},rightLabel:{name:"Botó dreta",if:{arg:"showTime"}},validate:{name:"validació interna",control:{type:"boolean"}}},parameters:{layout:"centered"}},t={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=750-7973&m=dev"}},args:{size:"lg",label:"Data",helpText:"Help text.",invalid:!1,showTime:!1,timepickerSelector:"manual",minutesRange:1,minHour:0,maxHour:23,leftLabel:"Cancel·lar",rightLabel:"Acceptar",validate:!0},render:e=>a`
    ...
    `},c={tags:["!dev"],render:()=>a`
     <div class="datepicker-canvas">
            <dss-datepicker validate minDate minDate="20/01/2024" maxDate="20/12/2026" helpText="Min 20/01/2024 || Max 20/12/2026">
...
}`,...(k=(m=t.parameters)==null?void 0:m.docs)==null?void 0:k.source}}};var b,v,g;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
     <div class="datepicker-canvas datepicker-canvas--sizes">
...
}`,...(g=(v=i.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var x,y,h;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <dss-datepicker>
...
}`,...(h=(y=r.parameters)==null?void 0:y.docs)==null?void 0:h.source}}};var T,f,D;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
     <dss-datepicker>
...
}`,...(F=(P=c.parameters)==null?void 0:P.docs)==null?void 0:F.source}}};const E=["Playground","Sizes","Disabled","ReadOnly","Required","Invalid","Timepicker","Buttons","CustomCalendar","Validation"],X=Object.freeze(Object.defineProperty({__proto__:null,Buttons:p,CustomCalendar:o,Disabled:r,Invalid:d,Playground:t,ReadOnly:s,Required:l,Sizes:i,Timepicker:n,Validation:c,__namedExportsOrder:E,default:G},Symbol.toStringTag,{value:"Module"}));export{r as D,d as I,t as P,s as R,X as S,n as T,c as V,i as a,l as b};
