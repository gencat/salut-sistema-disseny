        ...
        <div class="${e$1(l)}">
          ...
          <div class="dss-input-field">
            ...
            ${!d._showDropdown&&d._isTruncated&&d._selectedValue&&((g=d._selectedValue)==null?void 0:g.length)===1?u$1`
                <${dssTooltip$5}>${(f=d._input)==null?void 0:f.value}</${dssTooltip$5}>
              `:null}
        ...
        <div class="dss-item-list__item">
          ${d._widget?u$1`
                <div class="item-widget-badge">
                  ...
                  > 
                    ${a.iconBadgeLabel?u$1`<${dssTooltip$3} slot="tooltip" aria-hidden="true" ?tooltipFixed="${d.tooltipFixed}">${a.iconBadgeLabel}</${dssTooltip$3}>`:null}
                  </${dssIconBadge}>  
                </div>
              `:null}
          ...
          <div class="item-details">
            ...
            <div class="item-details__title">
              ...
              <div class="item-details__title-text" @mouseenter=${l}>
                ${a.title}
                <${dssTooltip$3} ?tooltipFixed="${d.tooltipFixed}" class="title-tooltip" slot="tooltip" aria-hidden="true">${a.title}</${dssTooltip$3}>
              </div>
            </div>
            <div class="item-details__subtitle" @mouseenter=${l}>
              ${a.subtitle}
              <${dssTooltip$3} ?tooltipFixed="${d.tooltipFixed}" class="title-tooltip" slot="tooltip" aria-hidden="true">${a.subtitle}</${dssTooltip$3}>
            </div>
          </div>
