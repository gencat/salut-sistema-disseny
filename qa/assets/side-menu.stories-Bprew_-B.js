...
}`,...(y=(P=b.parameters)==null?void 0:P.docs)==null?void 0:y.source}}};var N,w,C;c.parameters={...c.parameters,docs:{...(N=c.parameters)==null?void 0:N.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    const createMenuItems = [{
      label: 'Curs clinic'
...
}`,...(C=(w=c.parameters)==null?void 0:w.docs)==null?void 0:C.source}}};var S,v,O;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    const createMenuItems = [{
      label: 'Curs clinic',
