import{j as e,M as r,T as o,C as t,a}from"./index-MlXj6sD6.js";import{useMDXComponents as l}from"./index-DYs5BNo_.js";import{S as c,P as d,B as h,a as x,T as p,A as j,b as m,C as u}from"./widget.stories-DkmpKeIA.js";import"./iframe-OrK7ehTE.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-html-B2eaWknC.js";function n(i){const s={a:"a",blockquote:"blockquote",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...l(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
...
`,e.jsx(t,{of:m}),`
`,e.jsx(s.h3,{id:"custom-item-list",children:"Custom Item List"}),`
`,e.jsx(t,{of:u}),`
`,e.jsx(s.h4,{id:"changelog",children:"Changelog"}),`
`,e.jsxs(s.table,{children:[e.jsx(s.thead,{children:e.jsxs(s.tr,{children:[e.jsx(s.th,{children:"Versió"}),e.jsx(s.th,{children:"Canvis"})]})}),e.jsxs(s.tbody,{children:[e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"2.1.1"})}),e.jsx(s.td,{children:"Nou variant amb item-list:custom."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.strong,{children:"1.12.6"})}),e.jsx(s.td,{children:"Nou collection."})]})]})]})]})}function M(i={}){const{wrapper:s}={...l(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(n,{...i})}):n(i)}export{M as default};
