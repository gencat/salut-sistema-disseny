import"./lit-element-DhY7bShc.js";import{x as e}from"./lit-html-B2eaWknC.js";const O={title:"Components/Progress Indicator",argTypes:{title:{name:"Títol"},description:{name:"Descripció"},percentage:{name:"Percentatge",control:{type:"range",min:0,max:100,step:1},defaultValue:0},state:{name:"Estat",control:{type:"select"},options:["default","info","success","warning","error"],defaultValue:"default"},hasFailed:{name:"Mostrar error",control:{type:"boolean"},defaultValue:!1}},parameters:{layout:"centered"}},s={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=70-2791&m=dev"}},args:{title:"Title",description:"Description, short and clear.",percentage:0,state:"default",hasFailed:!1},render:r=>e`
...
}`,...(w=(v=a.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var y,F,$;n.parameters={...n.parameters,docs:{...(y=n.parameters)==null?void 0:y.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator title="Title" description="Description, short and clear." percentage="23" state="info"></dss-progress-indicator>
...
}`,...($=(F=n.parameters)==null?void 0:F.docs)==null?void 0:$.source}}};var x,P,E;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator title="Title" description="Description, short and clear." percentage="23" state="success"></dss-progress-indicator>
...
}`,...(E=(P=o.parameters)==null?void 0:P.docs)==null?void 0:E.source}}};var I,_,b;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator title="Title" description="Description, short and clear." percentage="23" state="warning"></dss-progress-indicator>
...
}`,...(b=(_=c.parameters)==null?void 0:_.docs)==null?void 0:b.source}}};var z,C,N;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-progress-indicator title="Title" description="Description, short and clear." percentage="23" state="error"></dss-progress-indicator>
...
}`,...(N=(C=d.parameters)==null?void 0:C.docs)==null?void 0:N.source}}};const V=["Playground","NoTitle","Title","DefaultState","InfoState","SuccessState","WarningState","ErrorState"],k=Object.freeze(Object.defineProperty({__proto__:null,DefaultState:a,ErrorState:d,InfoState:n,NoTitle:t,Playground:s,SuccessState:o,Title:i,WarningState:c,__namedExportsOrder:V,default:O},Symbol.toStringTag,{value:"Module"}));export{a as D,d as E,n as I,t as N,s as P,k as S,i as T,c as W,o as a};
