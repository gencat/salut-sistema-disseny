import{j as e,M as r,T as l,C as i}from"./index-a-fjzuZQ.js";import{useMDXComponents as t}from"./index-Ch6FiGIi.js";import{S as o,T as c,N as d,a as p,b as x,c as m,F as h,d as u,I as j,e as f,C as b,f as v,g as C}from"./custom-table-header.stories-8mhhnJH6.js";import"./iframe-Ddyg9Gom.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Cu4lwwaE.js";import"./index-Ca4lBP7z.js";import"./index-DrFu-skq.js";import"./lit-html-D6cejpwM.js";function a(n){const s={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .table-wrapper {
      width: 900px;
      height: 150px;
    }
  ...
  `}),`
`,e.jsx(r,{of:o}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(l,{}),e.jsx("dss-badge",{text:"dss-custom-table-header",size:"md",state:"info",outlined:!0,hideIcon:!0})]}),`
...
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#filtres-combinats",children:"Filtres combinats"})}),`
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"#filtres-combinats-sense-t%C3%ADtol",children:"Filtres combinats sense títol"})}),`
...
`,e.jsx(i,{of:f}),`
`,e.jsx("br",{}),`
`,e.jsx(s.h3,{id:"filtres-combinats",children:"Filtres combinats"}),`
`,e.jsx(i,{of:b}),`
`,e.jsx(s.h3,{id:"filtres-combinats-sense-títol",children:"Filtres combinats sense títol"}),`
`,e.jsx(s.p,{children:"Dins de Storybook, l’espai del canvas està limitat, de manera que la resolució de 1920px no arriba a mostrar-se. En cas d’utilitzar aquest exemple a la resolució màxima, el contenidor de tots els filtres ha d’actuar com una columna i pujar la seva posició, permetent disposar de més espai per visualitzar la taula."}),`
`,e.jsx(i,{of:v}),`
`,e.jsx(s.h3,{id:"accions-personalitzades",children:"Accions personalitzades"}),`
`,e.jsx(i,{of:C}),`
`,e.jsx("br",{})]})}function N(n={}){const{wrapper:s}={...t(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(a,{...n})}):a(n)}export{N as default};
