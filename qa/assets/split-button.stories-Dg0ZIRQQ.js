...
`,F={title:"Components/Split Button",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["lg","md","sm"]},variant:{name:"Variant",control:{type:"radio"},options:["primary","secondary"]},text:{name:"Text",control:{type:"text"}},showIcon:{name:"Mostra icona",control:{type:"boolean"}},mainIcon:{name:"Icon principal",control:{type:"text"},if:{arg:"showIcon"}},iconClose:{name:"Icona de acció per defecte (obrir)",control:{type:"text"}},iconOpen:{name:"Icona de acció secundària (tancar)",control:{type:"text"}},isOpen:{name:"Actiú",control:{type:"boolean"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}},hasMenu:{name:"Habilitar menú",control:{type:"boolean"}},dropdownPosition:{name:"Posición del menú",control:{type:"select"},options:["bottom-start","bottom-end","top-start","top-end"],if:{arg:"hasMenu"}}},parameters:{layout:"centered"}},o={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=1067-2312&m=dev"}},args:{size:"lg",variant:"primary",text:"Button",showIcon:!1,mainIcon:"add_box",iconClose:"expand_more",iconOpen:"expand_less",isOpen:!1,disabled:!1,hasMenu:!1,dropdownPosition:"bottom-start"},render:t=>s`
  ...
  `},i={tags:["!dev"],render:()=>s`
    ...
    `,decorators:[e(n,"split-button-disabled-style")]},m={tags:["!dev"],render:()=>s`
    ...
    `,decorators:[e(n,"split-button-icons-style")]},l={tags:["!dev"],render:()=>s`
      <dss-split-button variant="primary" text="Lorem ipsum dolor sit amet consecutur ipsum" size="md"></dss-split-button>
    `,decorators:[e(n,"split-button-max-width-style")]};var c,p,b;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...(b=(p=o.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var y,x,v;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-split-button variant="primary" text="Button" size="lg"></dss-split-button>
...
}`,...(v=(x=i.parameters)==null?void 0:x.docs)==null?void 0:v.source}}};var g,h,w;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-split-button variant="primary" text="Button"></dss-split-button>
...
}`,...(w=(h=a.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var S,A,B;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-split-button variant="primary" text="Button" isOpen></dss-split-button>
...
}`,...(B=(A=r.parameters)==null?void 0:A.docs)==null?void 0:B.source}}};var z,M,f;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-split-button variant="primary" text="Button" disabled></dss-split-button>
...
}`,...(f=(M=d.parameters)==null?void 0:M.docs)==null?void 0:f.source}}};var $,O,I;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <div style="height:250px">
...
}`,...(I=(O=m.parameters)==null?void 0:O.docs)==null?void 0:I.source}}};var _,P,C;u.parameters={...u.parameters,docs:{...(_=u.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
            <dss-split-button variant="primary" text="Button" size="lg" icon="add_box"></dss-split-button>
...
}`,...(C=(P=u.parameters)==null?void 0:P.docs)==null?void 0:C.source}}};var T,D,E;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <dss-split-button variant="primary" text="Lorem ipsum dolor sit amet consecutur ipsum" size="md"></dss-split-button>
...
}`,...(E=(D=l.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};const N=["Playground","Sizes","Types","Active","Disabled","Menu","Icons","MaxWidth"],W=Object.freeze(Object.defineProperty({__proto__:null,Active:r,Disabled:d,Icons:u,MaxWidth:l,Menu:m,Playground:o,Sizes:i,Types:a,__namedExportsOrder:N,default:F},Symbol.toStringTag,{value:"Module"}));export{r as A,d as D,u as I,m as M,o as P,W as S,a as T,i as a,l as b};
