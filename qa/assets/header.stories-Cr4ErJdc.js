import{x as t}from"./lit-html-D6cejpwM.js";import{w as r}from"./storybook-decorators-DSS85Rnr.js";const d=`
  .dss-layout-header {
    width: 1920px;
  }
...
`,I={title:"Collections/Header",argTypes:{variant:{name:"Variant",control:{type:"select"},options:["Amb pacient: Assistencial","Amb pacient: Administratiu","Sense pacient","Extern"]},area:{name:"Area",if:{arg:"variant",eq:"Extern"}},appName:{name:"Iniciativa",if:{arg:"variant",eq:"Extern"}},showPatient:{name:"Mostrar menu pacient",control:{type:"boolean"}},showLinks:{name:"Mostrar enllaços",control:{type:"boolean"}},showProfessional:{name:"Mostrar menu professional",control:{type:"boolean"}},showLogout:{name:"Mostrar botó tancar sessió",control:{type:"boolean"}}}},o={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=4099-39796&m=dev "}},args:{variant:"Amb pacient: Assistencial",area:"HES",appName:"Mi iniciativa",showPatient:!0,showLinks:!0,showProfessional:!0,showLogout:!1},render:e=>{const A=t`
                ...
                <dss-popover position="bottom" hideCloseIcon>
                    <dss-popover-body slot="body">
                        <dss-typography variant="body-3">
                            En aquest espai d’exemple s’ha d’incrustar el widget d’alertes i notificacions.
                        </dss-typography>
                    </dss-popover-body>
                </dss-popover>
            </div>
          ...
          ${e.variant==="Extern"?t`
            ...
            >
              ${e.showPatient?t`
                ...
                `:null}
              ${e.showLinks?i:null}
              ${e.showProfessional?q:null}
            </dss-header>
          `:e.variant==="Amb pacient: Assistencial"?t`
            <dss-header showEndVisit>
    ...
    `,decorators:[r(d,"header-external-style")]},u={tags:["!dev"],render:()=>t`
      <div class="dss-layout-header">
        <dss-header showEndVisit>
    ...
    `,decorators:[r(d,"header-patient-support-style")]},l={tags:["!dev"],render:()=>t`
      <div class="dss-layout-header">
        <dss-header>
          <dss-header-menu-patient slot="patient-menu" name="Nom del pacient" cip="CIP" age="Edat" gender="Gènere">
            <dss-avatar size="xl" name="Nom" surname="Pacient" slot="avatar"></dss-avatar>
    ...
    `,decorators:[r(d,"header-patient-admin-style")]},s={tags:["!dev"],render:()=>t`
      <div class="dss-layout-header">
        <dss-header>
          <dss-header-links slot="links"></dss-header-links>
          <dss-header-menu-professional slot="professional-menu" name="Nom del professional" center="Centre hospitalari" collegiate="859438475">
    ...
    `,decorators:[r(d,"header-no-patient-style")]},n={tags:["!dev"],render:()=>t`
      <div class="dss-layout-header">
        <dss-header jcef>
          <dss-header-menu-patient slot="patient-menu" name="Nom del pacient" cip="CIP" age="Edat" gender="Gènere">
            <dss-avatar size="xl" name="Nom" surname="Pacient" slot="avatar"></dss-avatar>
    ...
    `,decorators:[r(d,"header-jcef-style")]};var m,b,c;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...(c=(b=o.parameters)==null?void 0:b.docs)==null?void 0:c.source}}};var v,h,f;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="dss-layout-header">
...
}`,...(f=(h=a.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var y,w,g;u.parameters={...u.parameters,docs:{...(y=u.parameters)==null?void 0:y.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="dss-layout-header">
...
}`,...(g=(w=u.parameters)==null?void 0:w.docs)==null?void 0:g.source}}};var E,P,x;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="dss-layout-header">
...
}`,...(x=(P=l.parameters)==null?void 0:P.docs)==null?void 0:x.source}}};var k,N,S;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="dss-layout-header">
...
}`,...(S=(N=s.parameters)==null?void 0:N.docs)==null?void 0:S.source}}};var _,z,C;n.parameters={...n.parameters,docs:{...(_=n.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="dss-layout-header">
...
}`,...(C=(z=n.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};const $=["Playground","External","PatientSupport","PatientAdministrative","NoPatient","JCEF"],V=Object.freeze(Object.defineProperty({__proto__:null,External:a,JCEF:n,NoPatient:s,PatientAdministrative:l,PatientSupport:u,Playground:o,__namedExportsOrder:$,default:I},Symbol.toStringTag,{value:"Module"}));export{a as E,n as J,s as N,o as P,V as S,u as a,l as b};
