import{j as s,M as i}from"./blocks-BEOHU4QX.js";import{useMDXComponents as r}from"./index-IElg5Sqw.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DVq4slBB.js";function n(d){const e={h2:"h2",h3:"h3",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...r(),...d.components};return s.jsxs(s.Fragment,{children:[s.jsx(i,{title:"Documentació/Changelog v3/Breaking changes/Esdeveniments renombrats"}),`
...
`,s.jsx("br",{}),`
`,s.jsx(e.h3,{id:"dss-calendar",children:"dss-calendar"}),`
`,s.jsxs(e.table,{children:[s.jsx(e.thead,{children:s.jsxs(e.tr,{children:[s.jsx(e.th,{children:"Nom v2"}),s.jsx(e.th,{children:"Nom v3"})]})}),s.jsxs(e.tbody,{children:[s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onDateChange"}),s.jsx(e.td,{children:"date-changed"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onRangeChange"}),s.jsx(e.td,{children:"range-changed"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onCancel"}),s.jsx(e.td,{children:"cancel"})]})]})]}),`
`,s.jsx("br",{}),`
...
`,s.jsxs(e.table,{children:[s.jsx(e.thead,{children:s.jsxs(e.tr,{children:[s.jsx(e.th,{children:"Nom v2"}),s.jsx(e.th,{children:"Nom v3"})]})}),s.jsxs(e.tbody,{children:[s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onCopyCIP"}),s.jsx(e.td,{children:"copy-cip"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onViewDetails"}),s.jsx(e.td,{children:"x eliminat x"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onEdit"}),s.jsx(e.td,{children:"x eliminat x"})]})]})]}),`
`,s.jsx("br",{}),`
`,s.jsx(e.h3,{id:"dss-header-menu-professional",children:"dss-header-menu-professional"}),`
`,s.jsxs(e.table,{children:[s.jsx(e.thead,{children:s.jsxs(e.tr,{children:[s.jsx(e.th,{children:"Nom v2"}),s.jsx(e.th,{children:"Nom v3"})]})}),s.jsxs(e.tbody,{children:[s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onExit"}),s.jsx(e.td,{children:"primary-action"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onLogout"}),s.jsx(e.td,{children:"secondary-action"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onViewDetails"}),s.jsx(e.td,{children:"x eliminat x"})]})]})]}),`
`,s.jsx("br",{}),`
