import{x as s}from"./iframe-DLVb3rJw.js";import{w as t}from"./storybook-decorators-DSS85Rnr.js";const a=`
 .wrapper {
    width: 500px;
  }
...
}`,...v.parameters?.docs?.source}}};const T=["Playground","FullCard","Selected","Moving","Deleted","Disabled","NoCloseIcon","NoDetails","NoFlag","NoMenu","InfoItemCritic","MenuLeft"],_=Object.freeze(Object.defineProperty({__proto__:null,Deleted:b,Disabled:$,FullCard:m,InfoItemCritic:x,MenuLeft:v,Moving:p,NoCloseIcon:f,NoDetails:y,NoFlag:w,NoMenu:I,Playground:h,Selected:g,__namedExportsOrder:T,default:M},Symbol.toStringTag,{value:"Module"}));export{b as D,m as F,x as I,p as M,f as N,h as P,_ as S,g as a,$ as b,y as c,w as d,I as e,v as f};
