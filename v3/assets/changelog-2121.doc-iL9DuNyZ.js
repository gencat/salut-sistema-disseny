import{j as e,M as t}from"./blocks-DQomN2yo.js";import{useMDXComponents as r}from"./index-BHVMkkSS.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DLVb3rJw.js";function i(n){const s={code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Documentació/Changelog v2/2.12.1"}),`
...
funcionament de diferents components, i per això s’inclourà en la propera versió del `,e.jsx(s.strong,{children:"Design System v3"}),"."]})]}),e.jsx("br",{}),e.jsx(s.h4,{id:"reducció-dels-espaiats-interns-dels-components",children:"Reducció dels espaiats interns dels components"}),e.jsxs("changelog-item",{status:"design",children:[e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"Header"}),": padding-left/right: 12px > 8px, height: 72px > 64px"]}),e.jsx("br",{}),e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"Footer"}),": padding-top/bottom: 12px > 8px"]}),e.jsx("br",{}),e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"Breadcrumb Bar"}),": padding-top/bottom: 8px > 4px"]}),e.jsx("br",{}),e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"Modal Footer"}),": gap: 16px > 8px"]}),e.jsx("br",{}),e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"Tabs"}),": padding-left/right: 12px > 8px, height: 40px > 32px"]}),e.jsx("br",{}),e.jsxs(s.p,{children:[e.jsx(s.strong,{children:"Tile"}),": padding/gap: 16px > 12px"]})]})]})})]})}function x(n={}){const{wrapper:s}={...r(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(i,{...n})}):i(n)}export{x as default};
