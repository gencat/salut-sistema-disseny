import{j as e,M as a}from"./blocks-DQomN2yo.js";import{useMDXComponents as i}from"./index-BHVMkkSS.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DLVb3rJw.js";function t(s){const n={blockquote:"blockquote",code:"code",em:"em",h2:"h2",h3:"h3",p:"p",pre:"pre",strong:"strong",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"API's/Custom Suffix"}),`
...
`})}),`
`,e.jsx(n.p,{children:"A partir d’aquí, ja podríem fer l’import de la biblioteca en qualsevol mòdul de la nostra aplicació."})]})}function m(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{m as default};
