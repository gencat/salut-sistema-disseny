import{j as e,M as t}from"./blocks-CfVR1a0K.js";import{useMDXComponents as i}from"./index-BMHellmX.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CqPuVMaj.js";function a(s){const n={a:"a",code:"code",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Documentació/Changelog v3/Breaking changes/Components eliminats"}),`
...
`]}),`
`,e.jsx(n.p,{children:`Amb l’objectiu de facilitar la transició, posem a disposició dels desenvolupadors una còpia de seguretat CSS de l’anterior
v2 disponible al següent enllaç:`}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://codisisdisseny.salut.gencat.cat/backup/dss-v2-backup-css.zip",rel:"nofollow",children:"Backup CSS v2"})}),`
`]}),`
...
ja que pot suposar un impacte en els temps de càrrega de l’aplicació en carregar dues fulles d’estils.`})]})}function p(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{p as default};
