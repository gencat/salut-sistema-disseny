import{x as o}from"./iframe-PL0KlCAr.js";import{w as t}from"./storybook-decorators-DSS85Rnr.js";const s=`
    .wrapper {
        display: flex;
        align-items: center;
        gap: 16px;
    }
`,v={title:"Components/Icon Button",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},variant:{name:"Variant",control:{type:"select"},options:["primary","danger","warning","success","info","neutral","ghost","orange","purple"]},icon:{name:"Icona"},label:{name:"Label (accessibilitat)"},fill:{name:"Icona tipus fill",control:{type:"boolean"}}},parameters:{layout:"centered"}},i={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=39-6419&m=dev"}},args:{size:"md",variant:"primary",icon:"add_box",label:"Botó d'acció",fill:!1},render:a=>o`
    ...
    `,decorators:[t(s,"icon-button-notification-style")]};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...p.parameters?.docs?.source}}};const m=["Playground","Primary","Neutral","ErrorState","Warning","Success","Info","Orange","Purple","Notification"],z=Object.freeze(Object.defineProperty({__proto__:null,ErrorState:e,Info:b,Neutral:d,Notification:p,Orange:l,Playground:i,Primary:n,Purple:u,Success:r,Warning:c,__namedExportsOrder:m,default:v},Symbol.toStringTag,{value:"Module"}));export{e as E,b as I,d as N,l as O,i as P,z as S,c as W,n as a,r as b,u as c,p as d};
