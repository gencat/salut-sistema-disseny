import{j as s,M as i}from"./blocks-DQomN2yo.js";import{useMDXComponents as r}from"./index-BHVMkkSS.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DLVb3rJw.js";function n(d){const e={h2:"h2",h3:"h3",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...r(),...d.components};return s.jsxs(s.Fragment,{children:[s.jsx(i,{title:"Documentació/Changelog v3/Nom dels sdeveniments"}),`
...
`,s.jsxs(e.table,{children:[s.jsx(e.thead,{children:s.jsxs(e.tr,{children:[s.jsx(e.th,{children:"Nom v2"}),s.jsx(e.th,{children:"Nom v3"})]})}),s.jsxs(e.tbody,{children:[s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onToggleAccordion"}),s.jsx(e.td,{children:"toggle"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onAccordionCheckboxChange"}),s.jsx(e.td,{children:"checkbox-change"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onAccordionSecondaryAction"}),s.jsx(e.td,{children:"secondary-action"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onPrimaryAction"}),s.jsx(e.td,{children:"primary-action"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onWidgetNext"}),s.jsx(e.td,{children:"next"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onWidgetClose"}),s.jsx(e.td,{children:"close"})]})]})]}),`
`,s.jsx("br",{}),`
...
`,s.jsxs(e.table,{children:[s.jsx(e.thead,{children:s.jsxs(e.tr,{children:[s.jsx(e.th,{children:"Nom v2"}),s.jsx(e.th,{children:"Nom v3"})]})}),s.jsx(e.tbody,{children:s.jsxs(e.tr,{children:[s.jsx(e.td,{children:"onChangePage"}),s.jsx(e.td,{children:"page-change"})]})})]}),`
`,s.jsx("br",{}),`
...
`,s.jsx("br",{})]})}function j(d={}){const{wrapper:e}={...r(),...d.components};return e?s.jsx(e,{...d,children:s.jsx(n,{...d})}):n(d)}export{j as default};
