import{x as s}from"./iframe-CqPuVMaj.js";import{w as e}from"./storybook-decorators-DSS85Rnr.js";const n=`
 .css-1sqhzee {
    display:none
  }
...
`,p={title:"Collections/Split Button",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["lg","md","sm"]},variant:{name:"Variant",control:{type:"radio"},options:["primary","secondary"]},text:{name:"Text",control:{type:"text"}},showIcon:{name:"Mostra icona",control:{type:"boolean"}},mainIcon:{name:"Icon principal",control:{type:"text"},if:{arg:"showIcon"}},iconClose:{name:"Icona de acció per defecte (obrir)",control:{type:"text"}},iconOpen:{name:"Icona de acció secundària (tancar)",control:{type:"text"}},isOpen:{name:"Actiú",control:{type:"boolean"}},disabled:{name:"Deshabilitat",control:{type:"boolean"}},hasMenu:{name:"Habilitar menú",control:{type:"boolean"}},dropdownPosition:{name:"Posición del menú",control:{type:"select"},options:["bottom-start","bottom-end","top-start","top-end"],if:{arg:"hasMenu"}}},parameters:{layout:"centered"}},o={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=1067-2312&m=dev"}},args:{size:"lg",variant:"primary",text:"Button",showIcon:!1,mainIcon:"add_box",iconClose:"expand_more",iconOpen:"expand_less",isOpen:!1,disabled:!1,hasMenu:!1,dropdownPosition:"bottom-start"},render:t=>s`
  ...
  `},i={tags:["!dev"],render:()=>s`
    ...
    `,decorators:[e(n,"split-button-max-width-style")]},c={tags:["!dev"],render:()=>s`
        ...
        `,decorators:[e(n,"split-button-notification-style")]};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...c.parameters?.docs?.source}}};const b=["Playground","Sizes","Types","Active","Disabled","Menu","Icons","MaxWidth","Notification"],g=Object.freeze(Object.defineProperty({__proto__:null,Active:r,Disabled:l,Icons:u,MaxWidth:m,Menu:d,Notification:c,Playground:o,Sizes:i,Types:a,__namedExportsOrder:b,default:p},Symbol.toStringTag,{value:"Module"}));export{r as A,l as D,u as I,d as M,c as N,o as P,g as S,a as T,i as a,m as b};
