import{j as e,M as t,T as c,C as s}from"./blocks-BQe3t3mS.js";import{useMDXComponents as r}from"./index-D25yCQlW.js";import{S as a,P as o,a as d,M as p,N as x,T as h,b as j,U as m,c as u}from"./selector.stories-Ca_25JAF.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CdZ_4rdx.js";function l(i){const n={a:"a",blockquote:"blockquote",h3:"h3",h4:"h4",li:"li",p:"p",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
  .wrapper {
    display: flex;
...
`}),`
`,e.jsx(t,{of:a}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(c,{}),e.jsx("component-title",{children:"dss-selector"})]}),`
`,e.jsx("br",{}),`
`,e.jsx("dss-alert",{state:"warning",message:`Aquest component és una part interna del ng-input-dropdown. Si cal utilitzar-lo de manera independent, és necessari afegir la **propietat ariaLabel** 
...
`,e.jsx(s,{of:u})]})}function S(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(l,{...i})}):l(i)}export{S as default};
