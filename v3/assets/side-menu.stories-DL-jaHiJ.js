import{x as a}from"./iframe-CdZ_4rdx.js";import{w as o}from"./storybook-decorators-DSS85Rnr.js";const i=`
 .wrapper {
        height: 900px;
    }
    .wrapper--reduced {
...
`,I={title:"Collections/Side Menu",argTypes:{hideCreate:{name:"Amagar botó de crear ",control:{type:"boolean"}},createNotifications:{name:"Quantitat de notificacions per botó de crear",control:{type:"number",max:10,min:0}},topMenuItems:{name:"Quantitat de ítems Role Menu",control:{type:"number",max:6,min:1}},bottomMenuItems:{name:"Quantitat de ítems Global Menu",control:{type:"number",max:6,min:1}},firstItemIcon:{name:"Icona primer item",control:{type:"text"}},firstItemLabel:{name:"Label primer item",control:{type:"text"}},firstItemNotifications:{name:"Notificacions primer item",control:{type:"number",max:6,min:0}},firstItemSelected:{name:"Primer item seleccionat",control:{type:"boolean"}},firstItemDisabled:{name:"Deshabil·litar primer item",control:{type:"boolean"}},axiaHidden:{name:"Amagar botó de Axia",control:{type:"boolean"}},axiaDisabled:{name:"Deshabil·litar botó de Axia",control:{type:"boolean"}},axiaLabel:{name:"Label botó de Axia",control:{type:"text"}}}},s={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=250-5627&m=dev"}},args:{hideCreate:!1,createNotifications:0,topMenuItems:4,bottomMenuItems:3,firstItemIcon:"home",firstItemLabel:"Menu",firstItemNotifications:0,firstItemSelected:!1,firstItemDisabled:!1,axiaHidden:!1,axiaDisabled:!1,axiaLabel:"Axia"},render:e=>{const n=[{label:"Curs clinic",notifications:e.createNotifications},{label:"Informe"},{label:"PROM"},{label:"Visita"},{label:"Prescipció"}],l=()=>{const t=[];return Array.from({length:e.topMenuItems-1},()=>{t.push({icon:"add_box",label:"Role Menu"})}),t},M=[{icon:"settings",label:"Global Menu",notifications:"3",nestedMenu:[{icon:"add_box",label:"Global child 1",notifications:2},{icon:"add_box",label:"Global child 2"},{icon:"add_box",label:"Global child 3",notifications:1}]},...(()=>{const t=[];return Array.from({length:e.bottomMenuItems-1},()=>{t.push({icon:"add_box",label:"Global Menu"})}),t})()],x=[{icon:e.firstItemIcon,label:e.firstItemLabel,notifications:e.firstItemNotifications,disabled:e.firstItemDisabled,nestedMenu:[{icon:"add_box",label:"Role child 1",notifications:e.firstItemNotifications},{icon:"add_box",label:"Role child 2"},{icon:"add_box",label:"Role child 3"}]},...l()];return a`
  ...
  `}},d={tags:["!dev"],render:()=>a`
    ...
    `,decorators:[o(i,"sidemenu-reduced-style")]};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...m.parameters?.docs?.source}}};const _=["Playground","ByDefault","Expanded","ListItemOptions","NestedMenu","HideAxia","ReducedHeight"],R=Object.freeze(Object.defineProperty({__proto__:null,ByDefault:d,Expanded:b,HideAxia:u,ListItemOptions:c,NestedMenu:r,Playground:s,ReducedHeight:m,__namedExportsOrder:_,default:I},Symbol.toStringTag,{value:"Module"}));export{d as B,b as E,u as H,c as L,r as N,s as P,m as R,R as S};
