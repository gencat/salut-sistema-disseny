import{x as t}from"./iframe-DLVb3rJw.js";import{w as r}from"./storybook-decorators-DSS85Rnr.js";const q=`
  .dss-layout-header {
    width: 1920px;
  }
...
`,b={title:"Collections/Header",argTypes:{variant:{name:"Variant",control:{type:"select"},options:["Amb pacient: Assistencial","Amb pacient: Administratiu","Sense pacient","Extern"]},area:{name:"Area",if:{arg:"variant",eq:"Extern"}},appName:{name:"Iniciativa",if:{arg:"variant",eq:"Extern"}},showPatient:{name:"Mostrar menu pacient",control:{type:"boolean"}},showLinks:{name:"Mostrar enllaços",control:{type:"boolean"}},showProfessional:{name:"Mostrar menu professional",control:{type:"boolean"}},showLogout:{name:"Mostrar botó tancar sessió",control:{type:"boolean"}}}},o={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=4099-39796&m=dev "}},args:{variant:"Amb pacient: Assistencial",area:"HES",appName:"Mi iniciativa",showPatient:!0,showLinks:!0,showProfessional:!0,showLogout:!1},render:e=>{const m=t`
    ...
    `,decorators:[r(q,"header-jcef-style")]};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...n.parameters?.docs?.source}}};const c=["Playground","External","PatientSupport","PatientAdministrative","NoPatient","JCEF"],h=Object.freeze(Object.defineProperty({__proto__:null,External:u,JCEF:n,NoPatient:s,PatientAdministrative:l,PatientSupport:a,Playground:o,__namedExportsOrder:c,default:b},Symbol.toStringTag,{value:"Module"}));export{u as E,n as J,s as N,o as P,h as S,a,l as b};
