import{x as a}from"./iframe-CdZ_4rdx.js";import{w as r}from"./storybook-decorators-DSS85Rnr.js";const o=`
    .layout {
        height: 500px;
        width: 800px;
        display: flex;
...
`,u={title:"Collections/Sidebar",component:"dss-sidebar",argTypes:{showTitle:{name:"Mostrar título",control:{type:"boolean"}},titleText:{name:"Títol",if:{arg:"showTitle"}},placement:{name:"Posició del sidebar",control:{type:"radio"},options:["left","right"]},iconRight:{name:"Icona dreta"},iconLeft:{name:"Icona esquerra"}}},t={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=19-193&m=dev"}},args:{showTitle:!0,titleText:"Títol",placement:"left",iconRight:"keyboard_arrow_right",iconLeft:"keyboard_arrow_left"},render:e=>{const c=[{label:"Item1",icon:"add_box",hasAction:!0},{label:"Item2",icon:"add_box",hasAction:!0},{label:"Item3",icon:"add_box",hasAction:!0}],d=()=>a`
            <dss-sidebar
                ...
                ?expanded=${e.expanded}
            >
                <dss-list-menu .items=${c}></dss-list-menu>
            </dss-sidebar>
        `;return a`
    ...
    `,decorators:[r(o,"sidebar-no-title-style")]};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...n.parameters?.docs?.source}}};const m=["Playground","PlacementLeft","PlacementRight","NoTitle"],g=Object.freeze(Object.defineProperty({__proto__:null,NoTitle:n,PlacementLeft:i,PlacementRight:s,Playground:t,__namedExportsOrder:m,default:u},Symbol.toStringTag,{value:"Module"}));export{n as N,t as P,g as S,i as a,s as b};
