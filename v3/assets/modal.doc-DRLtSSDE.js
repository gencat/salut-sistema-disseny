import{j as e,M as l,T as d,S as o}from"./blocks-BQe3t3mS.js";import{useMDXComponents as n}from"./index-D25yCQlW.js";import{S as i}from"./modal.stories-C1Y2_v1o.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CdZ_4rdx.js";function a(t){const s={a:"a",blockquote:"blockquote",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...n(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:i}),`
...
`}),`
`,e.jsx(s.p,{children:"Pareu atenció a l'esdeveniment close que hem d'utilitzar per modificar la nostra variable Angular quan el modal es tanca internament al ShadowRoot."}),`
...
`})]})}function b(t={}){const{wrapper:s}={...n(),...t.components};return s?e.jsx(s,{...t,children:e.jsx(a,{...t})}):a(t)}export{b as default};
