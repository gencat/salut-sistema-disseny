import{j as e,M as l,T as t,C as i}from"./blocks-BQe3t3mS.js";import{useMDXComponents as s}from"./index-D25yCQlW.js";import{S as c,P as d,a as o,I as h,D as x,R as p,b as m,c as j,d as u,e as b,C as f}from"./ng-textarea.stories-3ZNKiWcq.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CdZ_4rdx.js";import"./storybook-decorators-DSS85Rnr.js";function r(a){const n={a:"a",blockquote:"blockquote",code:"code",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:c}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(t,{}),e.jsx("component-title",{children:"dss-ng-textarea"})]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Estem fent proves amb una nova estructura per a la documentació. Els exemples mostrats a continuació pertanyen a la propera versió v2.72. Si us plau, per consultar la documentació de la versió actual del Textarea, visita ",e.jsx(n.a,{href:"https://codisisdisseny.salut.gencat.cat/legacy/2.7.1/?path=/docs/components-textarea--docs",rel:"nofollow",children:"aquest enllaç"}),"."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
...
`,e.jsx(i,{of:f})]})}function D(a={}){const{wrapper:n}={...s(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(r,{...a})}):r(a)}export{D as default};
