import{x as s}from"./iframe-PL0KlCAr.js";import{w as r}from"./storybook-decorators-DSS85Rnr.js";const l=`
    .story-table-row {
        display: flex;
...
`,f={title:"Collections/Table/Cell",argTypes:{icon:{name:"Icona",if:{arg:"variant",eq:"default"}},value:{name:"Valor"},size:{name:"Mida",control:{type:"radio"},options:["sm","md","auto"]},variant:{name:"Variant",control:{type:"radio"},options:["default","header","expanded"]},alignment:{name:"Alineació",control:{type:"radio"},options:["left","center","right"]},state:{name:"Variant",control:{type:"select"},options:["default","hover","highlight"]},showSort:{name:"Mostrar sort",control:{type:"boolean"},if:{arg:"variant",eq:"header"}},sortState:{name:"Sort State",control:{type:"radio"},options:["asc","desc","none"],if:{arg:"variant",eq:"header"}},showBorderLeft:{name:"Mostrar border left",control:{type:"boolean"}},showBorderRight:{name:"Mostrar border right",control:{type:"boolean"}},hasIndicator:{name:"Mostrar corner indicador",control:{type:"boolean"}},reverse:{name:"Invertit",control:{type:"boolean"}}},parameters:{layout:"centered"}},a={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=4099-39796&m=dev "}},args:{icon:"add_box",value:"Value",size:"sm",variant:"Default",alignment:"left",state:"default",showSort:!1,sortState:"none",showBorderLeft:!1,showBorderRight:!1,hasIndicator:!1,reverse:!1},render:e=>{const x=S=>{switch(S){case"sm":return 1;case"md":return 1;case"auto":return 2;case"expanded":return}};return s`
  ...
  decorators: [withStyle(wrapperStyle, 'xxxx-style')]
}`,...y.parameters?.docs?.source}}};const _=["Playground","ColumnHeader","Sizes","Content","HybridContent","SlotContent","Icon","Borders","Alignment","Indicator","HideDivider","Reverse","SlotMaxWidth","Expanded","Dividers","UseCases"],$=Object.freeze(Object.defineProperty({__proto__:null,Alignment:v,Borders:u,ColumnHeader:t,Content:d,Dividers:w,Expanded:h,HideDivider:b,HybridContent:n,Icon:c,Indicator:g,Playground:a,Reverse:p,Sizes:o,SlotContent:i,SlotMaxWidth:m,UseCases:y,__namedExportsOrder:_,default:f},Symbol.toStringTag,{value:"Module"}));export{v as A,u as B,t as C,w as D,h as E,n as H,c as I,a as P,p as R,$ as S,y as U,d as a,i as b,o as c,g as d,b as e,m as f};
