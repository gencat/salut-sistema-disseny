import{x as a}from"./iframe-Dh-Rqy1o.js";import{w as t}from"./storybook-decorators-DSS85Rnr.js";const r=`
 .datepicker-canvas {
    min-height: 350px;
    display: flex;
...
`,D={title:"Components/Angular/Datepicker Range",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md"]},labelStart:{name:"Label per a la data dinici"},labelEnd:{name:"Label per a la data fin"},iconRangeStart:{name:"Icona per a la data dinici"},iconRangeEnd:{name:"icona per a la data fin"},helpText:{name:"Message for initial help"},invalid:{name:"Mostrar error",control:{type:"boolean"}},showButtons:{name:"Mostrar botons",control:{type:"boolean"},if:{arg:"showTime",truthy:!1}},leftLabel:{name:"Botó esquerra"},rightLabel:{name:"Botó dreta"}},parameters:{layout:"centered"}},n={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=750-7973&m=dev"}},args:{size:"md",labelStart:"Data inici",labelEnd:"Data fi",iconRangeStart:"calendar_month",iconRangeEnd:"calendar_month",helpText:"Help text.",invalid:!1,showButtons:!1,leftLabel:"Cancel·lar",rightLabel:"Acceptar"},render:e=>a`
    ...
    `,decorators:[t(r,"datepicker-range-buttons-style")]},u={tags:["!dev"],render:()=>{const e=new Date,y=e.getFullYear(),b=e.getMonth(),k=JSON.stringify([{date:`4/${b+1}/${y}`,type:"green"},{date:`14/${b+1}/${y}`,type:"yellow"},{date:`27/${b+1}/${y}`,type:"red"}]);return a`
      <div class="datepicker-canvas">
        <dss-ng-datepicker-range inputsize="lg" helpText="Help text." customCalendar='${k}'>
  ...
  render: () => {
    ...
    return html\`
      <div class="datepicker-canvas">
        <dss-ng-datepicker-range inputsize="lg" helpText="Help text." customCalendar='\${customCalendar}'>
          <label slot="label-range-start" for="customCalendarRangeStart">Data inicial</label>
          <input slot="input-range-start" id="customCalendarRangeStart" type="text"  />
          <label slot="label-range-end" for="customCalendarEndStart">Data final</label>
          <input slot="input-range-end" id="customCalendarEndStart" type="text"  />
...
}`,...m.parameters?.docs?.source}}};const S=["Playground","SizeLG","SizeMD","SizeSM","Disabled","Readonly","Required","Invalid","Buttons","CustomCalendar","Validation"],f=Object.freeze(Object.defineProperty({__proto__:null,Buttons:g,CustomCalendar:u,Disabled:d,Invalid:c,Playground:n,Readonly:p,Required:o,SizeLG:l,SizeMD:i,SizeSM:s,Validation:m,__namedExportsOrder:S,default:D},Symbol.toStringTag,{value:"Module"}));export{g as B,u as C,d as D,c as I,n as P,p as R,f as S,m as V,l as a,i as b,s as c,o as d};
