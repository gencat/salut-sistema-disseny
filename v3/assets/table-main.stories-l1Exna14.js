import{x as a}from"./iframe-DIl293iJ.js";import{w as c}from"./storybook-decorators-DSS85Rnr.js";const m=`
  .table-wrapper {
        width: 750px;
        overflow: hidden;
    }
...
`,u={title:"Collections/Table/Main",argTypes:{enableGrid:{name:"Habilitar mode grid",control:{type:"boolean"}},scrollable:{name:"Habilitar scroll horitzontal",control:{type:"boolean"}},gridTemplateColumnsDefault:{name:"Definir grid-template-columns Default",control:{type:"text"},if:{arg:"scrollable",truthy:!1}},gridTemplateColumnsScroll:{name:"Definir grid-template-columns Scroll",control:{type:"text"},if:{arg:"scrollable",truthy:!0}},hasStickyColumnsLeft:{name:"Habilitar columnas sticky esquerra",control:{type:"boolean"},if:{arg:"scrollable",truthy:!0}},hasStickyColumnsRight:{name:"Habilitar columnas sticky dreta",control:{type:"boolean"},if:{arg:"scrollable",truthy:!0}},stickyColumnsCountLeft:{name:"Número de columnas sticky izquierda",control:{type:"number",min:1,max:2},if:{arg:"hasStickyColumnsLeft",truthy:!0}},stickyColumnsCountRight:{name:"Número de columnas sticky derecha",control:{type:"number",min:1,max:2},if:{arg:"hasStickyColumnsRight",truthy:!0}}},parameters:{layout:"centered"}},r={parameters:{design:{type:"figma",url:"https://www.figma.com/design/3IF7P2qsk4KAFtTzwxXp8J/Components---Design-System-HES-Salut?node-id=4099-39796&m=dev "}},args:{enableGrid:!1,scrollable:!1,gridTemplateColumnsDefault:"50px repeat(3, minmax(150px, 1fr)) 100px 50px",gridTemplateColumnsScroll:"50px repeat(3, 300px) 100px 50px",hasStickyColumnsLeft:!1,stickyColumnsCountLeft:2,hasStickyColumnsRight:!1,stickyColumnsCountRight:1},render:e=>{const s={gridTemplateColumns:e.scrollable?e.gridTemplateColumnsScroll:e.gridTemplateColumnsDefault,scrollable:e.scrollable,leftStickyColumns:e.hasStickyColumnsLeft?e.stickyColumnsCountLeft:0,rightStickyColumns:e.hasStickyColumnsRight?e.stickyColumnsCountRight:0};return a`
    ...
    `,d=(e,s=!1)=>Array.from({length:e},(g,p)=>{const t=p===e-1&&!s;return a`
                <dss-row>
            ...
            <div class="table-wrapper">
                <dss-table-main config=${JSON.stringify({gridTemplateColumns:"50px repeat(3, 1fr) 100px 50px"})}>
                    <dss-thead>
                        ${o(!1)}
                    </dss-thead>
                    <dss-tbody>
        ...
        `,decorators:[c(m,"table-main-auto-grid-style")]},n={tags:["!dev"],render:()=>a`
        <div class="grid-description">
                gridTemplateColumns:
                <span class="grid-description__css">50px repeat(3, minmax(250px, 1fr)) 150px 50px</span>
            </div>
            <div class="table-wrapper">
                <dss-table-main config=${JSON.stringify({gridTemplateColumns:"50px repeat(3, minmax(250px, 1fr)) 150px 50px",scrollable:!0})}>
                    <dss-thead>
                        ${o(!1)}
                    </dss-thead>
                    <dss-tbody>
        ...
        `,decorators:[c(m,"table-main-scrollable-grid-style")]},i={tags:["!dev"],render:()=>a`
            <div class="table-wrapper">
                <dss-table-main config=${JSON.stringify({gridTemplateColumns:"50px repeat(3, minmax(250px, 1fr)) 150px 50px",scrollable:!0,leftStickyColumns:2,rightStickyColumns:1})}>
                    <dss-thead>
                        ${o(!1)}
                    </dss-thead>
                    <dss-tbody>
        ...
        `,decorators:[c(m,"table-main-sticky-columns-style")]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    design: {
      type: 'figma',
...
}`,...i.parameters?.docs?.source}}};const b=["Playground","AutoGrid","ScrollableGrid","StickyColumns"],C=Object.freeze(Object.defineProperty({__proto__:null,AutoGrid:l,Playground:r,ScrollableGrid:n,StickyColumns:i,__namedExportsOrder:b,default:u},Symbol.toStringTag,{value:"Module"}));export{l as A,r as P,C as S,n as a,i as b};
