import{j as e,M as r,T as c,C as s}from"./blocks-BQe3t3mS.js";import{useMDXComponents as t}from"./index-D25yCQlW.js";import{S as o,P as l,B as d,T as u,a as x,N as m,b as p,U as h,c as j,M as f}from"./ng-input-action.stories-pQw_-VSU.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CdZ_4rdx.js";function a(i){const n={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
 .inputs-sizes {
    display: flex;
    gap: 16px;
    align-items: end;
...
`}),`
`,e.jsx(r,{of:o}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(c,{}),e.jsx("component-title",{children:"dss-ng-input-action"})]}),`
`,e.jsx("br",{}),`
...
<dss-ng-input-action icon="" inputsize="lg" maskRegex="/(\\d{4})(?=\\d)/g" maskReplace="$1 " >
...
<input ... maxLength={19} />
</dss-ng-input-action>

Custom Pattern example React:
<dss-ng-input-action maskRegex="/^(.{2})(.*)$/" maskReplace="$1-$2">
...
<input ... maxLength={6} />
</dss-ng-input-action>

"""
`})})]})}function R(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}export{R as default};
