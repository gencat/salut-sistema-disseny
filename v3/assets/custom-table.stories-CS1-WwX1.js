import{x as t}from"./iframe-DVq4slBB.js";import{w as a}from"./storybook-decorators-DSS85Rnr.js";const M=[{column:"name",label:"Nom",sortType:"string"},{column:"age",label:"Edat",sortType:"number",align:"right"},{column:"badge",label:"Estat",align:"center"},{column:"result",label:"Resultat",align:"center"},{column:"review",label:"Revisat",align:"center"},{column:"actions",label:""}],R=[{column:"name",label:"Nom",sortType:"string",style:"width:200px;"},{column:"age",label:"Edat",sortType:"number",align:"right",style:"width:300px;"},{column:"badge",label:"Estat",align:"center",style:"width:300px;"},{column:"result",label:"Resultat",align:"center",style:"width:300px;"},{column:"review",label:"Revisat",align:"center",style:"width:300px;"},{column:"actions",label:"",style:"width:100px;"}],L=[{column:"name",label:"Nom",sortType:"string"},{column:"age",label:"Edat",sortType:"number",align:"right"},{column:"badge",label:"Estat",align:"center"},{column:"result",label:"Resultat",align:"center",highlight:!0},{column:"review",label:"Revisat",align:"center"},{column:"actions",label:""}],V=[{name:"John",age:22,badge:"text",result:120},{name:"William",age:43,badge:"text",result:44},{name:"Anna",age:12,badge:"text",result:22},{name:"Maria",age:87,badge:"text",result:83},{name:"Joe",age:66,badge:"text",result:180},{name:"Odette",age:55,badge:"text",result:120},{name:"Kimberley",age:16,badge:"text",result:44},{name:"Uta",age:56,badge:"text",result:22},{name:"Leila",age:71,badge:"text",result:83},{name:"Fitzgeral",age:32,badge:"text",result:180},{name:"Lea",age:22,badge:"text",result:120},{name:"Donita",age:43,badge:"text",result:44},{name:"Sonya",age:12,badge:"text",result:22},{name:"Thomas",age:87,badge:"text",result:83},{name:"Shayla",age:66,badge:"text",result:180},{name:"Marlene",age:55,badge:"text",result:120},{name:"Frederic",age:16,badge:"text",result:44},{name:"Jamie",age:56,badge:"text",result:22},{name:"Carmen",age:71,badge:"text",result:83},{name:"Joseph",age:32,badge:"text",result:180}],c=JSON.stringify(M),C=JSON.stringify(R),O=JSON.stringify(L),n=JSON.stringify(V),r=V.slice(0,4),e=`
  .table-wrapper {
    width: 900px;
    height: 600px;
  }
...
`,P={title:"Collections/Custom Table",argTypes:{},parameters:{layout:"centered"}},u={tags:["!dev"],args:{columnsHeader:c,mockedData:V,data:n},render:s=>t`
    ...
    `},v={tags:["!dev"],args:{columnsHeader:c,mockedData:V,data:n},render:s=>t`
      <div class="table-wrapper">
        <dss-custom-table 
          hideHeader 
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-row-style")]},o=(s,d,i,b=!1,l="left",J=!1,F=!1)=>t`
    <tr class="dss-tbody-row ${i!==""?`dss-tbody-row--${i}`:""} ${s?"dss-tbody-row--multiselect":""}">
      ...
      <td class="dss-td dss-td--font-bold">
        <div class="dss-td-content">
          ...
          `:""}
          ${b&&l==="left"?t`<dss-icon class="dss-td-content__icon" size="md" icon="person"></dss-icon>`:""}
          <span class="dss-td-content__value">${d.name} ${i??""}</span>
          ${b&&l==="right"?t`<dss-icon class="dss-td-content__icon" size="md" icon="person"></dss-icon>`:""}
        </div>
      </td>
      <td class="dss-td dss-td--align-right">
        <div class="dss-td-content">
          ${b&&l==="left"?t`<dss-icon class="dss-td-content__icon" size="md" icon="123"></dss-icon>`:""}
          <span class="dss-td-content__value">${d.age}</span>
          ${b&&l==="right"?t`<dss-icon class="dss-td-content__icon" size="md" icon="123"></dss-icon>`:""}
        </div>
      </td>
  ...
  `,m={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper">
        <dss-custom-table 
          multiselect 
          tableTitle="My custom table" 
    ...
    `,decorators:[a(e,"custom-table-alt-header-style")]},g={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper">
        <dss-custom-table 
          multiselect 
          tableTitle="My custom table" 
    ...
    `,decorators:[a(e,"custom-table-alt-header-style")]},p={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper">
        <dss-custom-table 
          multiselect 
          tableTitle="My custom table" 
    ...
    `,decorators:[a(e,"custom-table-alt-header-style")]},h={tags:["!dev"],args:{columnsHeader:C,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper">
      <dss-custom-table 
        tableTitle="My custom table" 
        filters='["Filter1","Filter2"]' 
    ...
    `,decorators:[a(e,"custom-table-horizontal-scroll-style")]},y={tags:["!dev"],args:{columnsHeader:C,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper">
      <dss-custom-table 
        multiselect 
        tableTitle="My custom table" 
    ...
    `,decorators:[a(e,"custom-table-sticky-style")]},_={tags:["!dev"],args:{columnsHeader:C,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper">
      <dss-custom-table 
        multiselect
    ...
    `,decorators:[a(e,"custom-table-sticky-lit-style")]},x={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:r},render:s=>t`
    ...
    `,decorators:[a(e,"custom-table-height-sm-style")]},z={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-height-auto-style")]},f={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-grid-style")]},w={tags:["!dev"],args:{columnsHeader:c,data:n,displayData:r},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-grid-no-divider-style")]},k={tags:["!dev"],args:{columnsHeader:c,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-custom-divider-style")]},S={tags:["!dev"],args:{columnsHeader:c,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-nested-rows-style")]},H={tags:["!dev"],args:{columnsHeader:O,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-highlight-style")]},D={tags:["!dev"],args:{columnsHeader:O,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-cell-hover-style")]},$={tags:["!dev"],args:{columnsHeader:c,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `,decorators:[a(e,"custom-table-cell-single-line-style")]},B={tags:["!dev"],args:{columnsHeader:c,data:n},render:s=>t`
      <div class="table-wrapper table-wrapper--sm">
        <dss-custom-table 
          hideHeader
          hidePaginator
    ...
    `},decorators:[a(e,"custom-table-custom-th-style")]},A=()=>{const s=[{label:"Element 1",value:"1"},{label:"Element 2",value:"2"},{label:"Element 3",value:"3"},{label:"Element 4",value:"4"}];return t`
...
}`,...T.parameters?.docs?.source}}};const E=["Playground","RowStyles","FiltersChips","FiltersSlot","FiltersCombined","HorizontalScroll","StickyColumnsCSS","StickyColumnsLIT","TableStylesHeightSM","TableStylesHeightAuto","TableStylesGrid","TableStylesGridNoDivider","TableStylesCustomDivider","TableStylesNestedRows","TableStylesHighlight","TableStylesCellHover","TableStylesCellSingleLine","TableStylesCornerAction","TableStylesCustomTh"],I=Object.freeze(Object.defineProperty({__proto__:null,FiltersChips:m,FiltersCombined:p,FiltersSlot:g,HorizontalScroll:h,Playground:u,RowStyles:v,StickyColumnsCSS:y,StickyColumnsLIT:_,TableStylesCellHover:D,TableStylesCellSingleLine:$,TableStylesCornerAction:B,TableStylesCustomDivider:k,TableStylesCustomTh:T,TableStylesGrid:f,TableStylesGridNoDivider:w,TableStylesHeightAuto:z,TableStylesHeightSM:x,TableStylesHighlight:H,TableStylesNestedRows:S,__namedExportsOrder:E,default:P},Symbol.toStringTag,{value:"Module"}));export{m as F,h as H,u as P,v as R,I as S,x as T,g as a,p as b,y as c,_ as d,z as e,f,w as g,k as h,S as i,H as j,D as k,$ as l,B as m,T as n};
