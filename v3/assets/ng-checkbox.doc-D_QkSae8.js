import{j as e,M as r,T as o,C as a}from"./blocks-DQomN2yo.js";import{useMDXComponents as l}from"./index-BHVMkkSS.js";import{S as t,P as c,N as d,T as x,L as m}from"./ng-checkbox.stories-BFgFDxLA.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DLVb3rJw.js";import"./storybook-decorators-DSS85Rnr.js";function i(s){const n={a:"a",blockquote:"blockquote",code:"code",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:t}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(o,{}),e.jsx("component-title",{children:"dss-ng-checkbox"})]}),`
`,e.jsx("br",{}),`
`,e.jsx("dss-alert",{fullWidth:!0,state:"warning",size:"md",message:"Aquest component es mantindrà només per a les iniciatives que continuïn utilitzant Angular Reactive Forms; en cas contrari, si us plau, feu servir el nou component dss-form-checkbox."}),`
`,e.jsxs(n.p,{children:["Veure nou component: ",e.jsx(n.a,{href:"/docs/components-form-checkbox--docs",children:e.jsx(n.strong,{children:"Form: Checkbox"})})]}),`
...
16px.`}),`
`,e.jsx(a,{of:m})]})}function g(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{g as default};
