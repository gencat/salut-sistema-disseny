import{x as a}from"./iframe-BJ1gb8kz.js";import{w as s}from"./storybook-decorators-DSS85Rnr.js";const r=`
  .css-1sqhzee {
        display:none
    }
...
`,x={title:"Components/Searchbar",argTypes:{multiple:{name:"Multiple",control:{type:"boolean"}},size:{name:"Size",control:{type:"radio"},options:["md","lg"]},icon:{name:"Icon",control:{type:"text"}},helpText:{name:"Help Text",control:{type:"text"}},threshold:{name:"Number of chars to enable predictive search",control:{type:"number"}},emptyDropdownText:{name:"No results Text",control:{type:"text"}},invalid:{name:"Invalid",control:{type:"boolean"}},readonly:{name:"Readonly",control:{type:"boolean"}},disabled:{name:"Disabled",control:{type:"boolean"}},recentSearches:{name:"Últimes cerques",control:{type:"boolean"}},recentSearchesText:{name:"Posición tooltip",control:{type:"text"},if:{arg:"recentSearches",truthy:!0}},isCatalogLoading:{name:"Simulate catalog loading",control:{type:"boolean"}},advancedFilter:{name:"Filtre avançat",control:{type:"boolean"}}},parameters:{layout:"centered"}},i={render:e=>{const t=[{value:"Diagnostics Inicial",icon:"person"},{value:"Diagnostics Crític",icon:"warning"},{value:"Diagnostics Neutral",icon:"sentiment_neutral"},{value:"Sense resultats",icon:"calculate"},{value:"Resultat 1",icon:"calculate"},{value:"Resultat Crític",icon:"warning"}];return a`
    ...
    `,decorators:[s(r,"searchbar-advanced-style")]};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: (args: any) => {
    const catalog = [{
...
}`,...w.parameters?.docs?.source}}};const T=["Playground","BasicUnique","BasicMultiple","PredictiveRecent","PredictiveCatalog","PredictiveCombined","PredictiveCustoms","Simple","Multiple","Size","Required","Disabled","ReadOnly","Predefined","LoadingCatalog","CustomStyle","AdvancedFilter"],I=Object.freeze(Object.defineProperty({__proto__:null,AdvancedFilter:w,BasicMultiple:o,BasicUnique:n,CustomStyle:D,Disabled:m,LoadingCatalog:y,Multiple:v,Playground:i,Predefined:S,PredictiveCatalog:l,PredictiveCombined:d,PredictiveCustoms:u,PredictiveRecent:c,ReadOnly:b,Required:h,Simple:p,Size:g,__namedExportsOrder:T,default:x},Symbol.toStringTag,{value:"Module"}));export{w as A,n as B,D as C,m as D,y as L,i as P,h as R,I as S,o as a,c as b,l as c,d,u as e,S as f,g,b as h};
