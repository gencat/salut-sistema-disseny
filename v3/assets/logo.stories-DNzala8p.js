import{x as r}from"./iframe-Dh-Rqy1o.js";const s={title:"Foundations/Logo",argTypes:{style:{name:"Estil",control:{type:"radio"},options:["default","negative","positive"]},width:{name:"Amplaria",control:{type:"text"}}},parameters:{layout:"centered"}},t={render:e=>r`<img
      style="width:${e.width};"
