import{j as e,M as i}from"./blocks-CfVR1a0K.js";import{useMDXComponents as r}from"./index-BMHellmX.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CqPuVMaj.js";function n(d){const s={blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...r(),...d.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Documentació/Changelog v3/Breaking changes/Esdeveniments renombrats"}),`
`,e.jsx(s.h2,{id:"migració-a-la-v3-canvi-de-nom-dels-esdeveniments",children:"Migració a la v3: Canvi de nom dels esdeveniments"}),`
`,e.jsx("br",{}),`
...
`,e.jsxs(s.table,{children:[e.jsx(s.thead,{children:e.jsxs(s.tr,{children:[e.jsx(s.th,{children:"Nom v2"}),e.jsx(s.th,{children:"Nom v3"})]})}),e.jsxs(s.tbody,{children:[e.jsxs(s.tr,{children:[e.jsx(s.td,{children:"onToggleAccordion"}),e.jsx(s.td,{children:"toggle"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:"onAccordionCheckboxChange"}),e.jsx(s.td,{children:"checkbox-changed"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:"onAccordionSecondaryAction"}),e.jsx(s.td,{children:"secondary-action"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:"onPrimaryAction"}),e.jsx(s.td,{children:"primary-action"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:"onWidgetNext"}),e.jsx(s.td,{children:"next"})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:"onWidgetClose"}),e.jsx(s.td,{children:"close"})]})]})]}),`
`,e.jsx("br",{}),`
...
`,e.jsx("br",{}),`
`,e.jsx(s.h3,{id:"dss-header-links",children:"dss-header-links"}),`
...
`,e.jsx("br",{}),`
`,e.jsx(s.h3,{id:"dss-tabs",children:"dss-tabs"}),`
