import{j as e,M as i,T as o,C as t}from"./blocks-BQe3t3mS.js";import{useMDXComponents as r}from"./index-D25yCQlW.js";import{S as c,P as l,a as d,M as u,L as h,b as p,c as m,d as x,e as j,f}from"./ng-input-switch.stories-B23d8bXA.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CdZ_4rdx.js";function a(s){const n={a:"a",blockquote:"blockquote",h3:"h3",p:"p",strong:"strong",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
...
`}),`
`,e.jsx(i,{of:c}),`
`,e.jsxs("div",{className:"dss-sb-title",children:[e.jsx(o,{}),e.jsx("component-title",{children:"dss-ng-input-switch"})]}),`
`,e.jsx("br",{}),`
...
`,e.jsx(t,{of:f}),`
`,e.jsx(n.p,{children:"Nota: en cas que s'utilitzi la propietat checked, el valor definit prevaldrà sobre l'atribut checked de l'input, per la qual cosa es recomana no barrejar ambdues opcions."})]})}function k(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{k as default};
