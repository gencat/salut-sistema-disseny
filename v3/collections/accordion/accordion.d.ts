...
export declare class Accordion extends LitElement {
    ...
    mainBadgeLabel: string | undefined;
    mainBadgeSize: string;
    mainBadgeIcon: string | undefined;
    mainBadgeStatus: string;
    mainBadgeOutlined: boolean;
    mainBadgeHideIcon: boolean;
