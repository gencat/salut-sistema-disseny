import{ae as e,af as d,ag as l,ah as i,ai as o}from"./index-CPQky8E4.js";import{u as r}from"./index-CFBmBEPl.js";import{S as a,P as c,B as h,I as x,a as j,b as p,c as m,d as u}from"./popover.stories-D7t51FD3.js";import"./iframe-B3b_zykC.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-html-B2eaWknC.js";function t(s){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",h2:"h2",h3:"h3",h4:"h4",h5:"h5",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
...
`]}),`
`,e.jsx(n.h5,{id:"mostrar-el-popover",children:"Mostrar el popover"}),`
`,e.jsx(n.p,{children:"Per mostrar el component hi ha dues opcions:"}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:[e.jsxs(n.strong,{children:["Utilitzant la propietat ",e.jsx(n.code,{children:"open"})]}),", de manera que en fer clic en algun element de la web modifiquem el valor de la propietat a true i així aparegui el component. Amb aquesta opció hauríem d'utilitzar la icona de tancar per tornar a ocultar el component."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Utilitzant CSS"}),", de manera que manualment assignaríem ",e.jsx(n.code,{children:"display:none"})," al selector ",e.jsx(n.code,{children:"dss-popover"})," i, en fer hover sobre algun element, el popover passaria a ",e.jsx(n.code,{children:"display:block"}),". Per a aquesta opció, cal tenir definida la propietat open sempre a true per defecte, i es recomana ocultar el botó de tancar amb ",e.jsx(n.code,{children:"hideCloseIcon"}),", ja que estem gestionant la visibilitat amb CSS."]}),`
`]}),`
`,e.jsx("br",{}),`
`,e.jsx(n.h4,{id:"changelog",children:"Changelog"}),`
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Versió"}),e.jsx(n.th,{children:"Canvis"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.strong,{children:"2.0.0"})}),e.jsx(n.td,{children:"Refactor v2."})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.strong,{children:"1.11.0"})}),e.jsx(n.td,{children:"Nou web component."})]})]})]})]})}function M(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{M as default};
