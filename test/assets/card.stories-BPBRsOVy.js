            ...
            ${t.showForm?s`
              <dss-card-form slot="form">
                <dss-input icon="person">
                  ...
                  <input slot="input" id="input4" class="dss-input" type="text" readonly="true" value="Exemple readonly" readonly/>
                </dss-input>
              </dss-card-form>
            `:null}
            ${t.showImage?s`
...
`,e=s`
 <dss-card-form slot="form">
    <dss-input icon="person">
      ...
      <input slot="input" id="cardInput" class="dss-input" type="text" readonly="true" value="Exemple readonly" readonly/>
    </dss-input>
  </dss-card-form>
`,a=s`
