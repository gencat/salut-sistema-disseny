import{g as getCustomElementSuffix,i,s,u}from"./custom-element-scope-KJWplpvx.js";import{r as r$1,a as r$2,i as i$1}from"./lit-element-vV9fql9z.js";import{x,E,B}from"./lit-html-paDGiEfB.js";import{n as n$1}from"./property-CzN8u98o.js";import{r as resetStyles}from"./reset.style-B0CQ8619.js";import{i as iconStyles}from"./icon.style-DPTab5RN.js";import{e}from"./class-map-2iHk_WiG.js";import{d as decorativeIconStyles,A as Accordion}from"./accordion-D8Cicuuk.js";import{b as booleanType,s as selectedType}from"./property-types-CkH-zh1n.js";import{c as createPopper,A as ActionMenu}from"./action-menu-i5ox-tYM.js";import{A as Alert}from"./alert-DctZgQKX.js";import{A as Avatar}from"./avatar-Bb5T61dP.js";import{b as badgeStates,B as Badge}from"./badge-yWdXoMyt.js";import{B as ButtonLink}from"./button-link-AVTPQ2S6.js";import{B as Button}from"./button-DbpOJUcP.js";import{b as buttonStyles}from"./button.style-2dqsCQot.js";import{s as scrollbarStyles,o,i as inputStyles,D as Datepicker_}from"./datepicker-Bsbzzuym.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function r(l){return n$1({...l,state:!0,attribute:!1})}function registerCustomElement(l,t){const a=getCustomElementSuffix(),c=`${l}${a}`;customElements.define(c,t)}const template$k=l=>x`

  ${l.fontLoaded?x`
      <i
        class=${e({"dss-icon":!0,[`dss-icon--${l.size}`]:!!l.size})}
        aria-hidden="true"
        translate="no"
      >
        ${l.icon}
    ...
    `:x`
      <span
        class=${e({"dss-icon-ghost":!0,[`dss-icon-ghost--${l.size}`]:!!l.size})}>
      </span>
    `}
`;var __defProp$Y=Object.defineProperty,__decorateClass$Y=(l,t,a,c)=>{for(var d=void 0,h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$Y(t,a,d),d};class Icon extends r$1{constructor(){super(...arguments),this.size="md",this.icon="",this.fontLoaded=!1}static get styles(){return[r$2(resetStyles),r$2(iconStyles)]}firstUpdated(){document.fonts.load('1em "Material Symbols Rounded"').then(()=>{this.fontLoaded=!0,console.log("Font loaded")})}render(){return template$k(this)}}__decorateClass$Y([n$1({type:String})],Icon.prototype,"size");__decorateClass$Y([n$1({type:String})],Icon.prototype,"icon");__decorateClass$Y([r()],Icon.prototype,"fontLoaded");const styles$h=".dss-action-menu-item{display:flex;align-items:center;padding:var(--dss-spacing-sm) var(--dss-spacing-md);gap:var(--dss-spacing-xs);background-color:var(--color-white);transition:all .3s ease-in-out;color:var(--color-neutral-900);cursor:pointer}.dss-action-menu-item:focus-visible{outline:none;box-shadow:inset 0 0 0 var(--dss-border-width-lg) var(--color-blue-200)}.dss-action-menu-item:not(.dss-action-menu-item--disabled):hover{background-color:var(--color-primary-100)}.dss-action-menu-item:not(.dss-action-menu-item--disabled):active,.dss-action-menu-item:not(.dss-action-menu-item--disabled).dss-action-menu-item--selected{background-color:var(--color-primary-50)}.dss-action-menu-item.dss-action-menu-item--first{border-top-left-radius:var(--dss-radius-sm);border-top-right-radius:var(--dss-radius-sm)}.dss-action-menu-item.dss-action-menu-item--last{border-bottom-left-radius:var(--dss-radius-sm);border-bottom-right-radius:var(--dss-radius-sm)}.dss-action-menu-item .dss-icon{color:var(--color-neutral-900)}.dss-action-menu-item--error:not(.dss-action-menu-item--disabled){color:var(--color-red-500)}.dss-action-menu-item--error:not(.dss-action-menu-item--disabled):hover{background-color:var(--color-red-50)}.dss-action-menu-item--error:not(.dss-action-menu-item--disabled):active{background-color:var(--color-red-100)}.dss-action-menu-item--error:not(.dss-action-menu-item--disabled).dss-action-menu-item--selected{background-color:var(--color-primary-50)}.dss-action-menu-item--error:not(.dss-action-menu-item--disabled) .dss-action-menu-item-label,.dss-action-menu-item--error:not(.dss-action-menu-item--disabled) .dss-icon{color:var(--color-red-500)}.dss-action-menu-item-label{flex:1;font-size:16px;line-height:24px;font-weight:var(--font-regular);color:var(--color-neutral-900);min-width:92px}.dss-action-menu-item--disabled{color:var(--color-neutral-500);cursor:not-allowed}.dss-action-menu-item--disabled .dss-action-menu-item-label{color:var(--color-neutral-500)}",dssIcon$3=i`dss-icon${s(getCustomElementSuffix())}`,dssIconButton$2=i`dss-icon-button${s(getCustomElementSuffix())}`,dssNotificationBadge$1=i`dss-notification-badge${s(getCustomElementSuffix())}`,actionMenuItemTemplate=l=>u`
  <li
    class=${e({"dss-action-menu-item":!0,"dss-action-menu-item--selected":!!l._selected,"dss-action-menu-item--disabled":!!l._disabled,"dss-action-menu-item--first":!!l._first,"dss-action-menu-item--last":!!l._last,[`dss-action-menu-item--${l._state}`]:!!l._state})}
    tabindex="${l._disabled?-1:0}"
    @click=${l._handleItemClick}
    @keydown=${l._handleKeydown}
  >
    ${l._leftIcon?u`<${dssIcon$3} size="md" icon="${l._leftIcon}"></${dssIcon$3}>`:null}
    <span class="dss-action-menu-item-label">${l._label}</span>
    ${!l._selected&&l._notifications>0?u`
          <${dssNotificationBadge$1}
            state="${l._notificationsState}"
            value="${l._notifications}"
          ></${dssNotificationBadge$1}>
        `:null}
    ${l._rightIcon?u`<${dssIcon$3} size="md" icon="${l._rightIcon}"></${dssIcon$3}>`:null}
    ${l._actionIcon?u`
          <${dssIconButton$2}
            icon="${l._actionIcon}"
            type="${l._actionState}"
      ...
      >
        <div class="calendar__content">
          <header class="calendar__header">
            ...
            <div class="calendar__header-item calendar__header-buttons">
              <button
                ...
                @click=${l._prev}
                ?disabled=${l._currMonth===((t=l._minDate)==null?void 0:t.getMonth())&&l._currYear===((a=l._minDate)==null?void 0:a.getFullYear())}
              >
              ...
              <button
                ...
                class="dss-icon-button dss-icon-button--primary dss-icon-button--lg"
                @click=${l._next}
                ?disabled=${l._currMonth===((c=l._maxDate)==null?void 0:c.getMonth())&&l._currYear===((d=l._maxDate)==null?void 0:d.getFullYear())}
              >
          ...
          <div class="calendar__days-content">
            ...
            >
              ${l._days.map(h=>{const p={"calendar__day-item--active":l._isToday(h),"calendar__day-item--weekend":l._isWeekend(h),"calendar__day-item--selected":l._isSelected(h),"calendar__day-item--range":l._isBetweenRange(h)||l._isBetweenRangeOnMouseOver(h),"calendar__day-item--selected-range-start":l._isSelectedRangeStart(h),"calendar__day-item--selected-range-end":l._isSelectedRangeEnd(h)||l._isOverRangeDate(h),"calendar__day-item--range-enabled":l._range};return u`
                  <button
                    class="calendar__day-item ${e(p)}"
                    @click=${()=>l._selectDate(h)}
                    @mouseover=${()=>l._selectRangeOverDate(h)}
                    @focus=${()=>l._selectRangeOverDate(h)}
                    ?disabled=${l._isInactive(h)}
                  >
                    ${h||null}
                  </button>
                `})}
...
`};var __defProp$W=Object.defineProperty,__getOwnPropDesc$T=Object.getOwnPropertyDescriptor,__decorateClass$W=(l,t,a,c)=>{for(var d=__getOwnPropDesc$T(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$W(t,a,d),d};const MONTH=["Gener","Febrer","Març","Abril","Maig","Juny","Juliol","Agost","Setembre","Octubre","Novembre","Desembre"],WEEK=["dl","dm","dc","dj","dv","ds","dg"];class Calendar extends r$1{constructor(){super(),this._range=!1,this._isRangeStartFocused=!1,this._isRangeEndFocused=!1,this._rangeStartDate=null,this._rangeEndDate=null,this._rangeOverDate=null,this._timepicker="",this._minutesRange=1,this._minHour=0,this._maxHour=24,this._customTimeListOptions=[],this._timepickerLabel="",this._date=new Date,this._currYear=this._date.getFullYear(),this._currMonth=this._date.getMonth(),this._currHour=void 0,this._currMin=void 0,this._days=this._getDays(),this._selectedDate=null,this._showTime=!1,this._showButtons=!0,this._leftLabel="Cancel·lar",this._rightLabel="Seleccionar",this._minDate=null,this._maxDate=null,this._timepickerValue="",this._showMonthSelector=!1,this._showYearSelector=!1,this._yearsRangeStart=new Date().getFullYear()-18,this._yearsRangeEnd=new Date().getFullYear()+1,this._isTimeFormatValid=!1,this._focusFirstElementHandler=this._focusFirstElement.bind(this)}static get styles(){return[r$2(iconStyles),r$2(buttonStyles),r$2(iconButtonStyles),r$2(styles$g)]}set range(t){const a=this._range;this._range=t,this.requestUpdate("range",a)}set isRangeStartFocused(t){const a=this._isRangeStartFocused;this._isRangeStartFocused=t,this.requestUpdate("isRangeStartFocused",a)}set isRangeEndFocused(t){const a=this._isRangeEndFocused;this._isRangeEndFocused=t,this.requestUpdate("isRangeStartFocused",a)}set selectedDate(t){const a=this._selectedDate;this._selectedDate=this._getDateString(t),this._updateCurrentDate(),this.requestUpdate("selectedDate",a)}set minDate(t){const a=this._minDate;this._minDate=this._getDateString(t),this.requestUpdate("minDate",a)}set maxDate(t){const a=this._maxDate;this._maxDate=this._getDateString(t),this.requestUpdate("maxDate",a)}set showTime(t){const a=this._showTime;this._showTime=t,this.requestUpdate("showTime",a)}set showButtons(t){const a=this._showButtons;this._showButtons=t,this.requestUpdate("showButtons",a)}set leftLabel(t){const a=this._leftLabel;this._leftLabel=t,this.requestUpdate("leftLabel",a)}set rightLabel(t){const a=this._rightLabel;this._rightLabel=t,this.requestUpdate("rightLabel",a)}set timepicker(t){const a=this._timepicker;this._timepicker=t,this.requestUpdate("timepicker",a)}set minutesRange(t){const a=this._minutesRange;this._minutesRange=t,this.requestUpdate("minutesRange",a)}set minHour(t){const a=this._minHour;this._minHour=t,this.requestUpdate("minHour",a)}set maxHour(t){const a=this._maxHour;this._maxHour=t,this.requestUpdate("maxHour",a)}set customTimeListOptions(t){const a=this._customTimeListOptions;this._customTimeListOptions=t,this.requestUpdate("customTimeListOptions",a)}set timepickerLabel(t){const a=this._timepickerLabel;this._timepickerLabel=t,this.requestUpdate("timepickerLabel",a)}set rangeStartDate(t){const a=this._rangeStartDate;this._rangeStartDate=this._getDateString(t),this.requestUpdate("rangeStartDate",a)}set rangeEndDate(t){const a=this._rangeEndDate;this._rangeEndDate=this._getDateString(t),this.requestUpdate("rangeEndDate",a)}connectedCallback(){super.connectedCallback(),this._range&&window.addEventListener("range-focus-calendar",this._focusFirstElementHandler)}disconnectedCallback(){super.disconnectedCallback(),this._range&&window.removeEventListener("range-focus-calendar",this._focusFirstElementHandler)}_focusFirstElement(){var a;const t=(a=this.shadowRoot)==null?void 0:a.querySelector("#firstCalendarElement");t==null||t.focus()}_prev(){this._currMonth-=1,this._update()}_next(){this._currMonth+=1,this._update()}_update(){(this._currMonth<0||this._currMonth>11)&&(this._date=new Date(this._currYear,this._currMonth,new Date().getDate()),this._currYear=this._date.getFullYear(),this._currMonth=this._date.getMonth()),this._days=this._getDays(),this.requestUpdate()}_getDays(){const t=[],a=startOfMonth(new Date(this._currYear,this._currMonth)),c=endOfMonth(new Date(this._currYear,this._currMonth)),d=eachDayOfInterval({start:a,end:c}),h=getDay(a);for(let p=h===0?6:h-1;p>0;p-=1)t.push(0);for(const p of d)t.push(p.getDate());return t}_isToday(t){const a=new Date;return t===a.getDate()&&this._currMonth===a.getMonth()&&this._currYear===a.getFullYear()}_isWeekend(t){const a=new Date(this._currYear,this._currMonth,t);return a.getDay()===0||a.getDay()===6}_isInactive(t){const a=new Date(this._currYear,this._currMonth,t);return t?this._minDate&&this._maxDate?!(a>=this._minDate&&a<=this._maxDate):this._minDate?!(a>=this._minDate):this._maxDate?!(a<=this._maxDate):!1:!0}_isSelected(t){var a,c,d,h,p,b;return this._range?t===((a=this._rangeStartDate)==null?void 0:a.getDate())&&this._currMonth===((c=this._rangeStartDate)==null?void 0:c.getMonth())&&this._currYear===((d=this._rangeStartDate)==null?void 0:d.getFullYear())||this._isSelectedRangeEnd(t):t===((h=this._selectedDate)==null?void 0:h.getDate())&&this._currMonth===((p=this._selectedDate)==null?void 0:p.getMonth())&&this._currYear===((b=this._selectedDate)==null?void 0:b.getFullYear())}_isSelectedRangeStart(t){var a,c,d,h,p,b,g,f;return this._range&&this._rangeStartDate&&this._rangeEndDate?!this._compareSelectedRangeDates()&&t===((a=this._rangeStartDate)==null?void 0:a.getDate())&&this._currMonth===((c=this._rangeStartDate)==null?void 0:c.getMonth())&&this._currYear===((d=this._rangeStartDate)==null?void 0:d.getFullYear()):this._range&&this._rangeStartDate&&!this._rangeEndDate?this._rangeOverDate!==null&&((h=this._rangeStartDate)==null?void 0:h.getTime())<((p=this._rangeOverDate)==null?void 0:p.getTime())&&t===((b=this._rangeStartDate)==null?void 0:b.getDate())&&this._currMonth===((g=this._rangeStartDate)==null?void 0:g.getMonth())&&this._currYear===((f=this._rangeStartDate)==null?void 0:f.getFullYear())&&(!this._isRangeStartFocused||this._showButtons)&&(this._isRangeEndFocused||this._rangeStartDate!==null):(this._range&&this._rangeStartDate===this._rangeEndDate,!1)}_isSelectedRangeEnd(t){var a,c,d;return!this._compareSelectedRangeDates()&&t===((a=this._rangeEndDate)==null?void 0:a.getDate())&&this._currMonth===((c=this._rangeEndDate)==null?void 0:c.getMonth())&&this._currYear===((d=this._rangeEndDate)==null?void 0:d.getFullYear())}_isOverRangeDate(t){var c,d,h;const a=t===((c=this._rangeOverDate)==null?void 0:c.getDate())&&this._currMonth===((d=this._rangeOverDate)==null?void 0:d.getMonth())&&this._currYear===((h=this._rangeOverDate)==null?void 0:h.getFullYear());return this._range&&this._rangeOverDate&&this._rangeStartDate&&!this._rangeEndDate?a&&this._rangeOverDate.getTime()>this._rangeStartDate.getTime()&&(!this._isRangeStartFocused||this._showButtons)&&(this._isRangeEndFocused||this._rangeStartDate!==null):!1}_compareSelectedRangeDates(){return this._rangeStartDate&&this._rangeEndDate?this._rangeStartDate.getFullYear()===this._rangeEndDate.getFullYear()&&this._rangeStartDate.getMonth()===this._rangeEndDate.getMonth()&&this._rangeStartDate.getDate()===this._rangeEndDate.getDate():!0}_isBetweenRange(t){const a=new Date(this._currYear,this._currMonth,t);return!this._isInactive(t)&&this._rangeStartDate&&this._rangeEndDate?a.getTime()>this._rangeStartDate.getTime()&&a.getTime()<this._rangeEndDate.getTime():!1}_isBetweenRangeOnMouseOver(t){const a=new Date(this._currYear,this._currMonth,t),c=this._isInactive(t);return!c&&this._rangeStartDate&&!this._rangeEndDate&&this._rangeOverDate?a.getTime()>this._rangeStartDate.getTime()&&a.getTime()<this._rangeOverDate.getTime()&&(!this._isRangeStartFocused||this._showButtons)&&(this._isRangeEndFocused||this._rangeStartDate!==null):!c&&this._rangeStartDate&&this._rangeEndDate&&this._rangeOverDate?a.getTime()>this._rangeStartDate.getTime()&&a.getTime()<this._rangeEndDate.getTime()&&a.getTime()<this._rangeOverDate.getTime()&&(!this._isRangeStartFocused||this._showButtons)&&(this._isRangeEndFocused||this._rangeStartDate!==null):!1}_selectDate(t){this._selectedDate=new Date(this._currYear,this._currMonth,t),this._range&&!this._showButtons&&(this._rangeStartDate&&this._rangeEndDate&&!this._isRangeEndFocused&&this._selectedDate.getTime()>=this._rangeEndDate.getTime()&&(this._rangeStartDate=null,this._rangeEndDate=null),this._isRangeStartFocused||!this._rangeStartDate||this._rangeStartDate.getTime()>this._selectedDate.getTime()?this._rangeStartDate=this._selectedDate:this._rangeEndDate=this._selectedDate),this._range&&this._showButtons&&(this._rangeStartDate&&this._rangeEndDate&&(this._rangeStartDate=null,this._rangeEndDate=null),!this._rangeStartDate||this._rangeStartDate.getTime()>this._selectedDate.getTime()?this._rangeStartDate=this._selectedDate:this._rangeEndDate=this._selectedDate),this.requestUpdate(),!this._showButtons&&(this._range?this._emitRange():this._emitDate())}_selectRangeOverDate(t){this._range&&(this._rangeOverDate=new Date(this._currYear,this._currMonth,t),this.requestUpdate())}_removeRangeOverDate(){this._rangeOverDate=null,this.requestUpdate()}_onCancel(){const t=new CustomEvent("onCancel",{bubbles:!0,composed:!0});this.dispatchEvent(t)}_onAccept(){this._range?this._emitRange():this._emitDate()}_emitDate(){var h,p,b,g;const t=(p=(h=this._selectedDate)==null?void 0:h.getDate())==null?void 0:p.toString().padStart(2,"0"),a=(this._currMonth+1).toString().padStart(2,"0");let c=`${t}/${a}/${this._currYear}`;if(this._showTime){const f=(b=this._currHour)==null?void 0:b.toString().padStart(2,"0"),$=(g=this._currMin)==null?void 0:g.toString().padStart(2,"0");c+=` ${f}:${$}`}const d=new CustomEvent("onDateChange",{detail:c,bubbles:!0,composed:!0});this.dispatchEvent(d)}_emitRange(){var d,h,p,b,g,f,$,v,m,y,k,w;let t=null;if((d=this._rangeStartDate)!=null&&d.getDate()&&((h=this._rangeStartDate)!=null&&h.getMonth())&&((p=this._rangeStartDate)!=null&&p.getFullYear())){const _=(b=this._rangeStartDate.getDate())==null?void 0:b.toString().padStart(2,"0"),S=(((g=this._rangeStartDate)==null?void 0:g.getMonth())+1).toString().padStart(2,"0");t=`${_}/${S}/${(f=this._rangeStartDate)==null?void 0:f.getFullYear()}`}let a=null;if(($=this._rangeEndDate)!=null&&$.getDate()&&((v=this._rangeEndDate)!=null&&v.getMonth())&&((m=this._rangeEndDate)!=null&&m.getFullYear())){const _=(y=this._rangeEndDate.getDate())==null?void 0:y.toString().padStart(2,"0"),S=(((k=this._rangeEndDate)==null?void 0:k.getMonth())+1).toString().padStart(2,"0");a=`${_}/${S}/${(w=this._rangeEndDate)==null?void 0:w.getFullYear()}`}const c=new CustomEvent("onRangeChange",{detail:{rangeStart:t,rangeEnd:a},bubbles:!0,composed:!0});this.dispatchEvent(c)}_updateCurrentDate(){if(!this._selectedDate){this._currYear=this._date.getFullYear(),this._currMonth=this._date.getMonth();return}this._currMonth=this._selectedDate.getMonth(),this._currYear=this._selectedDate.getFullYear(),this._currHour=this._selectedDate.getHours(),this._currMin=this._selectedDate.getMinutes(),this._days=this._getDays(),this._currHour>=10?this._timepickerValue=`${this._currHour}:`:this._timepickerValue=`0${this._currHour}:`,this._currMin>=10?this._timepickerValue+=this._currMin:this._timepickerValue+=`0${this._currMin}`}_getDateString(t){const a=t==null?void 0:t.replace(/(\d+[/])(\d+[/])/,"$2$1"),c=this._showTime?14:8;return(a==null?void 0:a.length)>c?new Date(a):null}_onSelectTime(t){if(this._isTimeFormatValid=!1,t.detail.status==="VALID"){this._isTimeFormatValid=!0;const a=t.detail.value;this._currHour=+a.substring(0,2),this._currMin=+a.substring(3,5)}this.requestUpdate()}_toggleMonthSelector(){this._showMonthSelector=!0,this.requestUpdate()}_onMonthSelectorClick(t){const a=MONTH.indexOf(t);this._currMonth=a,this._update(),this._showMonthSelector=!1,this.requestUpdate()}_toggleYearSelector(){this._showYearSelector=!0,this.requestUpdate()}_onYearSelectorClick(t){this._currYear=t,this._update(),this._showYearSelector=!1,this.requestUpdate()}_generateYearsRangeOptions(){const t=[];for(let c=this._yearsRangeStart;c<=this._yearsRangeEnd;c+=1)t.push(c);return t.map(c=>{const d=v=>{v&&v.focus()},h=v=>{let m=0;const y=this.renderRoot.querySelectorAll(".calendar-selector-options__item--year"),k=y.length-1;v===y[0]?d(y[k]):(y.forEach((w,_)=>{w===v&&(m=_)}),d(y[m-1]))},p=v=>{let m=0;const y=this.renderRoot.querySelectorAll(".calendar-selector-options__item--year"),k=y.length-1;v===y[k]?d(y[0]):(y.forEach((w,_)=>{w===v&&(m=_)}),d(y[m+1]))},b=v=>{const m=v.currentTarget,y=v;let k=!1;switch(y.key){case"ArrowUp":case"ArrowLeft":h(m),k=!0;break;case"ArrowDown":case"ArrowRight":p(m),k=!0;break;case"Enter":const w=v.target,_=this.renderRoot.querySelector('.calendar-selector-options__item--year[tabindex="0"]');_==null||_.setAttribute("tabindex","-1"),v.target.setAttribute("tabindex","0"),w.click(),k=!0;break;case"Escape":this.renderRoot.querySelector(".calendar-selector-options__item--selected").click(),k=!0;break}k&&(v.stopPropagation(),v.preventDefault())},f=new Date().getFullYear(),$={"calendar-selector-options__item--current":c===f,"calendar-selector-options__item--selected":c===this._currYear};return u`
      ...
      `})}_generateMonthsOptions(){return MONTH.map(a=>{const c=$=>{$&&$.focus()},d=$=>{let v=0;const m=this.renderRoot.querySelectorAll(".calendar-selector-options__item--month"),y=m.length-1;$===m[0]?c(m[y]):(m.forEach((k,w)=>{k===$&&(v=w)}),c(m[v-1]))},h=$=>{let v=0;const m=this.renderRoot.querySelectorAll(".calendar-selector-options__item--month"),y=m.length-1;$===m[y]?c(m[0]):(m.forEach((k,w)=>{k===$&&(v=w)}),c(m[v+1]))},p=$=>{const v=$.currentTarget,m=$;let y=!1;switch(m.key){case"ArrowUp":case"ArrowLeft":d(v),y=!0;break;case"ArrowDown":case"ArrowRight":h(v),y=!0;break;case"Enter":const k=$.target,w=this.renderRoot.querySelector('.calendar-selector-options__item--month[tabindex="0"]');w==null||w.setAttribute("tabindex","-1"),$.target.setAttribute("tabindex","0"),k.click(),y=!0;break;case"Escape":this.renderRoot.querySelector(".calendar-selector-options__item--selected").click(),y=!0;break}y&&($.stopPropagation(),$.preventDefault())},g=new Date().getMonth(),f={"calendar-selector-options__item--current":MONTH.indexOf(a)===g,"calendar-selector-options__item--selected":MONTH.indexOf(a)===this._currMonth};return u`
        <div
          class="calendar-selector-options__item calendar-selector-options__item--month ${e(f)}"
...
`;var __defProp$U=Object.defineProperty,__decorateClass$U=(l,t,a,c)=>{for(var d=void 0,h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$U(t,a,d),d};class Chip extends r$1{constructor(){super(...arguments),this.size="lg",this.icon="",this.label="",this.hasDelete=!1,this.disabled=!1,this.selected=!1,this.disableSelect=!1,this._isLabelTruncated=!1}static get styles(){return[r$2(resetStyles),r$2(chipStyles)]}handleToggle(){this.disableSelect||this.disabled||(this.selected=!this.selected,this.dispatchEvent(new CustomEvent("onToggle",{detail:{text:this.label,selected:this.selected}})))}handleDelete(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("onDelete",{detail:{text:this.label}}))}async firstUpdated(){var a;await this.updateComplete;const t=(a=this.shadowRoot)==null?void 0:a.querySelector(".dss-chip__label");t&&(this._isLabelTruncated=t.scrollWidth>t.offsetWidth,this._isLabelTruncated&&this.requestUpdate())}render(){return template$h(this)}}__decorateClass$U([n$1({type:String})],Chip.prototype,"size");__decorateClass$U([n$1({type:String})],Chip.prototype,"icon");__decorateClass$U([n$1({type:String})],Chip.prototype,"label");__decorateClass$U([n$1(booleanType)],Chip.prototype,"hasDelete");__decorateClass$U([n$1(booleanType)],Chip.prototype,"disabled");__decorateClass$U([n$1(booleanType)],Chip.prototype,"selected");__decorateClass$U([n$1(booleanType)],Chip.prototype,"disableSelect");function moveFocusToTarget(l){l&&l.focus()}function moveFocusToPreviousTarget(l,t,a){let c=0;const d=l.querySelectorAll(a),h=d.length-1;t===d[0]?moveFocusToTarget(d[h]):(d.forEach((p,b)=>{p===t&&(c=b)}),moveFocusToTarget(d[c-1]))}function moveFocusToNextTarget(l,t,a){let c=0;const d=l.querySelectorAll(a),h=d.length-1;t===d[h]?moveFocusToTarget(d[0]):(d.forEach((p,b)=>{p===t&&(c=b)}),moveFocusToTarget(d[c+1]))}function onKeyboardEnter(l,t,a){const c=l.querySelector(`${a}[tabindex="0"]`);c==null||c.setAttribute("tabindex","-1"),t.setAttribute("tabindex","0"),t.click()}function compareNumbers(l,t,a){return l||(l=0),t||(t=0),a==="asc"?l-t:t-l}function compareDates(l,t,a){return l||(l=new Date("1900-01-01")),t||(t=new Date("1900-01-01")),a==="asc"?l.getTime()-t.getTime():t.getTime()-l.getTime()}function compareStrings(l,t,a){return l||(l=""),t||(t=""),a==="asc"?l.localeCompare(t):t.localeCompare(l)}function sort(l,t,a="asc",c){return[...l].sort((d,h)=>{switch(c){case"number":return compareNumbers(d[t],h[t],a);case"date":return compareDates(new Date(d[t]),new Date(h[t]),a);case"string":return compareStrings(d[t],h[t],a);default:return 0}})}const checkboxStyles='.dss-checkbox{border-radius:2px;width:20px!important;height:20px!important;overflow:hidden;-webkit-appearance:none;-moz-appearance:none;appearance:none;border:var(--dss-border-width-sm) solid var(--color-primary-500);position:relative;cursor:pointer;transition:.3s all linear;flex-shrink:0;margin:var(--dss-spacing-tiny)}.dss-checkbox:focus-visible:enabled{outline:var(--dss-border-width-lg) solid var(--color-blue-200)}.dss-checkbox.dss-checkbox--validate{border-color:var(--color-neutral-700)}.dss-checkbox:hover{border-color:var(--color-primary-600);transition:.3s all linear}.dss-checkbox:hover.dss-checkbox--validate{border-color:var(--color-neutral-800)}.dss-checkbox:active{border-color:var(--color-primary-400);transition:.3s all linear}.dss-checkbox:active.dss-checkbox--validate{border-color:var(--color-neutral-500)}.dss-checkbox:checked{background-color:var(--color-primary-500)}.dss-checkbox:checked.dss-checkbox--validate{border-color:var(--color-green-500);background-color:var(--color-green-500)}.dss-checkbox:checked:before{font-family:var(--font-icons);content:"check";position:absolute;font-size:22px;color:var(--color-white);text-align:center;top:-4px;left:-2px}.dss-checkbox:checked:hover{border-color:var(--color-primary-600);background-color:var(--color-primary-600);transition:.3s all linear}.dss-checkbox:checked:hover.dss-checkbox--validate{border-color:var(--color-green-600);background-color:var(--color-green-600)}.dss-checkbox:checked:active{background-color:var(--color-primary-400);transition:.3s all linear}.dss-checkbox:checked:active.dss-checkbox--validate{border-color:var(--color-green-400);background-color:var(--color-green-400)}.dss-checkbox:indeterminate{background-color:var(--color-primary-500)}.dss-checkbox:indeterminate:before{font-family:var(--font-icons);font-size:18px;content:"remove";color:var(--color-white);position:absolute;top:-1px}.dss-checkbox:indeterminate.dss-checkbox--validate{background-color:var(--color-green-500)}.dss-checkbox:disabled{cursor:not-allowed;color:var(--color-neutral-900);border-color:var(--color-neutral-400)}.dss-checkbox:disabled:checked{background-color:var(--color-neutral-300)}.dss-checkbox:disabled:checked:before{color:var(--color-neutral-900)}.dss-checkbox.dss-checkbox--validate:disabled:checked:hover{background-color:var(--color-neutral-300)}.dss-checkbox-label{cursor:pointer}',customTableStyles=":host{display:block;width:100%;height:100%}.dss-custom-table{display:flex;flex-direction:column;height:100%;width:100%;overflow:hidden}.dss-custom-table-header,.dss-custom-table-footer{flex:0 1 auto}.dss-custom-table-body{flex:1 1 auto;overflow:auto;position:relative}.table-footer{display:flex;justify-content:space-between;align-items:center;gap:var(--dss-spacing-xs);padding:var(--dss-spacing-md);border-top:var(--dss-border-width-sm) solid var(--color-neutral-100);margin-top:var(--dss-spacing-md)}.table-footer-description{color:var(--color-neutral-900);font-size:16px;font-weight:var(--font-bold)}::slotted(.table-footer-actions){display:flex;justify-content:flex-end;align-items:center;gap:var(--dss-spacing-xs)}";var __defProp$T=Object.defineProperty,__getOwnPropDesc$R=Object.getOwnPropertyDescriptor,__decorateClass$T=(l,t,a,c)=>{for(var d=c>1?void 0:c?__getOwnPropDesc$R(t,a):t,h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=(c?p(t,a,d):p(d))||d);return c&&d&&__defProp$T(t,a,d),d};const dssTableHeader=i`dss-table-header${s(getCustomElementSuffix())}`,dssTablePaginator=i`dss-table-pagination${s(getCustomElementSuffix())}`;class CustomTable extends r$1{constructor(){super(...arguments),this.internalSelectedCounter=0,this._hideHeader=!1,this._hidePaginator=!1,this._columnsHeader=[],this._data=void 0,this._paginatedData=void 0,this._currentSortColumn="",this._currentSortType="string",this._currentSortOrder="none",this._multiselect=!1,this._radioselect=!1,this._allRowsSelected=!1,this._selectedRowsLabel="files seleccionades",this._isFirstUpdate=!0,this._shouldUpdate=!1,this._table=void 0,this._currentRowsChecked=0,this._selectedRowsCounter=void 0,this._tableTitle="",this._filters=[],this._innerFilters=!1,this._expandTable=!1,this._expandLabel="Ampliar",this._collapseLabel="Reduir",this._filtersLabel="Selecció",this._cleanFiltersLabel="Netejar filtres",this._noFiltersLabel="No hi ha filtres seleccionats",this._isTableHeaderCreated=!1,this._hideHeaderTitleAndExpand=!1,this._disableSorting=!1,this._isPaginationStarted=!1,this._totalResults=void 0,this._currentIndex=1,this._pageSize=10,this._pageSizeOptions=[5,10,20],this._resultstext="Resultats",this._rowsperpagetext="Files per pàgina",this._paginationState=void 0,this._pageSizeOptionsDisabled=!1,this._hidePaginationResults=!1,this._hideFooter=!1}static get styles(){return[r$2(iconStyles),r$2(scrollbarStyles),r$2(checkboxStyles),r$2(customTableStyles)]}set hideHeader(t){const a=this._hideHeader;this._hideHeader=t,this.requestUpdate("hideHeader",a)}set hidePaginator(t){const a=this._hidePaginator;this._hidePaginator=t,this.requestUpdate("hidePaginator",a)}set columnsHeader(t){const a=this._columnsHeader;this._columnsHeader=t,this.requestUpdate("columnsHeader",a)}set data(t){const a=this._data;this._data=t,this.requestUpdate("data",a)}set multiselect(t){const a=this._multiselect;this._multiselect=t,this.requestUpdate("multiselect",a)}set radioselect(t){const a=this._radioselect;this._radioselect=t,this.requestUpdate("radioselect",a)}set selectedRowsLabel(t){const a=this._selectedRowsLabel;this._selectedRowsLabel=t,this.requestUpdate("selectedRowsLabel",a)}set selectedRowsCounter(t){const a=this._selectedRowsCounter;this._selectedRowsCounter=t,this.requestUpdate("selectedRowsCounter",a)}set tableTitle(t){const a=this._tableTitle;this._tableTitle=t,this.requestUpdate("tableTitle",a)}set filters(t){const a=this._filters;this._filters=t,this.requestUpdate("filters",a)}set innerFilters(t){const a=this._innerFilters;this._innerFilters=t,this.requestUpdate("innerFilters",a)}set expandTable(t){const a=this._expandTable;this._expandTable=t,this.requestUpdate("expandTable",a)}set expandLabel(t){const a=this._expandLabel;this._expandLabel=t,this.requestUpdate("expandLabel",a)}set collapseLabel(t){const a=this._collapseLabel;this._collapseLabel=t,this.requestUpdate("collapseLabel",a)}set filtersLabel(t){const a=this._filtersLabel;this._filtersLabel=t,this.requestUpdate("filtersLabel",a)}set cleanFiltersLabel(t){const a=this._cleanFiltersLabel;this._cleanFiltersLabel=t,this.requestUpdate("cleanFiltersLabel",a)}set noFiltersLabel(t){const a=this._noFiltersLabel;this._noFiltersLabel=t,this.requestUpdate("noFiltersLabel",a)}set hideHeaderTitleAndExpand(t){const a=this._hideHeaderTitleAndExpand;this._hideHeaderTitleAndExpand=t,this.requestUpdate("hideHeaderTitleAndExpand",a)}set disableSorting(t){const a=this._disableSorting;this._disableSorting=t,this.requestUpdate("disableSorting",a)}set totalResults(t){const a=this._totalResults;this._totalResults=t,this.requestUpdate("totalResults",a)}set currentIndex(t){const a=this._currentIndex;this._currentIndex=t,this.requestUpdate("currentIndex",a)}set pageSize(t){const a=this._pageSize;this._pageSize=t,this.requestUpdate("pageSize",a)}set pageSizeOptions(t){const a=this._pageSizeOptions;this._pageSizeOptions=t,this.requestUpdate("pageSizeOptions",a)}set resultsLabel(t){const a=this._resultstext;this._resultstext=t,this.requestUpdate("resultsLabel",a)}set rowsPerPageLabel(t){const a=this._rowsperpagetext;this._rowsperpagetext=t,this.requestUpdate("rowsperpageLabel",a)}set hidePaginationResults(t){const a=this._hidePaginationResults;this._hidePaginationResults=t,this.requestUpdate("hidePaginationResults",a)}set pageSizeOptionsDisabled(t){const a=this._pageSizeOptionsDisabled;this._pageSizeOptionsDisabled=t,this.requestUpdate("pageSizeOptionsDisabled",a)}set hideFooter(t){const a=this._hideFooter;this._hideFooter=t,this.requestUpdate("hideFooter",a)}_getDataLength(){let t=0;return this._totalResults!==void 0&&this._totalResults>=0?t=this._totalResults:this._data&&(t=this._data.length),t}_sortBy(t,a,c,d,h){this._currentSortColumn=a,this._currentSortType=c,d?d==="none"?this._currentSortOrder="asc":d==="asc"?this._currentSortOrder="desc":d==="desc"&&(this._currentSortOrder="none"):this._currentSortOrder="asc",this._updateColumnSortState();let p;return this._currentSortOrder==="none"?p=t:p=sort(t,this._currentSortColumn,this._currentSortOrder,c),p&&!h&&this._dispatchSort(p),p}_updateColumnSortState(){this._columnsHeader.forEach(t=>{t.column===this._currentSortColumn?t.sortOrder=this._currentSortOrder:t.sortOrder&&(t.sortOrder="none")})}_onSelectAll(){if(this._table){this._allRowsSelected=!this._allRowsSelected;let t=0,a=0;const c=this._table.querySelectorAll(".dss-checkbox--multiselect");c.forEach(d=>{d.disabled?a+=1:(d.checked||(t+=1),d.checked=this._allRowsSelected)}),this._allRowsSelected?this._currentRowsChecked+=t:this._currentRowsChecked-=c.length-a,this._updateTableFooterRowsChecked(),this._dispatchMultiselect()}}_rowsCheckedListener(t){this._table&&t.tagName==="INPUT"&&t.type==="checkbox"&&t.classList.contains("dss-checkbox")&&!t.classList.contains("dss-checkbox--thead")&&(t.checked?this._currentRowsChecked+=1:this._currentRowsChecked-=1,this._updateTableFooterRowsChecked())}_updateTableFooterRowsChecked(){this._selectedRowsCounter===void 0&&(this.internalSelectedCounter=this._currentRowsChecked)}_updateTableHeader(){if(this._table){const t=this._table.querySelector(".dss-custom-table");let a=t.querySelector("thead");a||(a=document.createElement("thead"),a.classList.add("dss-thead"),t.insertBefore(a,t.firstChild)),B(this._generateTableHeaderHTML(),a)}}_generateTableHeaderHTML(){let t=!0,a=u``,c=u``;this._multiselect&&(a=u`
      ...
      `);const d=this._columnsHeader.map(p=>{const b=()=>{p.sortType&&!this._disableSorting&&(this._paginatedData?this._sortBy(this._paginatedData,p.column,p.sortType,p==null?void 0:p.sortOrder):this._sortBy(this._data,p.column,p.sortType,p==null?void 0:p.sortOrder),this._updateTableHeaderIcons())},g=y=>{const k=y.currentTarget,w=y;let _=!1;switch(w.key){case"ArrowLeft":this._table&&moveFocusToPreviousTarget(this._table,k,".dss-th-content--clickable"),_=!0;break;case"ArrowRight":this._table&&moveFocusToNextTarget(this._table,k,".dss-th-content--clickable"),_=!0;break;case"Enter":const C=y.target;this._table&&onKeyboardEnter(this._table,C,".dss-th-content--clickable"),_=!0;break}_&&(y.stopPropagation(),y.preventDefault())},f={"dss-th--align-center":p.align==="center","dss-th--align-right":p.align==="right"};let $=!1;p.sortType&&!this._disableSorting&&($=!0);const v={"dss-th-content--clickable":$},m=u`
        <th
          class="dss-th ${e(f)}"
          style="${o(p.style)}"
        >
      ...
      `;return t=!1,m});return u` <tr class="dss-thead-row ${e({})}">
      ${a} ${c} ${d}
    ...
    `}_updateTableHeaderIcons(){this._table&&this._table.querySelectorAll(".dss-th-content--clickable > .dss-icon").forEach(a=>{const c=a.getAttribute("column");let d="swap_vert";if(this._currentSortColumn===c)switch(this._currentSortOrder){case"asc":d="arrow_upward";break;case"desc":d="arrow_downward";break;default:d="swap_vert";break}a.innerHTML=d})}_paginate(t){const a=t.startIndex,c=t.endIndex;if(this._data){const d=c<=this._data.length?c:this._data.length;this._paginatedData=[...this._data.slice(a-1,d)]}if(t.pageSize&&(this._pageSize=t.pageSize),this._currentSortColumn&&this._currentSortOrder){let d="";this._currentSortOrder==="asc"?d="none":this._currentSortOrder==="desc"?d="asc":d="dsc",this._paginatedData=this._sortBy(this._paginatedData,this._currentSortColumn,this._currentSortType,d,!0)}return this._paginatedData}_rowKeydownListener(){if(this._table){let t=!0;this._table.querySelectorAll(".dss-tbody-row").forEach(c=>{t?c.setAttribute("tabindex","0"):c.setAttribute("tabindex","-1"),t=!1,c.addEventListener("keydown",d=>{let h=!1;switch(d.key){case"ArrowUp":this._table&&moveFocusToPreviousTarget(this._table,c,".dss-tbody-row"),h=!0;break;case"ArrowDown":this._table&&moveFocusToNextTarget(this._table,c,".dss-tbody-row"),h=!0;break;case"Enter":if(this._multiselect){const p=c.querySelector(".dss-checkbox--multiselect");p&&(p.checked=!(p!=null&&p.checked),this.requestUpdate()),h=!0}if(this._radioselect){const p=c.querySelector(".dss-radio");p&&(p.checked=!(p!=null&&p.checked),this.requestUpdate()),h=!0}break}h&&(d.stopPropagation(),d.preventDefault())})})}}_dispatchChangeFilters(t){this._filters=t.detail;const a={detail:this._filters,bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onUpdateFilters",a))}_dispatchExpandTable(t){this._expandTable=t.detail;const a={detail:this._expandTable,bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onExpandTable",a))}_dispatchOpenFilters(){const t={detail:!0,bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onOpenDrawer",t))}_dispatchPagination(t){var a;if(!this._totalResults||this._isPaginationStarted){const c={detail:t.detail,bubbles:!0,composed:!0};if(this._paginationState=c.detail,this._data&&!this._totalResults&&(c.detail.data=this._paginate(this._paginationState)),this._totalResults&&(this._shouldUpdate=!0),this._allRowsSelected){this._allRowsSelected=!1;const d=(a=this._table)==null?void 0:a.querySelector(".dss-checkbox--thead");d&&(d.checked=!1)}this.dispatchEvent(new CustomEvent("onPaginate",c))}this._isPaginationStarted=!0}_dispatchSort(t){const a={detail:{currentSortColumn:this._currentSortColumn,currentSortOrder:this._currentSortOrder,currentSortType:this._currentSortType,columnsHeader:this._columnsHeader,data:t},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onSort",a))}_dispatchMultiselect(){const t={detail:this._allRowsSelected,bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onMultiselect",t))}_initTable(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="table"]'))||void 0;this._table=t==null?void 0:t.assignedElements()[0],this._table&&(this._columnsHeader.length&&!this._isTableHeaderCreated&&(this._updateTableHeader(),this._isTableHeaderCreated=!0),this._rowKeydownListener(),new MutationObserver(d=>{d.forEach(h=>{h.type==="childList"&&h.addedNodes.length>0&&this._rowKeydownListener()}),this._checkAllRowsSelected()}).observe(this._table,{childList:!0,subtree:!0}))}_checkAllRowsSelected(){var t;if(this._table){const a=this._table.querySelectorAll(".dss-checkbox--multiselect");let c=!0;if(a.length===0&&(c=!1),a.forEach(d=>{!d.checked&&!d.disabled&&(c=!1)}),this._allRowsSelected!==c){this._allRowsSelected=c;const d=(t=this._table)==null?void 0:t.querySelector(".dss-checkbox--thead");d.checked=this._allRowsSelected}}}async firstUpdated(){await this.updateComplete,this._isFirstUpdate&&!this._table&&(this._initTable(),this.addEventListener("change",t=>{this._rowsCheckedListener(t.target),this._checkAllRowsSelected()})),this._isFirstUpdate=!1}willUpdate(t){const a=t.has("columnsHeader"),c=t.has("disableSorting"),d=t.has("data");if(c&&this._updateTableHeader(),a&&(this._columnsHeader.forEach(h=>{h.sortOrder&&(this._currentSortColumn=h.column,this._currentSortOrder=h.sortOrder,h.sortType&&(this._currentSortType=h.sortType))}),!this._isTableHeaderCreated&&this._table&&(this._updateTableHeader(),this._isTableHeaderCreated=!0)),d&&!this._isFirstUpdate)if(this._totalResults){if(this.internalSelectedCounter>this._totalResults&&(this.internalSelectedCounter=this._totalResults),this._shouldUpdate){if(this._currentSortColumn&&this._currentSortType&&this._currentSortOrder&&this._currentSortOrder!=="none"){const h=sort(this._data,this._currentSortColumn,this._currentSortOrder,this._currentSortType);this._dispatchSort(h)}this._shouldUpdate=!1}}else{const h=this._getDataLength();if(this.internalSelectedCounter>h&&(this.internalSelectedCounter=h,this._currentRowsChecked=h),this._paginationState){this._paginationState.endIndex<this._pageSize&&(this._paginationState.endIndex=this._pageSize);const p={detail:this._paginationState,bubbles:!0,composed:!0};this._dispatchPagination(p)}}}render(){return u`
    ...
    `}}__decorateClass$T([n$1({type:Number})],CustomTable.prototype,"internalSelectedCounter",2);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"hideHeader",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"hidePaginator",1);__decorateClass$T([n$1({type:Array})],CustomTable.prototype,"columnsHeader",1);__decorateClass$T([n$1({type:Array})],CustomTable.prototype,"data",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"multiselect",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"radioselect",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"selectedRowsLabel",1);__decorateClass$T([n$1({type:Number})],CustomTable.prototype,"selectedRowsCounter",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"tableTitle",1);__decorateClass$T([n$1({type:Array})],CustomTable.prototype,"filters",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"innerFilters",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"expandTable",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"expandLabel",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"collapseLabel",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"filtersLabel",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"cleanFiltersLabel",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"noFiltersLabel",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"hideHeaderTitleAndExpand",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"disableSorting",1);__decorateClass$T([n$1({type:Number})],CustomTable.prototype,"totalResults",1);__decorateClass$T([n$1({type:Number})],CustomTable.prototype,"currentIndex",1);__decorateClass$T([n$1({type:Number})],CustomTable.prototype,"pageSize",1);__decorateClass$T([n$1({type:Array})],CustomTable.prototype,"pageSizeOptions",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"resultsLabel",1);__decorateClass$T([n$1({type:String})],CustomTable.prototype,"rowsPerPageLabel",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"hidePaginationResults",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"pageSizeOptionsDisabled",1);__decorateClass$T([n$1(booleanType)],CustomTable.prototype,"hideFooter",1);const datepickerRangeStyles=":host{display:block;width:100%;min-width:257px}.dss-datepicker-range{position:relative;font-family:var(--font-family);height:48px}.dss-datepicker-range--sm{height:40px}.dss-datepicker-range-inputs{display:grid;grid-template-columns:1fr 1fr;gap:var(--dss-spacing-md)}.dss-datepicker-range-help{font-family:var(--font-family)}.dss-datepicker-range-help{font-family:inherit;font-size:12px;color:var(--color-neutral-700);padding:var(--dss-spacing-xxs) var(--dss-spacing-sm)}.dss-datepicker-range-help--disabled{color:var(--color-neutral-500)}.dss-datepicker-range-help--invalid{color:var(--color-red-500)}.dss-calendar{position:absolute;margin-top:var(--dss-spacing-xxs);top:48px;z-index:900;width:-moz-fit-content;width:fit-content}.dss-calendar--sm{margin-top:var(--dss-spacing-xxs);top:40px}",dssCalendar=i`dss-calendar${s(getCustomElementSuffix())}`,template$g=l=>{var p,b,g,f,$,v,m,y,k,w,_,C,S,T,D,q,U,P,I,L,O,R,A,z,F;const t={"dss-datepicker-range--sm":l._inputSize==="sm"},a={"dss-datepicker-range-help--invalid":l._invalid||!((p=l._inputRangeStart)!=null&&p.validity.valid)&&((b=l._inputRangeStart)==null?void 0:b.value)!==""||!((g=l._inputRangeEnd)!=null&&g.validity.valid)&&((f=l._inputRangeEnd)==null?void 0:f.value)!=="","dss-datepicker-range-help--disabled":(($=l._inputRangeStart)==null?void 0:$.disabled)&&((v=l._inputRangeEnd)==null?void 0:v.disabled)},c={"dss-input-group--focused":((m=l._inputRangeStart)==null?void 0:m.value)||l._isStartFocused||l._copyInputRangeStartPlaceholder,"dss-input-group--lg":l._inputSize==="md","dss-input-group--md":l._inputSize==="sm","dss-input-group--invalid":l._invalid||!((y=l._inputRangeStart)!=null&&y.validity.valid)&&((k=l._inputRangeStart)==null?void 0:k.value)!=="","dss-input-group--disabled":(w=l._inputRangeStart)==null?void 0:w.disabled,"dss-input-group--read-only":(_=l._inputRangeStart)==null?void 0:_.readOnly,"dss-input-group--required":(C=l._inputRangeStart)==null?void 0:C.required},d={"dss-input-group--focused":((S=l._inputRangeEnd)==null?void 0:S.value)||l._isEndFocused||l._copyInputRangeEndPlaceholder,"dss-input-group--lg":l._inputSize==="md","dss-input-group--md":l._inputSize==="sm","dss-input-group--invalid":l._invalid||!((T=l._inputRangeEnd)!=null&&T.validity.valid)&&((D=l._inputRangeEnd)==null?void 0:D.value)!=="","dss-input-group--disabled":(q=l._inputRangeEnd)==null?void 0:q.disabled,"dss-input-group--read-only":(U=l._inputRangeEnd)==null?void 0:U.readOnly,"dss-input-group--required":(P=l._inputRangeEnd)==null?void 0:P.required},h={"dss-calendar":!0,"dss-calendar--disabled":((I=l._inputRangeStart)==null?void 0:I.disabled)&&((L=l._inputRangeEnd)==null?void 0:L.disabled),"dss-calendar--sm":l._inputSize==="sm"};return u`
      <div class="dss-datepicker-range ${e(t)}">
        <div class="dss-datepicker-range-inputs">
          <div
            ...
            aria-expanded=${o(l._showCalendar)}
          >
            <span class="dss-icon dss-icon--md dss-input-icon"
              >${l._iconRangeStart}</span
            >
            <slot
          ...
          <div
            class="dss-datepicker-range-inputs__end dss-input-group dss-input-group--has-icon ${e(d)}"
            role="combobox"
            aria-controls="datepicker-range-calendar"
            aria-expanded=${o(l._showCalendar)}
          >
            <span class="dss-icon dss-icon--md dss-input-icon"
              >${l._iconRangeEnd}</span
            >
            <slot
        ...
        ${l._helpText?u`
            ...
            `:null}
        ${l._showCalendar&&!((O=l._inputRangeStart)!=null&&O.readOnly)&&!((R=l._inputRangeEnd)!=null&&R.readOnly)?u`
              <${dssCalendar}
                range
                ...
                class="${e(h)}"
                .selectedDate="${(A=l._inputRangeStart)==null?void 0:A.value}"
                .rangeStartDate="${(z=l._inputRangeStart)==null?void 0:z.value}"
                .rangeEndDate="${(F=l._inputRangeEnd)==null?void 0:F.value}"
...
`;var __defProp$Q=Object.defineProperty,__getOwnPropDesc$O=Object.getOwnPropertyDescriptor,__decorateClass$Q=(l,t,a,c)=>{for(var d=__getOwnPropDesc$O(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$Q(t,a,d),d};class HeaderLinks extends r$1{constructor(){super(...arguments),this._hideHelp=!1,this._disableHelp=!1,this._helpLabel="Ajuda",this._items=[]}static get styles(){return[r$2(resetStyles),r$2(iconStyles),r$2(headerLinksStyles)]}set hideHelp(t){const a=this._hideHelp;this._hideHelp=t,this.requestUpdate("hideHelp",a)}set disableHelp(t){const a=this._disableHelp;this._disableHelp=t,this.requestUpdate("disableHelp",a)}set helpLabel(t){const a=this._helpLabel;this._helpLabel=t,this.requestUpdate("helpLabel",a)}set items(t){const a=this._items;this._items=t,this.requestUpdate("items",a)}_dispatchItemAction(t){const a={detail:t,bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onClickLink",a))}_handleHelp(){this.dispatchEvent(new CustomEvent("onHelp",{bubbles:!0,composed:!0}))}render(){return headerLinksTemplate(this)}}__decorateClass$Q([n$1(booleanType)],HeaderLinks.prototype,"hideHelp");__decorateClass$Q([n$1(booleanType)],HeaderLinks.prototype,"disableHelp");__decorateClass$Q([n$1({type:String})],HeaderLinks.prototype,"helpLabel");__decorateClass$Q([n$1({type:Array})],HeaderLinks.prototype,"items");const headerMenuPatientStyles=":host{display:block}.dss-header-menu-patient{position:relative;display:flex;align-items:center;gap:var(--dss-spacing-md);width:-moz-max-content;width:max-content}.dss-header-menu-patient--lg{max-width:360px}.dss-header-menu-patient--md{max-width:320px}.dss-header-menu-patient--sm{max-width:280px}.dss-header-menu-patient-details__name{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1;align-self:stretch;overflow:hidden;color:var(--neutral-neutral-500, #656565);text-overflow:ellipsis;font-size:14px;font-weight:var(--font-semibold);line-height:24px;font-family:var(--font-family)}.dss-header-menu-patient-details__info{display:flex;align-items:center;gap:var(--dss-spacing-xs)}.dss-header-menu-patient-details__info-label{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1;align-self:stretch;overflow:hidden;color:var(--neutral-neutral-500);text-overflow:ellipsis;font-family:var(--font-family);font-size:14px;font-weight:var(--font-regular);line-height:24px}.dss-header-menu-patient-dropdown{position:absolute;top:calc(100% + var(--dss-spacing-lg));right:0;width:240px;z-index:900}.breakpoint-small-only{display:none}.divider-v{width:var(--dss-border-width-sm);height:14px;background-color:var(--color-neutral-500)}@media only screen and (max-width: 1024px){.dss-header-menu-patient-details__info-label--cip,.divider-v--cip{display:none}.breakpoint-small-only{display:block}}",headerMenuPatientTemplate=l=>x`
  ...
  >
    ...
    ${l._showDropdown?x`
          <div
            class=${e({"dss-header-menu-patient-dropdown":!0,"dss-header-menu-patient-dropdown--expanded":!!l._showDropdown})}
          >
            <dss-action-menu fullWidth>
              <dss-action-menu-item
                leftIcon="person"
                label="Detalls del pacient"
                @onClick="${()=>l._handleActionClick("Detalls del pacient")}"
              ></dss-action-menu-item>
              <dss-action-menu-item
...
`;var __defProp$P=Object.defineProperty,__getOwnPropDesc$N=Object.getOwnPropertyDescriptor,__decorateClass$P=(l,t,a,c)=>{for(var d=__getOwnPropDesc$N(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$P(t,a,d),d};class HeaderMenuPatient extends r$1{constructor(){super(),this._size="lg",this._name=void 0,this._cip=void 0,this._age=void 0,this._gender=void 0,this._disabled=!1,this._showDropdown=!1,this._toggleIcon="expand_more",this._handleDocumentClickBound=this._handleDocumentClick.bind(this)}static get styles(){return[r$2(resetStyles),r$2(iconStyles),r$2(headerMenuPatientStyles)]}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._handleDocumentClickBound)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleDocumentClickBound)}set size(t){const a=this._size;this._size=t==="md"||t==="sm"?t:"lg",this.requestUpdate("size",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}set name(t){const a=this._name;this._name=t,this.requestUpdate("name",a)}set cip(t){const a=this._cip;this._cip=t,this.requestUpdate("cip",a)}set age(t){const a=this._age;this._age=t,this.requestUpdate("age",a)}set gender(t){const a=this._gender;this._gender=t,this.requestUpdate("gender",a)}_toggleDropdown(){this._showDropdown=!this._showDropdown,this._toggleIcon=this._showDropdown?"expand_less":"expand_more",this.requestUpdate()}_handleClick(){this.dispatchEvent(new CustomEvent("onClick",{bubbles:!0,composed:!0}))}_handleActionClick(t){this.dispatchEvent(new CustomEvent("onActionPatientClick",{detail:{action:t},bubbles:!0,composed:!0}))}_handleCopyCIP(){this._cip&&(navigator.clipboard.writeText(this._cip),this.dispatchEvent(new CustomEvent("onCopyCIP",{detail:{text:this._cip},bubbles:!0,composed:!0})))}_handleDocumentClick(t){this._clickedOutside(this,t)}_clickedOutside(t,a){a.composedPath().includes(t)||this._showDropdown&&this._toggleDropdown()}render(){return headerMenuPatientTemplate(this)}}__decorateClass$P([n$1({type:String})],HeaderMenuPatient.prototype,"size");__decorateClass$P([n$1(booleanType)],HeaderMenuPatient.prototype,"disabled");__decorateClass$P([n$1({type:String})],HeaderMenuPatient.prototype,"name");__decorateClass$P([n$1({type:String})],HeaderMenuPatient.prototype,"cip");__decorateClass$P([n$1({type:String})],HeaderMenuPatient.prototype,"age");__decorateClass$P([n$1({type:String})],HeaderMenuPatient.prototype,"gender");const headerMenuProfessionalStyles=":host{display:block}.dss-header-menu-professional{position:relative;display:flex;align-items:center;gap:var(--dss-spacing-md);width:-moz-max-content;width:max-content}.dss-header-menu-professional--lg{max-width:360px}.dss-header-menu-professional--md{max-width:320px}.dss-header-menu-professional--sm{max-width:280px}.dss-header-menu-professional-details__name,.dss-header-menu-professional-dropdown__details-title,.dss-header-menu-professional-dropdown__details-subtitle{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1;align-self:stretch;overflow:hidden;color:var(--neutral-neutral-500, #656565);text-overflow:ellipsis;font-size:14px;font-weight:var(--font-semibold);line-height:24px;font-family:var(--font-family)}.dss-header-menu-professional-dropdown__details-title{color:var(--color-neutral-900)}.dss-header-menu-professional-details__info{display:flex;align-items:center}.dss-header-menu-professional-details__info-label{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1;align-self:stretch;overflow:hidden;color:var(--neutral-neutral-500);text-overflow:ellipsis;font-family:var(--font-family);font-size:14px;font-weight:var(--font-regular);line-height:24px}.dss-header-menu-professional-details__info-label:not(:last-child){border-right:var(--dss-border-width-sm) solid var(--color-neutral-100);padding-right:var(--dss-spacing-xxs);margin-right:var(--dss-spacing-xxs)}.dss-header-menu-professional-dropdown{position:absolute;top:calc(100% + var(--dss-spacing-lg));right:0;width:280px;z-index:900;display:flex;padding:var(--dss-spacing-md);flex-direction:column;gap:var(--dss-spacing-lg);background-color:var(--color-white);border-radius:var(--dss-radius-sm);box-shadow:0 8px 12px 6px #0000000d,0 4px 4px #0000001a}.dss-header-menu-professional-dropdown__details{display:flex;flex-direction:column;align-items:flex-start;gap:var(--dss-spacing-xs);align-self:stretch}.dss-header-menu-professional-dropdown__info{display:flex;flex-direction:column;align-items:flex-start;gap:var(--dss-spacing-md);align-self:stretch}.dss-header-menu-professional-dropdown__details-content{display:flex;flex-direction:column;align-items:flex-start;align-self:stretch}.dss-header-menu-professional-dropdown__details-description{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;align-self:stretch;overflow:hidden;color:var(--neutral-neutral-500);text-overflow:ellipsis;font-family:var(--font-family);font-size:14px;font-weight:var(--font-regultar);line-height:24px}.dss-header-menu-professional__divider{width:100%;height:var(--dss-border-width-sm);background-color:var(--color-neutral-200)}.dss-header-menu-professional-dropdown__preferences__options{display:flex;flex-direction:column;gap:var(--dss-spacing-xs)}.breakpoint-only-sm{display:none}@media only screen and (max-width: 1024px){.dss-header-menu-professional-details{display:none}.breakpoint-only-sm{display:block}}@media only screen and (min-width: 1025px){.dss-header-menu-professional-dropdown--hide-details .dss-header-menu-professional-dropdown__info,.dss-header-menu-professional-dropdown--hide-details .dss-header-menu-professional__divider{display:none}}",headerMenuProfessionalTemplate=l=>x`
  ...
  >
    ...
    ${l._showDropdown?x`
          <div
            class=${e({"dss-header-menu-professional-dropdown":!0,"dss-header-menu-professional-dropdown--expanded":!!l._showDropdown,"dss-header-menu-professional-dropdown--hide-details":!!l._hideDropdownDetails})}
          >
            <div class="dss-header-menu-professional-dropdown__info">
              <div class="dss-header-menu-professional-dropdown__details">
                ...
                >
                  ...
                  ${l._collegiate?x`
                        ...
                        >
                          ${l._collegiateLabel} ${l._collegiate}
                        </p>
                      `:null}
                </div>
                ...
                ${l._detailsHref?x`
                      ${l._detailsIcon?x`
                            <dss-button-link
                              label="${l._detailsLabel}"
                              linkHref="${l._detailsHref}"
                              icon="${l._detailsIcon}"
                              iconPosition="${l._detailsIconPosition}"
                            ></dss-button-link>
                          `:x`
                            <dss-button-link
                              label="${l._detailsLabel}"
              ...
              ${l._hideDropdownPreferences?null:x`
                    <div
            ...
            <dss-button
              label="${l._logoutLabel}"
              icon="${l._logoutIcon}"
              iconPosition="${l._logoutIconPosition}"
              fullWidth
        ...
        ${l._title?x`
              <h1 class="dss-header-title">
                ${l._area?x`
                      ...
                      >
                    `:null}
                <span class="dss-header-title__name">${l._title}</span>
              </h1>
            `:null}
      </div>
...
`;var __defProp$N=Object.defineProperty,__getOwnPropDesc$L=Object.getOwnPropertyDescriptor,__decorateClass$N=(l,t,a,c)=>{for(var d=__getOwnPropDesc$L(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$N(t,a,d),d};class Header extends r$1{constructor(){super(...arguments),this._title=void 0,this._area=void 0,this._logoSrc=""}static get styles(){return[r$2(resetStyles),r$2(iconStyles),r$2(headerStyles)]}set title(t){const a=this._title;this._title=t,this.requestUpdate("title",a)}set area(t){const a=this._area;this._area=t,this.requestUpdate("area",a)}set logoSrc(t){const a=this._logoSrc;this._logoSrc=t,this.requestUpdate("logoSrc",a)}_handleClick(){this.dispatchEvent(new CustomEvent("onClick",{bubbles:!0,composed:!0}))}render(){return headerTemplate(this)}}__decorateClass$N([n$1({type:String})],Header.prototype,"title");__decorateClass$N([n$1({type:String})],Header.prototype,"area");__decorateClass$N([n$1({type:String})],Header.prototype,"logoSrc");const template$e=l=>{const t={"dss-icon-badge--xl":l._size==="xl","dss-icon-badge--lg":l._size==="lg","dss-icon-badge--md":l._size==="md","dss-icon-badge--sm":l._size==="sm","dss-badge--danger":l._state==="danger","dss-badge--danger-low":l._state==="danger-low","dss-badge--danger-high":l._state==="danger-high","dss-badge--moderate":l._state==="moderate","dss-badge--moderate-low":l._state==="moderate-low","dss-badge--moderate-high":l._state==="moderate-high","dss-badge--slight":l._state==="slight","dss-badge--slight-low":l._state==="slight-low","dss-badge--slight-high":l._state==="slight-high","dss-badge--correct":l._state==="correct","dss-badge--undeterminated":l._state==="undeterminated","dss-badge--critic":l._state==="critic"&&!l._outlined,"dss-badge--critic-outlined":l._state==="critic"&&l._outlined,"dss-badge--alert":l._state==="alert"&&!l._outlined,"dss-badge--alert-outlined":l._state==="alert"&&l._outlined,"dss-badge--ideal":l._state==="ideal"&&!l._outlined,"dss-badge--ideal-outlined":l._state==="ideal"&&l._outlined,"dss-badge--info":l._state==="info"&&!l._outlined,"dss-badge--info-outlined":l._state==="info"&&l._outlined,"dss-badge--info-alt":l._state==="info-alt"&&!l._outlined,"dss-badge--info-alt-outlined":l._state==="info-alt"&&l._outlined,"dss-badge--neutral":l._state==="neutral"&&!l._outlined,"dss-badge--neutral-outlined":l._state==="neutral"&&l._outlined,"dss-badge--disabled":l._disabled,"dss-icon-badge--bubble":l._bubble};return u`
  ...
  `},styles$f=".dss-wrapper{position:relative}.dss-icon-badge{cursor:default;box-sizing:border-box;display:flex;justify-content:center;align-items:center;height:20px;width:20px;border:var(--dss-border-width-sm) solid var(--color-neutral-500);padding:var(--dss-spacing-tiny);border-radius:var(--dss-radius-xs);font-size:16px;color:var(--color-neutral-500);background-color:var(--color-white)}.dss-icon-badge--bubble{border-radius:var(--dss-radius-full)}.dss-icon-badge--md{height:24px;width:32px;padding:var(--dss-spacing-xxs) var(--dss-spacing-xs)}.dss-icon-badge--lg{height:32px;width:40px;padding:var(--dss-spacing-xxs) var(--dss-spacing-xs);border-radius:var(--dss-radius-sm);font-size:24px}.dss-icon-badge--xl{height:40px;width:40px;padding:var(--dss-spacing-xxs) var(--dss-spacing-xs);border-radius:var(--dss-radius-sm);font-size:24px}::slotted(dss-tooltip){display:none}.dss-icon-badge:hover+::slotted(dss-tooltip){display:block}";var __defProp$M=Object.defineProperty,__getOwnPropDesc$K=Object.getOwnPropertyDescriptor,__decorateClass$M=(l,t,a,c)=>{for(var d=__getOwnPropDesc$K(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$M(t,a,d),d};class IconBadge extends r$1{constructor(){super(...arguments),this._icon="warning",this._size="sm",this._state="",this._disabled=!1,this._isIconDefined=!1,this._outlined=!1,this._bubble=!1}static get styles(){return[r$2(iconStyles),r$2(styles$f),r$2(badgeStates)]}set icon(t){const a=this._icon;this._icon=t,this._isIconDefined=!0,this.requestUpdate("icon",a)}set size(t){const a=this._size;this._size=t,this.requestUpdate("size",a)}set state(t){const a=this._state;this._state=t,t&&!this._isIconDefined&&(t.includes("danger")?this._icon="warning":t.includes("moderate")?this._icon="emergency_home":t.includes("slight")?this._icon="error":t.includes("correct")?this._icon="check_circle":t.includes("undeterminated")?this._icon="circle":t.includes("critic")?this._icon="cancel":t.includes("alert")?this._icon="report":t.includes("ideal")?this._icon="check_circle":t.includes("info")?this._icon="info":t.includes("neutral")&&(this._icon="circle")),this.requestUpdate("state",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}set outlined(t){const a=this._outlined;this._outlined=t,this.requestUpdate("outlined",a)}set bubble(t){const a=this._bubble;this._bubble=t,this.requestUpdate("bubble",a)}render(){return template$e(this)}}__decorateClass$M([n$1({type:String})],IconBadge.prototype,"icon");__decorateClass$M([n$1({type:String})],IconBadge.prototype,"size");__decorateClass$M([n$1({type:String})],IconBadge.prototype,"state");__decorateClass$M([n$1(booleanType)],IconBadge.prototype,"disabled");__decorateClass$M([n$1(booleanType)],IconBadge.prototype,"outlined");__decorateClass$M([n$1(booleanType)],IconBadge.prototype,"bubble");const dssIcon$1=i`dss-icon${s(getCustomElementSuffix())}`,template$d=l=>u`
  <button
    class=${e({"dss-icon-button":!0,[`dss-icon-button--${l._type}`]:!!l._type,[`dss-icon-button--${l._size}`]:!!l._size})}
    ?disabled=${l._disabled}
    ?hidden=${l._hidden}
    @click=${l._handleClick}
  >
    <${dssIcon$1} icon="${l._icon}" size="${l._size}"></${dssIcon$1}>
  </button>
`;var __defProp$L=Object.defineProperty,__getOwnPropDesc$J=Object.getOwnPropertyDescriptor,__decorateClass$L=(l,t,a,c)=>{for(var d=__getOwnPropDesc$J(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$L(t,a,d),d};class IconButton extends r$1{constructor(){super(...arguments),this._type="default",this._size="md",this._icon=void 0,this._iconFill=!1,this._disabled=!1,this._hidden=!1}static get styles(){return[r$2(resetStyles),r$2(iconButtonStyles)]}set type(t){const a=this._type;this._type=t,this.requestUpdate("type",a)}set size(t){const a=this._size;this._size=t,this.requestUpdate("size",a)}set icon(t){const a=this._icon;this._icon=t,this.requestUpdate("icon",a)}set iconFill(t){const a=this._iconFill;this._iconFill=t,this.requestUpdate("iconFill",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}set hidden(t){const a=this._hidden;this._hidden=t,this.requestUpdate("hidden",a)}_handleClick(){this.dispatchEvent(new CustomEvent("onClick",{bubbles:!0,composed:!0}))}render(){return template$d(this)}}__decorateClass$L([n$1({type:String})],IconButton.prototype,"type");__decorateClass$L([n$1({type:String})],IconButton.prototype,"size");__decorateClass$L([n$1({type:String})],IconButton.prototype,"icon");__decorateClass$L([n$1(booleanType)],IconButton.prototype,"iconFill");__decorateClass$L([n$1(booleanType)],IconButton.prototype,"disabled");__decorateClass$L([n$1(booleanType)],IconButton.prototype,"hidden");const inputActionTemplate=l=>{var c,d,h,p,b,g,f;const t={"dss-input-group--invalid":l._invalid||!l._inputValidity,"dss-input-group--disabled":(c=l._input)==null?void 0:c.disabled,"dss-input-group--required":(d=l._input)==null?void 0:d.required,"dss-input-group--read-only":(h=l._input)==null?void 0:h.readOnly,"dss-input-group--focused":((p=l._input)==null?void 0:p.value)||l._placeholder||l._isFocused,"dss-input-group--lg":l._inputSize==="lg","dss-input-group--md":l._inputSize==="md","dss-input-group--numeric":l._isTypeNumeric,"dss-input-group--has-icon":l._icon&&l._icon!=="","dss-input-group--no-min-width":l._removeMinWidth,"dss-input-group--actions":!0,"dss-input-group--has-secondary-action":!!l._action&&!!l._secondaryAction,"dss-input-group--no-label":!l._labelSlot},a={"dss-input-help--invalid":l._invalid,"dss-input-help--disabled":(b=l._input)==null?void 0:b.disabled};return x`
        ...
        ${!this._openWithSearch&&!this._readonly?u`
            ...
            `:this._openWithSearch?u`
              <button
                ...
                tabindex="-1"
              >
                <span class="dss-icon dss-icon--md">close</span>
              </button>
            `:u``}
      </div>
  ...
  `};var __defProp$I=Object.defineProperty,__getOwnPropDesc$G=Object.getOwnPropertyDescriptor,__decorateClass$I=(l,t,a,c)=>{for(var d=__getOwnPropDesc$G(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$I(t,a,d),d};class InputSwitch extends r$1{constructor(){super(...arguments),this._checked=!1,this._isCheckedPropDefined=!1,this._isFirstUpdate=!0,this._disabled=!1,this._readonly=!1,this._size="md",this.observerConfig={attributes:!0,childList:!0,subtree:!0},this.callback=t=>{for(const a of t)a.type==="attributes"&&(this._checkInputAttributes(),this.requestUpdate())},this.observer=new MutationObserver(this.callback)}static get styles(){return[r$2(iconStyles),r$2(inputSwitchStyles)]}get _input(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="input"]'))||void 0;return this.requestUpdate(),t==null?void 0:t.assignedElements()[0]}set size(t){const a=this._size;this._size=t,this.requestUpdate("size",a)}set checked(t){const a=this._checked;this._checked=t,this._isCheckedPropDefined=!0,this._isFirstUpdate||this._dispatchChange(),this.requestUpdate("checked",a)}disconnectedCallback(){this.observer.disconnect()}_checkInputAttributes(){var c,d,h;if(!this._isCheckedPropDefined){const p=(c=this._input)==null?void 0:c.getAttribute("checked");this._checked=p!==null}const t=(d=this._input)==null?void 0:d.getAttribute("disabled");this._disabled=t!==null;const a=(h=this._input)==null?void 0:h.getAttribute("readonly");this._readonly=a!==null}_handleClick(){!this._disabled&&!this._readonly&&this._input&&(this._checked=!this._checked,this._checked?this._input.setAttribute("checked","true"):this._input.removeAttribute("checked"),this._dispatchChange())}_handleKeydown(t){(t.key==="Enter"||t.key===" ")&&this._handleClick()}_dispatchChange(){this.dispatchEvent(new CustomEvent("onChangeValue",{detail:this._checked,bubbles:!0,composed:!0}))}async firstUpdated(){try{await this.updateComplete,this._input&&(this._checkInputAttributes(),this.observer.observe(this._input,this.observerConfig)),this._isFirstUpdate=!1,this.requestUpdate()}catch{console.error("ERROR OCURRED")}}render(){return template$c(this)}}__decorateClass$I([n$1({type:String})],InputSwitch.prototype,"size");__decorateClass$I([n$1(booleanType)],InputSwitch.prototype,"checked");const template$b=l=>{var c,d,h,p,b,g,f;const t={"dss-input-group--invalid":l._invalid||!l._inputValidity,"dss-input-group--disabled":(c=l._input)==null?void 0:c.disabled,"dss-input-group--required":(d=l._input)==null?void 0:d.required,"dss-input-group--read-only":(h=l._input)==null?void 0:h.readOnly,"dss-input-group--focused":((p=l._input)==null?void 0:p.value)||l._placeholder||l._isFocused,"dss-input-group--lg":l._inputSize==="lg","dss-input-group--md":l._inputSize==="md","dss-input-group--numeric":l._isTypeNumeric,"dss-input-group--has-icon":l._icon&&l._icon!=="","dss-input-group--no-min-width":l._removeMinWidth,"dss-input-group--no-label":!l._labelSlot},a={"dss-input-help--invalid":l._invalid,"dss-input-help--disabled":(b=l._input)==null?void 0:b.disabled};return u`
    <div class="dss-input-wrapper">
        <div class="dss-input-group ${e(t)}">
          ${l._icon?u`
                <span class="dss-icon dss-icon--md dss-input-icon">
  ...
  `};var __defProp$H=Object.defineProperty,__getOwnPropDesc$F=Object.getOwnPropertyDescriptor,__decorateClass$H=(l,t,a,c)=>{for(var d=__getOwnPropDesc$F(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$H(t,a,d),d};class Input extends r$1{constructor(){super(...arguments),this._label="Label",this._icon="add_box",this._placeholder="",this._inputSize="lg",this._maxLength=void 0,this._invalid=!1,this._helpText="",this._isFocused=!1,this._isTypeNumeric=!1,this._inputValidity=!0,this._removeMinWidth=!1,this.observerConfig={attributes:!0,childList:!0,subtree:!0},this.callback=t=>{for(const a of t)a.type==="attributes"&&(this._checkInputAttributes(),this.requestUpdate())},this.observer=new MutationObserver(this.callback)}static get styles(){return[r$2(iconStyles),r$2(inputStyles),r$2(iconButtonStyles)]}get _input(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="input"]'))||void 0;return this.requestUpdate(),t==null?void 0:t.assignedElements()[0]}get _labelSlot(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="label"]'))||void 0;return t==null?void 0:t.assignedElements()[0]}set label(t){const a=this._label;this._label=t,this.requestUpdate("label",a)}set icon(t){const a=this._icon;this._icon=t,this.requestUpdate("icon",a)}set inputSize(t){const a=this._inputSize;t==="md"?this._inputSize=t:this._inputSize="lg",this.requestUpdate("inputSize",a)}set helpText(t){const a=this._helpText;this._helpText=t,this.requestUpdate("helpText",a)}set invalid(t){const a=this._invalid;this._invalid=t,this.requestUpdate("invalid",a)}set removeMinWidth(t){const a=this._removeMinWidth;this._removeMinWidth=t,this.requestUpdate("removeMinWidth",a)}set value(t){t!==void 0&&this.requestUpdate()}disconnectedCallback(){this.observer.disconnect()}_handleClick(){this.requestUpdate()}_handleInput(){this._isTypeNumeric&&this._maxLength&&this._input&&(this._input.value=this._input.value.slice(0,this._maxLength)),this._handleValidity(),this.requestUpdate()}_handleFocusIn(){this._isFocused=!0,this.requestUpdate()}_handleFocusOut(){this._isFocused=!1,this.requestUpdate()}_focusInput(){var t;(t=this._input)==null||t.focus()}_handleValidity(){var a;const t=(a=this._input)==null?void 0:a.checkValidity();t!==void 0&&(this._inputValidity=t)}_stepUp(){var t;(t=this._input)==null||t.stepUp(),this._handleValidity(),this._dispatchValueChange(),this.requestUpdate()}_stepDown(){var t;(t=this._input)==null||t.stepDown(),this._handleValidity(),this._dispatchValueChange(),this.requestUpdate()}_dispatchValueChange(){if(this._input){const t={detail:this._input.value,bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onInputChange",t))}}_checkInputAttributes(){var c,d,h,p,b;const t=(c=this._input)==null?void 0:c.getAttribute("placeholder");t&&(this._placeholder=t),((d=this._input)==null?void 0:d.getAttribute("type"))==="number"&&(this._isTypeNumeric=!0);const a=(h=this._input)==null?void 0:h.getAttribute("maxlength");this._maxLength=a?+a:void 0,(p=this._input)!=null&&p.value&&((b=this._input)==null?void 0:b.value)!==""&&this._handleValidity()}async firstUpdated(){try{await this.updateComplete,this._input&&(this._checkInputAttributes(),this.observer.observe(this._input,this.observerConfig)),this.requestUpdate()}catch{console.error("ERROR OCURRED")}}render(){return template$b(this)}}__decorateClass$H([n$1({type:String})],Input.prototype,"label");__decorateClass$H([n$1({type:String})],Input.prototype,"icon");__decorateClass$H([n$1({type:String})],Input.prototype,"inputSize");__decorateClass$H([n$1({type:String})],Input.prototype,"helpText");__decorateClass$H([n$1(booleanType)],Input.prototype,"invalid");__decorateClass$H([n$1(booleanType)],Input.prototype,"removeMinWidth");__decorateClass$H([n$1({type:String})],Input.prototype,"value");const dssBadge=i`dss-badge${s(getCustomElementSuffix())}`,itemListTemplate=l=>u`
  <div
    class=${e({"dss-item-list":!0,"dss-item-list--widget":l._widget})}
  >
    ${l._items.map(t=>{var a,c;return u`
        <div class="dss-item-list__item">
          ${l._widget?u`
                <div class="item-widget-badge">
                  <dss-icon-badge
                    size="sm"
                    state="${o(t.iconBadgeLeftState)}"
                    icon="${o(t.iconBadgeLeftIcon)}"
                  ></dss-icon-badge>
                </div>
              `:null}
          ...
          ${t.badgeText&&!l._widget?t.badgeIcon?u`
          ...
          ${l._widget?u`
                <div class="item-widget">
                  ${t.description?u`
                      ...
                      `:null}
                  ${(a=t.icons)!=null&&a.length?u`
                        ${t.icons.map(d=>u`
                            <i class="dss-icon dss-icon--md">${d.icon}</i>
                          `)}
                      `:null}
                  ${t.iconBadgeRightState?u`
                        <dss-icon-badge
                          size="sm"
                          state="${o(t.iconBadgeRightState)}"
                          icon="${o(t.iconBadgeRightIcon)}"
                        ></dss-icon-badge>
                      `:null}
                  ${(c=t.actions)!=null&&c.length?u`
                        ${t.actions.map(d=>u`
                            <dss-icon-button
                              icon="${d.icon}"
                              type="${d.type}"
                              @onClick=${()=>l._dispatchWidgetAction(t,d.action)}
                            ></dss-icon-button>
                          `)}
                      `:null}
                </div>
...
`;var __defProp$C=Object.defineProperty,__decorateClass$C=(l,t,a,c)=>{for(var d=void 0,h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$C(t,a,d),d};class Popover extends r$1{constructor(){super(...arguments),this.observerConfig={attributes:!0,childList:!0,subtree:!0},this.callback=t=>{for(const a of t)if(a.type==="attributes"&&a.attributeName==="data-popper-placement"){const c=this.getAttribute("data-popper-placement");c&&this._propagatePlacement(c)}},this.observer=new MutationObserver(this.callback),this.open=!1,this.hasDivider=!1,this.hideCloseIcon=!1,this.title="",this.actionIcon=void 0,this.position="top",this._popperInstance=null,this._parent=null}static get styles(){return[r$2(resetStyles),r$2(iconStyles),r$2(popoverStyles)]}disconnectedCallback(){this.observer.disconnect(),this._popperInstance&&(this._popperInstance.destroy(),this._popperInstance=null)}_handleAction(){this.dispatchEvent(new CustomEvent("onAction",{bubbles:!0,composed:!0}))}_handleClose(){this._closeMenu(),this.dispatchEvent(new CustomEvent("onClose",{bubbles:!0,composed:!0}))}_clickOutside(){document.addEventListener("click",t=>{const a=t.composedPath(),c=a.includes(this._parent);!a.includes(this)&&!c&&this._closeMenu()})}_closeMenu(){setTimeout(()=>{this.classList.contains("visible")&&(this.classList.remove("visible"),this.open=!1)},0)}createPopperInstance(t){this._popperInstance=createPopper(t,this,{placement:this.position,modifiers:[{name:"offset",options:{offset:[0,12]}}],onFirstUpdate:a=>{this._propagatePlacement(a.placement)}}),t.addEventListener("click",()=>{this.open||(this.open=!0,this.classList.add("visible"))})}_propagatePlacement(t){const a=this.renderRoot.querySelector(".dss-popover");a&&a.setAttribute("data-popper-placement",t)}async firstUpdated(){await this.updateComplete;const t=this.assignedSlot;this._parent=t?t.parentElement:this.parentElement,this._parent&&this.createPopperInstance(this._parent),this.observer.observe(this,this.observerConfig),setTimeout(()=>{this._clickOutside(),this.open&&(this.classList.add("visible"),this.requestUpdate())},0)}updated(t){super.updated(t),t.has("position")&&this._popperInstance&&this._popperInstance.setOptions({placement:this.position}),t.has("open")&&(this.open?this.classList.add("visible"):this.classList.remove("visible"))}render(){return popoverTemplate(this)}}__decorateClass$C([n$1(booleanType)],Popover.prototype,"open");__decorateClass$C([n$1(booleanType)],Popover.prototype,"hasDivider");__decorateClass$C([n$1(booleanType)],Popover.prototype,"hideCloseIcon");__decorateClass$C([n$1({type:String})],Popover.prototype,"title");__decorateClass$C([n$1({type:String})],Popover.prototype,"actionIcon");__decorateClass$C([n$1({type:String})],Popover.prototype,"position");class PopoverBody extends r$1{static get styles(){return[i$1`
        .dss-popover-body {
          display: flex;
  ...
  `};var __defProp$B=Object.defineProperty,__getOwnPropDesc$A=Object.getOwnPropertyDescriptor,__decorateClass$B=(l,t,a,c)=>{for(var d=__getOwnPropDesc$A(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$B(t,a,d),d};class ProgressIndicator extends r$1{constructor(){super(...arguments),this._hasFailed=!1,this._title="",this._description="",this._percentage=0}static get styles(){return r$2(styles$b)}set hasFailed(t){const a=this._hasFailed;this._hasFailed=t,this.requestUpdate("hasFailed",a)}set title(t){const a=this._title;this._title=t,this.requestUpdate("title",a)}set description(t){const a=this._description;this._description=t,this.requestUpdate("description",a)}set percentage(t){const a=Math.min(100,Math.max(0,t)),c=this._percentage;this._percentage=a,this.requestUpdate("percentage",c)}render(){return template$8(this)}}__decorateClass$B([n$1(booleanType)],ProgressIndicator.prototype,"hasFailed");__decorateClass$B([n$1({type:String})],ProgressIndicator.prototype,"title");__decorateClass$B([n$1({type:String})],ProgressIndicator.prototype,"description");__decorateClass$B([n$1({type:Number})],ProgressIndicator.prototype,"percentage");const styles$a=':host{width:100%}.dss-search{position:relative}.dss-search-bar{position:relative;display:grid;grid-template-columns:30px 1fr;min-height:48px;height:auto;width:100%;box-sizing:border-box;padding:var(--dss-spacing-sm);padding-right:calc((var(--dss-spacing-sm) * 2) + var(--icon-size-md));background-color:var(--color-white);border-radius:var(--dss-radius-sm);border:var(--dss-border-width-sm) solid var(--color-neutral-100);font-size:14px;font-family:inherit}.dss-search-bar--md{min-height:40px;padding-top:var(--dss-spacing-tiny);padding-bottom:var(--dss-spacing-tiny)}.dss-search-bar--focused{border-color:var(--color-blue-200);outline:var(--dss-border-width-lg) solid var(--color-blue-200)}.dss-search-bar--read-only{border-top:0;border-left:0;border-right:0;border-radius:0}.dss-search-bar--invalid{background-color:var(--color-red-50);border-color:var(--color-red-500)}.dss-search-bar--disabled{cursor:not-allowed;background-color:var(--color-neutral-50);color:var(--color-neutral-500)}.dss-search-bar__icon{color:var(--color-neutral-700);box-sizing:border-box;display:flex;justify-content:flex-start;align-items:center}.dss-search-bar--default .dss-search-bar__container{display:block}.dss-search-bar--md.dss-search-bar--default .dss-search-bar__container ::slotted(input){min-height:40px}.dss-search-bar--multiple .dss-search-bar__container{display:grid;grid-template-columns:auto minmax(min-content,1fr);gap:var(--dss-spacing-xs)}.dss-search-bar--multiple .dss-search-bar__chips{display:flex;flex-wrap:wrap;align-items:center;gap:var(--dss-spacing-xs)}.dss-search-bar__chips .dss-chip{display:inline-flex}.dss-search-bar__input{min-width:200px}::slotted(label){display:none;visibility:hidden;width:0}::slotted(input){height:100%;width:100%;margin:0;border:0;border-radius:0;color:var(--color-neutral-900);box-sizing:border-box;background-color:transparent}::slotted(input:focus-visible){outline:0}.dss-search-bar__clear{display:none;position:absolute;top:0;right:var(--dss-spacing-sm);height:100%;justify-content:center;align-items:center;box-sizing:border-box}.dss-search-bar--has-value:not(.dss-search-bar--disabled):not(.dss-search-bar--read-only) .dss-search-bar__clear{display:flex}.dss-search-help{display:flex;justify-content:space-between;font-family:var(--font-family);font-size:12px;color:var(--color-neutral-700);padding:var(--dss-spacing-xxs) var(--dss-spacing-sm)}.dss-search-bar--invalid+.dss-search-help{color:var(--color-red-500)}.dss-search-dropdown{margin-top:8px;position:absolute;top:52px;left:0;background-color:var(--color-white);width:100%;border-radius:var(--dss-radius-sm);box-shadow:0 4px 8px 3px #0000000d,0 1px 3px #0000001a;z-index:800;overflow:hidden}.dss-search-catalog--empty{height:150px;display:flex;justify-content:center;align-items:center;gap:var(--dss-spacing-xs);color:var(--color-blue-800)}.dss-search-catalog--empty .text{font-size:14px}.dss-catalog-item{box-sizing:border-box;display:flex;justify-content:flex-start;align-items:center;padding:var(--dss-spacing-sm) var(--dss-spacing-md);gap:var(--dss-spacing-xs);cursor:pointer}.dss-catalog-item:hover{background-color:var(--color-neutral-50)}.dss-catalog-item--selected{background-color:var(--color-primary-50)}.dss-catalog-item:focus-visible{border:var(--dss-border-width-lg) solid var(--color-blue-200);outline:0}.dss-search-title{padding:var(--dss-spacing-sm) var(--dss-spacing-md) 0;font-weight:var(--font-semibold);font-size:14px;color:var(--color-black)}.dss-catalog-item__icon{color:var(--color-neutral-900)}.dss-catalog-item__text{color:var(--color-neutral-900);font-size:16px}.dss-search-bar:not(.dss-search-bar--show-chips) .dss-search-bar__chips .dss-chip.dss-chip--hide{display:none}.dss-search-bar__chips .dss-chip__counter{cursor:pointer;position:relative;box-sizing:border-box;font-weight:var(--font-semibold);border-radius:var(--dss-radius-xl);border:var(--dss-border-width-sm) solid var(--color-primary-700);box-shadow:none;background-color:var(--color-primary-100);transition:.3s all ease-in;height:24px;font-size:12px;padding:var(--dss-spacing-xxs) var(--dss-spacing-xs);line-height:var(--line-16)}.dss-search-bar__chips .dss-chip__counter:hover{background-color:var(--color-primary-50)}.dss-chip__tooltip{display:none}.dss-chip__tooltip-item{margin-right:var(--dss-spacing-xxs)}.dss-chip__tooltip-item:not(:last-child):after{content:","}.dss-search-bar__chips .dss-chip__counter:hover .dss-chip__tooltip{display:block}',template$7=l=>{var d,h,p,b;const t={"dss-search-bar--invalid":l._invalid||!l._inputValidity,"dss-search-bar--disabled":(d=l._input)==null?void 0:d.disabled,"dss-search-bar--required":(h=l._input)==null?void 0:h.required,"dss-search-bar--read-only":(p=l._input)==null?void 0:p.readOnly,"dss-search-bar--focused":l._isFocused,"dss-search-bar--default":!l._multiple,"dss-search-bar--multiple":l._multiple,"dss-search-bar--show-chips":l._showAllChips,"dss-search-bar--md":l._inputSize==="md","dss-search-bar--has-value":l._showClearButton||((b=l._input)==null?void 0:b.value)||l._searchTerms.length>0},a={},c={};return u`
    <div class="dss-search">
          ...
          <div class="dss-search-bar__container">
            ${l._multiple?u`
                  <div class="dss-search-bar__chips">
                    ${u`${l._generateSearchChips()}`}
                    ${!l._showAllChips&&l._searchTerms.length>5?u`
                          <div class="dss-chip__counter">
                            ...
                            <dss-tooltip
                              ...
                              noHeightLimit
                            >
                              ${l._searchTerms.slice(5,l._searchTerms.length).map(g=>u`<span class="dss-chip__tooltip-item">
                                      ${g}
                                    </span>`)}
                            </dss-tooltip>
                          </div>
        ...
        ${l._helpText?u`
            ...
            `:null}
        ${l._showDropdown&&l._catalog&&l._input.value.length>=l._threshold?u`
              <div
                id="search-catalog"
                class="dss-search-dropdown ${e(c)}"
                style=${o(l._searchboxStyle)}
                role="listbox"
                aria-label="Search Catalog"
              >
                ${l._isCatalogLoading?u`
                      <div class="dss-search-catalog--empty">
                        <dss-spinner size="md"></dss-spinner>
                      </div>
                    `:u`
                      ${l._filteredCatalog.length>0?u`
                            ${l._recentSearches?u`
  ...
  `};var __defProp$A=Object.defineProperty,__getOwnPropDesc$z=Object.getOwnPropertyDescriptor,__decorateClass$A=(l,t,a,c)=>{for(var d=__getOwnPropDesc$z(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$A(t,a,d),d};class SearchBar extends r$1{constructor(){super(...arguments),this._multiple=!1,this._icon="search",this._placeholder="Escriu per cercar",this._inputSize="lg",this._invalid=!1,this._helpText="",this._isFocused=!1,this._showClearButton=!1,this._threshold=3,this._searchTerms=[],this._catalog=[],this._filteredCatalog=[],this._showDropdown=!1,this._isCatalogLoading=!1,this._emptyDropdownText="Sense resultats per",this._recentSearches=!1,this._recentSearchesText="Últimes cerques",this._dropdownStyle="",this._searchboxStyle="",this._showAllChips=!1,this.observerConfig={attributes:!0,childList:!0,subtree:!0},this.callback=t=>{for(const a of t)a.type==="attributes"&&this.requestUpdate()},this.observer=new MutationObserver(this.callback)}static get styles(){return[r$2(iconStyles),r$2(iconButtonStyles),r$2(chipStyles),r$2(styles$a)]}get _input(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="input"]'))||void 0;return this.requestUpdate(),t==null?void 0:t.assignedElements()[0]}set multiple(t){const a=this._multiple;this._multiple=t,this.requestUpdate("multiple",a)}set icon(t){const a=this._icon;this._icon=t,this.requestUpdate("icon",a)}set inputSize(t){const a=this._inputSize;t==="md"?this._inputSize=t:this._inputSize="lg",this.requestUpdate("inputSize",a)}set helpText(t){const a=this._helpText;this._helpText=t,this.requestUpdate("helpText",a)}set invalid(t){const a=this._invalid;t?this._invalid=t:this._invalid=this._inputValidity?t:!0,this.requestUpdate("invalid",a)}set threshold(t){const a=this._threshold;this._threshold=t,this.requestUpdate("threshold",a)}set searchTerms(t){const a=this._searchTerms;this._searchTerms=t,this.requestUpdate("searchTerms",a)}set catalog(t){const a=this._catalog;this._catalog=t,this.requestUpdate("catalog",a)}set emptyDropdownText(t){const a=this._emptyDropdownText;this._emptyDropdownText=t,this.requestUpdate("emptyDropdownText",a)}set recentSearchesText(t){const a=this._recentSearchesText;this._recentSearchesText=t,this.requestUpdate("recentSearchesText",a)}set recentSearches(t){const a=this._recentSearches;this._recentSearches=t,this.requestUpdate("recentSearches",a)}set isCatalogLoading(t){const a=this._isCatalogLoading;this._isCatalogLoading=t,this.requestUpdate("isCatalogLoading",a)}set dropdownStyle(t){const a=this._dropdownStyle;this._dropdownStyle=t,this.requestUpdate("dropdownStyle",a)}_getSearchStyle(){return`top: ${this.renderRoot.querySelectorAll(".dss-search-bar")[0].offsetHeight+4}px; ${this._dropdownStyle}`}get _inputValidity(){var t;return this._input&&this._input.value!==""?(t=this._input)==null?void 0:t.checkValidity():!0}_handleClick(){this.requestUpdate()}_handleInput(){let t=this._input.value;t.length>=this._threshold?(this._showDropdown=!0,this._filteredCatalog=this._getFilterCatalog(t),this._multiple&&t.endsWith(",")&&(t=t.slice(0,-1),this._searchTerms.push(t),this._input.value="",this._searchTerms.length&&this._dispatchSearchChange()),this._searchboxStyle=this._getSearchStyle(),this.requestUpdate()):this._hideDropdown(),this.requestUpdate()}_handleFocusIn(){this._isFocused=!0,this._showClearButton=!0,this.requestUpdate()}_handleFocusOut(){this._isFocused=!1,this._showClearButton=!1,this.requestUpdate()}_handleKeyDown(t){(t==null?void 0:t.key)==="Enter"?(this._showDropdown=!0,!this._multiple&&this._input.value!==""&&(this._searchTerms=[],this._searchTerms.push(this._input.value),this._dispatchSearchChange(),this._showDropdown=!1),this._searchboxStyle=this._getSearchStyle()):(t==null?void 0:t.key)==="Escape"&&(this._showDropdown=!1),this.requestUpdate()}_focusInput(){var t;(t=this._input)==null||t.focus()}_clearSearch(){this._input&&(this._input.value="",this._input.focus()),this._searchTerms=[],this._dispatchSearchChange(),this._hideDropdown(),this.requestUpdate()}_hideDropdown(){this._showDropdown=!1,this._filteredCatalog=[]}_getFilterCatalog(t){return this._catalog.filter(a=>a.value.toLowerCase().includes(t.toLowerCase()))}_generateSearchChips(){let t=0;return this._searchTerms.map(c=>{var b,g,f,$,v;const d=m=>{const y=m.target.getAttribute("term");this._searchTerms=this._searchTerms.filter(k=>k!==y),this._dispatchSearchChange(),this.requestUpdate()};t+=1;const h={disabled:((b=this._input)==null?void 0:b.disabled)||((g=this._input)==null?void 0:g.readOnly),"dss-chip--selected":!((f=this._input)!=null&&f.disabled)&&!(($=this._input)!=null&&$.readOnly),"dss-chip--hide":t>5};return x`
      ...
      `})}_generateFilterCatalog(){let t=!0;return this._filteredCatalog.map(c=>{const d=v=>{const m=v.target.getAttribute("value");m&&(this._multiple?this._searchTerms.includes(m)?this._searchTerms=this._searchTerms.filter(k=>k!==m):this._searchTerms.push(m):(this._input.value=m,this._showDropdown=!1,this._searchTerms=[],this._searchTerms.push(m)),this.requestUpdate(),this._dispatchSearchChange())},h=v=>{v&&v.focus()},p=v=>{let m=0;const y=this.renderRoot.querySelectorAll(".dss-catalog-item"),k=y.length-1;v===y[0]?h(y[k]):(y.forEach((w,_)=>{w===v&&(m=_)}),h(y[m-1]))},b=v=>{let m=0;const y=this.renderRoot.querySelectorAll(".dss-catalog-item"),k=y.length-1;v===y[k]?h(y[0]):(y.forEach((w,_)=>{w===v&&(m=_)}),h(y[m+1]))},g=v=>{const m=v.currentTarget,y=v;let k=!1;switch(y.key){case"ArrowUp":p(m),k=!0;break;case"ArrowDown":b(m),k=!0;break;case"Enter":const w=v.target,_=this.renderRoot.querySelector('.dss-catalog-item[tabindex="0"]');_==null||_.setAttribute("tabindex","-1"),v.target.setAttribute("tabindex","0"),w.click(),k=!0;break}k&&(v.stopPropagation(),v.preventDefault())},f={"dss-catalog-item--selected":this._searchTerms.includes(c.value)},$=x`
        <div
          class="dss-catalog-item ${e(f)}"
          value="${c.value}"
          tabindex="${t?0:-1}"
          @click="${d}"
          @keydown=${g}
      ...
      `,k=x`<span
        ...
        style="visibility: ${m}"
      ></span>`,w=D=>{this._manuallySelect(D,c.value)},_=D=>{var q,U,P,I;if(D.key==="Enter"||D.key===" ")this._manuallySelect(D,c.value);else if(D.key==="ArrowUp"){const L=D.target,O=(U=(q=L==null?void 0:L.closest(".dss-form-field"))==null?void 0:q.previousElementSibling)==null?void 0:U.querySelector("input");O==null||O.focus()}else if(D.key==="ArrowDown"){const L=D.target,O=(I=(P=L==null?void 0:L.closest(".dss-form-field"))==null?void 0:P.nextElementSibling)==null?void 0:I.querySelector("input");O==null||O.focus()}},[C,S]=this._getIndexSubtext(c.label);let T=x`${c.label}`;if(C!==-1&&S!==-1){const D=c.label.slice(0,C),q=c.label.slice(C,S),U=c.label.slice(S);T=x`${D}<span class="bold">${q}</span>${U}`}return x`
        <div
          class="${$}"
          @keyup="${_}"
          @click="${w}"
      ...
      `})}generatElementSelectAll(){var a;return(a=this._elementSelectAll)==null?void 0:a.map(c=>{const d=e({disabled:this._disabled,"dss-form-field":!0,"dss-type--default":this._type==="default","dss-type--green":this._type==="green","dss-selectAll":!0,"dss-disabled":this._disabled}),h=e({"dss-checkbox":this._multiple}),p=x`
        <input
          id="${this._elementId}"
      ...
      `;return x`
        <div
          class="${d}"
          @keyup="${f=>{var $,v,m,y;if(f.key==="Enter"||f.key===" ")this._manuallySelectAll(f);else if(f.key==="ArrowUp"){const k=f.target,w=(v=($=k==null?void 0:k.closest(".dss-form-field"))==null?void 0:$.previousElementSibling)==null?void 0:v.querySelector("input");w==null||w.focus()}else if(f.key==="ArrowDown"){const k=f.target,w=(y=(m=k==null?void 0:k.closest(".dss-form-field"))==null?void 0:m.nextElementSibling)==null?void 0:y.querySelector("input");w==null||w.focus()}}}"
          @click="${f=>{this._manuallySelectAll(f)}}"
          role="option"
        >
          ${p}
          <label for="${this._elementId}">${c}</label>
        </div>
      `})}render(){let t=this.generateListInputsElements();const a=this.generatElementSelectAll();this._multiple&&this._selectAll&&(t==null||t.unshift(a[0]),t=(t==null?void 0:t.length)===1?[]:t);const c=d=>{(d.key==="ArrowDown"||d.key==="ArrowUp")&&d.preventDefault()};return x`
      ${this._elements&&this._elements.length>0?x`
          ...
          `}
    `}}__decorateClass$z([n$1(booleanType)],Selector.prototype,"multiple");__decorateClass$z([n$1(booleanType)],Selector.prototype,"tick");__decorateClass$z([n$1(booleanType)],Selector.prototype,"deselectable");__decorateClass$z([n$1(booleanType)],Selector.prototype,"disabled");__decorateClass$z([n$1({type:Array})],Selector.prototype,"elements");__decorateClass$z([n$1(selectedType)],Selector.prototype,"selectedValue");__decorateClass$z([n$1({type:String})],Selector.prototype,"type");__decorateClass$z([n$1({type:String})],Selector.prototype,"boxStyle");__decorateClass$z([n$1({type:String})],Selector.prototype,"filtre");__decorateClass$z([n$1({type:String})],Selector.prototype,"labelSelectAll");__decorateClass$z([n$1({type:String})],Selector.prototype,"labelDeselectAll");__decorateClass$z([n$1(booleanType)],Selector.prototype,"selectAll");__decorateClass$z([n$1({type:Number})],Selector.prototype,"filterThreshold");__decorateClass$z([n$1({type:Number})],Selector.prototype,"elementsSelected");__decorateClass$z([n$1({type:String})],Selector.prototype,"ariaLabel");const sidemenuListItemStyles=":host{display:block;width:100%}.dss-sidemenu-list-item{cursor:pointer;box-sizing:border-box;height:40px;width:40px;display:flex;align-items:center;gap:var(--dss-spacing-xs);padding:var(--dss-spacing-xs);background-color:var(--color-primary-700);border-radius:var(--dss-radius-sm);font-size:14px;line-height:24px;font-weight:var(--font-semibold);transition:background-color .3s ease-in-out}.dss-sidemenu-list-item:not(:disabled):not(.dss-sidemenu-list-item--disabled):hover{background-color:var(--color-primary-900)}.dss-sidemenu-list-item:not(:disabled):not(.dss-sidemenu-list-item--disabled):active{background-color:var(--color-primary-800)}.dss-sidemenu-list-item:not(.dss-sidemenu-list-item--disabled):focus-visible{outline:var(--dss-border-width-lg) solid var(--color-blue-200)}.dss-sidemenu-list-item:disabled{color:var(--color-neutral-100);cursor:not-allowed}.dss-sidemenu-list-item--selected:not(.dss-sidemenu-list-item--disabled):not(:hover){box-shadow:inset 0 0 0 var(--dss-border-width-sm) var(--color-white)}.dss-sidemenu-list-item--disabled{cursor:not-allowed;color:var(--color-neutral-100)}.dss-sidemenu-list-item--expanded{width:100%}.dss-sidemenu-list-item__icon{position:relative;display:flex;align-items:center;justify-content:center}.dss-sidemenu-list-item__notification{position:absolute;top:-4px;right:-4px;display:block;z-index:800}.dss-sidemenu-list-item__notification--expanded{top:-8px;right:-8px}.dss-sidemenu-list-item__label{flex:1}.dss-sidemenu-list-item__tooltip{opacity:0;visibility:hidden;transition:opacity .5s ease-in,visibility .5s ease-in}.dss-sidemenu-list-item--collapsed:focus-visible .dss-sidemenu-list-item__tooltip,.dss-sidemenu-list-item--collapsed:hover .dss-sidemenu-list-item__tooltip{animation:show-tooltip 1s forwards}@keyframes show-tooltip{0%{opacity:0;visibility:hidden}99%{visibility:hidden}to{opacity:1;visibility:visible}}",dssTooltip=i`dss-tooltip${s(getCustomElementSuffix())}`,dssNotificationBadge=i`dss-notification-badge${s(getCustomElementSuffix())}`,sidemenuListItemTemplate=l=>u`
  <li
    role="menuitem"
    class=${e({"dss-sidemenu-list-item":!0,"dss-sidemenu-list-item--expanded":!!l._expanded,"dss-sidemenu-list-item--collapsed":!l._expanded,"dss-sidemenu-list-item--selected":!!l._selected,"dss-sidemenu-list-item--disabled":!!l._disabled})}
  ...
  >
    <span class="dss-sidemenu-list-item__icon">
      <i class="dss-icon dss-icon--md ">${l._icon}</i>
      ${l._notifications&&!l._showItemDropdown&&!l._selected?u`
            <${dssNotificationBadge}
              class=${e({"dss-sidemenu-list-item__notification":!0,"dss-sidemenu-list-item__notification--expanded":!!l._expanded})}
              ?dot=${!l._expanded}
              value="${l._notifications}"
              state="succes"
              type="default"
    ...
    ${l._expanded?u`
          ...
          ${l._hasNestedMenu?u` <i class="dss-icon dss-icon--md">chevron_right</i> `:null}
        `:null}
          ...
          >
            ...
            >
              <span class="dss-sidemenu-create__button__content">
                ...
                >
                ${l._createNotifications&&!l._showCreateDropdown?x`
                      <dss-notification-badge
                        class=${e({"dss-sidemenu-create__notification":!0,"dss-sidemenu-create__notification--expanded":!!l._expanded})}
                        ?dot=${!l._expanded}
              ...
              ${l._expanded?x` ${l._createLabel} `:null}
            </button>
...
`;var __defProp$w=Object.defineProperty,__getOwnPropDesc$v=Object.getOwnPropertyDescriptor,__decorateClass$w=(l,t,a,c)=>{for(var d=__getOwnPropDesc$v(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$w(t,a,d),d};class Sidemenu extends r$1{constructor(){super(),this._disabled=!1,this._expanded=!1,this._toggleDisabled=!1,this._toggleLabel="Tancar Menu",this._hideCreateMenu=!1,this._createDisabled=!1,this._createLabel="Crear",this._createMenuPosition="top",this._createNotifications=0,this._showCreateDropdown=!1,this._scrollContainerClass="dss-layout-sidebar",this._dropdown=null,this._handleDocumentClickBound=this._handleDocumentClick.bind(this),this._handleResizeBound=this._handleResize.bind(this),this._handleContainerScrollBound=this._handleContainerScroll.bind(this)}static get styles(){return[r$2(resetStyles),r$2(iconStyles),r$2(sidemenuStyles)]}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this._handleResizeBound),document.addEventListener("click",this._handleDocumentClickBound),this._handleResize()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._handleResizeBound),document.removeEventListener("click",this._handleDocumentClickBound),this._scrollContainer&&this._scrollContainer.removeEventListener("scroll",this._handleContainerScrollBound)}set expanded(t){const a=this._expanded;this._expanded=t,this.requestUpdate("expanded",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}set toggleLabel(t){const a=this._toggleLabel;this._toggleLabel=t,this.requestUpdate("toggleLabel",a)}set createLabel(t){const a=this._createLabel;this._createLabel=t,this.requestUpdate("createLabel",a)}set createMenuPosition(t){const a=this._createMenuPosition;this._createMenuPosition=t,this.requestUpdate("createMenuPosition",a)}set createNotifications(t){const a=this._createNotifications;this._createNotifications=t,this.requestUpdate("createNotifications",a)}set createDisabled(t){const a=this._createDisabled;this._createDisabled=t,this.requestUpdate("createDisabled",a)}set hideCreateMenu(t){const a=this._hideCreateMenu;this._hideCreateMenu=t,this.requestUpdate("hideCreateMenu",a)}set scrollContainerClass(t){const a=this._scrollContainerClass;this._scrollContainerClass=t,this.requestUpdate("scrollContainerClass",a)}get _createNotification(){var t;return((t=this.shadowRoot)==null?void 0:t.querySelector("dss-notification-badge"))||void 0}get _createSection(){var a;return(a=this.shadowRoot)==null?void 0:a.querySelector(".dss-sidemenu-create")}_propagateProperties(){var a;const t=(a=this.shadowRoot)==null?void 0:a.querySelectorAll("slot");t&&t.forEach(c=>{c.assignedElements().forEach(h=>{this._expanded?h.setAttribute("expanded","true"):h.removeAttribute("expanded"),this._scrollContainerClass?h.setAttribute("scrollContainerClass",this._scrollContainerClass):h.removeAttribute("scrollContainerClass")})})}_handleResize(){window.innerWidth<1024?(this.removeAttribute("expanded"),this._toggleDisabled=!0):this._toggleDisabled=!1,this.requestUpdate()}_clickedOutsideCreateMenu(t,a){a.composedPath().includes(t)||this._closeCreateDropdown()}_closeCreateDropdown(){this._showCreateDropdown&&(this._showCreateDropdown=!1,this.requestUpdate())}_handleDocumentClick(t){this._createSection&&this._clickedOutsideCreateMenu(this._createSection,t)}_toggleCreateMenu(){this._showCreateDropdown=!this._showCreateDropdown,this.requestUpdate()}_toggleSidemenu(){this._expanded?this.removeAttribute("expanded"):this.setAttribute("expanded","true")}_handleCreateMouseEnter(){this._createNotification&&this._createNotification.setAttribute("isHover","true")}_handleCreateMouseLeave(){this._createNotification&&this._createNotification.removeAttribute("isHover")}_handleCreateMouseDown(){this._createNotification&&this._createNotification.setAttribute("isActive","true")}_handleCreateFocusout(t){if(this._showCreateDropdown){const a=t.relatedTarget;a===null&&this._closeCreateDropdown(),a&&!this._createSection.contains(a)&&a.tagName!=="DSS-ACTION-MENU-ITEM"&&this._closeCreateDropdown()}}_handleCreateMouseUp(){this._createNotification&&this._createNotification.removeAttribute("isActive")}get _scrollContainer(){return document.querySelector(`.${this._scrollContainerClass}`)}_getCreateDropdownFixedPosition(){var c;const a=((c=this.shadowRoot)==null?void 0:c.querySelector(".dss-sidemenu-create")).getBoundingClientRect();this._dropdown&&(this._dropdown.style.left=`${a.right+8}px`,this._dropdown.classList.contains("dss-sidemenu-create__dropdown--top")?this._dropdown.style.top=`${a.top}px`:this._dropdown.style.top=`${a.bottom-this._dropdown.offsetHeight}px`)}_handleContainerScroll(){this._getCreateDropdownFixedPosition()}async firstUpdated(){var a;await this.updateComplete,this._propagateProperties();const t=(a=this.shadowRoot)==null?void 0:a.querySelector(".dss-sidemenu-create__dropdown");t&&(this._dropdown=t,this._getCreateDropdownFixedPosition()),this._scrollContainer&&this._scrollContainer.addEventListener("scroll",this._handleContainerScrollBound)}updated(t){super.updated(t),(t.has("expanded")||t.has("disabled"))&&(this._propagateProperties(),this._getCreateDropdownFixedPosition())}render(){return sidemenuTemplate(this)}}__decorateClass$w([n$1(booleanType)],Sidemenu.prototype,"expanded");__decorateClass$w([n$1(booleanType)],Sidemenu.prototype,"disabled");__decorateClass$w([n$1({type:String})],Sidemenu.prototype,"toggleLabel");__decorateClass$w([n$1({type:String})],Sidemenu.prototype,"createLabel");__decorateClass$w([n$1({type:String})],Sidemenu.prototype,"createMenuPosition");__decorateClass$w([n$1({type:Number})],Sidemenu.prototype,"createNotifications");__decorateClass$w([n$1(booleanType)],Sidemenu.prototype,"createDisabled");__decorateClass$w([n$1(booleanType)],Sidemenu.prototype,"hideCreateMenu");__decorateClass$w([n$1({type:String})],Sidemenu.prototype,"scrollContainerClass");const styles$8='.dss-slider{-webkit-appearance:none;-moz-appearance:none;appearance:none;width:100%;cursor:pointer;outline:none;border-radius:3px;height:4px;background:linear-gradient(to right,var(--color-primary-500) var(--progress),var(--color-neutral-100) var(--progress))}.dss-slider--vertical{transform:rotate(-90deg);transform-origin:center center}.dss-slider::-moz-range-thumb{-webkit-appearance:none;-moz-appearance:none;appearance:none;height:20px;width:20px;background-color:var(--color-primary-500);border-radius:50%;border:var(--dss-border-width-md) solid var(--color-white);-moz-transition:.3s ease-in-out;transition:.3s ease-in-out;box-sizing:border-box}.dss-slider::-webkit-slider-thumb:hover{background-color:var(--color-primary-600);-webkit-transition:all .3s linear;transition:all .3s linear}.dss-slider::-moz-range-thumb:hover{background-color:var(--color-primary-600);-moz-transition:all .3s linear;transition:all .3s linear}.dss-slider:active::-webkit-slider-thumb{background-color:var(--color-primary-400);-webkit-transition:none;transition:none}.dss-slider:active::-moz-range-thumb{background-color:var(--color-primary-400);-moz-transition:none;transition:none}.dss-slider:focus-visible::-webkit-slider-thumb{background-color:var(--color-primary-500);border-color:var(--color-blue-200);outline:2px solid var(--color-blue-200);-webkit-transition:none;transition:none}.dss-slider:focus-visible::-moz-range-thumb{background-color:var(--color-primary-500);border-color:var(--color-blue-200);outline:2px solid var(--color-blue-200);-moz-transition:none;transition:none}.dss-slider:disabled{cursor:not-allowed;background:linear-gradient(to right,var(--color-neutral-400) var(--progress),var(--color-neutral-100) var(--progress))}.dss-slider:disabled::-webkit-slider-thumb{background-color:var(--color-neutral-500);-webkit-transition:none;transition:none}.dss-slider:disabled::-moz-range-thumb{background-color:var(--color-neutral-500);-moz-transition:none;transition:none}.dss-slider:disabled+.dss-slider-tooltip{display:none!important}.dss-slider::-webkit-slider-thumb{-webkit-appearance:none;-moz-appearance:none;appearance:none;height:20px;width:20px;background-color:var(--color-primary-500);border-radius:50%;border:var(--dss-border-width-md) solid var(--color-white);-webkit-transition:.3s ease-in-out;transition:.3s ease-in-out;box-sizing:border-box}.dss-slider:hover+.dss-slider-tooltip{display:block}.dss-slider:focus-visible+.dss-slider-tooltip{display:block}.dss-slider-wrapper{min-width:200px;width:100%;position:relative}.dss-slider-tooltip{display:none;position:absolute;top:-50%}.dss-slider-tooltip--active{display:block}.dss-slider-tooltip .tooltip-wrapper{width:var(--dss-spacing-hg);height:var(--dss-spacing-hg);line-height:24px;text-align:center;background:var(--color-black);color:var(--color-white);font-size:16px;display:flex;align-items:center;justify-content:center;position:absolute;top:-45px;left:calc(50% + 1px);transform:translate(-50%);border-radius:var(--dss-radius-sm);box-shadow:0 4px 8px 3px #0000000d,0 1px 3px #0000001a}.dss-slider-tooltip .tooltip-wrapper:before{content:"";position:absolute;width:0;height:0;border-top:24px solid var(--color-black);border-left:24px solid transparent;border-right:24px solid transparent;top:100%;left:50%;margin-left:-24px;margin-top:-15px}.dss-slider-info{position:absolute;top:calc(100% + 6px);font-size:12px;line-height:16px;color:var(--color-neutral-700)}.dss-slider-info--min{left:0}.dss-slider-info--medium{left:calc(50% - 5px)}.dss-slider-info--max{right:0}.dss-slider--vertical>.dss-slider-tooltip .tooltip-value{transform:rotate(90deg)}.dss-slider--vertical>.dss-slider-info{transform:rotate(90deg);transform-origin:center center;margin-right:-10px}',template$6=l=>{var c;const t={"dss-slider--vertical":l._vertical},a={"dss-slider-tooltip--active":l._isTooltipTouched};return u`
    <div class="dss-slider-wrapper ${e(t)}">
      <input
        ...
        min=${l._min}
        max=${l._max}
        .value=${(c=l._value)==null?void 0:c.toString()}
        step=${l._step}
        direction="${l._orient}"
        @input="${l._handleInput}"
...
`;var __defProp$u=Object.defineProperty,__getOwnPropDesc$t=Object.getOwnPropertyDescriptor,__decorateClass$u=(l,t,a,c)=>{for(var d=__getOwnPropDesc$t(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$u(t,a,d),d};class Spinner extends r$1{constructor(){super(...arguments),this._size="md"}static get styles(){return r$2(styles$7)}set size(t){const a=this._size;this._size=t,this.requestUpdate("size",a)}render(){return template$5(this)}}__decorateClass$u([n$1({type:String})],Spinner.prototype,"size");const splitButtonStyles=".dss-split-button{display:flex;justify-content:center;align-items:center;width:-moz-fit-content;width:fit-content;font-family:var(--font-family)}.dss-split-button .dss-split-button-main:focus-visible,.dss-split-button .dss-split-button-icon:focus-visible{z-index:900}.dss-split-button-main{height:40px;padding-top:var(--dss-spacing-xs);padding-right:var(--dss-spacing-sm);padding-bottom:var(--dss-spacing-xs);padding-left:var(--dss-spacing-lg);box-sizing:border-box;border-radius:0;border-top-left-radius:var(--dss-radius-xl);border-bottom-left-radius:var(--dss-radius-xl);font-size:16px;line-height:24px;font-weight:var(--font-semibold)}.dss-split-button--primary .dss-split-button-main{border-right:var(--dss-border-width-sm) solid var(--color-white)}.dss-split-button--primary .dss-split-button-main:focus-visible{border-right:transparent}.dss-split-button--primary.dss-split-button--disabled .dss-split-button-main{border-right:var(--dss-border-width-sm) solid var(--color-neutral-500)}.dss-split-button-icon{height:40px;padding-top:var(--dss-spacing-xs);padding-right:var(--dss-spacing-md);padding-bottom:var(--dss-spacing-xs);padding-left:var(--dss-spacing-xs);box-sizing:border-box;border-radius:0;border-top-right-radius:var(--dss-radius-xl);border-bottom-right-radius:var(--dss-radius-xl);border-left:0}.dss-split-button-icon:hover:enabled{border-left:0}.dss-split-button--open.dss-split-button--primary .dss-split-button-icon:not(:disabled){background-color:var(--color-primary-700)}.dss-split-button--open.dss-split-button--secondary .dss-split-button-icon:not(:disabled){background-color:var(--color-primary-100)}.dss-split-button--md .dss-split-button-main{height:32px;font-size:14px;padding:var(--dds-spacing-xxs, 4px) var(--dds-spacing-xs, 8px) var(--dds-spacing-xxs, 4px) var(--dds-spacing-md, 16px)}.dss-split-button--md .dss-split-button-icon{height:32px;padding:var(--dds-spacing-xxs, 4px) var(--dds-spacing-xs, 8px) var(--dds-spacing-xxs, 4px) var(--dds-spacing-xxs, 4px)}.dss-split-button--sm .dss-split-button-main{height:24px;font-size:12px;padding:var(--dds-spacing-xxs, 4px) var(--dds-spacing-xs, 8px) var(--dds-spacing-xxs, 4px) var(--dds-spacing-sm, 12px);line-height:16px}.dss-split-button--sm .dss-split-button-icon{height:24px;padding:0px var(--dds-spacing-xxs, 4px) 0px var(--dss-spacing-tiny, 2px)}.dss-split-button-icon:disabled .dss-icon{color:var(--color-neutral-500)}",splitButtonTemplate=l=>{const t={"dss-split-button--primary":l._type==="primary","dss-split-button--secondary":l._type==="secondary","dss-split-button--open":l._isOpen,"dss-split-button--disabled":l._disabled,[`dss-split-button--${l._size}`]:!!l._size},a={"dss-button--primary":l._type==="primary","dss-button--secondary":l._type==="secondary"};return x`
  ...
  `};var __defProp$t=Object.defineProperty,__getOwnPropDesc$s=Object.getOwnPropertyDescriptor,__decorateClass$t=(l,t,a,c)=>{for(var d=__getOwnPropDesc$s(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$t(t,a,d),d};class SplitButton extends r$1{constructor(){super(),this._size="lg",this._iconClose="expand_more",this._iconOpen="expand_less",this._type="primary",this._text="",this._disabled=!1,this._isOpen=!1,this._dropdownPosition="bottom-right",this._hasMenu=!1,this._handleDocumentClickBound=this._handleDocumentClick.bind(this)}static get styles(){return[r$2(iconStyles),r$2(buttonStyles),r$2(splitButtonStyles)]}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._handleDocumentClickBound)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleDocumentClickBound)}set iconClose(t){const a=this._iconClose;this._iconClose=t,this.requestUpdate("iconClose",a)}set iconOpen(t){const a=this._iconOpen;this._iconOpen=t,this.requestUpdate("iconOpen",a)}set type(t){const a=this._type;this._type=t,this.requestUpdate("type",a)}set text(t){const a=this._text;this._text=t,this.requestUpdate("text",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}set isOpen(t){const a=this._isOpen;this._isOpen=t,this.requestUpdate("disabled",a)}set size(t){const a=this._size;t==="md"||t==="sm"?this._size=t:this._size="lg",this.requestUpdate("size",a)}set dropdownPosition(t){const a=this._dropdownPosition;this._dropdownPosition=t,this.requestUpdate("dropdownPosition",a)}set hasMenu(t){const a=this._hasMenu;this._hasMenu=t,this.requestUpdate("hasMenu",a)}_dispatchMainClick(){const t={bubbles:!1,composed:!1};this.dispatchEvent(new CustomEvent("onClick",t))}_dispatchIconClick(){this._hasMenu&&this._toggleMenu();const t={bubbles:!1,composed:!1};this.dispatchEvent(new CustomEvent("onSecondaryClick",t))}_toggleMenu(){this._isOpen=!this._isOpen,this.requestUpdate()}_handleDocumentClick(t){this._clickedOutsideItem(this,t)}_clickedOutsideItem(t,a){a.composedPath().includes(t)||this._isOpen&&(this._isOpen=!1,this.requestUpdate())}render(){return splitButtonTemplate(this)}}__decorateClass$t([n$1({type:String})],SplitButton.prototype,"iconClose");__decorateClass$t([n$1({type:String})],SplitButton.prototype,"iconOpen");__decorateClass$t([n$1({type:String})],SplitButton.prototype,"type");__decorateClass$t([n$1({type:String})],SplitButton.prototype,"text");__decorateClass$t([n$1(booleanType)],SplitButton.prototype,"disabled");__decorateClass$t([n$1(booleanType)],SplitButton.prototype,"isOpen");__decorateClass$t([n$1({type:String})],SplitButton.prototype,"size");__decorateClass$t([n$1({type:String})],SplitButton.prototype,"dropdownPosition");__decorateClass$t([n$1(booleanType)],SplitButton.prototype,"hasMenu");const styles$6=':host{display:inline-block;height:100%;width:100%;--circle: 32px;--circle-md: 24px;--circle-sm: 16px;--default-background: var(--color-white);--default-border-color: var(--color-neutral-500);--default-font-color: var(--color-neutral-900);--default-background-hover: var(--color-neutral-50);--default-font-color-active: var(--color-neutral-500);--active-background: var(--color-primary-500);--active-border-color: var(--color-primary-500);--active-font-color: var(--color-white);--completed-background: var(--color-primary-50);--disabled-background: var(--color-neutral-100);--disabled-border-color: var(--color-neutral-100);--disabled-font-color: var(--color-neutral-600);--line-width: 2px;--font-size: 18px;--font-size-md: 16px;--font-size-sm: 16px}.dss-circular-stepper{display:flex;gap:16px;align-items:center}.dss-circular-stepper__item{width:3rem;height:3rem;position:relative}.dss-circular-stepper__item svg{width:3rem;height:3rem;transform:rotate(-90deg)}.dss-circular-stepper__counter{position:absolute;font-size:.9rem;line-height:24px;left:0;top:0;width:3rem;height:3rem;display:flex;justify-content:center;align-items:center}.dss-circular-stepper__label,.dss-circular-stepper__counter b{font-weight:600;color:var(--color-neutral-700);font-size:.9rem;transition:.3s all ease-in;line-height:24px}.dss-circular-stepper circle{stroke:var(--color-neutral-200);stroke-dashoffset:0;fill:none;stroke-linecap:round;stroke-width:6px;stroke-dasharray:100,100;transition:.3s all ease-in}.dss-circular-stepper circle:last-of-type{stroke:var(--color-primary-500);stroke-dasharray:var(--percent),100;stroke-dashoffset:0}.dss-stepper{display:flex;list-style:none;justify-content:space-between;background:linear-gradient(var(--default-border-color) 0 0) no-repeat 50% calc((var(--circle) - var(--line-width)) / 2) / 100% var(--line-width);margin:var(--dss-spacing-xxs) 0 var(--dss-spacing-xl);padding:0;counter-reset:step}.dss-stepper--md{background:linear-gradient(var(--default-border-color) 0 0) no-repeat 50% calc((var(--circle-md) - var(--line-width)) / 2) / 100% var(--line-width)}.dss-stepper--sm{background:linear-gradient(var(--default-border-color) 0 0) no-repeat 50% calc((var(--circle-sm) - var(--line-width)) / 2) / 100% var(--line-width)}.dss-bubble{display:grid;place-items:center;gap:0;position:relative;border-radius:50%;transition:.3s outline ease-in}.dss-bubble:focus-visible{outline:var(--dss-border-width-lg) solid var(--color-blue-200)}.dss-bubble:before{cursor:pointer;content:counter(step) " ";counter-increment:step;display:grid;place-content:center;aspect-ratio:1;height:var(--circle);box-sizing:border-box;border-radius:50%;font-size:var(--font-size);font-weight:var(--font-semibold);font-family:var(--font-family);z-index:100;background-color:var(--default-background);border:var(--line-width) solid var(--active-border-color);color:var(--default-font-color);transition:.3s all ease-in}.dss-bubble:not(.dss-bubble--active):not(:active):hover:before{background-color:var(--completed-background)}.dss-stepper--md .dss-bubble:before{height:var(--circle-md);font-size:var(--font-size-md)}.dss-stepper--sm .dss-bubble:before{content:"";height:var(--circle-sm);font-size:var(--font-size-sm);height:16px;width:16px}.dss-bubble--active:before{background-color:var(--active-background);border-color:var(--active-border-color);color:var(--active-font-color)}.dss-bubble--active~.dss-bubble:before{background-color:var(--default-background);border-color:var(--default-border-color);color:var(--default-font-color)}.dss-bubble--active~.dss-bubble:not(.dss-bubble--active):hover:before{background-color:var(--default-background-hover)}.dss-bubble--active~.dss-bubble:active:before{background-color:var(--default-background);color:var(--default-font-color-active)}.dss-bubble--icon:before{content:attr(icon);font-family:var(--font-icons);font-weight:400}.dss-bubble--checked:before{content:"done";font-family:var(--font-icons);font-weight:400;font-size:24px;color:var(--color-primary-500)!important}.dss-stepper--sm .dss-bubble--checked:before{content:"check_circle";background-color:var(--color-primary-500);color:var(--color-white)!important;border-width:1px!important}.dss-stepper--sm .dss-bubble--checked:hover:before{border-color:var(--color-white);color:var(--color-primary-500)!important}.dss-bubble--checked:active:before{background-color:var(--color-white);color:var(--color-primary-300)!important;border-color:var(--color-primary-500)!important}.dss-stepper--sm .dss-bubble--checked:active:before{border-color:var(--color-white)!important;color:var(--color-primary-300)!important}.dss-bubble--info:before,.dss-bubble--active~.dss-bubble.dss-bubble--info:before{content:"info_i";font-family:var(--font-icons);font-weight:400;background-color:var(--color-white);color:var(--color-blue-500);border-color:var(--color-blue-500)}.dss-bubble--info:hover:before,.dss-bubble--active~.dss-bubble.dss-bubble--info:hover:before{background-color:var(--color-blue-50)!important}.dss-bubble--info:active:before,.dss-bubble--active~.dss-bubble.dss-bubble--info:not(.dss-bubble--active):active:before{color:var(--color-blue-300)!important;background-color:var(--color-white)!important}.dss-stepper--sm .dss-bubble--info:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--info:before{content:"info";background-color:var(--color-blue-500);border-color:var(--color-blue-500);color:var(--color-white)!important;border-width:1px!important}.dss-stepper--sm .dss-bubble--info:hover:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--info:hover:before{background-color:var(--color-blue-50)!important;border-color:var(--color-white);color:var(--color-blue-500)!important}.dss-stepper--sm .dss-bubble--info:active:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--info:active:before{background-color:var(--color-white)!important;border-color:var(--color-white)!important;color:var(--color-blue-300)!important}.dss-bubble--alert:before,.dss-bubble--active~.dss-bubble.dss-bubble--alert:before{content:"priority_high";font-family:var(--font-icons);font-weight:400;background-color:var(--color-white);color:var(--color-yellow-800);border-color:var(--color-yellow-800)}.dss-bubble--alert:not(:active):hover:before{background-color:var(--color-yellow-50)!important}.dss-bubble--alert:active:before,.dss-bubble--active~.dss-bubble.dss-bubble--alert:active:before{color:var(--color-yellow-700)!important;background-color:var(--color-white)}.dss-stepper--sm .dss-bubble--alert:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--alert:before{content:"error";background-color:var(--color-yellow-800);border-color:var(--color-yellow-800);color:var(--color-white)!important;border-width:1px!important}.dss-stepper--sm .dss-bubble--alert:hover:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--alert:hover:before{background-color:var(--color-yellow-50)!important;border-color:var(--color-white);color:var(--color-yellow-800)!important}.dss-stepper--sm .dss-bubble--alert:active:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--alert:active:before{background-color:var(--color-white)!important;border-color:var(--color-white)!important;color:var(--color-yellow-700)!important}.dss-bubble--error:before,.dss-bubble--active~.dss-bubble.dss-bubble--error:before{content:"close";font-family:var(--font-icons);font-weight:400;background-color:var(--color-white);color:var(--color-red-500);border-color:var(--color-red-500)}.dss-bubble--error:active:before,.dss-bubble--active~.dss-bubble.dss-bubble--error:active:before{color:var(--color-red-300)!important;background-color:var(--color-white)}.dss-stepper--sm .dss-bubble--error:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--error:before{content:"cancel";background-color:var(--color-red-500);border-color:var(--color-red-500);color:var(--color-white)!important;border-width:1px!important}.dss-stepper--sm .dss-bubble--error:hover:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--error:hover:before{background-color:var(--color-red-50)!important;border-color:var(--color-white);color:var(--color-red-500)!important}.dss-stepper--sm .dss-bubble--error:active:before,.dss-stepper--sm .dss-bubble--active~.dss-bubble.dss-bubble--error:active:before{background-color:var(--color-white)!important;border-color:var(--color-white)!important;color:var(--color-red-300)!important}.dss-bubble--disabled:before{cursor:not-allowed;background-color:var(--disabled-background)!important;border-color:var(--disabled-border-color)!important;color:var(--disabled-font-color)!important}.dss-stepper--vertical .dss-bubble:not(:first-child){margin-top:var(--dss-spacing-lg)}.dss-bubble--error:not(:active):hover:before{background-color:var(--color-red-50)!important}.dss-bubble--error:active:before{color:var(--color-red-300)!important}.dss-stepper--sm .dss-bubble--error:before{content:"cancel";background-color:var(--color-red-500);border-color:var(--color-red-500);color:var(--color-white)!important;border-width:1px!important}.dss-stepper--sm .dss-bubble--error:hover:before{background-color:var(--color-red-50)!important;border-color:var(--color-white);color:var(--color-red-500)!important}.dss-stepper--sm .dss-bubble--error:active:before{background-color:var(--color-white)!important;border-color:var(--color-white)!important;color:var(--color-red-300)!important}.dss-bubble--disabled:before{cursor:not-allowed;background:var(--disabled-background)!important;border-color:var(--disabled-border-color)!important;color:var(--disabled-font-color)!important}.dss-bubble--completed:not(:first-child):after{content:"";position:absolute;height:var(--line-width);right:0;top:calc((var(--circle) - var(--line-width)) / 2);width:var(--active-bar-width);background:var(--active-background)}.dss-bubble--active:not(:first-child):after{content:"";position:absolute;height:var(--line-width);right:0;top:calc((var(--circle) - var(--line-width)) / 2);width:var(--active-bar-width);background:var(--active-background);animation:animate .3s}.dss-stepper--md .dss-bubble--completed:not(:first-child):after{top:calc((var(--circle-md) - var(--line-width)) / 2)}.dss-stepper--md .dss-bubble--active:not(:first-child):after{top:calc((var(--circle-md) - var(--line-width)) / 2)}.dss-stepper--sm .dss-bubble--completed:not(:first-child):after{top:calc((var(--circle-sm) - var(--line-width)) / 2)}.dss-stepper--sm .dss-bubble--active:not(:first-child):after{top:calc((var(--circle-sm) - var(--line-width)) / 2)}.dss-stepper--vertical{height:100%;flex-direction:column;gap:0;background:linear-gradient(var(--default-border-color) 0 0) no-repeat calc((var(--circle) - var(--line-width)) / 2) 50% / var(--line-width) 100%}.dss-stepper--vertical .dss-bubble{display:flex;width:-moz-fit-content;width:fit-content}.dss-stepper--vertical .dss-bubble--completed:not(:first-child):after{content:"";position:absolute;width:var(--line-width);bottom:0;left:calc((var(--circle) - var(--line-width)) / 2);top:auto;right:auto;height:var(--active-bar-width);background:var(--active-background)}.dss-stepper--vertical .dss-bubble--active:not(:first-child):after{content:"";position:absolute;width:var(--line-width);bottom:0;left:calc((var(--circle) - var(--line-width)) / 2);top:auto;right:auto;height:var(--active-bar-width);background:var(--active-background);animation:column-animate .5s}.dss-stepper--md.dss-stepper--vertical{background:linear-gradient(var(--default-border-color) 0 0) no-repeat calc((var(--circle-md) - var(--line-width)) / 2) 50% / var(--line-width) 100%}.dss-stepper--sm.dss-stepper--vertical{background:linear-gradient(var(--default-border-color) 0 0) no-repeat calc((var(--circle-sm) - var(--line-width)) / 2) 50% / var(--line-width) 100%}.dss-stepper--md.dss-stepper--vertical .dss-bubble--completed:not(:first-child):after{left:calc((var(--circle-md) - var(--line-width)) / 2)}.dss-stepper--sm.dss-stepper--vertical .dss-bubble--completed:not(:first-child):after{left:calc((var(--circle-sm) - var(--line-width)) / 2)}.dss-stepper--md.dss-stepper--vertical .dss-bubble--active:not(:first-child):after{left:calc((var(--circle-md) - var(--line-width)) / 2)}.dss-stepper--sm.dss-stepper--vertical .dss-bubble--active:not(:first-child):after{left:calc((var(--circle-sm) - var(--line-width)) / 2)}.dss-stepper:not(.dss-stepper--vertical) .dss-bubble-label{position:absolute;top:calc(100% + var(--dss-spacing-xxs));left:50%;transform:translate(-50%)}.dss-bubble-label{width:-moz-max-content;width:max-content;font-weight:var(--font-regular);font-size:14px;color:var(--color-neutral-700)}.dss-bubble-label--disabled{color:var(--color-neutral-500)}.dss-bubble--active .dss-bubble-label{color:var(--color-neutral-700);font-weight:var(--font-semibold)}.dss-stepper--vertical .dss-bubble-label{position:absolute;left:calc(100% + var(--dss-spacing-xs));top:50%;transform:translateY(-50%)}.dss-bubble-label.hide-label{display:none}@keyframes animate{0%{width:0}to{width:100%}}@keyframes column-animate{0%{height:0}to{height:100%}}';var __defProp$s=Object.defineProperty,__getOwnPropDesc$r=Object.getOwnPropertyDescriptor,__decorateClass$s=(l,t,a,c)=>{for(var d=__getOwnPropDesc$r(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$s(t,a,d),d};class Stepper extends r$1{constructor(){super(...arguments),this._steps=[],this._currentStep=1,this._column=!1,this._circular=!1,this._hideLabel=!1,this._size="md",this._activeBarWidth="0",this._isFirstUpdate=!0}static get styles(){return r$2(styles$6)}set steps(steps){const oldValue=this._steps;this._steps=steps,typeof steps=="string"&&(this._steps=eval(`(${steps})`)),this.requestUpdate("steps",oldValue)}set currentStep(l){const t=this._currentStep;this._currentStep=l,this.requestUpdate("currentStep",t)}set column(l){const t=this._column;this._column=l,this.requestUpdate("column",t)}set circular(l){const t=this._circular;this._circular=l,this.requestUpdate("circular",t)}set hideLabel(l){const t=this._hideLabel;this._hideLabel=l,this.requestUpdate("hideLabel",t)}set size(l){const t=this._size;this._size=l,this.requestUpdate("size",t)}async firstUpdated(){await this.updateComplete,this._setActiveBarWidth(),this._isFirstUpdate=!1,this.requestUpdate()}willUpdate(l){this._isFirstUpdate||(l.has("currentStep")||l.has("steps")||l.has("column"))&&(this._setActiveBarWidth(),this.requestUpdate())}_setActiveBarWidth(){var d;const l=this._steps.length,t=(d=this.shadowRoot)==null?void 0:d.querySelector(".dss-stepper"),a=t==null?void 0:t.getBoundingClientRect(),c=this._column?a==null?void 0:a.height:a==null?void 0:a.width;if(c){const h=Math.floor(c/(l-1));this._activeBarWidth=`${h}px`}}_onStepClick(l,t){if(!(l.state==="disabled")){const c={detail:{step:l,stepNumber:t},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onStepClick",c))}}render(){var c,d;const l=(c=this._steps)==null?void 0:c.length,t=Math.round(this._currentStep/l*100),a={"dss-stepper--vertical":this._column,"dss-stepper--sm":this._size==="sm","dss-stepper--md":this._size==="md"};return x`
    ...
    `}}__decorateClass$q([n$1({type:Number})],TablePagination.prototype,"length");__decorateClass$q([n$1({type:Number})],TablePagination.prototype,"pageSize");__decorateClass$q([n$1({type:Array})],TablePagination.prototype,"pageSizeOptions");__decorateClass$q([n$1(booleanType)],TablePagination.prototype,"pageSizeOptionsDisabled");__decorateClass$q([n$1({type:String})],TablePagination.prototype,"currentIndex");__decorateClass$q([n$1({type:String})],TablePagination.prototype,"rowsPerPageText");__decorateClass$q([n$1({type:String})],TablePagination.prototype,"resultsText");__decorateClass$q([n$1(booleanType)],TablePagination.prototype,"hidePaginationResults");const tabsListStyles=':host{width:100%;height:-moz-fit-content;height:fit-content}:not(:defined){display:none}.dss-tabs{width:100%;height:-moz-fit-content;height:fit-content}.dss-tabs-header{display:flex;align-items:center;position:relative;width:100%;overflow:hidden}.dss-tabs-scroll-button{all:unset;cursor:pointer;display:none;position:absolute;top:0;bottom:0;padding:0 var(--dss-spacing-sm);z-index:900}.dss-tabs-scroll-button:before{content:"";display:block;position:absolute;top:0;bottom:2px;width:220px;z-index:-1;pointer-events:none}.dss-tabs-scroll-button--prev{left:0;padding-right:var(--dss-spacing-lg)}.dss-tabs-scroll-button.dss-tabs-scroll-button--prev:before{left:0;background:linear-gradient(to right,white,transparent)}.dss-tabs-scroll-button--next{right:0;padding-left:var(--dss-spacing-lg)}.dss-tabs-scroll-button.dss-tabs-scroll-button--next:before{right:0;background:linear-gradient(to left,white,transparent)}.dss-tabs-menu{box-sizing:border-box;min-height:48px;min-width:100%;display:flex;overflow-x:auto;scroll-behavior:smooth;-ms-overflow-style:none;scrollbar-width:none;border-bottom:var(--dss-border-width-sm) solid var(--color-neutral-200)}.dss-tabs-menu::-webkit-scrollbar{display:none}.dss-tabs-item{position:relative;white-space:nowrap;box-sizing:border-box;min-height:48px;display:flex;align-items:center;font-family:var(--font-family);font-size:14px;font-weight:600;line-height:24px;background-color:transparent;border:0;cursor:pointer;padding:var(--dss-spacing-sm);transition:color .3s ease-in-out}.dss-tabs-item:focus-visible{outline:var(--color-primary-200) solid var(--dss-border-width-lg);border-radius:var(--dss-radius-xs)}.dss-tabs-item:not(.dss-tabs-item--selected):not(:disabled):hover{color:var(--color-primary-600)}.dss-tabs-item:active{color:var(--color-primary-700)}.dss-tabs-item:disabled{color:var(--color-neutral-500);cursor:not-allowed}.dss-tabs-item:before{position:absolute;content:"";display:block;width:100%;height:var(--dss-border-width-md);background-color:transparent;left:0;bottom:-1px;transition:background-color .3s ease-in-out;border-radius:var(--dss-border-width-md)}.dss-tabs-item.dss-tabs-item--selected:before{background-color:var(--color-primary-500)}.dss-tabs-button{margin:0}::slotted(dss-icon-badge),::slotted(dss-notification-badge),::slotted(dss-badge){display:inline;margin-right:var(--dss-spacing-xs)!important}',tabsListTemplate=l=>x`
  <div class="dss-tabs">
...
`;var __defProp$p=Object.defineProperty,__getOwnPropDesc$o=Object.getOwnPropertyDescriptor,__decorateClass$p=(l,t,a,c)=>{for(var d=__getOwnPropDesc$o(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$p(t,a,d),d};class TabsList extends r$1{constructor(){super(),this._dssTabsId="",this._label="Tabs component name",this._tabs=[],this._tabsElements=window.document.querySelectorAll("[role='tab']"),this._firstTab=document.createElement("div"),this._lastTab=document.createElement("div"),this._addTabEnabled=!1,this._addTabText="Afegir Tab",this._handleUpdateArrowsBound=this._updateArrows.bind(this)}static get styles(){return[r$2(resetStyles),r$2(iconStyles),r$2(tabsListStyles)]}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this._handleUpdateArrowsBound)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._menu)==null||t.removeEventListener("scroll",this._handleUpdateArrowsBound),window.removeEventListener("resize",this._handleUpdateArrowsBound)}set dssTabsId(t){const a=this._dssTabsId;this._dssTabsId=t,this.requestUpdate("dssTabsId",a)}set label(t){const a=this._label;this._label=t,this.requestUpdate("selectedTab",a)}set tabs(t){const a=this._tabs;this._tabs=t,this.requestUpdate("tabs",a)}set addTabText(t){const a=this._addTabText;this._addTabText=t,this.requestUpdate("addTabText",a)}set addTabEnabled(t){const a=this._addTabEnabled;this._addTabEnabled=t,this.requestUpdate("addTabEnabled",a)}get _header(){var t;return((t=this.shadowRoot)==null?void 0:t.querySelector(".dss-tabs-header"))||void 0}get _menu(){var t;return((t=this.shadowRoot)==null?void 0:t.querySelector(".dss-tabs-menu"))||void 0}get _prevScroll(){var t;return((t=this.shadowRoot)==null?void 0:t.querySelector(".dss-tabs-scroll-button--prev"))||void 0}get _nextScroll(){var t;return((t=this.shadowRoot)==null?void 0:t.querySelector(".dss-tabs-scroll-button--next"))||void 0}updated(t){t.has("tabs")&&this.changeTabWatch()}async changeTabWatch(){this._tabsElements=this.renderRoot.querySelectorAll("[role='tab']"),this._tabsElements.forEach(t=>{t.addEventListener("keydown",a=>{this._handleKeydown(a)}),t.addEventListener("click",a=>{this.setSelectedTab(a.currentTarget)})}),this.setFirstAndLastTabs()}setFirstAndLastTabs(){let t=!1;this._tabsElements.forEach(a=>{t||(this._firstTab=a,t=!0),this._lastTab=a})}changeTab(t){const a={detail:{selectedPanel:t},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onChangeDssTab",a)),this.updatePanels(t)}updatePanels(t){window.document.querySelectorAll("dss-tabs-panel").forEach(c=>{const d=c.getAttribute("panelId");c.getAttribute("linkedTo")===this._dssTabsId&&(d===t?c.setAttribute("selected","true"):c.removeAttribute("selected"))})}_handleKeydown(t){const a=t,c=t.currentTarget;let d=!1;switch(a.key){case"ArrowLeft":this.moveFocusToPreviousTab(c),d=!0;break;case"ArrowRight":this.moveFocusToNextTab(c),d=!0;break;case"Home":this.moveFocusToTab(this._firstTab),d=!0;break;case"End":this.moveFocusToTab(this._lastTab),d=!0;break}d&&(t.stopPropagation(),t.preventDefault())}moveFocusToTab(t){t&&t.focus()}moveFocusToPreviousTab(t){let a=0;t===this._firstTab?this.moveFocusToTab(this._lastTab):(this._tabsElements.forEach((c,d)=>{c===t&&(a=d)}),this.moveFocusToTab(this._tabsElements[a-1]))}moveFocusToNextTab(t){let a=0;t===this._lastTab?this.moveFocusToTab(this._firstTab):(this._tabsElements.forEach((c,d)=>{c===t&&(a=d)}),this.moveFocusToTab(this._tabsElements[a+1]))}setSelectedTab(t){for(let a=0;a<this._tabsElements.length;a+=1){const c=this._tabsElements[a];t===c?(c.setAttribute("aria-selected","true"),c.removeAttribute("tabindex"),c.classList.add("dss-tabs-item--selected"),c.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})):(c.setAttribute("aria-selected","false"),c.setAttribute("tabindex","-1"),c.classList.remove("dss-tabs-item--selected"))}}addNewTab(){const t={detail:{},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onAddDssTab",t))}_updateArrows(){if(this._menu&&this._prevScroll&&this._nextScroll){const t=Math.ceil(this._menu.scrollLeft),a=Math.ceil(this._menu.scrollWidth-this._menu.clientWidth);this._prevScroll.style.display=t>0?"block":"none",this._nextScroll.style.display=t<a?"block":"none"}}_scrollMenu(t){this._menu&&this._menu.scrollBy({left:t*160,behavior:"smooth"})}async firstUpdated(){await this.updateComplete,this._menu&&this._menu.addEventListener("scroll",this._handleUpdateArrowsBound),this._updateArrows()}render(){return tabsListTemplate(this)}}__decorateClass$p([n$1({type:String})],TabsList.prototype,"dssTabsId");__decorateClass$p([n$1({type:String})],TabsList.prototype,"label");__decorateClass$p([n$1({type:Array})],TabsList.prototype,"tabs");__decorateClass$p([n$1({type:String})],TabsList.prototype,"addTabText");__decorateClass$p([n$1(booleanType)],TabsList.prototype,"addTabEnabled");const tabsPanelStyles=":host{width:100%;height:-moz-fit-content;height:fit-content}:not(:defined){display:none}[role=tabpanel]{width:100%;display:none}[role=tabpanel].has-scroll{overflow:auto}[role=tabpanel].selected{display:block}",tabsPanelTemplate=l=>{const t={selected:l._selected,"is-hidden":!l._selected,"has-scroll":l._hasScroll};return x`
  ...
  `};var __defProp$n=Object.defineProperty,__getOwnPropDesc$m=Object.getOwnPropertyDescriptor,__decorateClass$n=(l,t,a,c)=>{for(var d=__getOwnPropDesc$m(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$n(t,a,d),d};class Textarea extends r$1{constructor(){super(...arguments),this._maxLength=0,this._isTextareaFocused=!1,this._isGroupFocusedVisible=!1,this._showError=!1}static get styles(){return r$2(styles$3)}set value(t){t!==void 0&&this.requestUpdate()}set showError(t){const a=this._showError;this._showError=t,this.requestUpdate("showError",a)}get _label(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="label"]'))||void 0;return t==null?void 0:t.assignedElements()[0]}get _textarea(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="textarea"]'))||void 0;return t==null?void 0:t.assignedElements()[0]}get _description(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="description"]'))||void 0;return t==null?void 0:t.assignedElements()[0]}async firstUpdated(){try{await this.updateComplete;const{maxLength:t}=this._textarea;this._maxLength=t>0?t:0,this._addEventListeners(),this.requestUpdate()}catch{console.error("ERROR OCURRED")}}_addEventListeners(){this._textarea.addEventListener("input",this._handleInput.bind(this)),this._textarea.addEventListener("focus",this._handleFocus.bind(this)),this._textarea.addEventListener("focusout",this._handleFocusOut.bind(this)),this._textarea.addEventListener("blur",this._handleBlur.bind(this)),this._label.addEventListener("click",this._handelLabelClick.bind(this)),this._textarea.addEventListener("keyup",this._handleKeyup.bind(this))}_handleInput(){this.requestUpdate()}_handleKeyup(t){(t.keyCode?t.keyCode:t.which)===9&&this._handleFocus()}_handleFocus(){this._isGroupFocusedVisible=!0,this._isTextareaFocused=!0,this.requestUpdate()}_handleFocusOut(){this._handleBlur(),this._isGroupFocusedVisible=!1,this._isTextareaFocused=!1,this.requestUpdate()}_handleBlur(){this._isTextareaFocused=!1,this.requestUpdate()}_handelLabelClick(){this._textarea.focus(),this.requestUpdate()}_handleSlotChange(){this.requestUpdate()}render(){return template$4(this)}}__decorateClass$n([n$1({type:String})],Textarea.prototype,"value");__decorateClass$n([n$1(booleanType)],Textarea.prototype,"showError");const styles$2=":host{display:block;height:-moz-fit-content;height:fit-content;min-width:240px;width:100%}.dss-tile{box-sizing:border-box;height:104px;width:100%;overflow:hidden;background-color:var(--color-white);border-radius:var(--dss-radius-md);padding:var(--dss-spacing-md);display:flex;align-items:center;justify-content:flex-start;gap:var(--dss-spacing-md);border:var(--dss-border-width-sm) solid var(--color-neutral-100);transition:background-color .3s ease-in}.dss-tile-logo{display:flex;align-items:center;justify-content:center;box-sizing:border-box;min-width:48px;width:48px;height:48px;margin:0;padding:0;overflow:hidden;border-radius:var(--dss-radius-xs)}.dss-tile-logo__image{width:100%;max-width:100%;margin:0;padding:0}.dss-tile-content{width:100%;display:flex;align-items:center;justify-content:space-between;gap:var(--dss-spacing-md);flex:1 1 100%;min-width:0}.dss-tile-content .dss-tile-content__text{overflow:hidden}.dss-tile-title{display:-webkit-box;-webkit-line-clamp:1;-webkit-box-orient:vertical;max-height:24px;line-height:24px;font-size:14px;font-weight:var(--font-semibold);color:var(--color-neutral-900);margin:0;overflow:hidden}.dss-tile--disabled .dss-tile-title{color:var(--color-neutral-600)}.dss-tile-description{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;max-height:48px;line-height:24px;font-size:14px;color:var(--color-neutral-600);margin:0}.dss-tile--button:not(.dss-tile--disabled){cursor:pointer;border-color:var(--color-primary-600)}.dss-tile--selected:not(.dss-tile--disabled),.dss-tile--button:not(.dss-tile--disabled):hover,.dss-tile--selector:not(.dss-tile--disabled):hover{border:var(--dss-border-width-md) solid var(--color-primary-500)}.dss-tile--button:not(.dss-tile--disabled):active,.dss-tile--selector:not(.dss-tile--disabled):active{background-color:var(--color-primary-50)}.dss-tile--button:not(.dss-tile--disabled):focus-visible,.dss-tile--selector:not(.dss-tile--disabled):focus-visible{border-color:transparent;outline:var(--dss-border-width-lg) solid var(--color-blue-200)}.dss-tile--disabled{cursor:not-allowed;background-color:var(--color-neutral-50)}.dss-tile--disabled .dss-tile__title{color:var(--color-neutral-500)}::slotted(.dss-tile-action-group){display:flex;justify-content:center;align-items:center;gap:var(--dss-spacing-md)}.dss-tile--height-auto{height:auto}.dss-tile--widget{margin-top:var(--dss-spacing-xs)}",template$3=l=>{const t={"dss-tile--button":l._type==="button","dss-tile--selector":l._type==="selector","dss-tile--selected":l._type==="selector"&&l._selected,"dss-tile--action":l._type==="action","dss-tile--disabled":l._disabled,"dss-tile--height-auto":l._heightAuto,"dss-tile--widget":l._widget},a=()=>{const p={"dss-decorative-icon--disabled":l._disabled};return u`
    ...
    `,d=()=>u`
      <div class="dss-tile-content">
        <div class="dss-tile-content__text">
          <h4 class="dss-tile-title">${l._tileTitle}</h4>
          <p class="dss-tile-description">${l._description}</p>
        </div>
        ${l._type==="action"?u` <slot name="action"></slot> `:null}
      </div>
    `;let h=u``;return l._type==="button"||l._type==="selector"?h=u`
      <div
        class="dss-tile ${e(t)}"
        tabindex="${l._disabled?-1:0}"
        role="button"
    ...
    <div class="dss-timepicker">
      ...
      ${l._helpText?u`
          ...
          `:null}
      ${l._dropdown&&l._dropdown==="list"?u`
            <div
            ...
            >
              <div class="dss-timepicker-dropdown__container">
                ${u`${l._generateTimeListOptionsHTML(l._timeListOptions,l._customTimeListOptions)}`}
              </div>
            </div>
          `:null}
      ${l._dropdown&&l._dropdown==="manual"?u`
            <div
              id="timepicker-options"
            ...
            >
              ...
              <div class="dss-timepicker-dropdown__actions">
                <button
                  ...
                  @click=${l._timeManualSelectorCancel}
                >
                  Cancel-lar
                </button>
                <button
                  ...
                  @click=${l._timeManualSelectorAccept}
                >
                  Seleccionar
                </button>
              </div>
  ...
  `};var __defProp$l=Object.defineProperty,__getOwnPropDesc$k=Object.getOwnPropertyDescriptor,__decorateClass$l=(l,t,a,c)=>{for(var d=__getOwnPropDesc$k(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$l(t,a,d),d};class Timepicker extends r$1{constructor(){super(...arguments),this._value="",this._placeholder="",this._inputSize="lg",this._dropdown="",this._required=!1,this._disabled=!1,this._readonly=!1,this._invalid=!1,this._showDropdown=!1,this._helpText="",this._oldHelpText="",this._errorTimeFormatText="Format d'hora no vàlid",this._errorTimeOptionText="Opció de temps no disponible",this._manualHourSelector="",this._manualMinuteSelector="",this._minutesRange=1,this._minHour=0,this._maxHour=24,this._timeListOptions=[],this._customTimeListOptions=[],this._timeManualHourOptions=[],this._timeManualMinutesOptions=[],this._icon="schedule",this._inputValidity=!0,this._isFirstUpdated=!0,this.observerConfig={attributes:!0,childList:!0,subtree:!0},this.callback=t=>{for(const a of t)a.type==="attributes"&&(this._checkInputAttributes(),this.requestUpdate())},this.observer=new MutationObserver(this.callback),this._timePattern=/^\d{0,4}$/g,this._timeSeparator=":",this._timeInputOldValue=""}static get styles(){return[r$2(iconStyles),r$2(inputStyles),r$2(scrollbarStyles),r$2(buttonStyles),r$2(styles$1)]}get _input(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="input"]'))||void 0;return this.requestUpdate(),t==null?void 0:t.assignedElements()[0]}get _label(){var a;const t=((a=this.shadowRoot)==null?void 0:a.querySelector('slot[name="label"]'))||void 0;return this.requestUpdate(),t==null?void 0:t.assignedElements()[0]}set value(t){const a=this._value;this._value=t,this._input&&(this._input.value=t),this.requestUpdate("value",a)}set invalid(t){const a=this._invalid;this._invalid=t,this.requestUpdate("invalid",a)}set inputSize(t){const a=this._inputSize;t==="md"?this._inputSize=t:this._inputSize="lg",this.requestUpdate("inputSize",a)}set helpText(t){const a=this._helpText;this._helpText=t,this._oldHelpText=t,this.requestUpdate("helpText",a)}set errorTimeFormatText(t){const a=this._errorTimeFormatText;this._errorTimeFormatText=t,this.requestUpdate("errorTimeFormatText",a)}set errorTimeOptionText(t){const a=this._errorTimeOptionText;this._errorTimeOptionText=t,this.requestUpdate("errorTimeOptionText",a)}set dropdown(t){const a=this._dropdown;this._dropdown=t,this.requestUpdate("dropdown",a)}set showDropdown(t){const a=this._showDropdown;this._showDropdown=t,this.requestUpdate("showDropdown",a)}set minutesRange(t){const a=this._minutesRange;this._minutesRange=t,this._isFirstUpdated||this._updateTimeOptions(),this.requestUpdate("minutesRange",a)}set minHour(t){const a=this._minHour;this._minHour=t,this._isFirstUpdated||this._updateTimeOptions(),this.requestUpdate("minHour",a)}set maxHour(t){const a=this._maxHour;this._maxHour=t,this._isFirstUpdated||this._updateTimeOptions(),this.requestUpdate("maxHour",a)}set customTimeListOptions(t){const a=this._customTimeListOptions;this._customTimeListOptions=t,this.requestUpdate("customTimeListOptions",a)}set icon(t){const a=this._icon;this._icon=t,this.requestUpdate("icon",a)}disconnectedCallback(){this.observer.disconnect()}async firstUpdated(){try{await this.updateComplete,this._closeDropdown(),this._input&&(this._checkInputAttributes(),this.observer.observe(this._input,this.observerConfig)),this._updateTimeOptions(),this._isFirstUpdated=!1,this.requestUpdate()}catch{console.error("ERROR OCURRED")}}_updateTimeOptions(){this._dropdown&&(this._timeListOptions=this._generateTimeListOptions(),this._timeManualHourOptions=this._generateTimeManualHoursOptions(),this._timeManualMinutesOptions=this._generateTimeManualMinutesOptions())}_checkInputAttributes(){var p,b,g,f,$,v,m;const t=(p=this._input)==null?void 0:p.getAttribute("placeholder");t&&(this._placeholder=t),((b=this._input)==null?void 0:b.getAttribute("readonly"))!==null&&(this._readonly=!0),((g=this._input)==null?void 0:g.getAttribute("disabled"))!==null&&(this._disabled=!0),((f=this._input)==null?void 0:f.getAttribute("required"))!==null&&(this._required=!0);const h=($=this._input)==null?void 0:$.getAttribute("value");h!==null&&(this._value=h),(v=this._input)!=null&&v.value&&((m=this._input)==null?void 0:m.value)!==""&&this._handleValidity(),this.requestUpdate()}_handleValidity(){var a;const t=(a=this._input)==null?void 0:a.checkValidity();t!==void 0&&(this._inputValidity=t)}_closeDropdown(){document.addEventListener("click",t=>{t.composedPath().includes(this)||this._showDropdown&&(this._showDropdown=!1,this.requestUpdate())}),this.addEventListener("focusout",t=>{const a=t.relatedTarget;a!==null&&a!==this&&a!==this._input&&a!==this._label&&(this._showDropdown&&(this._showDropdown=!1),this.requestUpdate())})}_timeMask(t,a,c){const d=[];for(let h=0;h<t.length;h+=1)h!==0&&h%a===0&&d.push(c),d.push(t[h]);return d.join("")}_timeUnmask(t){return t.replace(/[^\d]/g,"")}_timeValidate(t){const a=t.slice(0,2),c=t.slice(3,5);this._input&&+a>=0&&+a<=23&&+c>=0&&+c<=59?(this._invalid=!1,this._helpText=this._oldHelpText,this._dropdown&&this._dropdown==="list"&&!this._timeListOptions.includes(this._input.value)?(this._helpText=this._errorTimeOptionText,this._invalid=!0):this._dropdown&&this._dropdown==="manual"&&(!this._timeManualHourOptions.includes(a)||!this._timeManualMinutesOptions.includes(c))?(this._helpText=this._errorTimeOptionText,this._invalid=!0):this._showDropdown=!1):(this._helpText=this._errorTimeFormatText,this._invalid=!0),this._dispatchValueChange(),this.requestUpdate()}_dispatchValueChange(){if(this._input){const t={detail:{value:this._input.value,status:this._invalid?"INVALID":"VALID"},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onTimepickerChange",t))}}_handleClick(){if(this._showDropdown=!0,this._value&&(this._dropdown&&this._dropdown==="list"&&this._timeListOptionsScrollTo(),this._dropdown&&this._dropdown==="manual")){const t=this._value.slice(0,2);this._timeManualOptionsScrollTo(t),setTimeout(()=>{this._timeManualOptionsScrollTo()},500)}this.requestUpdate()}_handleInput(){if(this._input){let t=this._input.value;t=this._timeUnmask(t),t.match(this._timePattern)?(t=this._timeMask(t,2,this._timeSeparator),this._input.value=t):this._input.value=this._timeInputOldValue,this._input.value.length===5&&(this._timeValidate(this._input.value),this._handleValidity()),this._dropdown&&this._dropdown==="list"&&this._timeListOptionsScrollTo(),this._dropdown&&this._dropdown==="manual"&&this._timeManualOptionsScrollTo()}}_handleKeyDown(t){this._input&&(this._timeInputOldValue=this._input.value,(t==null?void 0:t.key)==="Enter"||(t==null?void 0:t.key)===" "?(this._showDropdown=!0,this.requestUpdate()):(t==null?void 0:t.key)==="Escape"&&(this._showDropdown=!1,this.requestUpdate()))}_handleFocus(){this._placeholder="00:00",this._input&&this._input.setAttribute("placeholder",this._placeholder),this.requestUpdate()}_handleBlur(){this._placeholder="",this._input&&this._input.removeAttribute("placeholder"),this.requestUpdate()}_focusInput(){var t;(t=this._input)==null||t.focus(),this._handleClick()}_generateTimeListOptions(){const t=[];for(let a=this._minHour;a<this._maxHour;a+=1)for(let c=0;c<60;c+=this._minutesRange){const d=a.toString().padStart(2,"0"),h=c.toString().padStart(2,"0");t.push(`${d}:${h}`)}return t}_generateTimeListOptionsHTML(t,a){let c=!0;const d=a&&a.length>0;return(d?a:t).map(b=>{const g=w=>{w&&w.focus()},f=w=>{let _=0;const C=this.renderRoot.querySelectorAll(".dss-timepicker-dropdown__label"),S=C.length-1;w===C[0]?g(C[S]):(C.forEach((T,D)=>{T===w&&(_=D)}),g(C[_-1]))},$=w=>{let _=0;const C=this.renderRoot.querySelectorAll(".dss-timepicker-dropdown__label"),S=C.length-1;w===C[S]?g(C[0]):(C.forEach((T,D)=>{T===w&&(_=D)}),g(C[_+1]))},v=w=>{if(this._input){const _=w.target.getAttribute("value");_&&(this._input.value=_,this._helpText=this._oldHelpText,this._invalid=!1,this._showDropdown=!1,this._handleValidity(),this.requestUpdate(),this._dispatchValueChange())}},m=w=>{const _=w.currentTarget,C=w;let S=!1;switch(C.key){case"ArrowUp":f(_),S=!0;break;case"ArrowDown":$(_),S=!0;break;case"Enter":const T=w.target.querySelector("input"),D=this.renderRoot.querySelector('.dss-timepicker-dropdown__label[tabindex="0"]');D==null||D.setAttribute("tabindex","-1"),w.target.setAttribute("tabindex","0"),T==null||T.click(),S=!0;break}S&&(w.stopPropagation(),w.preventDefault())},y={"option--busy":typeof b=="object"&&b.state==="ocupat"},k=x`
        <div class="dss-timepicker-dropdown__option ${e(y)}">
          ...
          >
            ...
            <input
              ...
              type="radio"
              @click="${v}"
              .value="${d&&typeof b=="object"?b.value:b}"
            />
      ...
      `;return c=!1,k})}_generateTimeManualHoursOptions(){const t=[];for(let a=this._minHour;a<this._maxHour;a+=1){const c=a.toString().padStart(2,"0");t.push(c)}return t}_generateTimeManualMinutesOptions(){const t=[];for(let a=0;a<60;a+=this._minutesRange){const c=a.toString().padStart(2,"0");t.push(c)}return t}_generateTimeManualOptionsHTML(t,a){let c=!0;return a.map(h=>{const p=f=>{const $=f.target.getAttribute("value");$&&(t==="timepickerManualHour"?this._manualHourSelector=$:t==="timepickerManualMinutes"&&(this._manualMinuteSelector=$),this.requestUpdate())},b=f=>{const $=f.currentTarget,v=f;let m=!1;const y=_=>{_&&_.focus()},k=_=>{let C=0;const S=this.renderRoot.querySelectorAll(`.dss-timepicker-manual-item__label.${t}`),T=S.length-1;_===S[0]?y(S[T]):(S.forEach((D,q)=>{D===_&&(C=q)}),y(S[C-1]))},w=_=>{let C=0;const S=this.renderRoot.querySelectorAll(`.dss-timepicker-manual-item__label.${t}`),T=S.length-1;_===S[T]?y(S[0]):(S.forEach((D,q)=>{D===_&&(C=q)}),y(S[C+1]))};switch(v.key){case"ArrowUp":k($),m=!0;break;case"ArrowDown":w($),m=!0;break;case"Enter":const _=f.target.parentElement,C=_==null?void 0:_.querySelector("input"),S=this.renderRoot.querySelector(`.dss-timepicker-manual-item__label[tabindex="0"].${t}`);if(S==null||S.setAttribute("tabindex","-1"),f.target.setAttribute("tabindex","0"),C==null||C.click(),t==="timepickerManualHour"){const T=this.renderRoot.querySelector('.dss-timepicker-manual-item__label[tabindex="0"].timepickerManualMinutes');y(T)}else if(t==="timepickerManualMinutes"){const T=this.renderRoot.querySelector(".dss-timepicker-dropdown__actions-select");setTimeout(()=>{T.focus()},0)}m=!0;break}m&&(f.stopPropagation(),f.preventDefault())},g=x`
      ...
      `;return c=!1,g})}_checkDisableTimeManualSelector(){return this._manualHourSelector===""||this._manualMinuteSelector===""}_timeManualSelectorCancel(){const t=this.renderRoot.querySelectorAll(".dss-timepicker-manual-item__input-radio:checked");t.length&&t.forEach(a=>{a.checked=!1}),this._manualHourSelector="",this._manualMinuteSelector="",this._showDropdown=!1,this._handleValidity(),this.requestUpdate()}_timeManualSelectorAccept(){this._input&&(this._input.value=`${this._manualHourSelector}:${this._manualMinuteSelector}`,this._helpText=this._oldHelpText,this._invalid=!1,this._showDropdown=!1,this._handleValidity(),this.requestUpdate(),this._dispatchValueChange())}_timeListOptionsScrollTo(){if(this._input){const t=this._input.value.trim(),a=this.renderRoot.querySelectorAll(".dss-timepicker-dropdown__input-radio");let c=!1;a.forEach(d=>{const h=d.value;if(!c&&h.startsWith(t)){const p=d.closest("label");c=!0,p&&(setTimeout(()=>{p.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})},0),h===t&&(d.checked=!0))}})}}_timeManualOptionsScrollTo(t){if(this._input){const a=t?t.trim():this._input.value.trim();if(a.length<=2){const c=this.renderRoot.querySelectorAll(".dss-timepicker-dropdown__items--hour .dss-timepicker-manual-item__label");let d=!1;c.forEach(h=>{const p=h.innerHTML.replace(/<!--[\s\S]*?-->/g,"").trim();!d&&p.startsWith(a)&&(d=!0,setTimeout(()=>{h.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})},0),p===a&&h.click())})}else{const c=a.slice(3),d=this.renderRoot.querySelectorAll(".dss-timepicker-dropdown__items--minute .dss-timepicker-manual-item__label");let h=!1;d.forEach(p=>{const b=p.innerHTML.replace(/<!--[\s\S]*?-->/g,"").trim();!h&&b.startsWith(c)&&(h=!0,p.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"}),b===c&&p.click())})}}}render(){return template$2(this)}}__decorateClass$l([n$1({type:String,attribute:!0})],Timepicker.prototype,"value");__decorateClass$l([n$1(booleanType)],Timepicker.prototype,"invalid");__decorateClass$l([n$1({type:String})],Timepicker.prototype,"inputSize");__decorateClass$l([n$1({type:String})],Timepicker.prototype,"helpText");__decorateClass$l([n$1({type:String})],Timepicker.prototype,"errorTimeFormatText");__decorateClass$l([n$1({type:String})],Timepicker.prototype,"errorTimeOptionText");__decorateClass$l([n$1({type:String})],Timepicker.prototype,"dropdown");__decorateClass$l([n$1(booleanType)],Timepicker.prototype,"showDropdown");__decorateClass$l([n$1({type:Number})],Timepicker.prototype,"minutesRange");__decorateClass$l([n$1({type:Number})],Timepicker.prototype,"minHour");__decorateClass$l([n$1({type:Number})],Timepicker.prototype,"maxHour");__decorateClass$l([n$1({type:Array})],Timepicker.prototype,"customTimeListOptions");__decorateClass$l([n$1({type:String})],Timepicker.prototype,"icon");const styles=':host{opacity:0;visibility:hidden}:host(.visible){opacity:1;visibility:visible}.dss-tooltip{max-width:264px}.dss-tooltip-box{position:relative;box-sizing:border-box;width:-moz-max-content;width:max-content;max-width:264px;height:-moz-fit-content;height:fit-content;padding:var(--dss-spacing-xs) var(--dss-spacing-md);background-color:var(--color-neutral-800);border-radius:var(--dss-radius-sm);box-shadow:0 4px 8px 3px #0000000d,0 1px 3px #0000001a;font-size:14px;color:var(--color-white)}.dss-tooltip--align-left{text-align:left}.dss-tooltip--align-right{text-align:right}.dss-tooltip--align-center{text-align:center}.dss-tooltip--align-justify{text-align:justify}.dss-tooltip-box[data-popper-placement=top]:before{content:"";position:absolute;display:block;width:0px;left:50%;bottom:0;border:8px solid transparent;border-bottom:0;border-top:8px solid var(--color-neutral-800);transform:translate(-50%,100%)}.dss-tooltip-box[data-popper-placement=bottom]:before{content:"";position:absolute;display:block;width:0px;left:50%;top:0;border:8px solid transparent;border-top:0;border-bottom:8px solid var(--color-neutral-800);transform:translate(-50%,-100%)}.dss-tooltip-box[data-popper-placement=left]:before{content:"";position:absolute;display:block;width:0px;right:0;top:50%;border:8px solid transparent;border-right:0;border-left:8px solid var(--color-neutral-800);transform:translate(100%,-50%)}.dss-tooltip-box[data-popper-placement=right]:before{content:"";position:absolute;display:block;width:0px;left:0;top:50%;border:8px solid transparent;border-left:0;border-right:8px solid var(--color-neutral-800);transform:translate(-100%,-50%)}.dss-tooltip--no-height-limit .dss-tooltip-container{max-height:-moz-max-content;max-height:max-content}.dss-tooltip--hidden{display:none}',template$1=l=>{const t={"dss-tooltip":!0,[`dss-tooltip--${l.position}`]:!!l.position,[`dss-tooltip--align-${l.align}`]:!!l.align,"dss-tooltip--hidden":l.hide,"dss-tooltip--no-height-limit":l.noHeightLimit};return u`
    <div class="${e(t)}">
              ...
              <li class="file">
                ...
                <div class="file-description">
                  <p class="file-description__name">
                    ${c.name}
                    ${c.status==="loading"?u` <span class="dot-flashing"></span> `:u``}
                  </p>
                  ${l._fileErrors[c.name]?u`
                        <p class="file-description__error">
                          ${l._fileErrors[c.name]}
                        </p>
                      `:""}
                </div>
  ...
  <div class="dss-user-feedback">
    ...
    <div class="dss-user-feedback__body">
      <h4 class="dss-user-feedback__title">${l._title}</h4>
      <p class="dss-user-feedback__description">${l._description}</p>
      ${l._hasDetails?x`
            <div class="dss-user-feedback__details-action">
              ...
              >
                ...
                <i class="dss-icon dss-icon--sm">
                  ${l._detailsExpanded?"expand_less":"expand_more"}
                </i>
              </button>
            </div>

            ${l._detailsExpanded?x`
...
`;var __defProp$h=Object.defineProperty,__getOwnPropDesc$h=Object.getOwnPropertyDescriptor,__decorateClass$h=(l,t,a,c)=>{for(var d=__getOwnPropDesc$h(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$h(t,a,d),d};class Card extends r$1{constructor(){super(...arguments),this._dragged=!1,this._deleted=!1,this._selected=!1,this._disabled=!1,this._hasClose=!1,this._hasDetails=!1}static get styles(){return[r$2(resetStyles),r$2(iconStyles),r$2(iconButtonStyles),cardStyles]}set selected(t){const a=this._selected;this._selected=t,this.requestUpdate("selected",a)}set dragged(t){const a=this._dragged;this._dragged=t,this.requestUpdate("dragged",a)}set deleted(t){const a=this._deleted;this._deleted=t,this.requestUpdate("deleted",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}set hasClose(t){const a=this._hasClose;this._hasClose=t,this.requestUpdate("hasClose",a)}set hasDetails(t){const a=this._hasDetails;this._hasDetails=t,this.requestUpdate("hasDetails",a)}_propagateProperties(){var a;const t=(a=this.shadowRoot)==null?void 0:a.querySelectorAll("slot");t&&t.forEach(c=>{c.assignedElements().forEach(h=>{this._deleted?h.setAttribute("deleted","true"):h.removeAttribute("deleted"),this._disabled?h.setAttribute("disabled","true"):h.removeAttribute("disabled")})})}_dispatchClose(){this.dispatchEvent(new CustomEvent("onClose",{bubbles:!0}))}updated(t){super.updated(t),(t.has("deleted")||t.has("disabled"))&&this._propagateProperties()}render(){const t={"dss-card--selected":this._selected,"dss-card--dragged":this._dragged,"dss-card--deleted":this._deleted,"dss-card--disabled":this._disabled};return x`
    ...
    `}}__decorateClass$h([n$1(booleanType)],Card.prototype,"selected");__decorateClass$h([n$1(booleanType)],Card.prototype,"dragged");__decorateClass$h([n$1(booleanType)],Card.prototype,"deleted");__decorateClass$h([n$1(booleanType)],Card.prototype,"disabled");__decorateClass$h([n$1(booleanType)],Card.prototype,"hasClose");__decorateClass$h([n$1(booleanType)],Card.prototype,"hasDetails");var __defProp$g=Object.defineProperty,__getOwnPropDesc$g=Object.getOwnPropertyDescriptor,__decorateClass$g=(l,t,a,c)=>{for(var d=__getOwnPropDesc$g(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$g(t,a,d),d};class CardBody extends r$1{constructor(){super(...arguments),this._deleted=!1,this._disabled=!1}static get styles(){return[r$2(iconStyles),i$1`
        :host {
          display: flex;
          flex-direction: column;
          gap: var(--dss-spacing-xxs);
        }
      `]}set deleted(t){const a=this._deleted;this._deleted=t,this.requestUpdate("deleted",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}_propagateProperties(){var a;const t=(a=this.shadowRoot)==null?void 0:a.querySelectorAll("slot");t&&t.forEach(c=>{c.assignedElements().forEach(h=>{this._deleted?h.setAttribute("deleted","true"):h.removeAttribute("deleted"),this._disabled?h.setAttribute("disabled","true"):h.removeAttribute("disabled")})})}updated(t){super.updated(t),(t.has("deleted")||t.has("disabled"))&&this._propagateProperties()}render(){return x` <slot></slot> `}}__decorateClass$g([n$1(booleanType)],CardBody.prototype,"deleted");__decorateClass$g([n$1(booleanType)],CardBody.prototype,"disabled");var __defProp$f=Object.defineProperty,__getOwnPropDesc$f=Object.getOwnPropertyDescriptor,__decorateClass$f=(l,t,a,c)=>{for(var d=__getOwnPropDesc$f(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$f(t,a,d),d};class CardDescription extends r$1{constructor(){super(...arguments),this._deleted=!1,this._disabled=!1}static get styles(){return[r$2(resetStyles),i$1`
    ...
    `}}__decorateClass$f([n$1(booleanType)],CardDescription.prototype,"deleted");__decorateClass$f([n$1(booleanType)],CardDescription.prototype,"disabled");var __defProp$e=Object.defineProperty,__getOwnPropDesc$e=Object.getOwnPropertyDescriptor,__decorateClass$e=(l,t,a,c)=>{for(var d=__getOwnPropDesc$e(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$e(t,a,d),d};class CardFooter extends r$1{constructor(){super(...arguments),this._deleted=!1,this._disabled=!1}static get styles(){return i$1`
      :host {
        display: flex;
    ...
    `}}__decorateClass$c([n$1(booleanType)],CardHeader.prototype,"flag");__decorateClass$c([n$1(booleanType)],CardHeader.prototype,"hasMenu");__decorateClass$c([n$1(booleanType)],CardHeader.prototype,"deleted");__decorateClass$c([n$1(booleanType)],CardHeader.prototype,"disabled");var __defProp$b=Object.defineProperty,__getOwnPropDesc$b=Object.getOwnPropertyDescriptor,__decorateClass$b=(l,t,a,c)=>{for(var d=__getOwnPropDesc$b(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$b(t,a,d),d};class CardHighlights extends r$1{constructor(){super(...arguments),this._deleted=!1,this._disabled=!1}static get styles(){return i$1`
      :host {
        display: grid;
        grid-template-columns: repeat(auto-fit, minmax(10px, 1fr));
        gap: var(--dss-spacing-sm);
      }
    `}set deleted(t){const a=this._deleted;this._deleted=t,this.requestUpdate("deleted",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}_propagateProperties(){var a;const t=(a=this.shadowRoot)==null?void 0:a.querySelectorAll("slot");t&&t.forEach(c=>{c.assignedElements().forEach(h=>{this._deleted?h.setAttribute("deleted","true"):h.removeAttribute("deleted"),this._disabled?h.setAttribute("disabled","true"):h.removeAttribute("disabled")})})}updated(t){super.updated(t),(t.has("deleted")||t.has("disabled"))&&this._propagateProperties()}render(){return x` <slot></slot> `}}__decorateClass$b([n$1(booleanType)],CardHighlights.prototype,"deleted");__decorateClass$b([n$1(booleanType)],CardHighlights.prototype,"disabled");var __defProp$a=Object.defineProperty,__getOwnPropDesc$a=Object.getOwnPropertyDescriptor,__decorateClass$a=(l,t,a,c)=>{for(var d=__getOwnPropDesc$a(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$a(t,a,d),d};class CardHighlightsItem extends r$1{constructor(){super(...arguments),this._deleted=!1,this._disabled=!1,this._title="Title",this._icon="",this._text="Item"}static get styles(){return[r$2(resetStyles),r$2(iconStyles),i$1`
        .dss-card-highligth {
					width: 100%;
    ...
    `}}__decorateClass$a([n$1({type:String})],CardHighlightsItem.prototype,"icon");__decorateClass$a([n$1({type:String})],CardHighlightsItem.prototype,"title");__decorateClass$a([n$1({type:String})],CardHighlightsItem.prototype,"text");__decorateClass$a([n$1(booleanType)],CardHighlightsItem.prototype,"deleted");__decorateClass$a([n$1(booleanType)],CardHighlightsItem.prototype,"disabled");var __defProp$9=Object.defineProperty,__getOwnPropDesc$9=Object.getOwnPropertyDescriptor,__decorateClass$9=(l,t,a,c)=>{for(var d=__getOwnPropDesc$9(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$9(t,a,d),d};class CardImage extends r$1{constructor(){super(...arguments),this._source="",this._alt=""}static get styles(){return[i$1`
        :host {
          display: flex;
      ...
      `]}set source(t){const a=this._source;this._source=t,this.requestUpdate("source",a)}set alt(t){const a=this._alt;this._alt=t,this.requestUpdate("alt",a)}render(){return x` <img src="${this._source}" alt="${this._alt}" /> `}}__decorateClass$9([n$1({type:String})],CardImage.prototype,"source");__decorateClass$9([n$1({type:String})],CardImage.prototype,"alt");class CardInfo extends r$1{static get styles(){return i$1`
      :host {
        display: flex;
        justify-content: flex-end;
        align-items: center;
    ...
    `}render(){return x` <slot></slot> `}}var __defProp$8=Object.defineProperty,__getOwnPropDesc$8=Object.getOwnPropertyDescriptor,__decorateClass$8=(l,t,a,c)=>{for(var d=__getOwnPropDesc$8(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$8(t,a,d),d};class CardInfoItem extends r$1{constructor(){super(...arguments),this._icon="add_box",this._text="Info",this._critic=!1}static get styles(){return[r$2(iconStyles),i$1`
        :host {
    ...
    `}}__decorateClass$8([n$1({type:String})],CardInfoItem.prototype,"icon");__decorateClass$8([n$1({type:String})],CardInfoItem.prototype,"text");__decorateClass$8([n$1(booleanType)],CardInfoItem.prototype,"critic");var __defProp$7=Object.defineProperty,__getOwnPropDesc$7=Object.getOwnPropertyDescriptor,__decorateClass$7=(l,t,a,c)=>{for(var d=__getOwnPropDesc$7(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$7(t,a,d),d};class CardMenu extends r$1{constructor(){super(...arguments),this._position="right",this._disabled=!1,this._showMenu=!1}static get styles(){return[r$2(resetStyles),r$2(iconStyles),r$2(iconButtonStyles),i$1`
        :host {
          display: block;
        }
    ...
    `}}__decorateClass$7([n$1({type:String})],CardMenu.prototype,"position");__decorateClass$7([n$1(booleanType)],CardMenu.prototype,"disabled");var __defProp$6=Object.defineProperty,__getOwnPropDesc$6=Object.getOwnPropertyDescriptor,__decorateClass$6=(l,t,a,c)=>{for(var d=__getOwnPropDesc$6(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$6(t,a,d),d};class CardSubitle extends r$1{constructor(){super(...arguments),this._deleted=!1,this._disabled=!1,this._hasLink=!1,this._linkHref="#",this._hasIcon=!1,this._icon="add_box"}static get styles(){return[r$2(resetStyles),r$2(iconStyles),i$1`
        :host {
					width: 100%;
					display: block;
        }
    ...
    `}}__decorateClass$6([n$1(booleanType)],CardSubitle.prototype,"deleted");__decorateClass$6([n$1(booleanType)],CardSubitle.prototype,"disabled");__decorateClass$6([n$1(booleanType)],CardSubitle.prototype,"hasLink");__decorateClass$6([n$1({type:String})],CardSubitle.prototype,"linkHref");__decorateClass$6([n$1(booleanType)],CardSubitle.prototype,"hasIcon");__decorateClass$6([n$1({type:String})],CardSubitle.prototype,"icon");class CardTags extends r$1{static get styles(){return i$1`
      :host {
        display: flex;
        align-items: center;
        width: 100%;
    ...
    `}render(){return x` <slot></slot> `}}var __defProp$5=Object.defineProperty,__getOwnPropDesc$5=Object.getOwnPropertyDescriptor,__decorateClass$5=(l,t,a,c)=>{for(var d=__getOwnPropDesc$5(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$5(t,a,d),d};class CardTitle extends r$1{constructor(){super(...arguments),this._deleted=!1,this._disabled=!1}static get styles(){return[r$2(resetStyles),i$1`
        :host {
          display: block;
        }
        .dss-card-title {
    ...
    `}}__decorateClass$5([n$1(booleanType)],CardTitle.prototype,"deleted");__decorateClass$5([n$1(booleanType)],CardTitle.prototype,"disabled");var __defProp$4=Object.defineProperty,__getOwnPropDesc$4=Object.getOwnPropertyDescriptor,__decorateClass$4=(l,t,a,c)=>{for(var d=__getOwnPropDesc$4(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$4(t,a,d),d};const V=class V extends r$1{constructor(){super(...arguments),this._value="",this._label="",this._placeHolder="",this._previousDate="",this._minDate="",this._maxDate="",this._showCalendar=!1,this._showTime=!1,this._invalid=!1,this._showButtons=!1,this._required=!1,this._disabled=!1,this._readonly=!1,this._leftLabel="Cancel·lar",this._rightLabel="Acceptar",this._isFocused=!1,this._internals=this.attachInternals()}static get styles(){return i$1`
      :host {
        display: flex;
        width: fit-content;
        height: fit-content;
    ...
    `}get _input(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("input")}set value(t){const a=this._value;this._value=t,this._input&&(this._input.value=t),this.requestUpdate("value",a)}set label(t){const a=this._label;this._label=t,this.requestUpdate("label",a)}set placeHolder(t){const a=this._placeHolder;this._placeHolder=t,this.requestUpdate("placeHolder",a)}set required(t){const a=this._required;this._required=t,this.requestUpdate("required",a)}set disabled(t){const a=this._disabled;this._disabled=t,this.requestUpdate("disabled",a)}set readonly(t){const a=this._readonly;this._readonly=t,this.requestUpdate("readonly",a)}set showTime(t){const a=this._showTime;this._showTime=t,this.requestUpdate("showTime",a)}set showButtons(t){const a=this._showButtons;this._showButtons=t,this.requestUpdate("showButtons",a)}set leftLabel(t){const a=this._leftLabel;this._leftLabel=t,this.requestUpdate("leftLabel",a)}set rightLabel(t){const a=this._rightLabel;this._rightLabel=t,this.requestUpdate("rightLabel",a)}set minDate(t){const a=this._minDate;this._minDate=t,this.requestUpdate("minDate",a)}set maxDate(t){const a=this._maxDate;this._maxDate=t,this.requestUpdate("maxDate",a)}set invalid(t){const a=this._invalid;this._invalid=t,this.requestUpdate("invalid",a)}get value(){let t="";return this._input?t=this._input.value:t=this._value,t}get form(){return this._internals.form}get name(){return this.getAttribute("name")}get type(){return this.localName}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}formResetCallback(){this._input.value="",this.requestUpdate()}async firstUpdated(){try{await this.updateComplete,this._value&&(this._input.value=this._value),this._closeDropdown(),this.requestUpdate()}catch{console.error("ERROR OCURRED")}}_closeDropdown(){document.addEventListener("click",t=>{t.target!==this&&(this._showCalendar=!1,this._isFocused=!1,this.requestUpdate())}),document.addEventListener("focusout",t=>{t.target===this&&(this._showCalendar=!1,this._isFocused=!1,this.requestUpdate())})}_handleKeyUp(t){var a,c,d,h,p;if((t==null?void 0:t.key)==="Tab"?(this._isFocused=!0,this._handleBlur()):(t==null?void 0:t.key)==="Enter"||(t==null?void 0:t.key)===" "?(this._showCalendar=!0,this._handleBlur()):(t==null?void 0:t.key)==="Escape"&&(this._isFocused=!0,this._showCalendar=!1,this._handleBlur()),t.key==="Enter"&&((a=this._input.value)==null?void 0:a.length)>7){const b=(c=this._input.value)==null?void 0:c.replace(/(\d+[/])(\d+[/])/,"$2$1"),g=new Date(b),f=(d=g.getDate())==null?void 0:d.toString().padStart(2,"0"),$=(g.getMonth()+1).toString().padStart(2,"0"),v=g.getFullYear(),m=(h=g.getHours())==null?void 0:h.toString().padStart(2,"0"),y=(p=g.getMinutes())==null?void 0:p.toString().padStart(2,"0");let k=`${f}/${$}/${v}`;this._showTime&&(k+=` ${m}:${y}`),this._input.value=k,this._dispatchValueChange(),this.requestUpdate()}}_handleInput(t){var c;const a=(c=t.target.value)==null?void 0:c.replace(/\D/g,"");this._input.value=this._formatDate(a),this._dispatchValueChange(),this.requestUpdate()}_formatDate(t){let a=t.substring(0,2),c=t.substring(2,4);const d=t.substring(4,8);let h=t.substring(8,10),p=t.substring(10,12);Number(a)>3&&(a=a==null?void 0:a.padStart(2,"0")),Number(c)>1&&(c=c==null?void 0:c.padStart(2,"0")),Number(a)>31&&(a="31"),Number(c)>12&&(c="12"),c==="02"&&Number(a)>28&&(d==null?void 0:d.length)===4&&(a=new Date(Number(d),1,29).getMonth()===1?"29":"28");let b=`${a}${c?`/${c}`:""}${d?`/${d}`:""}`;return this._showTime&&(Number(h)>2&&(h=h==null?void 0:h.padStart(2,"0")),Number(h)>23&&(h="23"),Number(p)>5&&(p=p==null?void 0:p.padStart(2,"0")),b=`${b}${h?` ${h}`:""}${p?`:${p}`:""}`),b}_handleFocus(){this._readonly||(this._placeHolder=this._showTime?"DD/MM/YYYY HH:MM":"DD/MM/YYYY",this.requestUpdate())}_handleBlur(){this.requestUpdate()}_handelLabelClick(){var t;(t=this._input)==null||t.focus(),this.requestUpdate()}_onDateChange(t){const a=t.detail;this._input.value=a,this._showCalendar=!1,this._dispatchValueChange(),this.requestUpdate()}_onCancel(){this._showCalendar=!1,this._input.value=this._previousDate||"",this.placeHolder="",this.requestUpdate()}_onclick(){var t,a;this._disabled||this._readonly||(this._showCalendar=!this._showCalendar,this._previousDate=this._input.value,this._showCalendar?(t=this._input)==null||t.focus():((a=this._input)==null||a.blur(),this._onCancel()),this.requestUpdate())}_dispatchValueChange(){const t={detail:this._input.value,bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onValueChange",t))}render(){var c;const t={"dss-input--invalid":this._invalid,"dss-input--disabled":this._disabled},a={"dss-input__group--focused":((c=this._input)==null?void 0:c.value)||this._placeHolder||this._showCalendar||this._isFocused,"dss-input__group--required":this._required,"dss-input__group--active":this._showCalendar||this._isFocused};return x`
      ...
      ${this._showCalendar?x`
            ...
            ></dss-calendar>
          `:null}
    `}};V.formAssociated=!0,V.shadowRootOptions={...r$1.shadowRootOptions,delegatesFocus:!0};let DatePicker=V;__decorateClass$4([n$1({type:String,attribute:!0})],DatePicker.prototype,"value");__decorateClass$4([n$1({type:String})],DatePicker.prototype,"label");__decorateClass$4([n$1({type:String})],DatePicker.prototype,"placeHolder");__decorateClass$4([n$1(booleanType)],DatePicker.prototype,"required");__decorateClass$4([n$1(booleanType)],DatePicker.prototype,"disabled");__decorateClass$4([n$1(booleanType)],DatePicker.prototype,"readonly");__decorateClass$4([n$1(booleanType)],DatePicker.prototype,"showTime");__decorateClass$4([n$1(booleanType)],DatePicker.prototype,"showButtons");__decorateClass$4([n$1({type:String})],DatePicker.prototype,"leftLabel");__decorateClass$4([n$1({type:String})],DatePicker.prototype,"rightLabel");__decorateClass$4([n$1({type:String})],DatePicker.prototype,"minDate");__decorateClass$4([n$1({type:String})],DatePicker.prototype,"maxDate");__decorateClass$4([n$1(booleanType)],DatePicker.prototype,"invalid");var __defProp$3=Object.defineProperty,__getOwnPropDesc$3=Object.getOwnPropertyDescriptor,__decorateClass$3=(l,t,a,c)=>{for(var d=__getOwnPropDesc$3(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$3(t,a,d),d};class DropDownList extends r$1{constructor(){super(...arguments),this._elements=null,this._copyElements=null,this._tick=!0,this._type="default",this._style=null,this._boxStyle=null,this._inputStyle=null,this._selectedValue=null,this._multiple=!1,this._openWithSearch=!1,this._deselectable=!1,this._icon="search",this._label="",this._placeHolder="",this._showSelector=!1,this._required=!1,this._disabled=!1,this._readonly=!1,this._labelSelectAll="Seleccionar-ho tot",this._labelDeselectAll="Deseleccionar-ho tot",this._selectAll=!1,this._selectElements=0,this._isFocused=!1,this._isGroupFocusedVisible=!1}static get styles(){return i$1`
      :host {
        width: fit-content;
        height: fit-content;
        position: relative;
    ...
    >
      ...
      ${this._showSelector&&this._filteredElements&&((b=this._filteredElements)==null?void 0:b.length)>0?x`
          ...
          `:null}
    </div>`}}__decorateClass$3([n$1({type:String})],DropDownList.prototype,"icon");__decorateClass$3([n$1({type:String})],DropDownList.prototype,"label");__decorateClass$3([n$1({type:String})],DropDownList.prototype,"placeHolder");__decorateClass$3([n$1(booleanType)],DropDownList.prototype,"required");__decorateClass$3([n$1(booleanType)],DropDownList.prototype,"disabled");__decorateClass$3([n$1(booleanType)],DropDownList.prototype,"readonly");__decorateClass$3([n$1({type:Array})],DropDownList.prototype,"elements");__decorateClass$3([n$1(booleanType)],DropDownList.prototype,"multiple");__decorateClass$3([n$1(booleanType)],DropDownList.prototype,"openWithSearch");__decorateClass$3([n$1(booleanType)],DropDownList.prototype,"tick");__decorateClass$3([n$1(booleanType)],DropDownList.prototype,"deselectable");__decorateClass$3([n$1({type:Array})],DropDownList.prototype,"selectedValue");__decorateClass$3([n$1({type:String})],DropDownList.prototype,"type");__decorateClass$3([n$1({type:String})],DropDownList.prototype,"boxStyle");__decorateClass$3([n$1({type:String})],DropDownList.prototype,"inputStyle");__decorateClass$3([n$1({type:String})],DropDownList.prototype,"labelSelectAll");__decorateClass$3([n$1({type:String})],DropDownList.prototype,"labelDeselectAll");__decorateClass$3([n$1(booleanType)],DropDownList.prototype,"SelectAll");var __defProp$2=Object.defineProperty,__getOwnPropDesc$2=Object.getOwnPropertyDescriptor,__decorateClass$2=(l,t,a,c)=>{for(var d=__getOwnPropDesc$2(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$2(t,a,d),d};const INPUT_TYPE_NUMBER="number";class InputField extends r$1{constructor(){super(...arguments),this._type="text",this._value="",this._label="",this._description="",this._placeHolder="",this._icon="",this._maxLength=void 0,this._minLength=void 0,this._max=void 0,this._min=void 0,this._step=void 0,this._isInputFocused=!1,this._isGroupFocusedVisible=!1,this._isTypeNumeric=!1,this._clearable=!1,this._showError=!1,this._required=!1,this._disabled=!1,this._readonly=!1}static get styles(){return i$1`
      :host {
        width: 100%;
        height: fit-content;
      }
    ...
    `}}__decorateClass$2([n$1({type:String})],InputField.prototype,"value");__decorateClass$2([n$1({type:String})],InputField.prototype,"type");__decorateClass$2([n$1({type:String})],InputField.prototype,"label");__decorateClass$2([n$1({type:String})],InputField.prototype,"description");__decorateClass$2([n$1({type:String})],InputField.prototype,"placeHolder");__decorateClass$2([n$1(booleanType)],InputField.prototype,"required");__decorateClass$2([n$1(booleanType)],InputField.prototype,"disabled");__decorateClass$2([n$1(booleanType)],InputField.prototype,"readonly");__decorateClass$2([n$1({type:String})],InputField.prototype,"icon");__decorateClass$2([n$1(booleanType)],InputField.prototype,"clearable");__decorateClass$2([n$1(booleanType)],InputField.prototype,"showError");__decorateClass$2([n$1({type:Number})],InputField.prototype,"maxLength");__decorateClass$2([n$1({type:Number})],InputField.prototype,"minLength");__decorateClass$2([n$1({type:Number})],InputField.prototype,"max");__decorateClass$2([n$1({type:Number})],InputField.prototype,"min");__decorateClass$2([n$1({type:Number})],InputField.prototype,"step");var __defProp$1=Object.defineProperty,__getOwnPropDesc$1=Object.getOwnPropertyDescriptor,__decorateClass$1=(l,t,a,c)=>{for(var d=__getOwnPropDesc$1(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp$1(t,a,d),d};class Switch extends r$1{constructor(){super(...arguments),this._checked=!1,this._disabled=!1,this._label=null,this._size="md"}static get styles(){return i$1`
      :host {
        display: flex;
        width: fit-content;
        height: fit-content;
    ...
    `}}__decorateClass$1([n$1(booleanType)],Switch.prototype,"checked");__decorateClass$1([n$1(booleanType)],Switch.prototype,"disabled");__decorateClass$1([n$1({type:String})],Switch.prototype,"label");__decorateClass$1([n$1({type:String})],Switch.prototype,"size");var __defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(l,t,a,c)=>{for(var d=__getOwnPropDesc(t,a),h=l.length-1,p;h>=0;h--)(p=l[h])&&(d=p(t,a,d)||d);return d&&__defProp(t,a,d),d};class Table extends r$1{constructor(){super(...arguments),this._valueMaxLength=60,this._data=[],this._customData=void 0,this._pipeData=[],this._customTableHeader=void 0,this._filters=[],this._tableHeader=[],this._tableHeaderSort={},this._hasPaginator=!1,this._currentIndex=1,this._pageSize=10,this._pageSizeOptions="[5,10,20]",this._resultstext="Resultats",this._rowsperpagetext="Files per pàgina",this._textAlign="left",this._headerTitle="",this._hideHeader=!1,this._hideColumnHeader=!1,this._innerFilters=!1,this._expandTable=!1,this._expandLabel="Ampliar",this._collapseLabel="Reduir",this._rowsOnCollapsed=5,this._filtersLabel="Selecció",this._cleanFiltersLabel="Netejar filtres",this._openFiltersLabel="Filtres",this._selectedRowsLabel="files seleccionades",this._selectAllRows=!0,this._noFiltersLabel="No hi ha filtres seleccionats",this._footerButtons=3,this._maxContentWidth=!1,this._stickyColumns=!1,this._multiselect=!1,this._radioselect=!1,this._hasRowButton=!1,this._rowButtonLabel="Button",this._hasRowActions=!1,this._rowActionsIcons=["add_box","add_box","add_box"],this._footerButtonPrimaryLabel="Primary",this._footerButtonSecondaryLabel="Secondary",this._footerButtonAlternativeLabel="Alternative",this._enableRowActionsOnDeleted=!1,this._enableRowActionsOnDisabled=!1,this._currentSortColumn="",this._currentSortType="",this._copyPipeData=[],this._isFirstUpdate=!0}static get styles(){return[r$2(iconStyles),r$2(buttonStyles),r$2(iconButtonStyles),r$2(chipStyles),r$2(checkboxStyles),r$2(radioStyles),i$1`
      ...
      `);let h=!0;const p=this._tableHeader.map((g,f)=>{const $=()=>{this._customTableHeader?this._customTableHeader[f].sort&&this._sortBy(g,this._tableHeaderSort[g]):this._sortBy(g,this._tableHeaderSort[g]),this.requestUpdate()},v=S=>{const T=S.currentTarget,D=S;let q=!1;switch(D.key){case"ArrowLeft":moveFocusToPreviousTarget(this.renderRoot,T,".table-header-column--clickable"),q=!0;break;case"ArrowRight":moveFocusToNextTarget(this.renderRoot,T,".table-header-column--clickable"),q=!0;break;case"Enter":const U=S.target;onKeyboardEnter(this.renderRoot,U,".table-header-column--clickable"),q=!0;break}q&&(S.stopPropagation(),S.preventDefault())};let m="";this._customData&&this._customData.length>0?m=this._pipeData[0][g].type:this._data&&this._data.length>0&&(m=typeof this._pipeData[0][g]);const y={"table-th--review":m==="review","table-th--link":m==="link"};let k=!1;this._customTableHeader&&(this._customTableHeader[f].sort||(k=!0));const w={"table-header-column--review":m==="review","table-header-column--number":m==="number","table-header-column--link":m==="link","table-header-column--clickable":!k,"table-header-column--not-clickable":k},_=x`
    ...
    `}_generateTableTdRadio(t,a,c,d){return this._enableRowActionsOnDeleted&&(d=!1),this._enableRowActionsOnDisabled&&(c=!1),x`
      ...
      <td class="table-td table-td--button">
        ...
        >
          <button
            ...
            @keydown="${d=>this._onRowActionKeydown(d,this._rowButtonLabel,t)}"
            ?disabled=${a||c}
          >
    ...
    `}_generateTableTdActions(t,a,c){return this._enableRowActionsOnDeleted&&(c=!1),this._enableRowActionsOnDisabled&&(a=!1),x`
      <td class="table-td table-td--custom table-td--actions">
        ...
        >
          ${this._rowActionsIcons.map((d,h)=>x`
                <button
                  ...
                  ?disabled=${a||c}
                >
                  <span class="dss-icon">${d}</span>
                </button>
              `)}
        </div>
      </td>
    `}_generateTableTdSelfActions(t,a,c,d,h){return this._enableRowActionsOnDeleted&&(h=!1),this._enableRowActionsOnDisabled&&(d=!1),x`
      <td class="table-td table-td--custom table-td--actions">
        <div
          class="table-body-column table-body-column--custom table-body-column--actions"
        >
    ...
    `}_resetRowsTabIndex(){const t=this.renderRoot.querySelector('.table-body-row[tabindex="0"]');t==null||t.setAttribute("tabindex","-1"),this.renderRoot.querySelectorAll(".table-body-row")[0].setAttribute("tabindex","0")}_uncheckRadioRows(){this._data&&this._data.length>0&&this._pipeData.forEach(t=>{t.checked=!1})}_generateDefaultTableBody(){let t,a=!0;return this._data&&this._data.length>0&&(t=this._pipeData.map(c=>{const d=c.checked?c.checked:!1,h=c.deleted?c.deleted:!1,p=c.disabled?c.disabled:!1,b=_=>{const C=_.relatedTarget;C&&!C.className.includes("table-body-row")&&!C.className.includes("table-body-row__action")&&this._resetRowsTabIndex()},g=_=>{const C=_.currentTarget,S=_;let T=!1;switch(S.key){case"ArrowUp":moveFocusToPreviousTarget(this.renderRoot,C,".table-body-row"),T=!0;break;case"ArrowDown":moveFocusToNextTarget(this.renderRoot,C,".table-body-row"),T=!0;break;case"Enter":const D=_.target;D.tagName==="TR"&&(onKeyboardEnter(this.renderRoot,D,".table-body-row"),(this._multiselect||this._radioselect)&&(!h&&!p?(this._radioselect&&this._uncheckRadioRows(),c.checked?c.checked=!c.checked:c.checked=!0):this._enableRowActionsOnDeleted&&h?(this._radioselect&&this._uncheckRadioRows(),c.checked?c.checked=!c.checked:c.checked=!0):this._enableRowActionsOnDisabled&&p&&(this._radioselect&&this._uncheckRadioRows(),c.checked?c.checked=!c.checked:c.checked=!0),this.requestUpdate()),T=!0);break;case"Escape":const U=_.composedPath().find(P=>P instanceof HTMLElement&&P.classList.contains("table-body-row"));U&&U.focus();break}T&&(_.stopPropagation(),_.preventDefault())},f=this._multiselect?this._generateTableTdCheckbox(c,d,p,h):x``,$=this._radioselect?this._generateTableTdRadio(c,d,p,h):x``,v=this._hasRowButton?this._generateTableTdButton(c,p,h):x``,m=this._hasRowActions?this._generateTableTdActions(c,p,h):x``,y=this._tableHeader.map(_=>{const C={"table-body-column--number":typeof c[_]=="number"};return x`
            <td class="table-td">
              <div
          ...
          `}),w=x` <tr
          class="table-body-row ${e({"table-body-row--selected":d,"table-body-row--deleted":h,"table-body-row--disabled":p})}"
          tabindex="${a?0:-1}"
        ...
        >
          ${f} ${$} ${y}
          ${v} ${m}
        </tr>`;return a=!1,w})),t}_generateCustomTableBody(){let t,a=!0;return this._customData&&(t=this._pipeData.map(c=>{let d=c.checked?c.checked:!1;const h=c.deleted?c.deleted:!1,p=c.disabled?c.disabled:!1,b=_=>{const C=_.relatedTarget;C&&!C.className.includes("table-body-row")&&!C.className.includes("table-body-row__action")&&this._resetRowsTabIndex()},g=_=>{const C=_.currentTarget,S=_;let T=!1;switch(S.key){case"ArrowUp":moveFocusToPreviousTarget(this.renderRoot,C,".table-body-row"),T=!0;break;case"ArrowDown":moveFocusToNextTarget(this.renderRoot,C,".table-body-row"),T=!0;break;case"Enter":const D=_.target;D.tagName==="TR"&&(onKeyboardEnter(this.renderRoot,D,".table-body-row"),(this._multiselect||this._radioselect)&&((!h&&!p||this._enableRowActionsOnDeleted&&h||this._enableRowActionsOnDisabled&&p)&&(c.checked?(c.checked=!c.checked,d=c.checked):(c.checked=!0,d=c.checked)),this.requestUpdate())),T=!0;break;case"Escape":const U=_.composedPath().find(P=>P instanceof HTMLElement&&P.classList.contains("table-body-row"));U&&U.focus();break}T&&(_.stopPropagation(),_.preventDefault())},f=this._multiselect?this._generateTableTdCheckbox(c,d,p,h):x``,$=this._radioselect?this._generateTableTdRadio(c,d,p,h):x``,v=this._hasRowButton?this._generateTableTdButton(c,p,h):x``,m=this._hasRowActions?this._generateTableTdActions(c,p,h):x``,y=this._tableHeader.map(_=>{const C=T=>{c[T].value=!c[T].value;const D={detail:{action:"review",row:c},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("onRowAction",D)),this.requestUpdate()},S={"table-body-column--text":c[_].type==="text","table-body-column--number":c[_].type==="number","table-body-column--link":c[_].type==="link","table-body-column--badge":c[_].type==="badge","table-body-column--result":c[_].type==="result","table-body-column--review":c[_].type==="review","table-body-column--progress":c[_].type==="progress","table-body-column--font-bold":c[_].fontType==="bold","table-body-column--font-black":c[_].fontType==="black","table-body-column--icon-right":c[_].iconRight};return x`
        ...
        >
          ${f} ${$} ${y}
          ${v} ${m}
        </tr>`;return a=!1,w})),t}_generateFilterChips(){let t;return this._filters&&(t=this._filters.map(a=>{const c=p=>{const b=p.target.getAttribute("term");typeof a=="string"?this._filters=this._filters.filter(g=>g!==b):this._filters=this._filters.filter(g=>g.value.trim()!==(b==null?void 0:b.trim())),this._emitChangeFilters(),this.requestUpdate()};return x`
          <span tabindex="0" class="dss-chip dss-chip--sm dss-chip--selected">
            ${typeof a==="string"?x`
                  ${a}
                  <button
