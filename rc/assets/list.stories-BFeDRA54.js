import"./lit-element-vV9fql9z.js";import{x as e}from"./lit-html-paDGiEfB.js";const v={title:"Components/List",argTypes:{label:{name:"Text"},items:{name:"Quantitat de elements",control:{type:"select"},options:[1,2,3,4,5]},type:{name:"Tipus",control:{type:"select"},options:["unstyled","ordered","unordered"]}},parameters:{layout:"centered"}},s={render:d=>{const g=d.type!=="unstyled"?` dss-list--${d.type}`:"";return e`
      <ol class="dss-list${g}">
