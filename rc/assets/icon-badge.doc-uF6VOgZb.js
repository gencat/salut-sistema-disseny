import{ae as e,af as d,ag as l,ah as t,ai as c}from"./index-1F3Yg9mW.js";import{u as r}from"./index-BlDNg98T.js";import{S as a,P as h,a as o,D as x,T as j,I as p,C as m,b as u}from"./icon-badge.stories-CioFacBZ.js";import"./iframe-Cf2BqtzP.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DxHf6ONh.js";import"./index-DrFu-skq.js";import"./lit-html-B2eaWknC.js";function s(n){const i={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
   .css-1sqhzee {
    display:none
  }
...
`,e.jsxs(i.table,{children:[e.jsx(i.thead,{children:e.jsxs(i.tr,{children:[e.jsx(i.th,{children:"Name"}),e.jsx(i.th,{children:"Àmbit"}),e.jsx(i.th,{children:"Condition"}),e.jsx(i.th,{children:"Type"}),e.jsx(i.th,{children:"Default"}),e.jsx(i.th,{children:"Description"})]})}),e.jsxs(i.tbody,{children:[e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"size"})}),e.jsx(i.td,{children:"Input"}),e.jsx(i.td,{children:"Opcional"}),e.jsx(i.td,{children:"string"}),e.jsx(i.td,{children:"sm"}),e.jsx(i.td,{children:"Defineix la mida del component."})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"icon"})}),e.jsx(i.td,{children:"Input"}),e.jsx(i.td,{children:"Opcional"}),e.jsx(i.td,{children:"string"}),e.jsx(i.td,{children:"Depèn de l'estat"}),e.jsx(i.td,{children:"Sobreescriu la icona mostrada. Per defecte cada estat tindrà una icona assignada."})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"state"})}),e.jsx(i.td,{children:"Input"}),e.jsx(i.td,{children:"Requerida"}),e.jsx(i.td,{children:"string"}),e.jsx(i.td,{children:"-"}),e.jsx(i.td,{children:"Estil que mostrarà el component en funció del nivell de criticitat o informació. Veure llistat de correspondència per saber quin estat definir."})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"disabled"})}),e.jsx(i.td,{children:"Input"}),e.jsx(i.td,{children:"Opcional"}),e.jsx(i.td,{children:"boolean"}),e.jsx(i.td,{children:"false"}),e.jsx(i.td,{children:"Assigna al component l’estat deshabilitat."})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"outlined"})}),e.jsx(i.td,{children:"Input"}),e.jsx(i.td,{children:"Opcional"}),e.jsx(i.td,{children:"boolean"}),e.jsx(i.td,{children:"false"}),e.jsx(i.td,{children:"Modifica l’aparença del component quan l’estat definit és de criticitat. Aquest paràmetre no afecta els estats de criticitat."})]})]})]}),`
