import{x as t}from"./lit-html-paDGiEfB.js";const z={title:"Components/Timepicker",argTypes:{label:{name:"Label"},inputSize:{name:"Input Size",control:{type:"radio"},options:["md","lg"]},enableDropdown:{name:"Enable dropdown",control:{type:"boolean"}},dropdown:{name:"Dropdown type",control:{type:"radio"},options:["list","manual"],if:{arg:"enableDropdown",truthy:!0}},minutesRange:{name:"Minutes Range",control:{type:"number"},if:{arg:"enableDropdown"}},minHour:{name:"Min Hour",control:{type:"number"},if:{arg:"enableDropdown"}},maxHour:{name:"Max Hour",control:{type:"number"},if:{arg:"enableDropdown"}},helpText:{name:"Message for initial help"},errorTimeFormatText:{name:"Message for wrong time format"},errorTimeOptionText:{name:"Message for non-available time in dropdown",if:{arg:"enableDropdown"}}}},i={render:e=>t`
    ...
    `,args:{label:"Label",enableDropdown:!1,inputSize:"lg",dropdown:"list",minutesRange:1,minHour:0,maxHour:23,helpText:"Help text.",errorTimeFormatText:"Format not valid.",errorTimeOptionText:"Option not available."}},n={tags:["!dev"],render:()=>t`
    <div class="container--flex">
    <dss-timepicker>
      <label slot="label" for="myTimepicker001">Label</label>

      <input slot="input" id="myTimepicker001" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>

    <dss-timepicker helpText="Help text.">
      <label slot="label" for="myTimepicker002">Label</label>

      <input slot="input" id="myTimepicker002" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>

    <dss-timepicker inputSize="md">
      <label slot="label" for="myTimepicker003">Label</label>

      <input slot="input" id="myTimepicker003" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>

    <dss-timepicker inputSize="md" helpText="Help text.">
      <label slot="label" for="myTimepicker004">Label</label>

      <input slot="input" id="myTimepicker004" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>
  </div>
    `},r={tags:["!dev"],render:()=>t`
    <div class="container--flex">
    <dss-timepicker>
      ...
      <input slot="input" id="myTimepicker005" type="text" class="dss-input" maxlength="5" disabled />
    </dss-timepicker>
  </div>
    `},l={tags:["!dev"],render:()=>t`
     <div class="container--flex">
    <dss-timepicker>
      ...
      <input slot="input" id="myTimepicker006" type="text" class="dss-input" maxlength="5" value="12:45" readonly />
    </dss-timepicker>
  </div>
    `},a={tags:["!dev"],render:()=>t`
    ...
    <dss-timepicker dropdown="list">
      ...
      <input slot="input" id="myTimepicker007" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>
    ...
    <dss-timepicker dropdown="list" errorTimeOptionText="Option not available" helpText="Help text." minHour="8" maxHour="18" minutesRange="15">
      ...
      <input slot="input" id="myTimepicker008" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>
  </div>
    `},s={tags:["!dev"],render:()=>t`
    <div class="container--flex container--dropdown">
    <dss-timepicker dropdown="list" customTimeListOptions="[{&#x22;value&#x22;:&#x22;08:00&#x22;, &#x22;state&#x22;:&#x22;available&#x22;},{&#x22;value&#x22;:&#x22;09:00&#x22;, &#x22;state&#x22;:&#x22;available&#x22;},{&#x22;value&#x22;:&#x22;10:00&#x22;, &#x22;state&#x22;:&#x22;ocupat&#x22;},{&#x22;value&#x22;:&#x22;11:00&#x22;, &#x22;state&#x22;:&#x22;available&#x22;},{&#x22;value&#x22;:&#x22;12:00&#x22;, &#x22;state&#x22;:&#x22;available&#x22;}]" helpText="Help text.">
      ...
      <input slot="input" id="myTimepicker009" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>
  </div>
    `},o={tags:["!dev"],render:()=>t`
    <div class="container--flex container--dropdown">
    <dss-timepicker dropdown="manual">
      ...
      <input slot="input" id="myTimepicker010" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>
    ...
    <dss-timepicker dropdown="manual" errorTimeOptionText="Option not available" helpText="Help text." minHour="8" maxHour="18" minutesRange="15">
      ...
      <input slot="input" id="myTimepicker011" type="text" class="dss-input" maxlength="5" />
    </dss-timepicker>
  </div>
...
}`,...(d=(m=i.parameters)==null?void 0:m.docs)==null?void 0:d.source}}};var c,x,u;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="container--flex">
...
}`,...(u=(x=n.parameters)==null?void 0:x.docs)==null?void 0:u.source}}};var b,T,k;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="container--flex">
...
}`,...(w=(f=a.parameters)==null?void 0:f.docs)==null?void 0:w.source}}};var L,H,$;s.parameters={...s.parameters,docs:{...(L=s.parameters)==null?void 0:L.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="container--flex container--dropdown">
...
}`,...($=(H=s.parameters)==null?void 0:H.docs)==null?void 0:$.source}}};var S,O,D;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="container--flex container--dropdown">
...
}`,...(D=(O=o.parameters)==null?void 0:O.docs)==null?void 0:D.source}}};const R=["Playground","ByDefault","Disabled","ReadOnly","DropdownList","CustomDropdownList","DropdownManual"],M=Object.freeze(Object.defineProperty({__proto__:null,ByDefault:n,CustomDropdownList:s,Disabled:r,DropdownList:a,DropdownManual:o,Playground:i,ReadOnly:l,__namedExportsOrder:R,default:z},Symbol.toStringTag,{value:"Module"}));export{n as B,s as C,r as D,i as P,l as R,M as S,a,o as b};
