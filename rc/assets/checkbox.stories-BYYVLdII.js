import{x as l}from"./lit-html-paDGiEfB.js";const m={title:"Components/Checkbox",argTypes:{withLabel:{name:"Amb text",control:{type:"boolean"}},label:{name:"Text",control:{type:"text"},if:{arg:"withLabel"}},disabled:{name:"Deshabil·litar",control:{type:"boolean"}},checked:{name:"Marcat",control:{type:"boolean"}},validateType:{name:"Tipús validacio (verd)",control:{type:"boolean"}}},parameters:{layout:"centered"}},s={render:e=>l`
