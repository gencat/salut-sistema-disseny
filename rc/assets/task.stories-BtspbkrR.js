import"./lit-element-vV9fql9z.js";import{x as s}from"./lit-html-paDGiEfB.js";const U={title:"Components/Task",argTypes:{title1:{name:"Títol 1º Task",control:{type:"text"}},type1:{name:"Tipus alerta 1º Task",control:{type:"select"},options:["Sense informació","Resultat normal","Resultat alterat","Resultat patològic","Tasca pendent","Receptes que caduquen entre 11 i 60 dies","Receptes que caduquen en menys de 10 dies","Receptes caducades"]},title2:{name:"Títol 2º Task",control:{type:"text"}},type2:{name:"Tipus alerta 2º Task",control:{type:"select"},options:["Sense informació","Resultat normal","Resultat alterat","Resultat patològic","Tasca pendent","Receptes que caduquen entre 11 i 60 dies","Receptes que caduquen en menys de 10 dies","Receptes caducades"]},title3:{name:"Títol 3º Task",control:{type:"text"}},type3:{name:"Tipus alerta 3º Task",control:{type:"select"},options:["Sense informació","Resultat normal","Resultat alterat","Resultat patològic","Tasca pendent","Receptes que caduquen entre 11 i 60 dies","Receptes que caduquen en menys de 10 dies","Receptes caducades"]}},parameters:{layout:"centered"}},n={render:d=>{let e="",a="",t="";const v=s`<div
    ...
    >
      ...
      <span>1 - CAD</span>
    </div>`;switch(d.type1){case"Sense informació":e=v;break;case"Resultat normal":e=m;break;case"Resultat alterat":e=k;break;case"Resultat patològic":e=g;break;case"Tasca pendent":e=_;break;case"Receptes que caduquen entre 11 i 60 dies":e=y;break;case"Receptes que caduquen en menys de 10 dies":e=h;break;case"Receptes caducades":e=R;break}switch(d.type2){case"Sense informació":a=v;break;case"Resultat normal":a=m;break;case"Resultat alterat":a=k;break;case"Resultat patològic":a=g;break;case"Tasca pendent":a=_;break;case"Receptes que caduquen entre 11 i 60 dies":a=y;break;case"Receptes que caduquen en menys de 10 dies":a=h;break;case"Receptes caducades":a=R;break}switch(d.type3){case"Sense informació":t=v;break;case"Resultat normal":t=m;break;case"Resultat alterat":t=k;break;case"Resultat patològic":t=g;break;case"Tasca pendent":t=_;break;case"Receptes que caduquen entre 11 i 60 dies":t=y;break;case"Receptes que caduquen en menys de 10 dies":t=h;break;case"Receptes caducades":t=R;break}return s`<div class="dss-task">
      <div class="dss-task__item">
        <input class="dss-task__selector" name="task" type="radio" />
        <div class=" dss-task__content">
          <h4 class="dss-task__title dss-subtitle--sm">${d.title1}</h4>
          ${e}
        </div>
      </div>
      <div class="dss-task__item">
        <input class="dss-task__selector" name="task" type="radio" />
        <div class=" dss-task__content">
          <h4 class="dss-task__title dss-subtitle--sm">${d.title2}</h4>
          ${a}
        </div>
      </div>
      <div class="dss-task__item">
        <input class="dss-task__selector" name="task" type="radio" />
        <div class=" dss-task__content">
          <h4 class="dss-task__title dss-subtitle--sm">${d.title3}</h4>
          ${t}
        </div>
      </div>
...
}`,...(P=(A=i.parameters)==null?void 0:A.docs)==null?void 0:P.source}}};var w,D,N;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="dss-task">
...
}`,...(N=(D=c.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};var C,E,x;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
    <div class="dss-task">
...
}`,...(x=(E=l.parameters)==null?void 0:E.docs)==null?void 0:x.source}}};var $,I,O;r.parameters={...r.parameters,docs:{...($=r.parameters)==null?void 0:$.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: () => {
    return html\`
      <div class="dss-task">
