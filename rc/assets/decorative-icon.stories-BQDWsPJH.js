import{x as o}from"./lit-html-paDGiEfB.js";const w={title:"Components/Decorative Icon",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg","xl"]},color:{name:"Colors",control:{type:"select"},options:["default","success","error","disabled"]},iconType:{name:"Tipús icona",control:{type:"select"},options:["dss-icon","dss-icon dss-icon--fill"]},icon:{name:"Icona"}},parameters:{layout:"centered"}},s={render:a=>o`
    <div
