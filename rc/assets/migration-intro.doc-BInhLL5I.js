import{ae as e,af as s}from"./index-D51CeFyD.js";import{u as i}from"./index-Dvvi2AU9.js";import"./chunk-NUUEMKO5-BrMvvjZ4.js";import"./iframe-C-plfy9T.js";import"../sb-preview/runtime.js";import"./index-u5I_DdWt.js";import"./index-D-8MO0q_.js";import"./index-DrFu-skq.js";function o(a){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Migració V2/Intro"}),`
...
`,e.jsx(n.h4,{id:"elementos-desplegables-tooltips-action-menu-popovers-dropdowns",children:"Elementos desplegables: Tooltips, Action Menu, Popovers, Dropdowns"}),`
...
`,e.jsx(n.p,{children:`Esto nos estaba generando problemas de renderizado en situaciones donde se aplicaban los despeglabes en conteneddores
con un espacio limitado con scroll o overflow:hidden, o bien en contenedores situados en los bordes de la ventana.`}),`
...
`,e.jsx(n.p,{children:`Por este motivo, se ha refactorizado la funcionalidad de todos estos elementos para que cada desplegable se posicione dinámicamente
con respecto al contenedor que lo engloba pero siempre fuera del propio flujo de dicho contenedor. De forma que no se vea afectado
por la altura del mismo o por los bordes de la ventana.`}),`
`,e.jsx(n.p,{children:`La nueva funcionalidad incluye, además, la gestión dinámica del desplegable en función de la posición del contenedor en la ventana,
de forma que en aquellas situaciones donde no haya suficiente espacio para desplegar el contenido en una dirección, el elemento
modificará automáticamente su posición para estar siempre visible.`}),`
`,e.jsx(n.p,{children:"Todos estos cambios implican un refactor que debe hacerse tambien a nivel de iniciativas para adaptar el nuevo comportamiento."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Modificaciones necesarias:"})}),`
`,e.jsx(n.p,{children:`Hasta ahora los componentes desplegables se mostraban visibles por defecto (tooltips), siendo necesario añadir una lógica CSS
para ocultar o mostrar el componente cuando se hacía hover en el elemento relacionado, o bien era necesario definir una lógica externa
usando una propiedad open para mostrar u ocultar.`}),`
`,e.jsx(n.p,{children:"o debía manejarse la lógi"})]})}function h(a={}){const{wrapper:n}={...i(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(o,{...a})}):o(a)}export{h as default};
