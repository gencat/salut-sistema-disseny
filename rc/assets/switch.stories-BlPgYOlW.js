import"./lit-element-vV9fql9z.js";import{x as s}from"./lit-html-paDGiEfB.js";const $={title:"Discontinued/Switch ⚠️",argTypes:{size:{name:"Mida",control:{type:"radio"},options:["sm","md","lg"]},showLabel:{name:"Mostrar Label",control:{type:"boolean"}},label:{name:"Label",if:{arg:"showLabel"}}},parameters:{layout:"centered"}},e={render:l=>{const P=l.showLabel?l.label:null;return s`
