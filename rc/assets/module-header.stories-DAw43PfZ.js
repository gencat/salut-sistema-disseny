import{x as a}from"./lit-html-paDGiEfB.js";const B={title:"Components/Module Header",argTypes:{title:{name:"Títol",control:{type:"text"}},withDescription:{name:"Amb descripció",control:{type:"boolean"}},description:{name:"Descripció",control:{type:"text"},if:{arg:"withDescription"}},withButton:{name:"Amb botó",control:{type:"boolean"}},buttonNumber:{name:"Quantitat de botons",control:{type:"select"},options:[1,2],if:{arg:"withButton"}}},parameters:{layout:"centered"}},t={render:s=>{let c="";const o=document.createElement("div");o.className="dss-module-header__container",o.innerHTML=`<div class="dss-headline--sm">${s.title}</div>`;const i=document.createElement("div");if(i.className="dss-module-header__child-container",o.appendChild(i),s.withDescription&&(i.innerHTML=`<div class="dss-legend--sm">${s.description}</div>`),s.withButton){for(let l=1;l<=s.buttonNumber;l++)c+=`<button type="button" class="dss-button dss-button--md dss-button--subtle dss-button--icon-left">
