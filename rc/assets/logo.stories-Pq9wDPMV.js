import{x as a}from"./lit-html-paDGiEfB.js";const n={title:"Foundations/Logo",argTypes:{style:{name:"Estil",control:{type:"radio"},options:["default","negative","positive"]},width:{name:"Amplaria",control:{type:"text"}}},parameters:{layout:"centered"}},t={render:e=>a`<img
      style="width:${e.width};"
