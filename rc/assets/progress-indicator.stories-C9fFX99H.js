import"./lit-element-vV9fql9z.js";import{x as i}from"./lit-html-paDGiEfB.js";const m={title:"Components/Progress Indicator",argTypes:{title:{name:"Títol"},description:{name:"Descripció"},percentage:{name:"Percentatge",control:{type:"range",min:0,max:100,step:1}},hasFailed:{name:"Mostrar error",control:{type:"boolean"}}},parameters:{layout:"centered"}},r={render:t=>i`<dss-progress-indicator
      title="${t.title}"
